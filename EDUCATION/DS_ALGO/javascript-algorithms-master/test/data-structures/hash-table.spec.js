import mod from '../../src/data-structures/hash-table.js';
const Node = mod.Node;
const Hashtable = mod.Hashtable;
...
describe('Hash table', () => {
  ...
  it('should put() K(int):V in table properly.', () => {
    const hashTable = new Hashtable();
    hashTable.put(10, 'value');
    expect(hashTable.buckets[10].data).toBe('value');
  });
  it('should put() K(string):V in table properly.', () => {
    const hashTable = new Hashtable();
  ...
  it('should put() multiple K(int):Vs with hash collisions in properly (1).', () => {
    const hashTable = new Hashtable();
  ...
  it('should put() multiple K(int):Vs with hash collisions in properly (2).', () => {
    const hashTable = new Hashtable();
    hashTable.put(10, 'value', 'someHash');
    hashTable.put(35, 'anotherValue', 'someHash');
  ...
  it('should put() multiple K(string):Vs with hash collisions in properly (1).', () => {
    const hashTable = new Hashtable();
    // Same hash so going to same bucket, but different keys. Collision.
  ...
  it('should put() multiple K(string):Vs with hash collisions in properly (2).', () => {
    const hashTable = new Hashtable();
    hashTable.put('keyA', 'value', 'someHash');
    hashTable.put('keyB', 'anotherValue', 'someHash');
  ...
  it('should get() a K(int):V from table properly.', () => {
    const hashTable = new Hashtable();
    hashTable.put(10, 'value');
    expect(hashTable.get(10)).toBe('value');
  });
  it('should get() a K(string):V from table properly.', () => {
    const hashTable = new Hashtable();
    hashTable.put('keyA', 'value');
    expect(hashTable.get('keyA')).toBe('value');
  });
  it('should get() a K(int):V with collisions from table properly (1).', () => {
    const hashTable = new Hashtable();
    hashTable.put(10, 'value', 'someHash');
    hashTable.put(35, 'anotherValue', 'someHash');
    expect(hashTable.get(35, 'someHash')).toBe('anotherValue');
  });
  it('should get() a K(int):V with collisions from table properly (2).', () => {
    const hashTable = new Hashtable();
    hashTable.put(10, 'value', 'someHash');
    hashTable.put(35, 'anotherValue', 'someHash');
    hashTable.put(77, 'lastValue', 'someHash');
  ...
  it('should get() a K(int):V with collisions from table properly (3).', () => {
    const hashTable = new Hashtable();
    hashTable.put(10, 'value', 'someHash');
    hashTable.put(35, 'anotherValue', 'someHash');
    hashTable.put(77, 'lastValue', 'someHash');
  ...
  it('should get() a K(int):V with collisions from table properly (4).', () => {
    const hashTable = new Hashtable();
    hashTable.put(10, 'value', 'someHash');
    hashTable.put(35, 'anotherValue', 'someHash');
    hashTable.put(77, 'lastValue', 'someHash');
  ...
  it('should get() a K(string):V with collisions from table properly (1).', () => {
    const hashTable = new Hashtable();
    hashTable.put('keyA', 'value', 'someHash');
    hashTable.put('keyB', 'anotherValue', 'someHash');
    expect(hashTable.get('keyB', 'someHash')).toBe('anotherValue');
  });
  it('should get() a K(string):V with collisions from table properly (2).', () => {
    const hashTable = new Hashtable();
    hashTable.put('keyA', 'value', 'someHash');
    hashTable.put('keyB', 'anotherValue', 'someHash');
    hashTable.put('keyC', 'lastValue', 'someHash');
  ...
  it('should get() a K(string):V with collisions from table properly (3).', () => {
    const hashTable = new Hashtable();
    hashTable.put('keyA', 'value', 'someHash');
    hashTable.put('keyB', 'anotherValue', 'someHash');
    hashTable.put('keyC', 'lastValue', 'someHash');
  ...
  it('should get() a K(string):V with collisions from table properly (4).', () => {
    const hashTable = new Hashtable();
    hashTable.put('keyA', 'value', 'someHash');
    hashTable.put('keyB', 'anotherValue', 'someHash');
    hashTable.put('keyC', 'lastValue', 'someHash');
  ...
  it('should remove() a K(int):V from table properly (1).', () => {
  ...
  it('should remove() a K(int):V with collisions from table properly (2).', () => {
  ...
  it('should remove() a K(int):V with collisions from table properly (3).', () => {
  ...
  it('should remove() a K(int):V with collisions from table properly (4).', () => {
  ...
  it('should remove() a K(string):V from table properly (1).', () => {
    // remove only node/link in bucket : (B)
    const hashTable = new Hashtable();
    hashTable.put('keyA', 'value');
  ...
  it('should remove() a K(string):V with collisions from table properly (2).', () => {
    // remove start node/link in bucket : (B) - A
    const hashTable = new Hashtable();
    hashTable.put('keyA', 'value', 'someHash');
    hashTable.put('keyB', 'anotherValue', 'someHash');
  ...
  it('should remove() a K(string):V with collisions from table properly (3).', () => {
    // remove start node/link in bucket : (B) - A - C
    const hashTable = new Hashtable();
    hashTable.put('keyA', 'value', 'someHash');
    hashTable.put('keyB', 'anotherValue', 'someHash');
  ...
  it('should remove() a K(string):V with collisions from table properly (4).', () => {
    // remove middle node/link in bucket : A - (B) - C
    const hashTable = new Hashtable();
    hashTable.put('keyA', 'value', 'someHash');
    hashTable.put('keyB', 'anotherValue', 'someHash');
