  ...
  return {
    fetchAccountInfo: function () {
      ...
      function _doneHandler(a, b, response) {
        ...
        // console.log('\nFetch User Info...')
        // console.dir(resp)
        Notifier.showMessage('Sup ' + resp.display_name)
      } // end done handler
    ...
    bindNav: function () {
      $('#save_dropbox').on('click', function () {
        profile.current_filename =
          profile.current_filename ||
          '/Dillinger/' + generateRandomFilename('md')
      ...
      $('#import_dropbox').on('click', function () {
