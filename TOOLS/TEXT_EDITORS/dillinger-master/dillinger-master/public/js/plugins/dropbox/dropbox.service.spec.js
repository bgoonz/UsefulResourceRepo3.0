...
describe('dropboxService', function () {
  ...
  it('should save the current file on dropbox and return success message', function () {
    ...
    $httpBackend
      .expectPOST('save/dropbox')
      .respond({ data: { path: '/Dillinger/' + markDownDocument.title } })
    ...
    expect(diNotifyElementsText).toContain(
      'Successfully saved to: /Dillinger/DropBoxTestTitle'
    )
  })
})
