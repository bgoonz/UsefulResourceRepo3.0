...
module.exports = angular
  ...
  .factory('onedriveService', function ($http, diNotify) {
    ...
    service = {
      ...
      fetchFile: function (fileId, fileName) {
        return $http.get('fetch/onedrive?fileId=' + fileId).then(
          function successCallback(data) {
      ...
      fetchFiles: function () {
        ...
        return $http.get('import/onedrive').then(
          function successCallback(data) {
      ...
      restore: function () {
        service.fetched =
          angular.fromJson(localStorage.getItem('onedrive')) || defaults
