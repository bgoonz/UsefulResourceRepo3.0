...
module.exports = angular
  .module('plugins.onedrive', [
    'plugins.onedrive.service',
    'plugins.onedrive.modal'
  ])
  .controller(
    'Onedrive',
    function ($rootScope, $modal, onedriveService, documentsService) {
        ...
        return modalInstance.result.then(
          function successCallback() {
            documentsService.setCurrentDocumentTitle(
              onedriveService.fetched.fileName
            )
            documentsService.setCurrentDocumentBody(
              onedriveService.fetched.file
            )
