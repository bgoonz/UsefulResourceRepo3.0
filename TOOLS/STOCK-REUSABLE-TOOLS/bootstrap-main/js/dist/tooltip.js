  ...
  var Tooltip = /*#__PURE__*/ (function (_BaseComponent) {
    ...
    _proto.toggle = function toggle(event) {
      ...
      if (event) {
        ...
        var context = Data__default["default"].getData(
    ...
    _proto._enter = function _enter(event, context) {
      ...
      context =
        context ||
        Data__default["default"].getData(event.delegateTarget, dataKey);
    ...
    _proto._getConfig = function _getConfig(config) {
      var dataAttributes = Manipulator__default["default"].getDataAttributes(
        this._element
      );
