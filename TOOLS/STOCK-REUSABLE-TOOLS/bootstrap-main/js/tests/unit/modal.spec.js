...
describe("Modal", () => {
  ...
  describe("toggle", () => {
    it("should toggle a modal", (done) => {
      ...
      modalEl.addEventListener("shown.bs.modal", () => {
        expect(document.body.getAttribute("data-bs-padding-right")).toEqual(
          originalPadding,
          "original body padding should be stored in data-bs-padding-right"
        );
        modal.toggle();
      });
    ...
    it("should adjust the inline padding of fixed elements when opening and restore when closing", (done) => {
      ...
      const originalPadding = Number.parseInt(
      ...
      modalEl.addEventListener("shown.bs.modal", () => {
        ...
        expect(fixedEl.getAttribute("data-bs-padding-right")).toEqual(
          "0px",
    ...
    it("should adjust the inline margin of sticky elements when opening and restore when closing", (done) => {
      ...
      const originalMargin = Number.parseInt(
      ...
      modalEl.addEventListener("shown.bs.modal", () => {
        ...
        const currentMargin = Number.parseInt(
          window.getComputedStyle(stickyTopEl).marginRight,
          10
        );

        expect(stickyTopEl.getAttribute("data-bs-margin-right")).toEqual(
          "0px",
  ...
  describe("show", () => {
    ...
    it("should not close modal when clicking outside of modal-content if backdrop = static", (done) => {
      fixtureEl.innerHTML =
        '<div class="modal" data-bs-backdrop="static" ><div class="modal-dialog"></div></div>';
    ...
    it("should not overflow when clicking outside of modal-content if backdrop = static", (done) => {
      fixtureEl.innerHTML =
        '<div class="modal" data-bs-backdrop="static"><div class="modal-dialog" style="transition-duration: 20ms;"></div></div>';
