...
function collectNonEnumProps(e, t) {
  ...
  var n = nonEnumerableProps.length,
    ...
    a = "constructor";
  for (has(e, a) && !t.contains(a) && t.push(a); n--; )
...
function deepEq(e, t, n, r) {
  ...
  if ((n.push(e), r.push(t), a)) {
    ...
    for (; s--; ) if (!has(t, (c = f[s])) || !eq(e[c], t[c], n, r)) return !1;
  }
...
function get(e, t, n) {
  var r = deepGet(e, toPath$1(t));
  return isUndefined(r) ? n : r;
}
function has$1(e, t) {
  for (var n = (t = toPath$1(t)).length, r = 0; r < n; r++) {
    var i = t[r];
    if (!has(e, i)) return !1;
    e = e[i];
  }
...
function cb(e, t, n) {
  return _.iteratee !== iteratee ? _.iteratee(e, t) : baseIteratee(e, t, n);
}
...
function template(e, t, n) {
  !t && n && (t = n), (t = defaults({}, t, _.templateSettings));
  var r,
    i = RegExp(
      [
  ...
  e.replace(i, function (t, n, r, i, o) {
    return (
      (u += e.slice(a, o).replace(escapeRegExp, escapeChar)),
      (a = o + t.length),
      n
    ...
    (u =
      ...
      "return __p;\n");
  try {
    r = new Function(t.variable || "obj", "_", u);
  } catch (e) {
    throw ((e.source = u), e);
  }
  var o = function (e) {
...
function flatten(e, t, n, r) {
  ...
  for (var i = r.length, a = 0, u = getLength(e); a < u; a++) {
    ...
    if (isArrayLike(o) && (isArray(o) || isArguments$1(o)))
      if (t > 1) flatten(o, t - 1, n, r), (i = r.length);
...
function memoize(e, t) {
  var n = function (r) {
    ...
    return has(i, a) || (i[a] = e.apply(this, arguments)), i[a];
  };
  return (n.cache = {}), n;
}
...
function debounce(e, t, n) {
  var r,
    ...
    u = restArguments(function (u) {
      if ((r && clearTimeout(r), n)) {
        var o = !r;
        (r = setTimeout(a, t)), o && (i = e.apply(this, u));
      } else r = delay(a, t, this, u);
      return i;
    });
  return (
    (u.cancel = function () {
...
var invoke = restArguments(function (e, t, n) {
  ...
  return (
    isFunction$1(t)
      ? (i = t)
      : ((t = toPath$1(t)), (r = t.slice(0, -1)), (t = t[t.length - 1])),
    map(e, function (e) {
      var a = i;
      if (!a) {
...
var pick = restArguments(function (e, t) {
    ...
    isFunction$1(r)
      ...
      : ((r = keyInObj), (t = flatten(t, !1, !1)), (e = Object(e)));
  ...
  return (
    each(functions(e), function (t) {
      ...
      _.prototype[t] = function () {
        var e = [this._wrapped];
        return push.apply(e, arguments), chainResult(this, n.apply(_, e));
      };
    }),
    _
  );
