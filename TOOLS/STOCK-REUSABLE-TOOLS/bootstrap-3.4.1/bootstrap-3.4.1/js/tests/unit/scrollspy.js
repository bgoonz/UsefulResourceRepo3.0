$(function () {
  ...
  QUnit.test(
    ...
    function (assert) {
      ...
      $scrollspy.on("scroll.bs.scrollspy", function () {
        assert.ok(
          !$section.find("#one-link").parent().hasClass("active"),
          '"active" class removed from first section'
        );
        assert.ok(
          $section.find("#two-link").parent().hasClass("active"),
          '"active" class on middle section'
        );
        assert.ok(
          !$section.find("#three-link").parent().hasClass("active"),
