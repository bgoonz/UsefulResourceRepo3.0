          ...
          for (
            ...
            if (K.flags.dimensions.match(j))
              ...
              null == K.vars.cache.themeKeys &&
                (K.vars.cache.themeKeys = Object.keys(b.themes));
              var n =
                K.vars.cache.themeKeys[
                  0 | (Math.random() * K.vars.cache.themeKeys.length)
                ];
        ...
        function g(a) {
          ...
          "background" == e
            ? ((g.style.backgroundImage = "url(" + d + ")"),
              (g.style.backgroundSize = j.width + "px " + j.height + "px"))
            : ("img" === g.nodeName.toLowerCase()
                ? p(g, { src: d })
                : "object" === g.nodeName.toLowerCase() &&
                  (p(g, { data: d }), p(g, { type: "image/svg+xml" })),
              i.reRender &&
                b.setTimeout(function () {
                  ...
                  "img" === g.nodeName.toLowerCase()
                    ? p(g, { src: a })
                    : "object" === g.nodeName.toLowerCase() &&
                      (p(g, { data: a }), p(g, { type: "image/svg+xml" }));
                }, 100)),
          ...
          if (h.lineCount > 1) {
            ...
            for (var p = 0; p < h.words.length; p++) {
              ...
              (l + q.width >= n || r === !0) &&
                ...
                (k.y = m)),
                r !== !0 &&
                  (j.moveTo(l, 0), (l += h.spaceWidth + q.width), k.add(j));
            }
            b(g, k, l, g.properties.leading);
          ...
          for (
            ...
            (a = K.vars.invisibleImages[d[e]]),
              E(a) &&
                ...
                (c.push(a), delete K.vars.invisibleImages[d[e]]);
          c.length && J.run({ images: c }), b.requestAnimationFrame(l);
        }
        function m() {
          K.vars.visibilityCheckStarted ||
            (b.requestAnimationFrame(l), (K.vars.visibilityCheckStarted = !0));
        }
        function n(a) {
        ...
        var v = c(1),
          ...
          J = {
            ...
            addTheme: function (a, b) {
              return (
                null != a && null != b && (K.settings.themes[a] = b),
            ...
            run: function (a) {
              ...
              (K.vars.preempted = !0),
                ...
                -1 === K.setup.renderers.join(",").indexOf(c.renderer) &&
          ...
          L = (function () {
            ...
            return function (d) {
              ...
              if (K.setup.supportsSVG) {
                ...
                var j = b.getBBox(),
                  k = Math.ceil(
                    j.width / (e.properties.width * K.setup.lineWrapRatio)
                  ),
                  l = i.text.split(" "),
                  m = i.text.match(/\\n/g);
                (k += null == m ? 0 : m.length),
                ...
                return (
                  ...
                  { spaceWidth: s, lineCount: k, boundingBox: j, words: t }
                );
              }
              return !1;
            };
              ...
              return (
                ...
                function (b, e) {
                  ...
                  var H =
                    ...
                    btoa(unescape(encodeURIComponent(r(c, e.engineSettings))));
                  return H;
                }
              );
            }
          ...
          (function () {
            ...
            d.getContext &&
              ...
              document.createElementNS &&
                ...
                ((K.setup.renderer = "svg"), (K.setup.supportsSVG = !0));
          })(),
          m(),
          v &&
            v(function () {
              K.vars.preempted || J.run(),
                b.addEventListener
                  ? (b.addEventListener("resize", u, !1),
                    b.addEventListener("orientationchange", u, !1))
        ...
        e = function (a) {
          ...
          var c = 1,
            ...
            g = d(e, function (a) {
              ...
              (this.Group = d.extend(this, { constructor: c, type: "group" })),
                (this.Rect = d.extend(this, { constructor: c, type: "rect" })),
