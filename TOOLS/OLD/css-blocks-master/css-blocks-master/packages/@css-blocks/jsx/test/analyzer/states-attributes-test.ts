...
export class Test {
  ...
  @skip
  @test
  "When provided state value is string literal, only the corresponding state is registered"() {
    mock({
      "bar.block.css": `
        :scope { color: blue; }
        .pretty { color: red; }
  ...
  @skip
  @test
  "When provided state value is dynamic, all states in the group are registered"() {
    mock({
      "bar.block.css": `
        :scope { color: blue; }
        .pretty { color: red; }
  ...
  @skip
  @test
  "Boolean states with no value only ever register the one state and are never dynamic"() {
    mock({
      "bar.block.css": `
        :scope { color: blue; }
        .pretty { color: red; }
  ...
  @skip
  @test
  "Boolean states with a literal value only ever register the one state and are not dynamic"() {
    mock({
      "bar.block.css": `
        :scope { color: blue; }
        .pretty { color: red; }
  ...
  @skip
  @test
  "Boolean states with a dynamic value only ever register the one state and are dynamic"() {
    mock({
      "bar.block.css": `
        :scope { color: blue; }
        .pretty { color: red; }
