(function () {
  ...
  QUnit.test("bind", function (assert) {
    ...
    assert.strictEqual(
      typeof _.bind(func, 0)(),
      "object",
      "binding a primitive to `this` returns a wrapped primitive"
    );

    assert.strictEqual(
      _.bind(func, 0)().valueOf(),
      0,
      "can bind a function to `0`"
    );
    assert.strictEqual(
      _.bind(func, "")().valueOf(),
      "",
      "can bind a function to an empty string"
    );
    assert.strictEqual(
      _.bind(func, false)().valueOf(),
      false,
      "can bind a function to `false`"
    );
  ...
  QUnit.test("bindAll", function (assert) {
    ...
    assert.strictEqual(
      sayHi(),
      "hi: moe",
      "deeply flattens arguments into a single list"
    );
  });
  ...
  QUnit.test("throttle", function (assert) {
    ...
    _.delay(function () {
      assert.strictEqual(counter, 2, "incr was throttled");
      done();
    }, 64);
  });
  ...
  QUnit.test("throttle arguments", function (assert) {
    ...
    _.delay(function () {
      assert.strictEqual(value, 3, "updated to latest value");
      done();
    }, 104);
  });
  ...
  QUnit.test("throttle once", function (assert) {
    ...
    _.delay(function () {
      ...
      assert.strictEqual(counter, 1, "incr was called once");
      done();
    }, 64);
  });
  ...
  QUnit.test("throttle twice", function (assert) {
    ...
    throttledIncr();
    _.delay(function () {
      assert.strictEqual(counter, 2, "incr was called twice");
      done();
    }, 64);
  });
    ...
    function (assert) {
      ...
      _.delay(function () {
        ...
        assert.strictEqual(
          counter,
          2,
          "incr was throttled successfully, with tampered system time"
        );
        done();
  ...
  QUnit.test(
    "throttle continues to function after system time is not accessible (or in invalid format)",
    function (assert) {
      assert.expect(3);
      var done = assert.async();
      var counter = 0;
      ...
      _.delay(function () {
        ...
        assert.strictEqual(
          counter,
          3,
          "incr was throttled successfully, after system time method restoration"
        );
        done();
      }, 400);
    }
  ...
  QUnit.test("debounce after system time is set backwards", function (assert) {
    ...
    _.delay(function () {
      ...
      assert.strictEqual(
        counter,
        2,
        "incr was debounced successfully, with tampered system time"
      );
      done();
      Date.now = originalNowFunc;
      Date.prototype.getTime = originalGetTimeFunc;
  ...
  QUnit.test(
    "debounce after system time is is not accessible (or in invalid format)",
    function (assert) {
      assert.expect(3);
      var done = assert.async();
      var counter = 0;
      ...
      _.delay(function () {
        ...
        assert.strictEqual(
          counter,
          3,
          "incr was debounced successfully, after system time method restoration"
        );
        done();
      }, 400);
    }
  ...
  QUnit.test("debounce re-entrant", function (assert) {
    ...
    _.delay(function () {
      assert.strictEqual(
        value,
        "a1a2b1b2",
        "append was debounced successfully"
      );
      done();
    }, 100);
  });
  ...
  QUnit.test("after", function (assert) {
    ...
    assert.strictEqual(
      testAfter(0, 0),
      0,
      "after(0) should not fire immediately"
    );
    assert.strictEqual(
      testAfter(0, 1),
      1,
      "after(0) should fire when first invoked"
    );
  });
  ...
  QUnit.test("before", function (assert) {
    ...
    assert.strictEqual(
      testBefore(0, 0),
      0,
      "before(0) should not fire immediately"
    );
    assert.strictEqual(
      testBefore(0, 1),
      0,
  ...
  QUnit.test("iteratee", function (assert) {
    ...
    assert.strictEqual(
      deepProperty({ a: { b: 2 } }),
      2,
      "treats an array as a deep property accessor"
    );
