...
!(function (a, b) {
  ...
  function h(a) {
    return (
      w.postProcessor &&
        "function" == typeof w.postProcessor &&
        (a = w.postProcessor.call(a, a) || a),
      a
    );
  }
  function i(a, c) {
  ...
  function q() {
    if (
      a.XMLHttpRequest &&
      !("file:" === a.location.protocol && "ActiveXObject" in a)
    )
  ...
  function s(b, c, d, e) {
    ...
    if (
      ...
      h.relativeUrls &&
        (h.rootpath = e.rootpath
          ? o(e.rootpath + p(f.path, h.entryPath)).path
          : f.path),
      e.useFileCache && E[g])
    )
      try {
        ...
        function (h, i, j, k, l) {
          if (l) {
            ...
            if (
              ...
              o &&
              l.lastModified &&
              new Date(l.lastModified).valueOf() === new Date(o).valueOf()
            )
  ...
  w === b && ((w = exports), (x = c("./tree")), (w.mode = "node")),
    (w.Parser = function (a) {
      ...
      function n(a, b) {
        return v.charAt(y) === a
          ? (l(1), a)
          : void o(b || "expected '" + a + "' got '" + v.charAt(y) + "'");
      }
      function o(a, b) {
        var c = new Error(a);
        ...
        (E = {
          ...
          parse: function (d, e, f) {
            ...
            if (
              ...
              (j =
                f && f.globalVars
                  ? w.Parser.serializeVars(f.globalVars) + "\n"
                  : ""),
              (k =
                f && f.modifyVars
              ...
              (j || (f && f.banner)) &&
                ...
                (E.imports.contentsIgnoredChars[a.currentFileInfo.filename] =
                  m.length)),
              (d = d.replace(/\r\n/g, "\n")),
              (v = d = m + d.replace(/^\uFEFF/, "") + k),
              ...
              (B = (function (b) {
                ...
                for (i = 0; o > i; i++)
                  if (
                    ((k = b.charCodeAt(i)), !((k >= 97 && 122 >= k) || 34 > k))
                  )
                    switch (k) {
                      case 40:
                        q++, (f = i);
                      ...
                      case 96:
                        ...
                        if (n) continue;
                        return c(
                          "unmatched `" + String.fromCharCode(k) + "`",
                          j
                        );
                      case 47:
                        if (q || i == o - 1) continue;
                ...
                return function (e, f) {
                  ...
                  if (e.cleancss && "node" === w.mode) {
                    var o = c("clean-css"),
                      p = e.cleancssOptions || {};
                    return (
                      p.keepSpecialComments === b &&
                        (p.keepSpecialComments = "*"),
                      (p.processImport = !1),
                      (p.noRebase = !0),
            ...
            var p = function (b) {
              return (
                (b = l || b || E.imports.error),
                b ? (b instanceof u || (b = new u(b, a)), e(b)) : e(null, g)
              );
            };
            return a.processImports === !1
              ? p()
              : void new x.importVisitor(this.imports, p).run(g);
          },
          parsers: (F = {
            primary: function () {
            ...
            entities: {
              ...
              call: function () {
                ...
                if ((b = /^([\w-]+|%|progid:[\w\.]+)\(/.exec(C))) {
                  ...
                  if (
                    ((y += b.length),
                    "alpha" === c && ((e = F.alpha()), "undefined" != typeof e))
                  )
                    return e;
              ...
              assignment: function () {
                ...
                return (
                  (a = j(/^\w+(?=\s?=)/i)),
                  a && k("=")
                    ? ((b = F.entity()), b ? new x.Assignment(a, b) : void 0)
                    : void 0
                );
              },
              url: function () {
            ...
            variable: function () {
              var a;
              return "@" === v.charAt(y) && (a = j(/^(@[\w-]+)\s*:/))
                ? a[1]
                : void 0;
            },
            rulesetCall: function () {
              var a;
              return "@" === v.charAt(y) && (a = j(/^(@[\w-]+)\s*\(\s*\)\s*;/))
                ? new x.RulesetCall(a[1])
                : void 0;
            },
            extend: function (a) {
              var b,
            ...
            mixin: {
              ...
              args: function (a) {
                ...
                for (d(); ; ) {
                  ...
                  if (
                    (a
                      ? l.value && 1 == l.value.length && (t = l.value[0])
                      : (t = l),
                    t && t instanceof x.Variable)
                  )
                    if (k(":")) {
                      if (
                        (q.length > 0 &&
                          (b && o("Cannot mix ; and , as delimiter types"),
                          (c = !0)),
                      ...
                      if (!a && j(/^\.{3}/)) {
                        (p.variadic = !0),
                          k(";") && !b && (b = !0),
                          (b ? r : s).push({ name: l.name, variadic: !0 });
                        break;
                      }
                      a || ((g = h = t.name), (i = null));
                    }
              ...
              definition: function () {
                ...
                if (
                  ...
                  if (
                    ...
                    a = b[1];
                    var l = this.args(!1);
                    if (((h = l.args), (i = l.variadic), !k(")")))
                      return (A = y), void e();
                    if (
                      (F.comments(),
                      j(/^when/) && (g = m(F.conditions, "expected condition")),
                      (c = F.block()))
                    )
            ...
            mediaFeature: function () {
              ...
              do
                if ((b = d.keyword() || d.variable())) e.push(b);
                  ...
                  if (((c = this.property()), (b = this.value()), !k(")")))
                    return null;
                  if (c && b)
                    e.push(
                      new x.Paren(
                        new x.Rule(c, b, null, null, y, a.currentFileInfo, !0)
                      )
                    );
                  else {
                    if (!b) return null;
            ...
            mediaFeatures: function () {
              ...
              do
                if ((a = this.mediaFeature())) {
                  if ((c.push(a), !k(","))) break;
                } else if (((a = b.variable()), a && (c.push(a), !k(","))))
                  break;
              while (a);
            ...
            media: function () {
              ...
              return (
                ...
                j(/^@media/) && ((b = this.mediaFeatures()), (c = this.block()))
                  ? ((d = new x.Media(c, b, y, a.currentFileInfo)),
              ...
              if ("@" === v.charAt(y)) {
                ...
                if ((d(), (b = j(/^@[a-z-]+/)))) {
                  ...
                  return (
                    ...
                    i
                      ? ((c = this.entity()),
                        c || o("expected " + b + " identifier"))
                      : l
                      ? ((c = this.expression()),
                        c || o("expected " + b + " expression"))
                      : m &&
                        ((c = (j(/^[^{;]+/) || "").trim()),
                        c && (c = new x.Anonymous(c))),
                    this.comments(),
                    ...
                    g || (!p && c && k(";"))
                      ? (f(),
                        new x.Directive(
                          ...
                          n,
                          a.currentFileInfo,
                          a.dumpLineNumbers ? t(n, v, a) : null
                        ))
                      : void e()
                  );
                }
              ...
              do
                (a = this.addition() || this.entity()),
                  a &&
                    (c.push(a),
                    p(/^\/[\/*]/) ||
                      ((b = k("/")), b && c.push(new x.Anonymous(b))));
              while (a);
            ...
            ruleProperty: function () {
              ...
              function c() {
                var a = /^\s*\/\*(?:[^*]|\*+[^\/*])*\*+\//.exec(f);
                return a
                  ? ((i += a[0].length), (f = f.slice(a[0].length)), !0)
                  : !1;
              }
              var d,
                e,
    ...
    (function (d) {
      ...
      (d.functions = {
        ...
        contrast: function (a, b, c, d) {
          ...
          return (
            (d = "undefined" == typeof d ? 0.43 : j(d)), a.luma() < d ? c : b
          );
        },
        e: function (a) {
          return new d.Anonymous(
            a instanceof d.JavaScript ? a.evaluated : a.value
          );
        },
        escape: function (a) {
          return new d.Anonymous(
        ...
        replace: function (a, b, c, e) {
          var f = a.value;
          return (
            (f = f.replace(new RegExp(b.value, e ? e.value : ""), c.value)),
        ...
        unit: function (a, b) {
          ...
          return (
            (b = b ? (b instanceof d.Keyword ? b.value : b.toCSS()) : ""),
          ...
          for (e = 0; e < c.length; e++)
            if (((g = c[e]), g instanceof d.Dimension))
              if (
                ((h =
                  "" === g.unit.toString() && l !== b
                    ? new d.Dimension(g.value, l).unify()
                    : g.unify()),
                (j =
                  "" === h.unit.toString() && k !== b ? k : h.unit.toString()),
                (k =
                  ("" !== j && k === b) ||
                ...
                (i =
                  "" === m[f].unit.toString() && l !== b
                    ? new d.Dimension(m[f].value, l).unify()
                    : m[f].unify()),
              ...
              Array.isArray(c[e].value) &&
                Array.prototype.push.apply(
                  c,
                  Array.prototype.slice.call(c[e].value)
                );
          return 1 == m.length
            ? m[0]
            : ((c = m
        ...
        "svg-gradient": function (a) {
          ...
          for (
            ...
            m[h].value
              ? ((i = m[h].value[0]), (j = m[h].value[1]))
              : ((i = m[h]), (j = b)),
              (i instanceof d.Color &&
                (((0 === h || h + 1 === m.length) && j === b) ||
                  j instanceof d.Dimension)) ||
                e(),
          ...
          return (
            (g = "'data:image/svg+xml" + (p ? ";base64" : "") + "," + g + "'"),
        ...
        m = {
          ...
          softlight: function (a, b) {
            ...
            return (
              b > 0.5 &&
                ((d = 1),
                (c = a > 0.25 ? Math.sqrt(a) : ((16 * a - 12) * a + 4) * a)),
              a - (1 - 2 * b) * d * (c - a)
            );
          },
    ...
    (function (a) {
      ...
      (a.Color.prototype = {
        ...
        operate: function (b, c, d) {
          for (
            var e = [], f = this.alpha * (1 - d.alpha) + d.alpha, g = 0;
            3 > g;
            g++
          )
        ...
        (a.Color.fromKeyword = function (b) {
          if (((b = b.toLowerCase()), a.colors.hasOwnProperty(b)))
        ...
        (a.DetachedRuleset.prototype = {
          ...
          callEval: function (b) {
            return this.ruleset.eval(
              this.frames ? new a.evalEnv(b, this.frames.concat(b.frames)) : b
            );
          },
        });
    })(c("../tree")),
    ...
    (function (a) {
      (a.Directive = function (a, b, c, d, e, f) {
        ...
        (a.Directive.prototype = {
          ...
          variable: function (b) {
            return this.rules
              ? a.Ruleset.prototype.variable.call(this.rules, b)
              : void 0;
          },
          find: function () {
            return this.rules
              ? a.Ruleset.prototype.find.apply(this.rules, arguments)
              : void 0;
          },
          rulesets: function () {
            return this.rules
              ? a.Ruleset.prototype.rulesets.apply(this.rules)
              : void 0;
          },
          markReferenced: function () {
            var a, b;
    ...
    (function (a) {
      (a.Element = function (b, c, d, e) {
        ...
        (a.Combinator.prototype = {
          ...
          genCSS: function (a, b) {
            var c =
              a.compress || this._noSpaceCombinators[this.value] ? "" : " ";
                ...
                for (j = !0, g = 0; g < c.length; g++) {
                  ...
                  if (!i && d.matchArgs(e, b)) {
                    if (((l = { mixin: d, group: u }), d.matchCondition)) {
                      ...
                      (s[0] || s[1]) &&
                        (s[0] != s[1] && (l.group = s[1] ? v : w), r.push(l));
                    } else r.push(l);
                    q = !0;
                  }
                }
                  ...
                  if (((l = r[g].group), l === u || l === m))
                    try {
                      (d = r[g].mixin),
                        ...
                        Array.prototype.push.apply(
                          p,
                          d.evalCall(b, e, this.important).rules
                        );
                    } catch (x) {
                      throw {
                        message: x.message,
                ...
                new a.evalEnv(
                  ...
                  [
                    this.evalParams(
                      ...
                      new a.evalEnv(
                        c,
                        this.frames ? this.frames.concat(c.frames) : c.frames
                      ),
                      b,
                      []
                    ),
            ...
            if (b.isMathOn()) {
              if (
                (c instanceof a.Dimension &&
                  d instanceof a.Color &&
                  (c = c.toColor()),
                d instanceof a.Dimension &&
    ...
    (function (a) {
      ...
      (a.Rule = function (c, d, e, f, g, h, i, j) {
        (this.name = c),
          (this.value =
            d instanceof a.Value || d instanceof a.Ruleset
              ? d
              : new a.Value([d])),
        ...
        (a.Rule.prototype = {
          ...
          eval: function (b) {
            ...
            "string" != typeof f &&
              ((f =
                1 === f.length && f[0] instanceof a.Keyword
                  ? f[0].value
                  : c(b, f)),
              (g = !1)),
            ...
            try {
              if (
                ((d = this.value.eval(b)),
                !this.variable && "DetachedRuleset" === d.type)
              )
                throw {
              ...
              throw (
                ("number" != typeof h.index &&
                  ((h.index = this.index),
                  (h.filename = this.currentFileInfo.filename)),
                h)
              );
            } finally {
              e && (b.strictMath = !1);
        ...
        (a.Ruleset.prototype = {
          ...
          eval: function (b) {
            ...
            o || (b.selectors = o = []),
              ...
              (m.root || m.allowImports || !m.strictImports) &&
                m.evalImports(b);
            var p = m.rules,
              q = p ? p.length : 0;
            for (f = 0; q > f; f++)
              (p[f] instanceof a.mixin.Definition ||
                p[f] instanceof a.DetachedRuleset) &&
                (p[f] = p[f].eval(b));
            ...
            if ((n.shift(), o.shift(), b.mediaBlocks))
              for (f = r; f < b.mediaBlocks.length; f++)
            ...
            if (e)
              for (c = 0; c < e.length; c++)
                e[c] instanceof a.Import &&
                  ((d = e[c].eval(b)),
                  d && d.length
                    ? (e.splice.apply(e, [c, 1].concat(d)), (c += d.length - 1))
                    : e.splice(c, 1, d),
                  this.resetCache());
          },
          makeImportant: function () {
          ...
          matchCondition: function (b, c) {
            ...
            return d.evaldCondition
              ? d.condition && !d.condition.eval(new a.evalEnv(c, c.frames))
                ? !1
                : !0
              : !1;
          },
          ...
          genCSS: function (b, c) {
            ...
            for (e = 0; e < l.length; e++)
              (i = l[e]),
                ...
                i.genCSS
                  ? i.genCSS(b, c)
                  : i.value && c.add(i.value.toString()),
                b.lastRule
                  ? (b.lastRule = !1)
                  : c.add(b.compress ? "" : "\n" + o);
            if (
              ...
              for (
                l.length && n && c.add(n), m[0].genCSS(b, c), e = 1;
                g > e;
                e++
              )
          ...
          CacheElements: function () {
            ...
            if (!this._elements) {
              ...
              (this._elements = d.match(/[,&#\*\.\w-]([\w-]|(\\.))*/g)),
                this._elements
                  ? "&" === this._elements[0] && this._elements.shift()
                  : (this._elements = []);
            }
          },
      ...
      (a.Variable = function (a, b, c) {
        ...
        (a.Variable.prototype = {
          ...
          eval: function (b) {
            ...
            if (
              (0 === d.indexOf("@@") &&
                (d = "@" + new a.Variable(d.slice(1)).eval(b).value),
              this.evaluating)
            )
              throw {
                type: "Name",
                    ...
                    function (c, d, g, i) {
                      ...
                      h.importMultiple ||
                        (b.skip = j
                          ? !0
                          : function () {
                              return i in e.onceFileDetectionMap
                                ? !0
                                : ((e.onceFileDetectionMap[i] = !0), !1);
                            });
                      var k = function (a) {
                        e.importCount--,
                      ...
                      return !d ||
                        ...
                        f || (!h.importMultiple && j))
                        ? void k()
                        : ((e.recursionDetector[i] = !0),
                          void new a.importVisitor(
                            e._importer,
                            k,
                            h,
                            e.onceFileDetectionMap,
                            e.recursionDetector
                          ).run(d));
                    }
                  );
      ...
      (a.toCSSVisitor = function (b) {
        ...
        (a.toCSSVisitor.prototype = {
          ...
          visitDirective: function (b) {
            ...
            return (
              b.rules && b.rules.rules && this._mergeRules(b.rules.rules), b
            );
          },
          ...
          visitRuleset: function (b, c) {
            ...
            if ((b.firstRoot && this.checkPropertiesInRoot(b.rules), b.root))
              b.accept(this._visitor),
                (c.visitDeeper = !1),
                (b.firstRoot || (b.rules && b.rules.length > 0)) &&
                  e.splice(0, 0, b);
            else {
              b.paths &&
            ...
            if (!b.root) {
              ...
              for (c = 0; i > c; c++)
                b.rules[c] instanceof a.Extend &&
                  (g.push(h[c]), (b.extendOnEveryPath = !0));
              var j = b.paths;
    ...
    (function (a) {
      (a.sourceMapOutput = function (a) {
        (this._css = []),
          ...
          a.sourceMapBasepath &&
            (this._sourceMapBasepath = a.sourceMapBasepath.replace(/\\/g, "/")),
            ...
            for (var b in this._contentsMap)
              if (this._contentsMap.hasOwnProperty(b)) {
                ...
                this._contentsIgnoredCharsMap[b] &&
                  (d = d.slice(this._contentsIgnoredCharsMap[b])),
          ...
          if ((this._rootNode.genCSS(a, this), this._css.length > 0)) {
            ...
            this._sourceMapURL
              ...
              : this._sourceMapFilename &&
                (e = this.normalizeFilename(this._sourceMapFilename)),
              this._writeSourceMap
                ? this._writeSourceMap(f)
                : (e =
                    "data:application/json;base64," +
                    c("./encoder.js").encodeBase64(f)),
  ...
  if (
    ((w.watch = function () {
      return (
        w.watchMode || ((w.env = "development"), v()), (this.watchMode = !0), !0
      );
    }),
    (w.unwatch = function () {
  ...
  for (var H = 0; H < G.length; H++)
    ("stylesheet/less" === G[H].rel ||
      (G[H].rel.match(/stylesheet/) && G[H].type.match(C))) &&
      w.sheets.push(G[H]);
      ...
      (c = e = new Date()),
        u(
          function (a, b, f, i, k) {
            ...
            d(
              "css for " + i.href + " generated in " + (new Date() - e) + "ms",
              z.info
            ),
              0 === k.remaining &&
                d(
