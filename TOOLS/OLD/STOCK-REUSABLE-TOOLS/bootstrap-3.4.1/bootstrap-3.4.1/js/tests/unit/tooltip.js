$(function () {
  ...
  QUnit.test("should expose default settings", function (assert) {
    assert.expect(1);
    assert.ok(
      $.fn.bootstrapTooltip.Constructor.DEFAULTS,
      "defaults is defined"
    );
  });
  ...
  QUnit.test(
    ...
    function (assert) {
      ...
      var $style = $(
        '<style> div[rel="tooltip"] { position: absolute; } #qunit-fixture { top: inherit; left: inherit } </style>'
      ).appendTo("head");
      var $container = $("<div/>")
        .css({
          position: "relative",
  ...
  QUnit.test(
    ...
    function (assert) {
      ...
      var $container = $('<div id="scrollable-div"/>').appendTo(
        "#qunit-fixture"
      );
      var $target = $(
  ...
  QUnit.test(
    ...
    function (assert) {
      ...
      $target
        .on("shown.bs.tooltip", function () {
          assert.strictEqual(
            Math.round($container.find(".tooltip").offset().top),
            12
          );
          $target.bootstrapTooltip("hide");
        })
      ...
      $target
        .on("shown.bs.tooltip", function () {
          ...
          var expected = Math.round(
            $(window).height() - 12 - $tooltip[0].offsetHeight
          );
  ...
  QUnit.test(
    ...
    function (assert) {
      ...
      $target
        .on("shown.bs.tooltip", function () {
          assert.strictEqual(
            Math.round($container.find(".tooltip").offset().left),
            12
          );
          $target.bootstrapTooltip("hide");
        })
    ...
    function (assert) {
      ...
      $target
        .on("shown.bs.tooltip", function () {
          var $tooltip = $container.find(".tooltip");
          assert.strictEqual(
            Math.round($tooltip.offset().left),
  ...
  QUnit.test(
    ...
    function (assert) {
      ...
      var $container = $('<div class="container-viewport"/>').appendTo(
        document.body
      );
      var $target = $(
    ...
    $target.bootstrapTooltip({
      ...
      viewport: function ($element) {
        assert.strictEqual(
          $element[0],
          $target[0],
          "viewport function was passed target as argument"
        );
  ...
  QUnit.test(
    ...
    function (assert) {
      ...
      $(
        ...
        .appendTo("body")
        .on("shown.bs.tooltip", function () {
          var arrowStyles = $(this)
            .data("bs.tooltip")
            .$tip.find(".tooltip-arrow")
            .attr("style");
          assert.ok(
            /left/i.test(arrowStyles) && !/top/i.test(arrowStyles),
