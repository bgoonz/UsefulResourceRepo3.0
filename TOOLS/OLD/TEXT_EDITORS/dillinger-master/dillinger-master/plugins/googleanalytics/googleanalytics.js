...
function GoogleAnalytics() {
  this.GoogleAnalytics_config_file = path.resolve(
    __dirname,
    '../../configs/googleanalytics/',
    'googleanalytics-config.json'
  )
  ...
  if (fs.existsSync(this.GoogleAnalytics_config_file)) {
    ...
    console.log(
      'GoogleAnalytics config found in file. Plugin enabled. (UAID: "' +
    ...
    this.isConfigEnabled = true
    console.log(
      'GoogleAnalytics config found in environment. Plugin enabled. (UAID: "' +
        this.GoogleAnalytics_config.UAID +
        '")'
    )
  } else {
    ...
    console.warn(
      'GoogleAnalytics config not found at ' +
        this.GoogleAnalytics_config_file +
        '. Plugin disabled.'
    )
  }
...
GoogleAnalytics.prototype.generateGATrackingJS =
  function generateGATrackingJS() {
    return `
...
GoogleAnalytics.prototype.generateTrackSponsoredLinkClicks =
