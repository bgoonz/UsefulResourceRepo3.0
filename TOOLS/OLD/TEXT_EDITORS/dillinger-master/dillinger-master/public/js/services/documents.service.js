  ...
  .factory('documentsService', function ($rootScope, $http, Sheet, diNotify) {
    ...
    function save(manual) {
      ...
      return window.localStorage.setItem(
        'currentDocument',
        angular.toJson(service.currentDocument)
      )
    }
    ...
    function init() {
      var item, _ref
      service.files =
        angular.fromJson(window.localStorage.getItem('files')) || []
      service.currentDocument =
        angular.fromJson(window.localStorage.getItem('currentDocument')) || {}
