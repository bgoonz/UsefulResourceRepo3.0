...
module.exports = angular
  .module('diDocuments.export', ['diDocuments.service'])
  .controller('DocumentsExport', function ($scope, $attrs, documentsService) {
    ...
    function asHTML(styled) {
      if (window.ga) {
        var previewOrExport =
          $attrs.diTarget === 'preview' ? 'Preview' : 'Export'
        ga(
          'send',
          'event',
          'click',
