...
module.exports = angular
  .module('plugins.googledrive', [
    'plugins.googledrive.service',
    'plugins.googledrive.modal'
  ])
  .controller(
    'Googledrive',
    function ($rootScope, $modal, googledriveService, documentsService) {
        ...
        return modalInstance.result.then(
          function () {
            documentsService.setCurrentDocumentTitle(
              googledriveService.fetched.fileName
            )
            documentsService.setCurrentDocumentBody(
              googledriveService.fetched.file
            )
            documentsService.setCurrentDocumentId(
              googledriveService.fetched.fileId
            )
