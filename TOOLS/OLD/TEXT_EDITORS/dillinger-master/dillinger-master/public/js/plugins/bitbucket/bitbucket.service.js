    ...
    var defaults = {
      ...
      service = {
        ...
        fetchTreeFiles: function (sha, branch, repo, owner, fileExts) {
          ...
          return $http
            .post('import/bitbucket/tree_files', {
        ...
        fetchBranches: function (repo, owner, page, per_page) {
          ...
          return $http
            .post('import/bitbucket/branches', {
              owner: owner || service.config.current.owner,
              repo: repo || service.config.current.repo,
        ...
        restore: function () {
          service.config =
            angular.fromJson(localStorage.getItem('bitbucket')) || defaults
