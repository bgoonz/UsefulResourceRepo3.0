...
module.exports = angular
  ...
  .factory('googledriveService', function ($http, diNotify) {
    ...
    service = {
      ...
      fetchFile: function (fileId) {
        return $http.get('fetch/googledrive?fileId=' + fileId).then(
          function successCallback(data) {
      ...
      fetchFiles: function () {
        ...
        return $http.get('import/googledrive').then(
          function (data) {
            if (di != null) {
              di.$scope.$close()
            }
      ...
      restore: function () {
        service.fetched =
          angular.fromJson(localStorage.getItem('googledrive')) || defaults
