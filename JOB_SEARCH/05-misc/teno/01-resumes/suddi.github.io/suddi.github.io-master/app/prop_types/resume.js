...
module.exports.profiles = PropTypes.arrayOf(module.exports.profile).isRequired;

module.exports.bulletPoints = PropTypes.arrayOf(PropTypes.string).isRequired;
...
module.exports.workSet = PropTypes.arrayOf(module.exports.work).isRequired;
...
module.exports.awardsSet = PropTypes.arrayOf(module.exports.awards).isRequired;
...
module.exports.skillDetailsSet = PropTypes.arrayOf(module.exports.skillDetails);
...
module.exports.skillsSet = PropTypes.arrayOf(module.exports.skills).isRequired;
