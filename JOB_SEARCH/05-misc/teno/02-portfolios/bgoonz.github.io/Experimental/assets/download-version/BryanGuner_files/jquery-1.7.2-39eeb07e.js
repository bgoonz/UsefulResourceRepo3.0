!(function (e, t) {
  ...
  function g(e) {
    ...
    "input" === t
      ...
      : "script" !== t &&
        ...
        H.grep(e.getElementsByTagName("input"), m);
  }
  function y(e) {
  ...
  function v(e, t, n) {
    ...
    if (r > 0) {
      if ("border" !== n)
        for (; o > i; i += 2)
          n || (r -= parseFloat(H.css(e, "padding" + We[i])) || 0),
            "margin" === n
              ? (r += parseFloat(H.css(e, n + We[i])) || 0)
              : (r -= parseFloat(H.css(e, "border" + We[i] + "Width")) || 0);
      return r + "px";
    }
    if (((r = Le(e, t)), (0 > r || null == r) && (r = e.style[t]), Oe.test(r)))
      return r;
    if (((r = parseFloat(r) || 0), n))
      for (; o > i; i += 2)
        (r += parseFloat(H.css(e, "padding" + We[i])) || 0),
          "padding" !== n &&
            (r += parseFloat(H.css(e, "border" + We[i] + "Width")) || 0),
          "margin" === n && (r += parseFloat(H.css(e, n + We[i])) || 0);
    return r + "px";
  }
  function b(e) {
    return function (t, n) {
    ...
    for (
      ...
      (s = l[u](n, r, i)),
        "string" == typeof s &&
          (!f || a[s]
            ? (s = t)
            : (n.dataTypes.unshift(s), (s = x(e, n, r, i, s, a))));
  ...
  function L(e, t) {
    var n = {};
    return (
      H.each(Tt.concat.apply([], Tt.slice(0, t)), function () {
        n[this] = e;
      }),
      n
    );
  ...
  function D(e) {
    if (!vt[e]) {
      ...
      n.remove(),
        ("none" !== r && "" !== r) ||
          (ht ||
            ((ht = F.createElement("iframe")),
            (ht.frameBorder = ht.width = ht.height = 0)),
          t.appendChild(ht),
          (mt && ht.createElement) ||
            ((mt = (ht.contentWindow || ht.contentDocument).document),
            mt.write(
              (H.support.boxModel ? "<!doctype html>" : "") + "<html><body>"
            ),
            mt.close()),
          (n = mt.createElement(e)),
        ...
        (s.fn = s.prototype =
          {
            ...
            pushStack: function (e, t, n) {
              ...
              return (
                s.isArray(e) ? L.apply(r, e) : s.merge(r, e),
                (r.prevObject = this),
        ...
        s.extend({
          ...
          ready: function (e) {
            if ((e === !0 && !--s.readyWait) || (e !== !0 && !s.isReady)) {
              ...
              o.fireWith(F, [s]),
                s.fn.trigger && s(F).trigger("ready").off("ready");
            }
          },
          bindReady: function () {
            if (!o) {
              if (
                ((o = s.Callbacks("once memory")), "complete" === F.readyState)
              )
          ...
          parseJSON: function (t) {
            return "string" == typeof t && t
              ? ((t = s.trim(t)),
                e.JSON && e.JSON.parse
                  ? e.JSON.parse(t)
                  : m.test(t.replace(g, "@").replace(y, "]").replace(v, ""))
          ...
          : F.attachEvent &&
            (a = function () {
              "complete" === F.readyState &&
                (F.detachEvent("onreadystatechange", a), s.ready());
            }),
        s
      );
    })(),
      ...
      f = function (t) {
        ...
        for (n = 0, r = t.length; r > n; n++)
          (i = t[n]),
            ...
            "array" === o
              ? f(i)
              : "function" === o && ((e.unique && p.has(i)) || u.push(i));
      },
      d = function (t, n) {
        for (
          n = n || [],
          ...
          u &&
            (e.once
              ? r === !0
                ? p.disable()
                : (u = [])
              : c && c.length && ((r = c.shift()), p.fireWith(r[0], r[1])));
      },
      p = {
        add: function () {
          if (u) {
            var e = u.length;
            f(arguments),
              o ? (s = u.length) : r && r !== !0 && ((a = e), d(r[0], r[1]));
          }
          return this;
        },
        remove: function () {
        ...
        has: function (e) {
          if (u)
            for (var t = 0, n = u.length; n > t; t++) if (e === u[t]) return !0;
          return !1;
        },
        empty: function () {
          return (u = []), this;
        ...
        fireWith: function (t, n) {
          return (
            c && (o ? e.once || c.push([t, n]) : (e.once && r) || d(t, n)), this
          );
        },
        fire: function () {
  ...
  H.extend({
                  ...
                  H.isFunction(i)
                    ? l[e](function () {
                        (n = i.apply(this, arguments)),
                          n && H.isFunction(n.promise)
                            ? n.promise().then(r.resolve, r.reject, r.notify)
                            : r[o + "With"](this === l ? r : this, [n]);
                      })
                    : l[e](r[o]);
                }
              );
    ...
    when: function (e) {
      function t(e) {
        return function (t) {
          (r[e] = arguments.length > 1 ? B.call(arguments, 0) : t),
            --s || l.resolveWith(l, r);
        };
      }
      function n(e) {
        return function (t) {
          (a[e] = arguments.length > 1 ? B.call(arguments, 0) : t),
            l.notifyWith(u, a);
        };
      }
      ...
      if (o > 1) {
        for (; o > i; i++)
          r[i] && r[i].promise && H.isFunction(r[i].promise)
            ? r[i].promise().then(t(i), l.reject, n(i))
            : --s;
        s || l.resolveWith(l, r);
    ...
    (H.support = (function () {
      ...
      if (
        ...
        return {};
      (i = F.createElement("select")),
        (o = i.appendChild(F.createElement("option"))),
      ...
      if (
        ...
        for (c in { submit: 1, change: 1, focusin: 1 })
          (u = "on" + c),
            (f = u in d),
            f ||
              (d.setAttribute(u, "return;"), (f = "function" == typeof d[u])),
            (t[c + "Bubbles"] = f);
      return (
        s.removeChild(d),
        (s = i = o = d = a = null),
          ...
          y &&
            ...
            e.getComputedStyle &&
              ...
              (t.reliableMarginRight =
                0 ===
                (parseInt(
                  (e.getComputedStyle(s, null) || { marginRight: 0 })
                    .marginRight,
                  10
                ) || 0))),
            ...
            (r = d.firstChild),
            (i = r.firstChild),
            (o = r.nextSibling.firstChild.firstChild),
            (a = {
            ...
            (a.doesNotIncludeMarginInBodyOffset = y.offsetTop !== u),
            e.getComputedStyle &&
              ((d.style.marginTop = "1%"),
              (t.pixelMargin =
                "1%" !==
                (e.getComputedStyle(d, null) || { marginTop: 0 }).marginTop)),
  ...
  H.extend({
    ...
    hasData: function (e) {
      return (
        (e = e.nodeType ? H.cache[e[H.expando]] : e[H.expando]), !!e && !i(e)
      );
    },
    data: function (e, n, r, i) {
      if (H.acceptData(e)) {
        ...
        if ((d && f[d] && (p || i || f[d].data)) || !u || r !== t)
          return (
            d || (c ? (e[l] = d = ++H.uuid) : (d = l)),
            f[d] || ((f[d] = {}), c || (f[d].toJSON = H.noop)),
            ("object" != typeof n && "function" != typeof n) ||
              (i
                ? (f[d] = H.extend(f[d], n))
                : (f[d].data = H.extend(f[d].data, n))),
            (o = a = f[d]),
            i || (a.data || (a.data = {}), (a = a.data)),
            r !== t && (a[H.camelCase(n)] = r),
            p && !a[n]
              ? o.events
              : (u
                  ? ((s = a[n]), null == s && (s = a[H.camelCase(n)]))
                  : (s = a),
                s)
          );
      }
      ...
      if (H.acceptData(e)) {
        ...
        if (u[c]) {
          ...
          (n || (delete u[c].data, i(u[c]))) &&
            (H.support.deleteExpando || !u.setInterval
              ? delete u[c]
              : (u[c] = null),
            l &&
              (H.support.deleteExpando
                ? delete e[s]
                : e.removeAttribute
                ? e.removeAttribute(s)
                : (e[s] = null)));
    ...
    H.fn.extend({
      data: function (e, n) {
        ...
        if (e === t) {
          if (
            this.length &&
            ((f = H.data(u)), 1 === u.nodeType && !H._data(u, "parsedAttrs"))
          ) {
            for (a = u.attributes, l = a.length; l > c; c++)
              (s = a[c].name),
                0 === s.indexOf("data-") &&
                  ((s = H.camelCase(s.substring(5))), r(u, s, f[s]));
    ...
    H.extend({
      _mark: function (e, t) {
        e &&
          ((t = (t || "fx") + "mark"), H._data(e, t, (H._data(e, t) || 0) + 1));
      },
      ...
      dequeue: function (e, t) {
        ...
        "inprogress" === r && (r = n.shift()),
          ...
          n.length ||
            (H.removeData(e, t + "queue " + t + ".run", !0), o(e, t, "queue"));
      },
    }),
    H.fn.extend({
      queue: function (e, n) {
      ...
      promise: function (e, n) {
        ...
        for (
          ...
          (i =
            H.data(a[s], u, t, !0) ||
            ((H.data(a[s], c, t, !0) || H.data(a[s], f, t, !0)) &&
              H.data(a[s], u, H.Callbacks("once memory"), !0))) &&
            (l++, i.add(r));
  ...
  H.fn.extend({
    ...
    toggleClass: function (e, t) {
      ...
      return H.isFunction(e)
        ...
        : this.each(function () {
            if ("string" === n)
              for (
                var i, o = 0, a = H(this), s = t, l = e.split(X);
                (i = l[o++]);
    ...
    val: function (e) {
        ...
        o = this[0];
      {
        ...
        if (o)
          return (
            (n = H.valHooks[o.type] || H.valHooks[o.nodeName.toLowerCase()]),
    ...
    H.extend({
          ...
          get: function (e) {
            ...
            for (n = l ? o : 0, r = l ? o + 1 : s.length; r > n; n++)
              if (
                ((i = s[n]),
                i.selected &&
                  (H.support.optDisabled
                    ? !i.disabled
                    : null === i.getAttribute("disabled")) &&
                  (!i.parentNode.disabled ||
                    !H.nodeName(i.parentNode, "optgroup")))
              ) {
        ...
        if (e && 3 !== l && 8 !== l && 2 !== l)
          return i && n in H.attrFn
            ...
            : ((s = 1 !== l || !H.isXMLDoc(e)),
              s &&
                ((n = n.toLowerCase()),
                (a = H.attrHooks[n] || (Y.test(n) ? I : W))),
              r !== t
                ? null === r
                  ? void H.removeAttr(e, n)
      ...
      prop: function (e, n, r) {
        ...
        if (e && 3 !== s && 8 !== s && 2 !== s)
          return (
            (a = 1 !== s || !H.isXMLDoc(e)),
            a && ((n = H.propFix[n] || n), (o = H.propHooks[n])),
            r !== t
        ...
        tabIndex: {
          get: function (e) {
            ...
            return n && n.specified
              ? parseInt(n.value, 10)
              : U.test(e.nodeName) || (G.test(e.nodeName) && e.href)
              ? 0
              : t;
          },
        },
      ...
      (W = H.valHooks.button =
        {
          get: function (e, n) {
            ...
            return (
              (r = e.getAttributeNode(n)),
              r && ($[n] ? "" !== r.nodeValue : r.specified) ? r.nodeValue : t
            );
          },
          set: function (e, t, n) {
    ...
    H.support.hrefNormalized ||
      H.each(["href", "src", "width", "height"], function (e, n) {
  ...
  var Q = /^(?:textarea|input|select)$/i,
    ...
    ae = function (e) {
      return H.event.special.hover
        ? e
        : e.replace(Z, "mouseenter$1 mouseleave$1");
    };
  (H.event = {
              ...
              ((a.handle = s =
                function (e) {
                  return "undefined" == typeof H ||
                    ...
                    ? t
                    : H.event.dispatch.apply(s.elem, arguments);
                }),
              (s.elem = e)),
            n = H.trim(ae(n)).split(" "),
            u = 0;
      ...
      if (y && (d = y.events)) {
        for (t = H.trim(ae(t || "")).split(" "), o = 0; o < t.length; o++)
          if (((a = K.exec(t[o]) || []), (s = l = a[1]), (u = a[2]), s)) {
            ...
            0 === m.length &&
              c !== m.length &&
              ((p.teardown && p.teardown.call(e, u) !== !1) ||
                H.removeEvent(e, s, y.handle),
              delete d[s]);
    ...
    trigger: function (n, r, i, o) {
      if (!i || (3 !== i.nodeType && 8 !== i.nodeType)) {
        var a,
          ...
          y = [];
        if (
          !ne.test(g + H.event.triggered) &&
          (g.indexOf("!") >= 0 && ((g = g.slice(0, -1)), (s = !0)),
          g.indexOf(".") >= 0 &&
            ((y = g.split(".")), (g = y.shift()), y.sort()),
          (i && !H.event.customEvent[g]) || H.event.global[g])
        )
          if (
            ((n =
              "object" == typeof n
            ...
            for (l in a)
              a[l].events &&
                a[l].events[g] &&
                H.event.trigger(n, r, a[l].handle.elem, !0);
          }
      }
    },
    dispatch: function (n) {
      ...
      if (
        ...
        if (h && (!n.button || "click" !== n.type))
          for (
            a = H(this), a.context = this.ownerDocument || this, o = n.target;
            o != this;
            o = o.parentNode || this
          )
            if (o.disabled !== !0) {
              for (l = {}, c = [], a[0] = o, r = 0; h > r; r++)
                (f = p[r]),
                  (d = f.selector),
                  l[d] === t && (l[d] = f.quick ? oe(o, f.quick) : a.is(d)),
                  l[d] && c.push(f);
              c.length && v.push({ elem: o, matches: c });
            }
        for (
          p.length > h && v.push({ elem: this, matches: p.slice(h) }), r = 0;
          ...
          for (
            ...
            (f = u.matches[i]),
              (g ||
                ...
                (n.handleObj = f),
                (s = (
                  (H.event.special[f.origType] || {}).handle || f.handler
                ).apply(u.elem, m)),
                s !== t &&
                  ((n.result = s),
    ...
    fix: function (e) {
      ...
      return (
        e.target || (e.target = i.srcElement || F),
    ...
    (H.removeEvent = F.removeEventListener
      ? function (e, t, n) {
          ...
          return H.nodeName(this, "form")
            ...
            : void H.event.add(
                ...
                function (e) {
                  ...
                  r &&
                    !r._submit_attached &&
                    (H.event.add(r, "submit._submit", function (e) {
                      e._submit_bubble = !0;
                    }),
      ...
      toggle: function (e) {
        var t = arguments,
          ...
          i = function (n) {
            ...
            return (
              H._data(this, "lastToggle" + e.guid, i + 1),
              n.preventDefault(),
    ...
    H.each(
      ...
      function (e, t) {
        (H.fn[t] = function (e, n) {
          ...
          ee.test(t) && (H.event.fixHooks[t] = H.event.keyHooks),
          te.test(t) && (H.event.fixHooks[t] = H.event.mouseHooks);
      }
    ),
    (function () {
        ...
        for (var s = 0, l = r.length; l > s; s++) {
          ...
          if (u) {
            ...
            for (u = u[e]; u; ) {
              ...
              if (
                (1 !== u.nodeType || a || ((u[i] = n), (u.sizset = s)),
      ...
      var d = function (e, t, n, i) {
        ...
        do
          if (
            (r.exec(""), (s = r.exec(N)), s && ((N = s[3]), T.push(s[1]), s[2]))
          ) {
            c = s[3];
            break;
          }
        ...
        if (
          (u || (u = l), u || d.error(p || e), "[object Array]" === a.call(u))
        )
          if (b)
            if (t && 1 === t.nodeType)
              for (y = 0; null != u[y]; y++)
                u[y] &&
                  (u[y] === !0 ||
                    (1 === u[y].nodeType && d.contains(t, u[y]))) &&
                  n.push(l[y]);
            else
              for (y = 0; null != u[y]; y++)
      ...
      for (var y in h.match)
        (h.match[y] = new RegExp(
          h.match[y].source + /(?![^\[]*\])(?![^\(]*\))/.source
        )),
          (h.leftMatch[y] = new RegExp(
      ...
      var x, T;
      F.documentElement.compareDocumentPosition
        ? (x = function (e, t) {
            return e === t
              ? ((s = !0), 0)
      ...
      var w = function (e, t, n) {
        for (
          var r, i = [], o = "", a = t.nodeType ? [t] : t;
          (r = h.match.PSEUDO.exec(e));
  ...
  H.fn.extend({
    ...
    is: function (e) {
      return (
        ...
        ("string" == typeof e
          ? de.test(e)
            ? H(e, this.context).index(this[0]) >= 0
            : H.filter(e, this).length > 0
    ...
    closest: function (e, t) {
      ...
      return (
        (i = i.length > 1 ? H.unique(i) : i), this.pushStack(i, "closest", e)
      );
    },
    index: function (e) {
      return e
      ...
      function (e, t) {
        H.fn[e] = function (n, r) {
          ...
          return (
            ...
            (i = this.length > 1 && !pe[e] ? H.unique(i) : i),
            (this.length > 1 || ue.test(r)) && le.test(e) && (i = i.reverse()),
            this.pushStack(i, e, fe.call(arguments).join(","))
          );
        };
      }
    ),
    H.extend({
      ...
      dir: function (e, n, r) {
        for (
          var i = [], o = e[n];
          o && 9 !== o.nodeType && (r === t || 1 !== o.nodeType || !H(o).is(r));
  ...
  (Se.optgroup = Se.option),
    ...
    (Se.th = Se.td),
    H.support.htmlSerialize || (Se._default = [1, "div<div>", "</div>"]),
    H.fn.extend({
      text: function (e) {
        return H.access(
          this,
      ...
      remove: function (e, t) {
        for (var n, r = 0; null != (n = this[r]); r++)
          (e && !H.filter(e, [n]).length) ||
            (t ||
              1 !== n.nodeType ||
              (H.cleanData(n.getElementsByTagName("*")), H.cleanData([n])),
      ...
      empty: function () {
        for (var e, t = 0; null != (e = this[t]); t++)
          for (
            1 === e.nodeType && H.cleanData(e.getElementsByTagName("*"));
            e.firstChild;
        ...
        return H.access(
          ...
          function (e) {
            ...
            if (
              "string" == typeof e &&
              !Te.test(e) &&
              (H.support.leadingWhitespace || !ge.test(e)) &&
              ...
              try {
                for (; i > r; r++)
                  (n = this[r] || {}),
                    1 === n.nodeType &&
                      (H.cleanData(n.getElementsByTagName("*")),
                      (n.innerHTML = e));
                n = 0;
              } catch (o) {}
            }
      ...
      replaceWith: function (e) {
        return this[0] && this[0].parentNode
          ...
          : this.length
          ? this.pushStack(H(H.isFunction(e) ? e() : e), "replaceWith", e)
          : this;
      },
      detach: function (e) {
      ...
      domManip: function (e, n, r) {
        ...
        if (this[0]) {
          if (
            ((s = l && l.parentNode),
            (i =
              H.support.parentNode &&
              s &&
              11 === s.nodeType &&
              s.childNodes.length === this.length
                ? { fragment: s }
                : H.buildFragment(e, this, u)),
            (a = i.fragment),
            ...
            for (var c = 0, d = this.length, p = d - 1; d > c; c++)
              r.call(
                n ? f(this[c], o) : this[c],
                i.cacheable || (d > 1 && p > c) ? H.clone(a, !0, !0) : a
              );
          }
          u.length &&
    ...
    (H.buildFragment = function (e, t, n) {
      ...
      return (
        ...
        !(
          ...
          we.test(s) ||
          (!H.support.checkClone && Ce.test(s)) ||
          (!H.support.html5Clone && Ne.test(s)) ||
          ((i = !0), (o = H.fragments[s]), o && 1 !== o && (r = o)),
    ...
    H.extend({
      clone: function (e, t, n) {
        ...
        if (
          !(
            (H.support.noCloneEvent && H.support.noCloneChecked) ||
      ...
      clean: function (e, t, n, r) {
        ...
        (t = t || F),
          "undefined" == typeof t.createElement &&
            (t = t.ownerDocument || (t[0] && t[0].ownerDocument) || F);
          ...
          if (("number" == typeof l && (l += ""), l)) {
            if ("string" == typeof l)
              if (xe.test(l)) {
                l = l.replace(ye, "<$1></$2>");
                var f,
                  d = (ve.exec(l) || ["", ""])[1].toLowerCase(),
                  p = Se[d] || Se._default,
                  h = p[0],
                  m = t.createElement("div"),
                  y = Ae.childNodes;
                for (
                  t === F ? Ae.appendChild(m) : c(t).appendChild(m),
                    m.innerHTML = p[1] + l + p[2];
                  h--;
                ...
                if (!H.support.tbody) {
                  ...
                  for (a = b.length - 1; a >= 0; --a)
                    H.nodeName(b[a], "tbody") &&
                      !b[a].childNodes.length &&
                      b[a].parentNode.removeChild(b[a]);
                }
                !H.support.leadingWhitespace &&
                  ge.test(l) &&
                  m.insertBefore(t.createTextNode(ge.exec(l)[0]), m.firstChild),
                  (l = m.childNodes),
                  m &&
        ...
        if (n)
          for (
            ...
            if (
              ((o = s[u]),
              r && H.nodeName(o, "script") && (!o.type || Ee.test(o.type)))
            )
      ...
      cleanData: function (e) {
        for (
          var t,
            ...
            i = H.cache,
            o = H.event.special,
            a = H.support.deleteExpando,
            s = 0;
          null != (r = e[s]);
          s++
        )
          if (
            (!r.nodeName || !H.noData[r.nodeName.toLowerCase()]) &&
            (n = r[H.expando])
          ) {
            if (((t = i[n]), t && t.events)) {
            ...
            a
              ? delete r[H.expando]
              : r.removeAttribute && r.removeAttribute(H.expando),
              delete i[n];
          }
      },
    });
  ...
  (H.fn.css = function (e, n) {
      ...
      style: function (e, n, r, i) {
        if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
          ...
          if (
            ...
            "string" === a &&
              (o = Be.exec(r)) &&
              ((r = +(o[1] + 1) * +o[2] + parseFloat(H.css(e, n))),
              (a = "number")),
            !(
              null == r ||
              ("number" === a && isNaN(r)) ||
              ("number" !== a || H.cssNumber[s] || (r += "px"),
      ...
      (De = function (e, t) {
        ...
        return (
          ...
          (r = e.ownerDocument.defaultView) &&
            ...
            "" !== n ||
              H.contains(e.ownerDocument.documentElement, e) ||
              (n = H.style(e, t))),
          !H.support.pixelMargin &&
            i &&
            Pe.test(t) &&
            Oe.test(n) &&
    ...
    H.expr &&
      ...
      ((H.expr.filters.hidden = function (e) {
        ...
        return (
          (0 === t && 0 === n) ||
          (!H.support.reliableHiddenOffsets &&
  ...
  ($e = rt.exec(Ie.toLowerCase()) || []),
      ...
      load: function (e, n, r) {
        ...
        n &&
          (H.isFunction(n)
            ? ((r = n), (n = t))
            : "object" == typeof n &&
              ((n = H.param(n, H.ajaxSettings.traditional)), (a = "POST")));
        var s = this;
        return (
          H.ajax({
            url: e,
            ...
            complete: function (e, t, n) {
              (n = e.responseText),
                e.isResolved() &&
                  ...
                  s.html(o ? H("<div>").append(n.replace(Ze, "")).find(o) : n)),
                r && s.each(r, [n, t, e]);
            },
          }),
          this
        ...
        return this.map(function () {
          ...
          .filter(function () {
            return (
              this.name &&
              !this.disabled &&
              (this.checked || et.test(this.nodeName) || Ge.test(this.type))
            );
          })
          .map(function (e, t) {
            var n = H(this).val();
    ...
    H.each(["get", "post"], function (e, n) {
      H[n] = function (e, r, i, o) {
        return (
          H.isFunction(r) && ((o = o || i), (i = r), (r = t)),
          H.ajax({ type: n, url: e, data: r, success: i, dataType: o })
        );
      };
    }),
    H.extend({
      ...
      ajaxSetup: function (e, t) {
        return (
          t ? T(e, H.ajaxSettings) : ((t = e), (e = H.ajaxSettings)), T(e, t), e
        );
      },
      ajaxSettings: {
        url: Ie,
      ...
      ajax: function (e, n) {
              ...
              if (
                (d.ifModified &&
                  ((b = w.getResponseHeader("Last-Modified")) &&
                    (H.lastModified[i] = b),
                  (x = w.getResponseHeader("Etag")) && (H.etag[i] = x)),
                304 === e)
              )
                (E = "notmodified"), (u = !0);
              else
        ...
        if (
          ...
          (d.url = ((e || d.url) + "")
            .replace(Ve, "")
            .replace(Qe, $e[1] + "//")),
          (d.dataTypes = H.trim(d.dataType || "*")
            .toLowerCase()
            .split(tt)),
          null == d.crossDomain &&
            ((u = rt.exec(d.url.toLowerCase())),
            (d.crossDomain = !(
              !u ||
              (u[1] == $e[1] &&
                u[2] == $e[2] &&
          ...
          d.data &&
            ...
            (d.data = H.param(d.data, d.traditional)),
          x(ot, d, n, w),
          2 === T)
        )
          return !1;
        if (
          ...
          c && 0 === H.active++ && H.event.trigger("ajaxStart"),
          !d.hasContent &&
            (d.data &&
              ((d.url += (Ke.test(d.url) ? "&" : "?") + d.data), delete d.data),
            (i = d.url),
            d.cache === !1))
        ) {
          var E = H.now(),
  ...
  H.ajaxSetup({
    ...
    H.ajaxPrefilter("json jsonp", function (t, n, r) {
      ...
      if (
        "jsonp" === t.dataTypes[0] ||
        (t.jsonp !== !1 && (ct.test(t.url) || (i && ct.test(t.data))))
      ) {
        var o,
          a = (t.jsonpCallback = H.isFunction(t.jsonpCallback)
            ? t.jsonpCallback()
            : t.jsonpCallback),
          s = e[a],
          l = t.url,
                  ...
                  try {
                    if (r && (i || 4 === l.readyState))
                      if (
                        ((r = t),
                        a &&
                          ((l.onreadystatechange = H.noop), dt && delete ft[a]),
                        i)
                      )
  ...
  H.fn.extend({
    show: function (e, t, n) {
      ...
      for (var o = 0, a = this.length; a > o; o++)
        (r = this[o]),
          r.style &&
            ((i = r.style.display),
            H._data(r, "olddisplay") ||
              "none" !== i ||
              (i = r.style.display = ""),
            (("" === i && "none" === H.css(r, "display")) ||
              !H.contains(r.ownerDocument.documentElement, r)) &&
      ...
      for (o = 0; a > o; o++)
        (r = this[o]),
          r.style &&
            ((i = r.style.display),
            ("" !== i && "none" !== i) ||
              (r.style.display = H._data(r, "olddisplay") || ""));
      return this;
    },
    hide: function (e, t, n) {
    ...
    animate: function (e, t, n, r) {
      function i() {
        ...
        for (t in e) {
          ...
          !h ||
            ...
            "inline" === H.css(this, "display") &&
              "none" === H.css(this, "float") &&
              (H.support.inlineBlockNeedsLayout && "inline" !== D(this.nodeName)
                ? (this.style.zoom = 1)
          ...
          (i = new H.fx(this, p, r)),
            ...
            bt.test(n)
              ...
              : ((l = xt.exec(n)),
                ...
                l
                  ? ((c = parseFloat(l[2])),
                    (f = l[3] || (H.cssNumber[r] ? "" : "px")),
                    "px" !== f &&
                      (H.style(this, r, (c || 1) + f),
                      (u = ((c || 1) / i.cur()) * u),
                      H.style(this, r, u + f)),
                    l[1] && (c = ("-=" === l[1] ? -1 : 1) * c + u),
                    i.custom(u, c, f))
      ...
      var o = H.speed(t, n, r);
      return H.isEmptyObject(e)
        ? this.each(o.complete, [!1])
        : ((e = H.extend({}, e)),
          o.queue === !1 ? this.each(i) : this.queue(o.queue, i));
    },
    stop: function (e, n, r) {
      return (
        ...
        this.each(function () {
          ...
          for (n = o.length; n--; )
            o[n].elem !== this ||
              (null != e && o[n].queue !== e) ||
              (r ? o[n](!0) : o[n].saveState(), (i = !0), o.splice(n, 1));
        ...
        return (
          ...
          (r.complete = function (e) {
            H.isFunction(r.old) && r.old.call(this),
              r.queue ? H.dequeue(this, r.queue) : e !== !1 && H._unmark(this);
          }),
          r
        );
      },
    ...
    (H.fx.prototype = {
      ...
      custom: function (e, n, r) {
        ...
        (this.startTime = yt || S()),
          ...
          (this.unit = r || this.unit || (H.cssNumber[this.prop] ? "" : "px")),
          (i.queue = this.options.queue),
          (i.elem = this.elem),
          (i.saveState = function () {
            H._data(o.elem, "fxshow" + o.prop) === t &&
              (o.options.hide
                ? H._data(o.elem, "fxshow" + o.prop, o.start)
                : o.options.show && H._data(o.elem, "fxshow" + o.prop, o.end));
          }),
          i() &&
            H.timers.push(i) &&
            !gt &&
      ...
      show: function () {
        ...
        (this.options.orig[this.prop] = e || H.style(this.elem, this.prop)),
          (this.options.show = !0),
          e !== t
      ...
      hide: function () {
        (this.options.orig[this.prop] =
          H._data(this.elem, "fxshow" + this.prop) ||
          H.style(this.elem, this.prop)),
          (this.options.hide = !0),
        ...
        if (e || i >= s.duration + this.startTime) {
          ...
          if (o) {
            if (
              ...
              for (t in s.animatedProperties)
                H.style(a, t, s.orig[t]),
                  H.removeData(a, "fxshow" + t, !0),
        ...
        return (
          s.duration == 1 / 0
            ...
            : ((n = i - this.startTime),
              ...
              (this.pos = H.easing[s.animatedProperties[this.prop]](
                this.state,
                n,
                0,
                1,
  ...
  var wt,
    ...
    Ct = /^(?:body|html)$/i;
  (wt =
    "getBoundingClientRect" in F.documentElement
      ? function (e, t, n, r) {
          try {
          ...
          var o = t.body,
            ...
            u =
              a.pageYOffset ||
              (H.support.boxModel && n.scrollTop) ||
              o.scrollTop,
            c =
              a.pageXOffset ||
              (H.support.boxModel && n.scrollLeft) ||
              o.scrollLeft,
            f = r.top + u - s,
            d = r.left + c - l;
          return { top: f, left: d };
      ...
      : function (e, t, n) {
          for (
            ...
            e !== a &&
            e !== n &&
            (!H.support.fixedPosition || "fixed" !== l.position);
            ...
            (r = s ? s.getComputedStyle(e, null) : e.currentStyle),
              ...
              e === i &&
                ...
                (o = i),
                (i = e.offsetParent)),
              H.support.subtractsBorderForOverflowNotVisible &&
                "visible" !== r.overflow &&
                ((u += parseFloat(r.borderTopWidth) || 0),
                (c += parseFloat(r.borderLeftWidth) || 0)),
              (l = r);
          return (
            ("relative" !== l.position && "static" !== l.position) ||
              ((u += a.offsetTop), (c += a.offsetLeft)),
            H.support.fixedPosition &&
              "fixed" === l.position &&
              ((u += Math.max(n.scrollTop, a.scrollTop)),
    ...
    (H.fn.offset = function (e) {
      ...
      return r
        ? n === r.body
          ? H.offset.bodyOffset(n)
          : wt(n, r, r.documentElement)
        : null;
    }),
    (H.offset = {
      bodyOffset: function (e) {
        ...
        return (
          H.support.doesNotIncludeMarginInBodyOffset &&
            ((t += parseFloat(H.css(e, "marginTop")) || 0),
    ...
    H.fn.extend({
      position: function () {
        ...
        var e = this[0],
          t = this.offsetParent(),
          n = this.offset(),
          r = Ct.test(t[0].nodeName) ? { top: 0, left: 0 } : t.offset();
        return (
          (n.top -= parseFloat(H.css(e, "marginTop")) || 0),
      ...
      offsetParent: function () {
        return this.map(function () {
          for (
            ...
            e && !Ct.test(e.nodeName) && "static" === H.css(e, "position");
            ...
            function (e, i, o) {
              ...
              return o === t
                ? a
                  ? n in a
                    ? a[n]
                    : (H.support.boxModel && a.document.documentElement[i]) ||
                      a.document.body[i]
                  : e[i]
                : void (a
                    ? a.scrollTo(
    ...
    H.each({ Height: "height", Width: "width" }, function (e, n) {
      ...
      (H.fn["inner" + e] = function () {
        ...
        (H.fn["outer" + e] = function (e) {
          ...
          return t
            ? t.style
              ? parseFloat(H.css(t, n, e ? "margin" : "border"))
              : this[n]()
            : null;
        }),
        (H.fn[n] = function (e) {
            ...
            function (e, n, a) {
              ...
              return H.isWindow(e)
                ? ((s = e.document),
                  ...
                  (H.support.boxModel && l) || (s.body && s.body[r]) || l)
                : 9 === e.nodeType
                ? ((s = e.documentElement),
                  s[r] >= s[i]
                    ? s[r]
                    : Math.max(e.body[i], s[i], e.body[o], s[o]))
                : a === t
                ? ((u = H.css(e, n)),
                  (c = parseFloat(u)),
                  H.isNumeric(c) ? c : u)
