...
*/
  ...
  t("String.prototype.endsWith", function (a) {
    return a
      ...
      : function (b, c) {
          ...
          void 0 === c && (c = d.length);
          for (
            var e = Math.max(0, Math.min(c | 0, d.length)), f = b.length;
            0 < f && 0 < e;
      ...
      if (n && Ca(h.i, l))
        for (var p = 0; p < n.length; p++) {
          ...
          if ((k !== k && q.key !== q.key) || k === q.key)
            return { id: l, list: n, index: p, D: q };
        }
      return { id: l, list: n, index: -1, D: void 0 };
    }
    function e(h) {
      this.i = {};
      this.h = b();
    ...
    e.prototype["delete"] = function (h) {
      ...
      return h.D && h.list
        ? (h.list.splice(h.index, 1),
          ...
          (h.D.previous.next = h.D.next),
          (h.D.next.previous = h.D.previous),
          (h.D.head = null),
          this.size--,
          !0)
        : !1;
  ...
  var Fb = {},
    Lb = new I("about:invalid#zClosurez", Fb);
  var Mb;
  a: {
    var Nb = x.navigator;
    if (Nb) {
  ...
  var fc = J("Opera"),
    ...
    ic =
      J("Gecko") &&
      !(-1 != Mb.toLowerCase().indexOf("webkit") && !J("Edge")) &&
      !(J("Trident") || J("MSIE")) &&
      !J("Edge"),
    jc = -1 != Mb.toLowerCase().indexOf("webkit") && !J("Edge");
  function kc() {
    var a = x.document;
  ...
  var uc = sc;
  var vc = J("Firefox") || J("FxiOS"),
    wc = dc() || J("iPod"),
    xc = J("iPad"),
    yc =
      J("Safari") &&
      !(
        ((J("Chrome") || J("CriOS")) && !J("Edge")) ||
        J("Coast") ||
        J("Opera") ||
        J("Edge") ||
        J("Edg/") ||
  ...
  m.remove = function (a, b, c) {
    ...
    this.set(a, "", { xa: 0, path: b, domain: c });
    return d;
  };
  m.isEmpty = function () {
  ...
  function rd() {
      ...
      for (r = 0; 80 > r; r++) {
        if (40 > r)
          if (20 > r) {
            var wa = D ^ (w & (y ^ D));
            var oc = 1518500249;
          } else (wa = w ^ y ^ D), (oc = 1859775393);
        else
          60 > r
            ? ((wa = (w & y) | (D & (w | y))), (oc = 2400959708))
            : ((wa = w ^ y ^ D), (oc = 3395469782));
        wa =
          ((((p << 5) | (p >>> 27)) & 4294967295) + wa + da + oc + q[r]) &
          4294967295;
        da = D;
        D = y;
    ...
    function c(p, q) {
      if ("string" === typeof p) {
        ...
        for (var r = [], w = 0, y = p.length; w < y; ++w)
  ...
  function sd(a, b, c) {
    ...
    return d && a && b ? [b, td(qd(d), a, c || null)].join(" ") : null;
  }
  function td(a, b, c) {
    var d = [],
      e = [];
  ...
  var vd = {};
  function wd(a) {
    return !!vd.FPA_SAMESITE_PHASE2_MOD || !(void 0 === a || !a);
  }
  function xd(a, b, c, d) {
    (a = x[a]) || (a = new nd(document).get(b));
    return a ? sd(a, c, d) : null;
  }
  function yd(a) {
    var b = void 0 === b ? !1 : b;
    var c = qd(String(x.location.href)),
      d = [];
    var e = b;
    e = void 0 === e ? !1 : e;
    var f = x.__SAPISID || x.__APISID || x.__3PSAPISID || x.__OVERRIDE_SID;
    wd(e) && (f = f || x.__1PSAPISID);
    if (f) e = !0;
    else {
      var g = new nd(document);
      f =
        g.get("SAPISID") ||
        g.get("APISID") ||
        g.get("__Secure-3PAPISID") ||
        g.get("SID");
      wd(e) && (f = f || g.get("__Secure-1PAPISID"));
      e = !!f;
    }
    e &&
      ((e = (c =
      ...
      (e = e ? sd(e, c ? "SAPISIDHASH" : "APISIDHASH", a) : null) && d.push(e),
      c &&
        wd(b) &&
        ((b = xd("__1PSAPISID", "__Secure-1PAPISID", "SAPISID1PHASH", a)) &&
          d.push(b),
        (a = xd("__3PSAPISID", "__Secure-3PAPISID", "SAPISID3PHASH", a)) &&
          d.push(a)));
  ...
  Qd.prototype.update = function (a, b) {
    if (null != a) {
      ...
      for (var c = b - this.i, d = 0, e = this.o, f = this.j; d < b; ) {
        if (0 == f) for (; d <= c; ) Rd(this, a, d), (d += this.i);
        if ("string" === typeof a)
          for (; d < b; ) {
  ...
  Qd.prototype.digest = function () {
    var a = [],
      b = 8 * this.m;
    56 > this.j
      ? this.update(this.l, 56 - this.j)
      : this.update(this.l, this.i - (this.j - 56));
  ...
  function Ud(a, b) {
    if (a.classList) var c = a.classList.contains(b);
      ...
      (c = a.classList ? a.classList : Sd(a).match(/\S+/g) || []),
        (c = 0 <= Ya(c, b));
    return c;
  }
  function Vd() {
    ...
    a.classList
      ...
      : Ud(a, "inverted-hdpi") &&
        Td(
          a,
          Za(
            a.classList ? a.classList : Sd(a).match(/\S+/g) || [],
            function (b) {
  ...
  function ae(a, b) {
    ...
    if (1 < c) {
      ...
      if (a instanceof ae)
        for (c = be(a), d = 0; d < c.length; d++) this.set(c[d], a.get(c[d]));
  ...
  m.remove = function (a) {
    return Object.prototype.hasOwnProperty.call(this.j, a)
      ? (delete this.j[a],
        this.i--,
        this.N++,
        this.h.length > 2 * this.i && ce(this),
        !0)
      : !1;
  };
  function ce(a) {
  ...
  m.set = function (a, b) {
    Object.prototype.hasOwnProperty.call(this.j, a) ||
      (this.i++, this.h.push(a), this.N++);
    this.j[a] = b;
  };
  m.forEach = function (a, b) {
    for (var c = be(this), d = 0; d < c.length; d++) {
      var e = c[d],
        f = this.get(e);
      a.call(b, f, e, this);
    }
  ...
  m.K = function (a) {
    ...
    e.next = function () {
      ...
      if (b >= d.h.length) throw Wd;
      var f = d.h[b++];
      return a ? f : d.j[f];
    };
    return e;
  };
  var ee = !gc || 9 <= Number(uc),
    fe;
  if ((fe = gc)) {
    var ge;
    if (Object.prototype.hasOwnProperty.call(rc, "9")) ge = rc["9"];
    else {
      for (
        var he = 0,
          ie = vb(String(qc)).split("."),
          je = vb("9").split("."),
          ke = Math.max(ie.length, je.length),
          le = 0;
        0 == he && le < ke;
        le++
      ) {
        ...
        do {
          ...
          he =
            Eb(
              0 == oe[1].length ? 0 : parseInt(oe[1], 10),
              0 == pe[1].length ? 0 : parseInt(pe[1], 10)
            ) ||
            Eb(0 == oe[2].length, 0 == pe[2].length) ||
            Eb(oe[2], pe[2]);
          me = oe[3];
          ne = pe[3];
        } while (0 == he);
  ...
  te.prototype.init = function (a, b) {
    ...
    this.state = a.state;
    this.j = a;
    a.defaultPrevented && te.G.preventDefault.call(this);
  };
  te.prototype.stopPropagation = function () {
    te.G.stopPropagation.call(this);
    this.j.stopPropagation
      ? this.j.stopPropagation()
      : (this.j.cancelBubble = !0);
  };
  te.prototype.preventDefault = function () {
    te.G.preventDefault.call(this);
    var a = this.j;
    if (a.preventDefault) a.preventDefault();
    else if (((a.returnValue = !1), qe))
      try {
  ...
  ze.prototype.add = function (a, b, c, d, e) {
    ...
    -1 < g
      ? ((b = a[g]), c || (b.ea = !1))
      : ((b = new xe(b, this.src, f, !!d, e)), (b.ea = c), a.push(b));
    return b;
  };
  ...
  function Be(a, b) {
    ...
    c in a.listeners &&
      cb(a.listeners[c], b) &&
      (ye(b), 0 == a.listeners[c].length && (delete a.listeners[c], a.h--));
  }
  function Ae(a, b, c, d) {
  ...
  function Fe(a, b, c, d, e) {
    if (d && d.once) Ge(a, b, c, d, e);
    else if (Array.isArray(b))
      for (var f = 0; f < b.length; f++) Fe(a, b[f], c, d, e);
    else
      (c = He(c)),
        a && a[ve]
          ? Ie(a, b, c, B(d) ? !!d.capture : !!d, e)
          : Je(a, b, c, !1, d, e);
  }
  ...
  function Ge(a, b, c, d, e) {
    if (Array.isArray(b))
      ...
      (c = He(c)),
        a && a[ve]
          ? a.h.add(String(b), c, !0, B(d) ? !!d.capture : !!d, e)
          : Je(a, b, c, !0, d, e);
  }
  function Oe(a, b, c, d, e) {
    if (Array.isArray(b))
      ...
      ((d = B(d) ? !!d.capture : !!d), (c = He(c)), a && a[ve])
    ...
    if ("number" !== typeof a && a && !a.V) {
      ...
      if (b && b[ve]) Be(b.h, a);
        ...
        b.removeEventListener
          ...
          : b.detachEvent
          ? b.detachEvent(Me(c), d)
          : b.addListener && b.removeListener && b.removeListener(d);
        Ee--;
        (c = Ke(b))
          ? (Be(c, a), 0 == c.h && ((c.src = null), (b[Ce] = null)))
          : ye(a);
      }
    }
  }
    ...
    if ((a = Ke(a)))
      if ((b = a.listeners[b.toString()]))
        for (b = b.concat(), a = 0; a < b.length; a++) {
          var f = b[a];
          f && f.capture == c && !f.V && ((f = Re(f, d)), (e = e && !1 !== f));
        }
    return e;
  }
  function Re(a, b) {
  ...
  function Ne(a, b) {
    ...
    if (!ee) {
      ...
      if (!(0 > c.keyCode || void 0 != c.returnValue)) {
        ...
        c = [];
        for (f = d.h; f; f = f.parentNode) c.push(f);
        f = a.type;
  ...
  function Ue(a, b) {
    ...
    e = b;
    var f = e.type || e;
    if ("string" === typeof e) e = new se(e, c);
    else if (e instanceof se) e.target = e.target || c;
    else {
      var g = e;
      e = new se(f, c);
      pb(e, g);
    ...
    e.i ||
      ...
      e.i || (g = Ve(k, f, !1, e) && g));
    if (d)
      for (h = 0; !e.i && h < d.length; h++)
        (k = e.h = d[h]), (g = Ve(k, f, !1, e) && g);
  }
  Te.prototype.A = function () {
    ...
    if (this.h) {
      ...
      for (c in a.listeners) {
        for (var d = a.listeners[c], e = 0; e < d.length; e++) ++b, ye(d[e]);
        ...
        if (b instanceof String || b instanceof Number || b instanceof Boolean)
          ...
          for (d in b)
            Object.prototype.hasOwnProperty.call(b, d) &&
              ((f = b[d]),
              "function" != typeof f &&
                (c.push(e), Ze(d, c), c.push(":"), Xe(a, f, c), (e = ",")));
          c.push("}");
          return;
        }
      }
  ...
  function pf(a, b) {
    a.i || (2 != a.h && 3 != a.h) || qf(a);
    a.l ? (a.l.next = b) : (a.i = b);
    a.l = b;
  }
  function jf(a, b, c, d) {
    var e = gf(null, null, null);
    e.h = new cf(function (f, g) {
      e.i = b
        ? function (h) {
            try {
              var k = b.call(d, h);
    ...
    if (0 == a.h) {
      ...
      a: {
        var d = c,
          ...
          f = a.F;
        if (d instanceof cf) {
          pf(d, gf(e || Ja, f || null, a));
          var g = !0;
        } else if (bf(d)) d.then(e, f, a), (g = !0);
        else {
          if (B(d))
            try {
              var h = d.then;
  ...
  cf.prototype.C = function () {
    for (var a; (a = nf(this)); ) of(this, a, this.h, this.u);
    this.o = !1;
  };
  function of(a, b, c, d) {
    if (3 == c && b.onRejected && !b.j) for (; a && a.m; a = a.j) a.m = !1;
    if (b.h) (b.h.j = null), tf(b, c, d);
    else
      try {
        b.j ? b.i.call(b.context) : tf(b, c, d);
      } catch (e) {
        uf.call(null, e);
      }
    Cd(ff, b);
  ...
  function Af(a) {
    return void 0 === a || a instanceof zf ? a : new zf(a);
  }
  yf.prototype.set = function (a, b) {
    yf.G.set.call(this, a, Af(b));
  };
  yf.prototype.i = function (a) {
    a = yf.G.get.call(this, a);
  ...
  F(Bf, yf);
  Bf.prototype.set = function (a, b, c) {
    if ((b = Af(b))) {
      if (c) {
        if (c < E()) {
          Bf.prototype.remove.call(this, a);
          return;
        }
        b.expiration = c;
      }
    ...
    Bf.G.set.call(this, a, b);
  };
  Bf.prototype.i = function (a) {
    var b = Bf.G.i.call(this, a);
    if (b) {
      var c = b.creation,
        d = b.expiration;
      if ((d && d < E()) || (c && c > E())) Bf.prototype.remove.call(this, a);
      else return b;
    }
  };
  function Cf() {}
  ...
  m.set = function (a, b) {
    this.h.setAttribute(Jf(a), b);
    Kf(this);
  };
  m.get = function (a) {
    a = this.h.getAttribute(Jf(a));
    if ("string" !== typeof a && null !== a)
      throw "Storage mechanism: Invalid value was encountered";
    return a;
  };
  m.remove = function (a) {
    this.h.removeAttribute(Jf(a));
    Kf(this);
  };
  m.K = function (a) {
    var b = 0,
  ...
  Zf.prototype.stopImmediatePropagation = function () {
    this.event &&
      ((this.event.cancelBubble = !0),
      this.event.stopImmediatePropagation &&
        this.event.stopImmediatePropagation());
  };
  var hb = x.ytEventsEventsListeners || {};
  z("ytEventsEventsListeners", hb, void 0);
  var ag = x.ytEventsEventsCounter || { count: 0 };
  z("ytEventsEventsCounter", ag, void 0);
  function bg(a, b, c, d) {
    d = void 0 === d ? {} : d;
    a.addEventListener &&
  ...
  function hg(a) {
    ...
    this.l = 0;
    this.H = dg(window, "mousemove", C(this.I, this));
    a = C(this.F, this);
    "function" === typeof a && (a = Qf(a));
  ...
  hg.prototype.F = function () {
    if (this.h) {
      ...
      if (0 != this.m) {
        ...
        this.j[this.l] = 0.5 < Math.abs((d - this.o) / this.o) ? 1 : 0;
  ...
  function og(a) {
    ...
    if (null == A("_lact", window)) {
      ...
      z("_fact", c, window);
      -1 == c && pg();
      dg(document, "keydown", pg);
      dg(document, "keyup", pg);
      dg(document, "mousedown", pg);
      dg(document, "mouseup", pg);
      a &&
        (b
          ? dg(
              window,
          ...
          : (dg(window, "resize", function () {
            ...
            dg(window, "scroll", function () {
              qg("scroll", 200);
            })));
      new hg(function () {
        qg("mouse", 100);
      });
      dg(document, "touchstart", pg, { passive: !0 });
      dg(document, "touchend", pg, { passive: !0 });
    }
  }
  function qg(a, b) {
    ng[a] ||
  ...
  function pg() {
    null == A("_lact", window) && og();
    var a = E();
    z("_lact", a, window);
    -1 == A("_fact", window) && z("_fact", a, window);
  ...
  var sg = x.ytPubsubPubsubInstance || new M(),
    tg = x.ytPubsubPubsubSubscribedKeys || {},
    ug = x.ytPubsubPubsubTopicToKeys || {},
    vg = x.ytPubsubPubsubIsSynchronous || {};
  function wg(a, b) {
    var c = xg();
    if (c && b) {
      var d = c.subscribe(
  ...
  M.prototype.unsubscribeByKey = M.prototype.W;
  M.prototype.publish = M.prototype.O;
  M.prototype.clear = M.prototype.clear;
  z("ytPubsubPubsubInstance", sg, void 0);
  z("ytPubsubPubsubTopicToKeys", ug, void 0);
  z("ytPubsubPubsubIsSynchronous", vg, void 0);
  z("ytPubsubPubsubSubscribedKeys", tg, void 0);
  var Cg = window,
    Q =
      Cg.ytcsi && Cg.ytcsi.now
        ? Cg.ytcsi.now
        : Cg.performance &&
          Cg.performance.timing &&
          Cg.performance.now &&
          Cg.performance.timing.navigationStart
        ? function () {
            return Cg.performance.timing.navigationStart + Cg.performance.now();
          }
        : function () {
            return new Date().getTime();
          };
  var Dg = Wf("initial_gel_batch_timeout", 1e3),
    Eg = Math.pow(2, 16) - 1,
    Fg = null,
    Gg = 0,
    Hg = void 0,
    ...
    Kg = 0,
    Lg = !0,
    Mg = x.ytLoggingTransportGELQueue_ || new Map();
  z("ytLoggingTransportGELQueue_", Mg, void 0);
  var Ng = x.ytLoggingTransportTokensToCttTargetIds_ || {};
  z("ytLoggingTransportTokensToCttTargetIds_", Ng, void 0);
  function Og(a) {
    a = void 0 === a ? !1 : a;
    return new cf(function (b) {
      gg(Ig);
      gg(Jg);
      Jg = 0;
      Hg && Hg.isReady() ? (Pg(b, a), Mg.clear()) : (Qg(), b());
    });
  }
  function Qg() {
    O("web_gel_timeout_cap") && !Jg && (Jg = P(Og, 6e4));
    gg(Ig);
    var a = H("LOGGING_BATCH_TIMEOUT", Wf("web_gel_debounce_ms", 1e4));
    O("shorten_initial_gel_batch_timeout") && Lg && (a = Dg);
    Ig = P(Og, a);
  }
  function Pg(a, b) {
    var c = Hg;
    b = void 0 === b ? !1 : b;
    for (
      var d = Math.round(Q()), e = Mg.size, f = u(Mg), g = f.next();
      !g.done;
      g = f.next()
    ) {
      var h = u(g.value);
  ...
  function Ug(a, b) {
    ...
    if (c) {
      ...
      !d &&
        O("web_client_counter_random_seed") &&
        (d = Math.floor((Math.random() * Eg) / 2));
      d++;
      d > Eg && (d = 1);
      ...
      Fg &&
        ...
        O("log_gel_rtt_web") &&
        (a.previousBatchInfo = {
          serializedClientEventId: Fg,
          roundtripMs: String(Gg),
        });
      Fg = c;
      Gg = 0;
    }
  ...
  var Wg = x.ytLoggingGelSequenceIdObj_ || {};
  z("ytLoggingGelSequenceIdObj_", Wg, void 0);
  function Xg(a, b, c, d) {
    d = void 0 === d ? {} : d;
    var e = {};
    ...
    O("log_sequence_info_on_gel_web") &&
      d.M &&
      ((a = e.context),
      (b = d.M),
      (Wg[b] = b in Wg ? Wg[b] + 1 : 0),
      (a.sequence = { index: Wg[b], groupKey: b }),
      d.Ha && delete Wg[d.M]);
    d = d.L;
    a = "";
    d &&
    ...
    d.push(e);
    c && (Hg = new c());
    c = Wf("web_logging_max_batch") || 100;
    e = Q();
    d.length >= c ? Og(!0) : 10 <= e - Kg && (Qg(), (Kg = e));
  }
  function Yg() {
    var a = Zg;
          ...
          l.args = [
            {
              ...
              value: g[1],
              query: a,
              method: eh == p ? "unchanged" : p,
            },
          ];
          bh.hasOwnProperty(n) || ("ReferenceError" === l.name ? Sf(l) : Rf(l));
        }
    }
    return d;
  }
  ...
  function dh(a) {
    return a && a.match(ah) ? a : decodeURIComponent(a.replace(/\+/g, " "));
  }
  function ih(a) {
    var b = jh;
    ...
    k = [
      ...
      k,
      l,
      h.screen ? h.screen.availWidth : void 0,
      h.screen ? h.screen.availTop : void 0,
      n,
      p,
      q,
      r,
  ...
  z(
    "yt.ads_.signals_.getAdSignalsString",
    function (a) {
      return fh(ih(a));
    },
    void 0
  ...
  var nh = {
    ...
    oh =
      "app debugcss debugjs expflag force_ad_params force_viral_ad_response_params forced_experiments innertube_snapshots innertube_goldens internalcountrycode internalipoverride absolute_experiments conditional_experiments sbb sr_bns_address client_dev_root_url".split(
        " "
      ),
    ph = !1;
  function qh(a, b) {
    ...
    d && e
      ...
      : (c = e
          ? Yb(c) == e &&
            (Number(c.match(Wb)[4] || null) || null) ==
              (Number(a.match(Wb)[4] || null) || null)
          : !0);
    d = O("web_ajax_ignore_global_headers_if_set");
    for (var f in nh)
      (e = H(nh[f])),
        !e || (!c && Yb(a)) || (d && void 0 !== b[f]) || (b[f] = e);
    if (c || !Yb(a))
    ...
    if (c || !Yb(a)) b["X-YouTube-Ad-Signals"] = fh(ih(void 0));
    return b;
  }
  function rh(a) {
  ...
  function sh(a, b) {
    if (window.fetch && "XML" != b.format) {
      ...
      b.onFetchTimeout &&
        0 < b.timeout &&
        (f = P(function () {
          e || ((e = !0), gg(f), b.onFetchTimeout.call(b.context || x));
        }, b.timeout));
    } else vh(a, b);
  }
  function vh(a, b) {
      ...
      f = wh(
        ...
        function (k) {
          if (!e) {
            ...
            if (l || p || q) n = xh(a, c, k, b.convertToSafeHtml);
            if (l)
    ...
    if (b.onTimeout && 0 < b.timeout) {
      var g = b.onTimeout;
      var h = P(function () {
        e || ((e = !0), f.abort(), gg(h), g.call(b.context || x, f));
      }, b.timeout);
    }
    return f;
  }
  ...
  function uh(a, b) {
    ...
    b.excludeXsrf ||
      (Yb(a) && !b.withCredentials && Yb(a) != document.location.hostname) ||
      "POST" != b.method ||
    ...
    !ph &&
      f &&
      "POST" != b.method &&
      ((ph = !0), Rf(Error("AJAX request with postData should use POST")));
    return e;
  }
  function xh(a, b, c, d) {
    var e = null;
    switch (b) {
      case "JSON":
        ...
        break;
      case "XML":
        if ((a = (a = c.responseXML) ? yh(a) : null))
          (e = {}),
  ...
  function wh(a, b, c, d, e, f, g) {
    function h() {
      4 == (k && "readyState" in k ? k.readyState : 0) && b && Qf(b)(k);
    }
    c = void 0 === c ? "GET" : c;
    d = void 0 === d ? "" : d;
    var k = lh();
    ...
    O("debug_forward_web_query_parameters") && (a = rh(a));
    k.open(c, a, !0);
    f && (k.responseType = f);
  ...
  function Sg() {
    return {
      ...
      Na: H("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),
      Oa: H("INNERTUBE_CONTEXT_CLIENT_NAME", "WEB"),
      innertubeContextClientVersion: H(
        "INNERTUBE_CONTEXT_CLIENT_VERSION",
        void 0
      ),
      Qa: H("INNERTUBE_CONTEXT_HL", void 0),
      Pa: H("INNERTUBE_CONTEXT_GL", void 0),
      Ra: H("INNERTUBE_HOST_OVERRIDE", void 0) || "",
      Ta: !!H("INNERTUBE_USE_THIRD_PARTY_AUTH", !1),
      Sa: !!H("INNERTUBE_OMIT_API_KEY_WHEN_AUTH_HEADER_IS_PRESENT", !1),
  ...
  function Rg(a) {
    ...
    a.appInstallData &&
      O("web_log_app_install_experiments") &&
      ((b.client.configInfo = b.client.configInfo || {}),
      (b.client.configInfo.appInstallData = a.appInstallData));
    H("DELEGATED_SESSION_ID") &&
      !O("pageid_as_header_web") &&
      (b.user = { onBehalfOfUser: H("DELEGATED_SESSION_ID") });
    a = Object;
    f = a.assign;
    e = b.client;
    c = {};
    d = u(Object.entries(gh(H("DEVICE", ""))));
  ...
  function Ch(a, b, c) {
    c = void 0 === c ? {} : c;
    var d = { "X-Goog-Visitor-Id": c.visitorData || H("VISITOR_DATA", "") };
    if (b && b.includes("www.youtube-nocookie.com")) return d;
    (b = c.sk || H("AUTHORIZATION")) ||
      (a ? (b = "Bearer " + A("gapi.auth.getToken")().rk) : (b = yd([])));
    b &&
      ((d.Authorization = b),
      (d["X-Goog-AuthUser"] = H("SESSION_INDEX", 0)),
      O("pageid_as_header_web") &&
        (d["X-Goog-PageId"] = H("DELEGATED_SESSION_ID")));
    return d;
  }
  function Dh(a) {
    a = Object.assign({}, a);
  ...
  function Fh(a) {
    var b = new Ff();
    (b = b.isAvailable() ? (a ? new Lf(b, a) : b) : null) ||
      ((a = new Gf(a || "UserDataSharedStore")),
      (b = a.isAvailable() ? a : null));
    this.h = (a = b) ? new Bf(a) : null;
  ...
  Fh.prototype.get = function (a, b) {
    ...
    if (d && (c = od.get("" + a, void 0)) && ((c = unescape(c)), b))
      try {
        c = JSON.parse(c);
      } catch (e) {
  ...
  var Gh;
  function Hh() {
    Gh || (Gh = new Fh("yt.innertube"));
    return Gh;
  }
  function Ih(a, b, c, d) {
    if (d) return null;
    d = Hh().get("nextId", !0) || 1;
    var e = Hh().get("requests", !0) || {};
    e[d] = {
      method: a,
      request: b,
      authState: Dh(c),
    ...
    Hh().set("nextId", d + 1, 86400, !0);
    Hh().set("requests", e, 86400, !0);
    return d;
  }
  function Jh(a) {
    var b = Hh().get("requests", !0) || {};
    delete b[a];
    Hh().set("requests", b, 86400, !0);
  }
  function Kh(a) {
    var b = Hh().get("requests", !0);
    if (b) {
  ...
  var Nh = A("ytPubsub2Pubsub2Instance") || new M();
  M.prototype.subscribe = M.prototype.subscribe;
  M.prototype.unsubscribeByKey = M.prototype.W;
  M.prototype.publish = M.prototype.O;
  M.prototype.clear = M.prototype.clear;
  z("ytPubsub2Pubsub2Instance", Nh, void 0);
  var Oh = A("ytPubsub2Pubsub2SubscribedKeys") || {};
  z("ytPubsub2Pubsub2SubscribedKeys", Oh, void 0);
  var Ph = A("ytPubsub2Pubsub2TopicToKeys") || {};
  z("ytPubsub2Pubsub2TopicToKeys", Ph, void 0);
  var Qh = A("ytPubsub2Pubsub2IsAsync") || {};
  z("ytPubsub2Pubsub2IsAsync", Qh, void 0);
  ...
  function bi(a, b) {
    ai ||
      ($h.push({ type: "EVENT", eventType: a, payload: b }),
      10 < $h.length && $h.shift());
  }
  function R(a, b) {
  ...
  var ci = {},
    di =
      ((ci.AUTH_INVALID = "No user identifier specified."),
      (ci.EXPLICIT_ABORT = "Transaction was explicitly aborted."),
      (ci.IDB_NOT_SUPPORTED = "IndexedDB is not supported."),
      (ci.MISSING_OBJECT_STORE = "Object store not created."),
      (ci.UNKNOWN_ABORT = "Transaction was aborted for unknown reasons."),
      (ci.QUOTA_EXCEEDED =
      ...
      (ci.EXECUTE_TRANSACTION_ON_CLOSED_DB =
  ...
  function S(a, b, c) {
    ...
    ai ||
      ($h.push({ type: "ERROR", payload: this }), 10 < $h.length && $h.shift());
  }
  v(S, R);
  function ei(a) {
    S.call(this, "MISSING_OBJECT_STORE", { xk: a }, di.MISSING_OBJECT_STORE);
  ...
  function gi(a, b, c) {
    ...
    if ("QuotaExceededError" === a.name)
      return new S("QUOTA_EXCEEDED", { objectStoreNames: c, dbName: b });
    if (yc && "UnknownError" === a.name)
      return new S("QUOTA_MAYBE_EXCEEDED", { objectStoreNames: c, dbName: b });
    if (
    ...
    a.args = [{ name: "IdbError", yk: a.name, dbName: b, objectStoreNames: c }];
    return a;
  }
  function hi(a) {
    if (!a) throw Error();
  ...
  T.all = function (a) {
    return new T(function (b, c) {
      var d = [],
        e = a.length;
      0 === e && b(d);
      for (var f = { P: 0 }; f.P < a.length; f = { P: f.P }, ++f.P)
        ji(
          T.resolve(a[f.P]).then(
            (function (g) {
              return function (h) {
                d[g.P] = h;
                e--;
  ...
  T.prototype.then = function (a, b) {
    var c = this,
      d = null !== a && void 0 !== a ? a : ii,
      e = null !== b && void 0 !== b ? b : hi;
    return new T(function (f, g) {
      "PENDING" === c.state.status
        ...
        ? ki(c, c, d, f, g)
        : "REJECTED" === c.state.status && li(c, c, e, f, g);
    });
  };
  function ji(a, b) {
    a.then(void 0, b);
  ...
  function ki(a, b, c, d, e) {
    try {
      ...
      f instanceof T ? mi(a, b, f, d, e) : d(f);
    } catch (g) {
      e(g);
    }
  }
  ...
  m.add = function (a, b, c) {
    return ri(this, [a], "readwrite", function (d) {
      return si(d, a).add(b, c);
    });
  };
  m.clear = function (a) {
    return ri(this, [a], "readwrite", function (b) {
      return si(b, a).clear();
    });
  };
  m.close = function () {
  ...
  m.count = function (a, b) {
    return ri(this, [a], "readonly", function (c) {
      return si(c, a).count(b);
    });
  };
  m["delete"] = function (a, b) {
    return ri(this, [a], "readwrite", function (c) {
      return si(c, a)["delete"](b);
    });
  };
  m.get = function (a, b) {
    return ri(this, [a], "readwrite", function (c) {
  ...
  function ri(a, b, c, d) {
    ...
    try {
      ...
      var f = ti(e, d)["catch"](function (g) {
        throw gi(g, a.h.name, b.join());
      });
    } catch (g) {
      f =
        g instanceof Error
          ? Promise.reject(gi(g, a.h.name, b.join()))
          : Promise.reject(
              gi(
                Error("unexpected transaction error: " + g),
                a.h.name,
                b.join()
              )
            );
  ...
  function ui(a, b, c, d) {
    cc(a, function f() {
      ...
      return Aa(f, function (q) {
        ...
        2 != q.h
          ? ((h = Math.round(Q())), vi(k, !0, c, h - g), (q.h = 0), (q.l = 0))
          : ((l = ta(q)),
            (n = Math.round(Q())),
            (p = n - g),
            l instanceof S &&
              ("QUOTA_EXCEEDED" === l.type ||
                "QUOTA_MAYBE_EXCEEDED" === l.type) &&
              bi("QUOTA_EXCEEDED", {
                dbName: k.h.name,
                objectStoreNames: c,
            ...
            l instanceof S &&
              "UNKNOWN_ABORT" === l.type &&
              (bi("TRANSACTION_UNEXPECTEDLY_ABORTED", {
                objectStoreNames: c,
  ...
  function xi(a, b) {
    return yi(a, { query: b }, function (c) {
  ...
  m["delete"] = function (a) {
    return a instanceof IDBKeyRange ? xi(this, a) : U(this.h["delete"](a));
  };
  m.get = function (a) {
    return U(this.h.get(a));
  };
  m.index = function (a) {
    return new zi(this.h.index(a));
  };
  m.getName = function () {
    return this.h.name;
  };
  ...
  function si(a, b) {
    var c = a.h.objectStore(b),
      d = a.i.get(c);
    d || ((d = new wi(c)), a.i.set(c, d));
    return d;
  }
  function zi(a) {
    this.h = a;
  }
  zi.prototype.count = function (a) {
    return U(this.h.count(a));
  };
  zi.prototype["delete"] = function (a) {
    return Di(this, { query: a }, function (b) {
  ...
  zi.prototype.getKey = function (a) {
  ...
  function Ai(a) {
    return U(a).then(function (b) {
      return null === b ? null : new Ei(a, b);
    });
  }
  m = Ei.prototype;
  m.advance = function (a) {
    this.cursor.advance(a);
    return Ai(this.request);
  };
      ...
      return Aa(e, function (y) {
        if (1 == y.h)
          return (
            ...
            (p = g.closed),
            (r = function () {
              q || (q = new qi(f.result, { closed: p }));
              return q;
            }),
            f.addEventListener("upgradeneeded", function (D) {
              if (null === D.newVersion)
                throw Error(
                  "Invariant: newVersion on IDbVersionChangeEvent is null"
                );
              if (null === f.transaction)
                throw Error(
                  "Invariant: transaction on IDbOpenDbRequest is null"
                );
              D.dataLoss &&
                "none" !== D.dataLoss &&
                bi("IDB_DATA_CORRUPTED", {
                  reason: D.dataLossMessage || "unknown reason",
                  dbName: a,
                });
              var da = r(),
                wa = new Bi(f.transaction);
              n && n(da, D.oldVersion, D.newVersion, wa);
            }),
            h &&
        ...
        w = y.m;
        k &&
          w.addEventListener("versionchange", function () {
            k(r());
          });
        w.addEventListener("close", function () {
          bi("IDB_UNEXPECTEDLY_CLOSED", { dbName: a, dbVersion: w.version });
          l && l();
        });
        return y["return"](r());
      });
  ...
  Hi.prototype["delete"] = function (a) {
    a = void 0 === a ? {} : a;
    return Gi(this.name, a);
  };
  function Ji() {
    var a = Ki;
    if (!a.h) {
        ...
        d = function () {
          return cc(a, function g() {
            ...
            return Aa(g, function (p) {
              switch (p.h) {
                case 1:
                  return (p.l = 2), sa(p, Ii(h.name, h.options.version, c), 4);
                case 4:
                  k = p.m;
                  if (!vc) {
                    p.h = 5;
                  ...
                  if (
                    ...
                    return p["return"](
                      Ii(
                        h.name,
                        void 0,
                        Object.assign(Object.assign({}, c), { upgrade: void 0 })
                      )
                    );
                  b();
                  throw n;
  ...
  var Ki = new Hi({
    ...
    upgrade: function (a, b) {
      1 > b && a.h.createObjectStore("databases", { keyPath: "actualName" });
    },
  });
  function Li(a) {
    return cc(this, function c() {
      ...
      return Aa(c, function (e) {
        if (1 == e.h) return sa(e, Ji(), 2);
        d = e.m;
        return e["return"](
          ri(d, ["databases"], "readwrite", function (f) {
            var g = si(f, "databases");
              ...
              if (
                h
                  ? a.actualName !== h.actualName ||
                    ...
                    a.signedIn !== h.signedIn ||
                    a.clearDataOnAuthChange !== h.clearDataOnAuthChange
                  : 1
              )
                return U(g.h.put(a, void 0)).then(function () {});
            });
          })
        );
      });
      ...
      return Aa(b, function (e) {
        switch (e.h) {
          case 1:
            ...
            if ((f && !O("ytidb_allow_on_ios_safari_v8_and_v9")) || hc)
              return e["return"](!1);
            try {
              if (
                ((c = self),
  ...
  function Pi() {
    if (void 0 !== Ni) return Ni;
    ai = !0;
    return (Ni = Oi().then(function (a) {
      ai = !1;
      return a;
    }));
  }
  ...
  function Vi(a) {
    window.addEventListener("online", function () {
      a.l = !0;
      a.j && Ue(a, "ytnetworkstatus-online");
      Wi(a);
      if (a.o && O("offline_error_handling")) {
        var b = Ri().get("errors", !0);
        if (b) {
          for (var c in b)
            if (b[c]) {
  ...
  function Ui(a) {
    window.addEventListener("offline", function () {
      a.l = !1;
      a.j && Ue(a, "ytnetworkstatus-offline");
      Wi(a);
    });
  }
  function Wi(a) {
    a.u &&
      (Sf(new R("NetworkStatusManager state did not match poll", Q() - 0)),
      (a.u = !1));
  }
  function Xi(a) {
    a = void 0 === a ? {} : a;
    ...
    a.ha
      ? ((this.ha = a.ha),
        Ie(this.j, "ytnetworkstatus-online", function () {
          Yi(b, "publicytnetworkstatus-online");
        }),
        Ie(this.j, "ytnetworkstatus-offline", function () {
          Yi(b, "publicytnetworkstatus-offline");
        }))
      : (Ie(this.j, "ytnetworkstatus-online", function () {
  ...
  function $i(a, b) {
    ...
    Pi().then(function () {
      Zi || (Zi = new Xi({ Va: !0 }));
      Zi.j.l !== Ti() &&
        Sf(new R("NetworkStatusManager isOnline does not match window status"));
      vh(a, b);
    });
  }
  function aj(a, b) {
  ...
  function Vg(a, b, c, d) {
    ...
    Pi().then(function (p) {
      if (
        d.retry &&
        O("retry_web_logging_batches") &&
        "www.youtube-nocookie.com" != g
      ) {
        if ((O("networkless_gel") && !p) || !O("networkless_gel"))
          var q = Ih(b, c, k, h);
        if (q) {
          var r = f.onSuccess,
            w = f.onFetchSuccess;
      ...
      try {
        O("use_fetch_for_op_xhr")
          ? sh(n, f)
          : O("networkless_gel") && d.retry
          ? ((f.method = "POST"),
            !d.pb && O("nwl_send_fast_on_unload") ? aj(n, f) : $i(n, f))
          : ((f.method = "POST"),
  ...
  function V(a, b, c) {
    c = void 0 === c ? {} : c;
    var d = bj;
    H("ytLoggingEventsDefaultDisabled", !1) && bj == bj && (d = null);
    Xg(a, b, d, c);
  }
  var cj = [
    {
        ...
        for (var k = 0, l = 0; l < a.args.length; l++) {
          ...
          if (n)
            if (Array.isArray(n)) {
              ...
              for (
                k = 0;
                k < n.length && !(n[k] && ((r += jj(k, n[k], p, q)), 500 < r));
                k++
              );
              k = r;
            } else if ("object" === typeof n)
              for (q in ((q = void 0), (r = c), n)) {
                if (n[q]) {
                  var w = q;
                  var y = n[q],
                    D = r;
                  w =
                    "string" !== typeof y ||
                    ("clickTrackingParams" !== w && "trackingParams" !== w)
                      ? 0
                      : (y = hj(atob(y.replace(/-/g, "+").replace(/_/g, "/"))))
                      ? jj(w + ".ve", y, p, D)
                      : 0;
                  k += w;
                  k += jj(q, n[q], p, r);
          ...
          for (f = u(d.qa[c.name]), e = f.next(); !e.done; e = f.next())
            if (((g = e.value), (e = c.message.match(g.regexp)))) {
              ...
              for (h = 0; h < f.length; h++)
                (g[f[h]] = e[h + 1]),
                  (c.params["params.error." + f[h]] = e[h + 1]);
              c.message = d.ya(g);
              break;
            }
      c.params || (c.params = {});
      a = fj();
      c.params["params.errorServiceSignature"] =
        "msg=" + a.i.length + "&cb=" + a.h.length;
      c.params["params.serviceWorker"] = "false";
      c.params["params.fscripts"] = String(
        document.querySelectorAll("script:not([nonce])").length
      );
      window.yterr && "function" === typeof window.yterr && window.yterr(c);
      a = 0 === c.sampleWeight;
      if (!lj.has(c.message) && !a) {
        "ERROR" === b
          ? (gj.O("handleError", c),
            O("record_app_crashed_web") &&
              0 === oj &&
              1 === c.sampleWeight &&
              (oj++,
              V("appCrashed", { appCrashType: "APP_CRASH_TYPE_BREAKPAD" })),
            nj++)
          : "WARNING" === b && gj.O("handleWarning", c);
        if (O("kevlar_gel_error_routing")) {
          d = b;
          a: {
            a = u(pj);
            for (e = a.next(); !e.done; e = a.next())
              if (Zh(e.value.toLowerCase())) {
                a = !0;
                break a;
              }
            a = !1;
          ...
          if (!a) {
            e = { stackTrace: c.stack };
            c.fileName && (e.filename = c.fileName);
            a =
              c.lineNumber && c.lineNumber.split ? c.lineNumber.split(":") : [];
            0 !== a.length &&
              (1 !== a.length || isNaN(Number(a[0]))
                ? 2 !== a.length ||
                  isNaN(Number(a[0])) ||
                  isNaN(Number(a[1])) ||
                  ((e.lineNumber = Number(a[0])),
                  (e.columnNumber = Number(a[1])))
                : (e.lineNumber = Number(a[0])));
            a = {
            ...
            "ERROR" === d
              ...
              : "WARNING" === d && (a.level = "ERROR_LEVEL_WARNNING");
            d = { isObfuscated: !0, browserStackInfo: e };
            e = { pageUrl: window.location.href, kvPairs: [] };
            H("FEXP_EXPERIMENTS") && (e.experimentIds = H("FEXP_EXPERIMENTS"));
            if ((f = c.params))
              for (g = u(Object.keys(f)), h = g.next(); !h.done; h = g.next())
                (h = h.value),
                  e.kvPairs.push({ key: "client." + h, value: String(f[h]) });
            f = H("SERVER_NAME", void 0);
            g = H("SERVER_VERSION", void 0);
            f &&
              g &&
              (e.kvPairs.push({ key: "server.name", value: f }),
              e.kvPairs.push({ key: "server.version", value: g }));
            V("clientError", {
              errorMetadata: e,
              stackTrace: d,
              logMessage: a,
        ...
        if (!O("suppress_error_204_logging")) {
          ...
          b = {
            ...
            postParams: {
              url: H("PAGE_NAME", window.location.href),
              file: c.fileName,
            },
            method: "POST",
          };
          ...
          if (b.postParams) {
            ...
            d = u(Object.keys(a));
            for (e = d.next(); !e.done; e = d.next())
              (e = e.value), (b.postParams["client." + e] = a[e]);
            if ((a = H("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS", void 0)))
              for (d = u(Object.keys(a)), e = d.next(); !e.done; e = d.next())
                (e = e.value), (b.postParams[e] = a[e]);
            a = H("SERVER_NAME", void 0);
            d = H("SERVER_VERSION", void 0);
            a &&
              d &&
              ((b.postParams["server.name"] = a),
              (b.postParams["server.version"] = d));
          }
          vh(H("ECATCHER_REPORT_HOST", "") + "/error_204", b);
        }
        lj.add(c.message);
        mj++;
      }
  ...
  function uj(a) {
    return (
      wj[a] ||
      (wj[a] = String(a).replace(/\-([a-z])/g, function (b, c) {
  ...
  function Aj(a, b, c) {
    ...
    f
      ? b && b()
      : (b && ((f = wg(d, b)), (b = "" + Na(b)), (Cj[b] = f)),
        g ||
          (e = Dj(
            a,
            d,
            function () {
              vj(e, "loaded") || (tj(e), zg(d), P(Sa(Ag, d), 0));
            },
            c
          )));
  }
  ...
  function Ej(a) {
    ...
    b && (Ag(a), b.parentNode.removeChild(b));
  }
  function Fj(a, b) {
    if (a && b) {
      var c = "" + Na(b);
  ...
  function Ij() {
    if (
      !O("disable_ad_status_on_html5_clients") &&
      (!O("condition_ad_status_fetch_on_consent_cookie_html5_clients") ||
        od.get("CONSENT", "").startsWith("YES+")) &&
      "1" != kb()
    ) {
      var a = function () {
        Hj = !0;
      ...
      ? ((this.i = !0),
        zj(
          ...
          function () {
            ...
            (h ? window.trayride : window.botguard)
              ? Lj(g, c, d, f, h)
              : (Ej(b), qj(new R("Unable to load Botguard", "from " + b)));
          },
          e
        ))
      : a &&
        ...
        ((a = a.includes("trayride")) ? window.trayride : window.botguard)
          ? Lj(this, c, d, f, a)
          : qj(Error("Unable to load Botguard from JS")));
  };
  ...
  function Oj(a) {
    ...
    return Mj.h
      ? Mj.h.hot
        ? Mj.h.hot(void 0, void 0, a)
        : Mj.h.invoke(void 0, void 0, a)
      : null;
  }
  var Pj = E().toString();
  function Qj() {
    a: {
      ...
      if (Pj)
        for (a = 1, b = 0; b < Pj.length; b++)
          (d[a % 16] = d[a % 16] ^ (d[(a - 1) % 16] / 4) ^ Pj.charCodeAt(b)),
            a++;
    }
    a = [];
  ...
  var Rj = x.ytLoggingDocDocumentNonce_ || Qj();
  z("ytLoggingDocDocumentNonce_", Rj, void 0);
  var Sj = {
    Wd: 0,
    Yb: 1,
    ic: 2,
  ...
  function Vj(a) {
    return new Uj({ trackingParams: a });
  }
  Uj.prototype.getAsJson = function () {
    var a = {};
  ...
  Uj.prototype.isClientVe = function () {
  ...
  function Yj(a) {
    return H(Xj(void 0 === a ? 0 : a), void 0);
  }
  z("yt_logging_screen.getRootVeType", Yj, void 0);
  function Zj(a) {
    return (a = Yj(void 0 === a ? 0 : a))
      ? new Uj({ veType: a, youtubeData: void 0 })
      : null;
  }
  function ak() {
  ...
  z("yt_logging_screen.getCttAuthInfo", ck, void 0);
  function dk(a, b, c, d) {
    c = void 0 === c ? 0 : c;
    if (a !== H(Wj(c)) || b !== H(Xj(c)))
      if (
        (bk(a, d, c),
        N(Wj(c), a),
        N(Xj(c), b),
        0 == c || O("web_screen_associated_all_layers"))
      )
        (b = function () {
          setTimeout(function () {
            a &&
              Xg(
                ...
                { clientDocumentNonce: Rj, clientScreenNonce: a },
                bj
              );
          }, 0);
        }),
  ...
  z("yt_logging_screen.setCurrentScreen", dk, void 0);
  function ek(a) {
    Lh.call(this, 1, arguments);
    this.csn = a;
  }
  v(ek, Lh);
  var Uh = new Mh("screen-created", ek),
    fk = [],
    hk = gk,
    ik = 0;
  function jk(a, b, c, d) {
    ...
    for (var e = d.next(); !e.done; e = d.next())
      (e = e.value.getAsJson()),
        (ib(e) || (!e.trackingParams && !e.veType)) &&
          qj(Error("Child VE logged with no data"));
    d = { L: ck(b), M: b };
    "UNDEFINED_CSN" == b
      ? kk("visualElementAttached", c, d)
      : a
      ? Xg("visualElementAttached", c, a, d)
      : V("visualElementAttached", c, d);
  }
  function lk(a, b) {
    var c = O("use_default_events_client") ? void 0 : bj,
      d = { csn: a, ve: b.getAsJson(), eventType: 1 },
      e = { L: ck(a), M: a };
    "UNDEFINED_CSN" == a
      ? kk("visualElementShown", d, e)
      : c
      ? Xg("visualElementShown", d, c, e)
      : V("visualElementShown", d, e);
  }
  function mk(a, b, c) {
    var d = "INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK";
    c = { csn: b, ve: c.getAsJson(), gestureType: d };
    d = { L: ck(b), M: b };
    "UNDEFINED_CSN" == b
      ? kk("visualElementGestured", c, d)
      : a
      ? Xg("visualElementGestured", c, a, d)
      : V("visualElementGestured", c, d);
  }
  function gk() {
  ...
  function kk(a, b, c) {
    fk.push({ payloadName: a, payload: b, options: c });
    ik || (ik = Vh());
  }
  function Wh(a) {
    if (fk) {
      for (var b = u(fk), c = b.next(); !c.done; c = b.next())
        (c = c.value),
          c.payload &&
            ((c.payload.csn = a.csn),
            Xg(c.payloadName, c.payload, null, c.options));
      fk.length = 0;
    }
    ik = 0;
  }
  function nk(a, b, c) {
    jk(O("use_default_events_client") ? void 0 : bj, a, b, [c]);
  }
  var ok = {
    Vb: 29434,
    Xb: 3611,
  ...
  F(pk, L);
  pk.prototype.subscribe = function (a, b, c) {
  ...
  m = sk.prototype;
  m.start = function () {
    this.m || this.i || ((this.m = !0), rk(this.h, "RECEIVING"));
  };
  m.Aa = function (a, b, c) {
    if (this.m && !this.i) {
      var d = b || {};
      switch (a) {
        ...
        case "removeEventListener":
          "string" === typeof d.event && tk(this, d.event);
          break;
        default:
          this.l.isReady() &&
            this.l.isExternalMethodAvailable(a, c || null) &&
            ((b = uk(a, b || {})),
            (c = this.l.handleExternalCall(a, b, c || null)),
            (c = vk(a, c)) && this.m && !this.i && rk(this.h, a, c));
      }
    }
  };
  m.hb = function (a, b) {
    this.m && !this.i && rk(this.h, a, this.la(a, b));
  };
  m.la = function (a, b) {
  ...
  m.A = function () {
    var a = this.h;
    a.i || vf(a.h, "command", this.Aa, this);
    this.h = null;
    for (var b in this.j) tk(this, b);
  ...
  function xk(a, b, c) {
    "string" === typeof a &&
      (a = { mediaContentUrl: a, startSeconds: b, suggestedQuality: c });
    a: {
      if (
        (b = a.mediaContentUrl) &&
        (b = /\/([ve]|embed)\/([^#?]+)/.exec(b)) &&
  ...
  v(Ak, sk);
  Ak.prototype.addEventListener = function (a, b) {
    this.l.addEventListener(a, b);
  };
  Ak.prototype.removeEventListener = function (a, b) {
  ...
  Ak.prototype.la = function (a, b) {
    ...
    return sk.prototype.la.call(this, a, b);
  };
  Ak.prototype.A = function () {
    sk.prototype.A.call(this);
    delete this.l;
  };
  function Bk(a, b, c) {
    L.call(this);
    ...
    this.u = function (e) {
      a: if (
        ...
        if (
          ...
          switch (f.event) {
            case "listening":
              "null" != e.origin && (d.l = d.B = e.origin);
              d.j = e.source;
              d.sessionId = f.id;
              d.h && (d.h(), (d.h = null));
              break;
  ...
  v(Bk, L);
  Bk.prototype.sendMessage = function (a, b) {
    var c = b || this.j;
    if (c) {
  ...
  function Ck() {
    var a = (this.i = new Bk(!!H("WIDGET_ID_ENFORCE"))),
      b = C(this.eb, this);
    a.m = b;
    a.o = null;
  ...
  m.eb = function (a, b, c) {
    "addEventListener" == a && b
      ? ((a = b[0]),
        this.m[a] ||
          "onReady" == a ||
          (this.addEventListener(a, Dk(this, a)), (this.m[a] = !0)))
      : this.za(a, b, c);
  };
  m.za = function () {};
  function Dk(a, b) {
  ...
  m.sendMessage = function (a, b) {
    this.Ba({ event: a, info: void 0 == b ? null : b });
  };
  m.dispose = function () {
    this.i = null;
  };
  function Fk(a) {
    ...
    this.addEventListener("onWebglSettingsChanged", C(this.nb, this));
  }
  v(Fk, Ck);
  m = Fk.prototype;
  m.za = function (a, b, c) {
  ...
  m.addEventListener = function (a, b) {
    this.j.push({ eventType: a, listener: b });
  ...
  m.kb = function (a) {
    ...
    this.h.getVideoUrl && (a.videoUrl = this.h.getVideoUrl());
    this.h.getVideoContentRect &&
      (a.videoContentRect = this.h.getVideoContentRect());
    ...
    this.h.getStoryboardFormat &&
      (a.storyboardFormat = this.h.getStoryboardFormat());
    Ek(this, a);
  };
  m.ib = function (a) {
    Ek(this, { playbackQuality: a });
  };
  m.jb = function (a) {
    Ek(this, { playbackRate: a });
  };
  m.gb = function () {
    for (
      var a = this.h.getOptions(), b = { namespaces: a }, c = 0, d = a.length;
      c < d;
      c++
    ) {
      var e = a[c],
  ...
  m.mb = function () {
    Ek(this, { muted: this.h.isMuted(), volume: this.h.getVolume() });
  };
  m.lb = function (a) {
    a = {
      currentTime: a,
  ...
  m.nb = function () {
    var a = { sphericalProperties: this.h.getSphericalProperties() };
    Ek(this, a);
  };
  m.dispose = function () {
  ...
  function Gk(a, b, c) {
    ...
    this.h = a;
    this.l = c;
    this.m = dg(window, "message", C(this.o, this));
    this.j = new qk(this, a, b);
  ...
  Gk.prototype.o = function (a) {
    ...
    if (b && ((b = a.data), "string" === typeof b)) {
      ...
      b.command &&
        ((c = this.j), c.i || c.m("command", b.command, b.data, a.origin));
    }
  };
    ...
    return kf(
      new cf(function (c, d) {
        ...
        a.onError = function (e) {
          d(new Jk("Unknown request error", "net.unknown", e));
        };
        a.onTimeout = function (e) {
          d(new Jk("Request timed out", "net.timeout", e));
        };
        b = vh("//googleads.g.doubleclick.net/pagead/id", a);
      }),
      function (c) {
        c instanceof lf && b.abort();
        return hf(c);
      }
    );
  }
  ...
  Kk.prototype.then = function (a, b, c) {
    return 1 === this.i && a
      ? ((a = a.call(c, this.h)), bf(a) ? a : Lk(a))
      : 2 === this.i && b
      ? ((a = b.call(c, this.h)), bf(a) ? a : Mk(a))
      : this;
  };
  ...
  function Nk(a) {
    ...
    this.isMissing = a instanceof Ok;
    this.isTimeout = a instanceof Jk && "net.timeout" == a.errorCode;
    this.isCanceled = a instanceof lf;
  }
  v(Nk, Va);
  Nk.prototype.name = "BiscottiError";
  function Ok() {
    Va.call(this, "Biscotti ID is missing from server");
  }
  v(Ok, Va);
  Ok.prototype.name = "BiscottiMissingError";
  var Ik = { format: "RAW", method: "GET", timeout: 5e3, withCredentials: !0 },
    Pk = null;
  function Zg() {
    if (O("disable_biscotti_fetch_on_html5_clients"))
      return hf(Error("Fetching biscotti ID is disabled."));
    if (
      O("condition_biscotti_fetch_on_consent_cookie_html5_clients") &&
      !od.get("CONSENT", "").startsWith("YES+")
    )
      return hf(Error("User has not consented - not fetching biscotti id."));
    if ("1" == kb())
      return hf(Error("Biscotti ID is not available in private embed mode"));
    Pk ||
      (Pk = kf(Hk().then(Qk), function (a) {
        return Rk(2, a);
      }));
    return Pk;
  }
  function Qk(a) {
    a = a.responseText;
    if (0 != a.lastIndexOf(")]}'", 0)) throw new Ok();
    a = JSON.parse(a.substr(4));
    if (1 < (a.type || 1)) throw new Ok();
    a = a.id;
    $g(a);
    Pk = Lk(a);
    Sk(18e5, 2);
  ...
  function $k(a, b) {
    ...
    c = u(c);
    for (d = c.next(); !d.done; d = c.next()) bl(a, d.value);
    return a;
  }
  function bl(a, b) {
    for (var c in b)
  ...
  function dl(a, b) {
    for (var c = u(b), d = c.next(); !d.done; d = c.next())
      (d = d.value),
        al(d) ? a.push(bl({}, d)) : cl(d) ? a.push(dl([], d)) : a.push(d);
    return a;
  }
  function al(a) {
  ...
  function gl(a, b, c, d, e) {
    ...
    if (a)
      if (c && !Zh("cobalt")) {
        if (a) {
          a instanceof I ||
            ...
            Jb.test(a)
              ...
              : ((a = String(a)),
                (a = a.replace(/(%0A|%0D)/g, "")),
                (a =
                  (b = a.match(Ib)) && Hb.test(b[1]) ? new I(a, Fb) : null)));
          a = Gb(a || Lb);
          if ("about:invalid#zClosurez" === a || a.startsWith("data")) a = "";
            ...
            a instanceof Pb && a.constructor === Pb
              ? (a = a.h)
              : (La(a), (a = "type_error:SafeHtml"));
            a = encodeURIComponent(String(We(a.toString())));
          }
          /^[\s\xa0]*$/.test(a) ||
            ((a = Ic("IFRAME", {
      ...
      } else if (e) wh(a, b, "POST", e, d);
      else if (H("USE_NET_AJAX_FOR_PING_TRANSPORT", !1) || d)
        wh(a, b, "GET", "", d);
      else {
        b: {
          try {
  ...
  v(kl, Lh);
  var ll = new Mh("aft-recorded", jl),
    ml = new Mh("timing-sent", kl);
  var nl = window;
  function ol() {
    this.timing = {};
  ...
  function tl(a) {
    var b;
    (b = A("ytcsi." + (a || "") + "data_")) ||
      ((b = { tick: {}, info: {} }), Ta("ytcsi." + (a || "") + "data_", b));
    return b;
  }
  function ul(a) {
    a = tl(a);
  ...
  function wl(a) {
    var b = sl(a || ""),
      c = rl(a);
    c && !ql && (Rh(ll, new jl(Math.round(c - b._start), a)), (ql = !0));
  }
  function xl() {
    var a = A("ytcsi.debug");
    a ||
      ((a = []), z("ytcsi.debug", a, void 0), z("ytcsi.reference", {}, void 0));
    return a;
  }
  function yl(a) {
    a = a || "";
    var b = A("ytcsi.reference");
    b || (xl(), (b = A("ytcsi.reference")));
    if (b[a]) return b[a];
    var c = xl(),
      d = { timerName: a, info: {}, tick: {}, span: {} };
    c.push(d);
    return (b[a] = d);
  }
  var zl = x.ytLoggingLatencyUsageStats_ || {};
  z("ytLoggingLatencyUsageStats_", zl, void 0);
  function Al() {
    this.h = 0;
  }
  function Bl() {
  ...
  Al.prototype.tick = function (a, b, c) {
    Cl(this, "tick_" + a + "_" + b) ||
      V(
        "latencyActionTicked",
  ...
  Al.prototype.info = function (a, b) {
    var c = Object.keys(a).join("");
    Cl(this, "info_" + c + "_" + b) ||
      ((c = Object.assign({}, a)),
      (c.clientActionNonce = b),
      V("latencyActionInfo", c));
  };
  Al.prototype.span = function (a, b) {
    var c = Object.keys(a).join("");
    Cl(this, "span_" + c + "_" + b) ||
      ((a.clientActionNonce = b), V("latencyActionSpan", a));
  };
  function Cl(a, b) {
    zl[b] = zl[b] || { count: 0 };
    var c = zl[b];
    ...
    a.h ||
      (a.h = kg(
        function () {
          var d = Q(),
            e;
          for (e in zl) zl[e] && 6e4 < d - zl[e].time && delete zl[e];
          a && (a.h = 0);
        },
        0,
        5e3
  ...
  var Y = {},
    ...
    Fl = {},
    Gl =
      ((Fl.ccs = "CANARY_STATE_"),
      (Fl.mver = "MEASUREMENT_VERSION_"),
      (Fl.pis = "PLAYER_INITIALIZED_STATE_"),
      (Fl.yt_pt = "LATENCY_PLAYER_"),
      (Fl.pa = "LATENCY_ACTION_"),
      (Fl.yt_vst = "VIDEO_STREAM_TYPE_"),
      Fl),
    Hl =
  ...
  function Il(a) {
    return !!H("FORCE_CSI_ON_GEL", !1) || O("csi_on_gel") || !!tl(a).useGel;
  }
  function Jl(a) {
    a = tl(a);
    if (a.gel) {
    ...
    if (null !== b)
      if (((ul(c)[a] = b), Il(c))) {
        ...
        if (a in Dl) {
          b = Dl[a];
          0 <= Ya(El, b) && (d = !!d);
          a in Gl && "string" === typeof d && (d = Gl[a] + d.toUpperCase());
          a = d;
          d = b.split(".");
          ...
          0 <= Ya(Hl, a) || qj(new R("Unknown label logged with GEL CSI", a)),
            (f = void 0);
        f &&
          Il(c) &&
          ((b = yl(c || "")),
  ...
  function Ll(a, b, c) {
    var d = sl(c);
    if (O("use_first_tick") && Ml(a, c)) return d[a];
    if (!b && "_" !== a[0]) {
      var e = a;
      pl.mark &&
    ...
    if (!e) {
      if (
        !A("yt.timing." + (c || "") + "pingSent_") &&
        ((f = H((c || "") + "TIMING_ACTION", void 0)),
        (e = sl(c)),
        A("ytglobal.timing" + (c || "") + "ready_") &&
          f &&
          Ml("_start") &&
          rl(c))
      )
  ...
  function Nl(a) {
    if (!Il(a)) {
      var b = sl(a),
        ...
        f = { v: 2, s: e, action: H((a || "") + "TIMING_ACTION", void 0) },
        g = c.srt;
      ...
      b = !!c.ap;
      O("debug_csi_data") &&
        ((c = A("yt.timing.csiData")),
        c || ((c = []), Ta("yt.timing.csiData", c)),
      ...
      if (
        window.navigator &&
        window.navigator.sendBeacon &&
        (b || O("always_send_csi_204_with_beacon"))
      ) {
        var r = void 0 === r ? "" : r;
        hl(f, r) || gl(f, void 0, void 0, void 0, r);
      } else gl(f);
      z("yt.timing." + (a || "") + "pingSent_", !0, void 0);
      Rh(ml, new kl(n.aft + (Number(g) || 0), a));
    }
  }
  var Ol = window;
  Ol.ytcsi && ((Ol.ytcsi.info = Kl), (Ol.ytcsi.tick = Ll));
  function Pl() {
    this.l = [];
    this.m = [];
    this.h = [];
  ...
  function Ql(a, b, c) {
    ...
    b.then(function (d) {
      ...
      g &&
        h &&
        ((d.csn = g),
        (null === (e = d.response) || void 0 === e ? 0 : e.trackingParams) &&
          jk(a.client, g, h, [Vj(d.response.trackingParams)]),
        (null === (f = d.playerResponse) || void 0 === f
          ? 0
          : f.trackingParams) &&
          jk(a.client, g, h, [Vj(d.playerResponse.trackingParams)]));
    });
  }
  function Rl(a, b, c, d) {
    d = void 0 === d ? 0 : d;
    if (a.i.has(d)) a.l.push([b, c]);
      ...
      var e = W(d);
      c = c || Zj(d);
      e && c && jk(a.client, e, c, [b]);
    }
  }
  Pl.prototype.clickCommand = function (a) {
    var b = W();
    if (!a.clickTrackingParams || !b) return !1;
    mk(this.client, b, Vj(a.clickTrackingParams));
    return !0;
  };
  function Sl(a, b, c) {
    c = void 0 === c ? {} : c;
    ...
    a.j = function () {
      ...
      var f = Zj(c.layer);
      if (f) {
        for (var g = u(a.l), h = g.next(); !h.done; h = g.next())
          (h = h.value), Rl(a, h[0], h[1] || f, c.layer);
        f = u(a.m);
        for (g = f.next(); !g.done; g = f.next()) {
          ...
          h &&
            ...
            ((g = a.client),
            (k = k[1]),
            (k = { csn: h, ve: l.getAsJson(), clientData: k }),
            (l = { L: ck(h), M: h }),
            "UNDEFINED_CSN" == h
              ? kk("visualElementStateChanged", k, l)
              : g
              ? Xg("visualElementStateChanged", k, g, l)
              : V("visualElementStateChanged", k, l));
        }
      }
    };
    W(c.layer) || a.j();
    if (c.va)
      for (var d = u(c.va), e = d.next(); !e.done; e = d.next())
        Ql(a, e.value, c.layer);
  ...
  function Tl(a, b, c) {
    ...
    try {
      var g = a.client,
        ...
        p = {
          csn: n,
          pageVe: new Uj({ veType: b, youtubeData: void 0 }).getAsJson(),
        };
      h && h.visualElement
        ? (p.implicitGesture = {
        ...
        : h &&
          qj(
            new R("newScreen() parent element does not have a VE - rootVe", b)
          );
      k && (p.cloneCsn = k);
      k = { L: l, M: n };
      g ? Xg("screenCreated", p, g, k) : V("screenCreated", p, k);
      Rh(Uh, new ek(n));
      var q = n;
    } catch (r) {
      sj(r, {
    ...
    dk(q, b, c.layer, c.L);
    if (
      (b = e && "UNDEFINED_CSN" !== e && d) &&
      !(b = O("screen_manager_skip_hide_killswitch"))
    ) {
      a: {
        b = u(Object.values(Sj));
    ...
    b &&
      ((b = a.client),
      (f = !0),
      (g = (f = void 0 === f ? !1 : f) ? 16 : 8),
      (d = { csn: e, ve: d.getAsJson(), eventType: g }),
      (f = { L: ck(e), M: e, Ha: f }),
      "UNDEFINED_CSN" == e
        ? kk("visualElementHidden", d, f)
        : b
        ? Xg("visualElementHidden", d, b, f)
        : V("visualElementHidden", d, f));
    a.h[a.h.length - 1] &&
      !a.h[a.h.length - 1].csn &&
      (a.h[a.h.length - 1].csn = q || "");
    Kl("csn", q);
    Zk.getInstance().clear();
    d = Zj(c.layer);
    e &&
      "UNDEFINED_CSN" !== e &&
      d &&
      (O("web_mark_root_visible") || O("music_web_mark_root_visible")) &&
      lk(q, d);
    ...
    for (q = e.next(); !q.done; q = e.next())
      (q = u(q.value)),
        (b = q.next().value),
        q.next().value === c.layer && d && Rl(a, b, d, c.layer);
  }
  function Ul() {
    L.call(this);
    this.h = [];
  ...
  var Wl = /cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;
  function Xl(a) {
    a = a || "";
    if (window.spf) {
      var b = a.match(Wl);
  ...
  function Yl(a) {
    ...
    d ||
      (c && !d) ||
      (c = $l(a, b, function () {
        vj(c, "loaded") || (tj(c), zg(b), P(Sa(Ag, b), 0));
      }));
  }
  function $l(a, b, c) {
  ...
  m.loadNewVideoConfig = function (a) {
    if (!this.i) {
      this.Y && (gg(this.Y), (this.Y = 0));
      a instanceof Vl || (a = new Vl(a));
      this.ja = a;
      this.h = a.clone();
      cm(this);
      this.aa ||
        (this.aa = em(
          this,
          this.h.args.jsapicallback || "onYouTubePlayerReady"
        ));
      this.h.args.jsapicallback = null;
      if ((a = this.h.attrs.width))
        this.u.style.width = id(Number(a) || String(a));
      if ((a = this.h.attrs.height))
        this.u.style.height = id(Number(a) || String(a));
      dm(this);
      this.B && fm(this);
    }
  };
  function cm(a) {
    ...
    a.l = b || a.l;
    "video-player" == a.l &&
      ((a.l = a.I), a.j ? (a.j.rootElementId = a.I) : (a.h.attrs.id = a.I));
    a.u.id == a.l &&
      ((a.l += "-player"),
      a.j ? (a.j.rootElementId = a.l) : (a.h.attrs.id = a.l));
  }
  m.Ja = function () {
    return this.ja;
  };
  function fm(a) {
    a.h &&
      ...
      ((a.h.loaded = !0),
      "0" != a.h.args.autoplay
        ? a.api.loadVideoByPlayerVars(a.h.args)
        : a.api.cueVideoByPlayerVars(a.h.args));
  }
  function gm(a) {
    var b = !0,
      c = hm(a);
    c && a.h && ((a = im(a)), (b = vj(c, "version") === a));
    return b && !!A("yt.player.Application.create");
  }
  function dm(a) {
    if (!a.i && !a.R) {
      var b = gm(a);
      if (b && "html5" == (hm(a) ? "html5" : null))
        (a.S = "html5"), a.B || jm(a);
      else if ((km(a), (a.S = "html5"), b && a.o)) a.ba.appendChild(a.o), jm(a);
      else {
        a.h && (a.h.loaded = !0);
        var c = !1;
        a.F = function () {
          c = !0;
          var d = lm(a, "player_bootstrap_method")
            ? A("yt.player.Application.createAlternate") ||
              A("yt.player.Application.create")
            : A("yt.player.Application.create");
        ...
        b
          ? a.F()
          : (zj(im(a), a.F),
            (b = a.j ? a.j.cssUrl : a.h.assets.css) && Xl(b),
            mm(a) && !c && z("yt.player.Application.create", null, void 0));
      }
    }
  }
  function hm(a) {
  ...
  function jm(a) {
    if (!a.i) {
      ...
      c
        ? ((a.R = !1),
          (!lm(a, "html5_remove_not_servable_check_killswitch") &&
            b.isNotServable &&
            a.h &&
            b.isNotServable(a.h.args.video_id)) ||
            nm(a))
        : (a.ra = P(function () {
            jm(a);
          }, 50));
  ...
  function nm(a) {
    ...
    a.B = !0;
    var b = hm(a);
    b.addEventListener && (a.H = om(a, b, "addEventListener"));
    b.removeEventListener && (a.Z = om(a, b, "removeEventListener"));
    var c = b.getApiInterface();
    c = c.concat(b.getInternalApiInterface());
    for (var d = 0; d < c.length; d++) {
      var e = c[d];
      a.api[e] || (a.api[e] = om(a, b, e));
    }
  ...
  function om(a, b, c) {
    ...
    return function () {
      try {
        ...
        "sendAbandonmentPing" != c && ((e.params = c), (a.ia = e), Sf(e));
      }
    };
  }
  function bm(a) {
    a.B = !1;
    if (a.Z) for (var b in a.m) a.Z(b, a.m[b]);
    for (var c in a.X) gg(parseInt(c, 10));
    a.X = {};
    a.H = null;
    a.Z = null;
  ...
  m.Ya = function (a) {
    zg("WATCH_LATER_VIDEO_ADDED", a);
  };
  m.Za = function (a) {
    zg("WATCH_LATER_VIDEO_REMOVED", a);
  };
  m.La = function () {
    return this.S || (hm(this) ? "html5" : null);
  };
  m.Ka = function () {
    return this.ia;
  };
  function km(a) {
    ...
    b &&
      (gm(a) || !mm(a)
        ? (a.o = b)
        : (b && b.destroy && b.destroy(), (a.o = null)));
    for (a = a.ba; (b = a.firstChild); ) a.removeChild(b);
  }
  m.cancel = function () {
    this.F && Fj(im(this), this.F);
    gg(this.ra);
    this.R = !1;
  };
  m.A = function () {
    km(this);
    if (this.o && this.h && this.o.destroy)
      try {
        this.o.destroy();
      } catch (b) {
        Rf(b);
  ...
  function mm(a) {
    return a.h && a.h.args && a.h.args.fflags
      ? -1 != a.h.args.fflags.indexOf("player_destroy_old_version=true")
      : !1;
  }
  function im(a) {
  ...
  var qm = {},
    rm = "player_uid_" + ((1e9 * Math.random()) >>> 0);
  function sm(a, b, c) {
    var d = "player";
    c = void 0 === c ? !0 : c;
  ...
  function zm(a) {
    ...
    if (b && a && (dk(b, a), (a = Zj())))
      for (var c in wm)
        if (wm.hasOwnProperty(c)) {
          var d = wm[c];
          d && nk(b, a, d);
        }
  }
  function Am(a) {
    wm[a.id] = Vj(a.tracking_params);
  }
  function Bm(a) {
    var b = W();
    a = wm[a.id];
    b && a && mk(O("use_default_events_client") ? void 0 : bj, b, a);
  }
  function Cm(a) {
    a = a.ids;
    var b = W();
  ...
  function Dm(a, b, c) {
    ...
    if (b) {
      ...
      if (0 <= Ya(f, g) || (!g && 0 == d.lastIndexOf("/", 0)))
        if (
          (O("autoescape_tempdata_url") &&
            ((f = document.createElement("a")), Sb(f, d), (d = f.href)),
          d)
        ) {
          g = d.match(Wb);
          d = g[5];
          ...
          if ((d = 0 > f ? d : d.substr(0, f)))
            if (
              ...
              isFinite(k) &&
                0 < k &&
                ((e = b),
                (b = "ST-" + Vb(d).toString(36)),
                (e = e ? $b(e) : ""),
                Eh(b, e, k || 5));
            } else
              (k = b),
                (e = "ST-" + Vb(d).toString(36)),
                (k = k ? $b(k) : ""),
                Eh(e, k, 5);
        }
    }
  ...
  z("yt.setMsg", Uf, void 0);
  z("yt.msgs.set", Uf, void 0);
  z("yt.logging.errors.log", rj, void 0);
  z(
    "writeEmbed",
    function () {
      ...
      window !== window.top &&
        ...
        (a.args.loaderUrl = c);
      if (
        (c = H("WEB_PLAYER_CONTEXT_CONFIGS", void 0)) &&
        ...
        if (!d.serializedForcedExperimentIds) {
          ...
          -1 != e.indexOf("?")
            ? ((e = (e || "").split("#")[0]),
              (e = e.split("?", 2)),
              (e = gh(1 < e.length ? e[1] : e[0])))
            : (e = {});
          e.forced_experiments &&
            (d.serializedForcedExperimentIds = e.forced_experiments);
        }
        Z = sm(a, c.WEB_PLAYER_CONTEXT_CONFIG_ID_EMBEDDED_PLAYER, !1);
      } else Z = sm(a);
      Z.addEventListener("onScreenChanged", zm);
      Z.addEventListener("onLogClientVeCreated", xm);
      Z.addEventListener("onLogServerVeCreated", Am);
      Z.addEventListener("onLogVeClicked", Bm);
      Z.addEventListener("onLogVesShown", Cm);
      Z.addEventListener("onVideoDataChange", ym);
      ...
      H("ENABLE_JS_API")
        ...
        : H("ENABLE_POST_API") &&
          "string" === typeof a &&
          "string" === typeof b &&
          ((um = new Gk(window.parent, a, b)), (vm = new Ak(Z, um.j)));
      Ij();
    },
    void 0
  );
  var Em = Qf(function () {
      Ll("ol");
      var a = Vk.getInstance(),
        b = !!((Yk("f" + (Math.floor(119 / 31) + 1)) || 0) & 67108864),
        c = 1 < window.devicePixelRatio;
      if (document.body && Ud(document.body, "exp-invert-logo"))
        if (c && !Ud(document.body, "inverted-hdpi")) {
          var d = document.body;
          if (d.classList) d.classList.add("inverted-hdpi");
          else if (!Ud(d, "inverted-hdpi")) {
            var e = Sd(d);
            Td(d, e + (0 < e.length ? " inverted-hdpi" : "inverted-hdpi"));
          }
        } else !c && Ud(document.body, "inverted-hdpi") && Vd();
      b != c &&
        ((b = "f" + (Math.floor(119 / 31) + 1)),
        (d = Yk(b) || 0),
        (d = c ? d | 67108864 : d & -67108865),
        0 == d ? delete X[b] : ((c = d.toString(16)), (X[b] = c.toString())),
        a.save());
      Pl.h || (Pl.h = new Pl());
      a = Pl.h;
      c = 16623;
      var f = void 0 === f ? {} : f;
      Object.values(ok).includes(c) ||
        (qj(new R("createClientScreen() called with a non-page VE", c)),
        (c = 83769));
      f.isHistoryNavigation || a.h.push({ rootVe: c, key: f.key || "" });
      a.l = [];
      a.m = [];
      f.va ? Sl(a, c, f) : Tl(a, c, f);
    }),
    Fm = Qf(function () {
      Z && Z.sendAbandonmentPing && Z.sendAbandonmentPing();
      H("PL_ATT") && Mj.dispose();
      for (var a = 0, b = Gj.length; a < b; a++) mg(Gj[a]);
      Gj.length = 0;
      ...
      Sc(vm, um);
      Z &&
        (Z.removeEventListener("onScreenChanged", zm),
        Z.removeEventListener("onLogClientVeCreated", xm),
        Z.removeEventListener("onLogServerVeCreated", Am),
        Z.removeEventListener("onLogVeClicked", Bm),
        Z.removeEventListener("onLogVesShown", Cm),
        Z.removeEventListener("onVideoDataChange", ym),
        Z.destroy());
      wm = {};
    });
  window.addEventListener
    ? (window.addEventListener("load", Em),
      window.addEventListener("unload", Fm))
    : window.attachEvent &&
      (window.attachEvent("onload", Em), window.attachEvent("onunload", Fm));
  Ta(
    "yt.abuse.player.botguardInitialized",
    A("yt.abuse.player.botguardInitialized") || Nj
  );
  Ta(
    "yt.abuse.player.invokeBotguard",
    A("yt.abuse.player.invokeBotguard") || Oj
  );
  Ta(
    "yt.abuse.dclkstatus.checkDclkStatus",
    A("yt.abuse.dclkstatus.checkDclkStatus") || Jj
  );
  Ta("yt.player.exports.navigate", A("yt.player.exports.navigate") || Dm);
  Ta("yt.util.activity.init", A("yt.util.activity.init") || og);
  Ta(
    "yt.util.activity.getTimeSinceActive",
    A("yt.util.activity.getTimeSinceActive") || rg
  );
  Ta("yt.util.activity.setTimestamp", A("yt.util.activity.setTimestamp") || pg);
}.call(this));
