  ...
  function f(e) {
    ...
    function m() {
      ...
      for (let i = 0; i < r.length; i += 2)
        o.push({ name: r[i], startTime: r[i + 1] });
      return o;
    }
    return { mark: n, getMarks: m };
  }
  function c() {
      ...
      return typeof performance.timeOrigin != "number" && !performance.timing
        ...
        : {
            ...
            getMarks() {
              ...
              for (const n of performance.getEntriesByType("mark"))
                r.push({
                  name: n.name,
    ...
    if (typeof process == "object") {
      ...
      return f(e);
    } else return console.trace("perf-util loaded in UNKNOWN environment"), f();
  }
  function a(e) {
    return (
      e.MonacoPerformanceMarks || (e.MonacoPerformanceMarks = c()),
...
//# sourceMappingURL=https://ticino.blob.core.windows.net/sourcemaps/054a9295330880ed74ceaedda236253b4f39a335/core/vs/base/common/performance.js.map
