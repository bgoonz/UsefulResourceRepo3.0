module.exports = /******/ (function (modules) {
  ...
  \***********************************************************************/
      ...
      /***/ function (
        ...
        /* harmony import */ var http__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(/*! http */ "http");
        /* harmony import */ var url__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(/*! url */ "url");
        /* harmony import */ var https__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(/*! https */ "https");
        /* harmony import */ var zlib__WEBPACK_IMPORTED_MODULE_4__ =
        ...
        function clone(instance) {
          ...
          if (
            body instanceof stream__WEBPACK_IMPORTED_MODULE_0__ &&
          ...
          return new fetch.Promise(function (resolve, reject) {
            ...
            req.on("response", function (res) {
              ...
              if (codings == "gzip" || codings == "x-gzip") {
                body = body.pipe(
                  zlib__WEBPACK_IMPORTED_MODULE_4__.createGunzip(zlibOptions)
                );
                response = new Response(body, response_options);
                resolve(response);
                return;
              ...
              if (codings == "deflate" || codings == "x-deflate") {
                ...
                raw.once("data", function (chunk) {
                  ...
                  if ((chunk[0] & 0x0f) === 0x08) {
                    body = body.pipe(
                      zlib__WEBPACK_IMPORTED_MODULE_4__.createInflate()
                    );
                  } else {
                    body = body.pipe(
                      zlib__WEBPACK_IMPORTED_MODULE_4__.createInflateRaw()
                    );
                  }
                  response = new Response(body, response_options);
                  resolve(response);
              ...
              if (
                codings == "br" &&
                typeof zlib__WEBPACK_IMPORTED_MODULE_4__.createBrotliDecompress ===
                  "function"
              ) {
                body = body.pipe(
                  zlib__WEBPACK_IMPORTED_MODULE_4__.createBrotliDecompress()
                );
                response = new Response(body, response_options);
                resolve(response);
                return;
  ...
  \***************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        exports.bundlePage = (bundleFile, constants) =>
  ...
  \***********************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        const bundlePage_1 = __webpack_require__(
          /*! ../bundlePage */ "../vscode-js-profile-core/out/bundlePage.js"
        );
        const open_location_1 = __webpack_require__(
          /*! ../open-location */ "../vscode-js-profile-core/out/open-location.js"
        );
        const profileAnnotations_1 = __webpack_require__(
          /*! ../profileAnnotations */ "../vscode-js-profile-core/out/profileAnnotations.js"
        );
        const readonly_custom_document_1 = __webpack_require__(
          /*! ../readonly-custom-document */ "../vscode-js-profile-core/out/readonly-custom-document.js"
        );
        const reopenWithEditor_1 = __webpack_require__(
          /*! ../reopenWithEditor */ "../vscode-js-profile-core/out/reopenWithEditor.js"
        );
        const model_1 = __webpack_require__(
          /*! ./model */ "../vscode-js-profile-core/out/cpu/model.js"
        );
        class CpuProfileEditorProvider {
          ...
          openCustomDocument(uri) {
            return __awaiter(this, void 0, void 0, function* () {
              ...
              const document =
                new readonly_custom_document_1.ReadonlyCustomDocument(
                  uri,
                  model_1.buildModel(raw)
                );
          ...
          resolveCustomEditor(document, webviewPanel) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                switch (message.type) {
                  case "openDocument":
                    open_location_1.openLocation({
                      rootPath:
                        (_a = document.userData) === null || _a === void 0
                          ? void 0
                          : _a.rootPath,
                    ...
                    return;
                  case "reopenWith":
                    reopenWithEditor_1.reopenWithEditor(
                      document.uri,
                      message.viewType,
              ...
              webviewPanel.webview.html = yield bundlePage_1.bundlePage(
                this.bundle,
                Object.assign({ MODEL: document.userData }, this.extraConsts)
              );
            });
          }
          /**
  ...
  \**************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        const path_1 = __webpack_require__(
          /*! ../path */ "../vscode-js-profile-core/out/path.js"
        );
        const location_mapping_1 = __webpack_require__(
          /*! ../location-mapping */ "../vscode-js-profile-core/out/location-mapping.js"
        );
        /**
        ...
        const getBestLocation = (profile, candidates = []) => {
          var _a;
          if (
            !((_a = profile.$vscode) === null || _a === void 0
              ? void 0
              : _a.rootPath)
          ) {
            return candidates[0];
          ...
          for (const candidate of candidates) {
            const mapped = location_mapping_1.addRelativeDiskPath(
              profile.$vscode.rootPath,
              candidate
            );
        ...
        const ensureSourceLocations = (profile) => {
          ...
          for (const node of profile.nodes) {
            ...
            node.positionTicks =
              (_a = node.positionTicks) === null || _a === void 0
                ? void 0
                : _a.map((tick) =>
                    Object.assign(Object.assign({}, tick), {
                      ...
                      startLocationId: getLocationIdFor(
                        Object.assign(Object.assign({}, node.callFrame), {
        ...
        exports.buildModel = (profile) => {
          ...
          return {
            ...
            timeDeltas,
            rootPath:
              (_c = profile.$vscode) === null || _c === void 0
                ? void 0
                : _c.rootPath,
            duration: profile.endTime - profile.startTime,
          };
  ...
  \***************************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, "__esModule", { value: true });
        const vscode = __webpack_require__(/*! vscode */ "vscode");
        const node_fetch_1 = __webpack_require__(
          /*! node-fetch */ "../vscode-js-profile-core/node_modules/node-fetch/lib/index.mjs"
        );
        /**
        ...
        exports.addRelativeDiskPath = (rootPath, candidate) => {
          if (candidate.source.path && candidate.source.sourceReference === 0) {
            return Object.assign(Object.assign({}, candidate), {
              ...
              relativePath: path_1.properRelative(
                rootPath,
  ...
  \******************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        const download_file_provider_1 = __webpack_require__(
          /*! ./download-file-provider */ "../vscode-js-profile-core/out/download-file-provider.js"
        );
        /**
         * Gets the best location for display among the given set of candidates
         */
        exports.openLocation = ({
          rootPath,
          location,
          viewColumn,
          callFrame,
        ...
        const showPosition = (doc, lineNumber, columnNumber, viewColumn) =>
          __awaiter(void 0, void 0, void 0, function* () {
        ...
        const showPositionInFile = (rootPath, location, viewColumn) =>
          __awaiter(void 0, void 0, void 0, function* () {
            const diskPaths = exports.getCandidateDiskPaths(
              rootPath,
              location.source
            );
            ...
            const doc = yield vscode.workspace.openTextDocument(
              vscode.Uri.file(diskPaths[existingIndex])
            );
            yield showPosition(
              doc,
              location.lineNumber,
        ...
        const showPositionInUrl = (
          { url: rawUrl, lineNumber, columnNumber },
          viewColumn
        ) =>
          __awaiter(void 0, void 0, void 0, function* () {
            var _a, _b;
            ...
            const path = path_2.resolve(
              (_b =
                (_a = vscode.workspace.workspaceFolders) === null ||
                _a === void 0
                  ? void 0
                  : _a[0].uri.fsPath) !== null && _b !== void 0
                ? _b
                : os_1.tmpdir(),
            ...
            const document = yield vscode.workspace.openTextDocument(
              vscode.Uri.file(path).with({
                scheme: download_file_provider_1.DownloadFileProvider.scheme,
                query: rawUrl,
              })
            );
            yield showPosition(
        ...
        exports.getCandidateDiskPaths = (rootPath, source) => {
          ...
          for (const folder of (_a = vscode.workspace.workspaceFolders) !==
            null && _a !== void 0
            ? _a
            : []) {
            ...
            locations.push(
              path_2.resolve(
                folder.uri.fsPath,
                path_1.properRelative(rootPath, source.path)
              )
            );
          }
          return locations;
  ...
  \***********************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        const array_1 = __webpack_require__(
          /*! ./array */ "../vscode-js-profile-core/out/array.js"
        );
        const open_location_1 = __webpack_require__(
          /*! ./open-location */ "../vscode-js-profile-core/out/open-location.js"
        );
        ...
        const basenameRe = /[^/\\]+$/;
        const getBasename = (pathOrUrl) => {
          var _a, _b;
          return (_b =
            (_a = basenameRe.exec(pathOrUrl)) === null || _a === void 0
              ? void 0
              : _a[0]) !== null && _b !== void 0
            ? _b
            : pathOrUrl;
        ...
        class ProfileAnnotations {
          ...
          add(rootPath, location) {
            ...
            const expand = array_1.once(() => {
              ...
              for (const path of open_location_1.getCandidateDiskPaths(
                rootPath,
                src.source
              )) {
                this.set(
            ...
            if (
              (_a = location.src) === null || _a === void 0
                ? void 0
                : _a.source.path
            ) {
              this.addExpansionFn(
                getBasename(location.src.source.path),
                expand
              );
            }
          }
          ...
          set(file, position, data) {
            ...
            if (
              ((_a = list[index]) === null || _a === void 0
                ? void 0
                : _a.position.line) === position.line
            ) {
              const existing = list[index];
              if (position.character < existing.position.character) {
                existing.position = new vscode_1.Position(
                  position.line,
                  position.character
                );
              }
              ...
              list.splice(index, 0, {
                position: new vscode_1.Position(
                  position.line,
                  position.character
                ),
                data: {
          ...
          getLensesForFile(file) {
            ...
            return (_b =
              (_a = this.data.get(path_1.lowerCaseInsensitivePath(file))) ===
                null || _a === void 0
                ? void 0
                : _a
                    .map(({ position, data }) => {
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        class ProfileCodeLensProvider {
          ...
          provideCodeLenses(document) {
            var _a, _b;
            const byPath =
              (_a = this.lenses) === null || _a === void 0
                ? void 0
                : _a.getLensesForFile(
                    path_1.lowerCaseInsensitivePath(document.uri.fsPath)
                  );
            if (byPath) {
              return byPath;
            }
            const byUrl =
              document.uri.scheme ===
              download_file_provider_1.DownloadFileProvider.scheme
                ? (_b = this.lenses) === null || _b === void 0
                  ? void 0
                  : _b.getLensesForFile(document.uri.query)
                : undefined;
            if (byUrl) {
              return byUrl;
            }
  ...
  \*********************************************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        function reopenWithEditor(uri, viewType, requireExtension) {
          if (
            requireExtension &&
            !vscode.extensions.all.some((e) => e.id === requireExtension)
          ) {
  ...
  \**************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        Object.defineProperty(exports, "__esModule", { value: true });
        const vscode = __webpack_require__(/*! vscode */ "vscode");
        const editorProvider_1 = __webpack_require__(
          /*! vscode-js-profile-core/out/cpu/editorProvider */ "../vscode-js-profile-core/out/cpu/editorProvider.js"
        );
        const profileCodeLensProvider_1 = __webpack_require__(
          /*! vscode-js-profile-core/out/profileCodeLensProvider */ "../vscode-js-profile-core/out/profileCodeLensProvider.js"
        );
        const download_file_provider_1 = __webpack_require__(
          /*! vscode-js-profile-core/out/download-file-provider */ "../vscode-js-profile-core/out/download-file-provider.js"
        );
        const path_1 = __webpack_require__(/*! path */ "path");
        function activate(context) {
          const lenses =
            new profileCodeLensProvider_1.ProfileCodeLensProvider();
          context.subscriptions.push(
            vscode.window.registerCustomEditorProvider(
              "jsProfileVisualizer.cpuprofile.table",
              new editorProvider_1.CpuProfileEditorProvider(
                lenses,
                path_1.join(__dirname, "client.bundle.js")
              )
            ),
            vscode.workspace.registerTextDocumentContentProvider(
              "js-viz-download",
              new download_file_provider_1.DownloadFileProvider()
            ),
