...
class ExtensionHostDebugConfigurationProvider {
  resolveDebugConfiguration(folder, debugConfiguration) {
    ...
    const useV3 =
      (_b =
        (_a = getWithoutDefault("debug.extensionHost.useV3")) !== null &&
        _a !== void 0
          ? _a
          : getWithoutDefault("debug.javascript.usePreview")) !== null &&
      _b !== void 0
        ? _b
        : true;
    if (useV3) {
      folder =
        ...
        (vscode.workspace.workspaceFolders
          ...
          : undefined);
      debugConfiguration["__workspaceFolder"] =
        folder === null || folder === void 0 ? void 0 : folder.uri.fsPath;
...
function getWithoutDefault(setting) {
  ...
  return (_a =
    info === null || info === void 0 ? void 0 : info.workspaceValue) !== null &&
    _a !== void 0
    ? _a
