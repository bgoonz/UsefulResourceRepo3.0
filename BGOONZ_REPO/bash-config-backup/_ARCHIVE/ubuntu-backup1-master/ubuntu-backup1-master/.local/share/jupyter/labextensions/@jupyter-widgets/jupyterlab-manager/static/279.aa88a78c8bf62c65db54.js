(self.webpackChunk_jupyter_widgets_jupyterlab_manager =
  ...
  [279],
  {
    279: (e, r) => {
      ...
      E("NUMERICIDENTIFIER"),
        (o[s.NUMERICIDENTIFIER] = "0|[1-9]\\d*"),
        E("NUMERICIDENTIFIERLOOSE"),
        (o[s.NUMERICIDENTIFIERLOOSE] = "[0-9]+"),
        E("NONNUMERICIDENTIFIER"),
        (o[s.NONNUMERICIDENTIFIER] = "\\d*[a-zA-Z-][a-zA-Z0-9-]*"),
        E("MAINVERSION"),
        (o[s.MAINVERSION] =
          "(" +
        ...
        (o[s.PRERELEASEIDENTIFIER] =
          "(?:" +
          o[s.NUMERICIDENTIFIER] +
          "|" +
          o[s.NONNUMERICIDENTIFIER] +
          ")"),
        ...
        (o[s.LOOSEPLAIN] =
          ...
          "?"),
        E("LOOSE"),
        (o[s.LOOSE] = "^" + o[s.LOOSEPLAIN] + "$"),
        E("GTLT"),
        (o[s.GTLT] = "((?:<|>)?=?)"),
        E("XRANGEIDENTIFIERLOOSE"),
        (o[s.XRANGEIDENTIFIERLOOSE] = o[s.NUMERICIDENTIFIERLOOSE] + "|x|X|\\*"),
        E("XRANGEIDENTIFIER"),
        (o[s.XRANGEIDENTIFIER] = o[s.NUMERICIDENTIFIER] + "|x|X|\\*"),
        E("XRANGEPLAIN"),
        (o[s.XRANGEPLAIN] =
          "[v=\\s]*(" +
        ...
        (o[s.XRANGEPLAINLOOSE] =
          ...
          "?)?)?"),
        E("XRANGE"),
        (o[s.XRANGE] = "^" + o[s.GTLT] + "\\s*" + o[s.XRANGEPLAIN] + "$"),
        E("XRANGELOOSE"),
        (o[s.XRANGELOOSE] =
          "^" + o[s.GTLT] + "\\s*" + o[s.XRANGEPLAINLOOSE] + "$"),
        E("COERCE"),
        (o[s.COERCE] =
          "(^|[^\\d])(\\d{1,16})(?:\\.(\\d{1,16}))?(?:\\.(\\d{1,16}))?(?:$|[^\\d])"),
        E("COERCERTL"),
        (i[s.COERCERTL] = new RegExp(o[s.COERCE], "g")),
        E("LONETILDE"),
        (o[s.LONETILDE] = "(?:~>?)"),
        E("TILDETRIM"),
        (o[s.TILDETRIM] = "(\\s*)" + o[s.LONETILDE] + "\\s+"),
        (i[s.TILDETRIM] = new RegExp(o[s.TILDETRIM], "g")),
        E("TILDE"),
        (o[s.TILDE] = "^" + o[s.LONETILDE] + o[s.XRANGEPLAIN] + "$"),
        E("TILDELOOSE"),
        (o[s.TILDELOOSE] = "^" + o[s.LONETILDE] + o[s.XRANGEPLAINLOOSE] + "$"),
        E("LONECARET"),
        (o[s.LONECARET] = "(?:\\^)"),
        E("CARETTRIM"),
        (o[s.CARETTRIM] = "(\\s*)" + o[s.LONECARET] + "\\s+"),
        (i[s.CARETTRIM] = new RegExp(o[s.CARETTRIM], "g")),
        E("CARET"),
        (o[s.CARET] = "^" + o[s.LONECARET] + o[s.XRANGEPLAIN] + "$"),
        E("CARETLOOSE"),
        (o[s.CARETLOOSE] = "^" + o[s.LONECARET] + o[s.XRANGEPLAINLOOSE] + "$"),
        E("COMPARATORLOOSE"),
        (o[s.COMPARATORLOOSE] =
          "^" + o[s.GTLT] + "\\s*(" + o[s.LOOSEPLAIN] + ")$|^$"),
        E("COMPARATOR"),
        (o[s.COMPARATOR] =
          "^" + o[s.GTLT] + "\\s*(" + o[s.FULLPLAIN] + ")$|^$"),
        E("COMPARATORTRIM"),
        (o[s.COMPARATORTRIM] =
          "(\\s*)" +
          o[s.GTLT] +
          ...
          o[s.XRANGEPLAIN] +
          ")"),
        (i[s.COMPARATORTRIM] = new RegExp(o[s.COMPARATORTRIM], "g")),
        E("HYPHENRANGE"),
        (o[s.HYPHENRANGE] =
          "^\\s*(" +
          o[s.XRANGEPLAIN] +
        ...
        E("STAR"),
        (o[s.STAR] = "(<|>)?=?\\s*\\*");
      for (var u = 0; u < a; u++) t(u, o[u]), i[u] || (i[u] = new RegExp(o[u]));
      function p(e, r) {
        if (
          ((r && "object" == typeof r) ||
        ...
        if (!(r.loose ? i[s.LOOSE] : i[s.FULL]).test(e)) return null;
        try {
          return new c(e, r);
        } catch (e) {
          return null;
      ...
      function c(e, r) {
        ...
        var o = e.trim().match(r.loose ? i[s.LOOSE] : i[s.FULL]);
        ...
        (c.prototype.comparePre = function (e) {
          ...
          do {
            var n = this.prerelease[r],
              i = e.prerelease[r];
            if (
              (t("prerelease compare", r, n, i), void 0 === n && void 0 === i)
            )
              return 0;
      ...
      function w(e, r) {
        for (var t = !0, n = e.slice(), i = n.pop(); t && n.length; )
          (t = n.every(function (e) {
            return i.intersects(e, r);
          })),
            (i = n.pop());
        return t;
      }
      ...
      function C(e, r, t, n, i, o, s, a, E, u, p, c, l) {
        return (
          (r = g(t)
            ? ""
            : g(n)
      ...
      (T.prototype.parse = function (e) {
        var r = this.options.loose ? i[s.COMPARATORLOOSE] : i[s.COMPARATOR],
          t = e.match(r);
        if (!t) throw new TypeError("Invalid comparator: " + e);
        (this.operator = void 0 !== t[1] ? t[1] : ""),
          "=" === this.operator && (this.operator = ""),
          t[2]
            ? (this.semver = new c(t[2], this.options.loose))
            : (this.semver = A);
      }),
        ...
        (T.prototype.intersects = function (e, r) {
          ...
          if (
            ...
            return (
              "" === this.value ||
              ((t = new S(e.value, r)), d(this.value, t, r))
            );
          if ("" === e.operator)
            return (
              "" === e.value || ((t = new S(this.value, r)), d(e.semver, t, r))
            );
          var n = !(
              (">=" !== this.operator && ">" !== this.operator) ||
        ...
        (S.prototype.parseRange = function (e) {
          ...
          e = e.trim();
          var n = r ? i[s.HYPHENRANGELOOSE] : i[s.HYPHENRANGE];
          (e = e.replace(n, C)),
            t("hyphen replace", e),
            (e = e.replace(i[s.COMPARATORTRIM], "$1$2$3")),
            t("comparator trim", e, i[s.COMPARATORTRIM]),
            (e = (e = (e = e.replace(i[s.TILDETRIM], "$1~")).replace(
              i[s.CARETTRIM],
              "$1^"
            ))
              .split(/\s+/)
              .join(" "));
          var o = r ? i[s.COMPARATORLOOSE] : i[s.COMPARATOR],
            a = e
              .split(" ")
              .map(function (e) {
                return (function (e, r) {
                  return (
                    ...
                    (e = (function (e, r) {
                      return e
                        ...
                        .map(function (e) {
                          return (function (e, r) {
                            t("caret", e, r);
                            var n = r.loose ? i[s.CARETLOOSE] : i[s.CARET];
                            return e.replace(n, function (r, n, i, o, s) {
                              var a;
                              return (
                                t("caret", e, r, n, i, o, s),
                                g(n)
                    ...
                    (e = (function (e, r) {
                      return e
                        ...
                        .map(function (e) {
                          return (function (e, r) {
                            var n = r.loose ? i[s.TILDELOOSE] : i[s.TILDE];
                            return e.replace(n, function (r, n, i, o, s) {
                              var a;
                              return (
                                t("tilde", e, r, n, i, o, s),
                      ...
                      return (
                        ...
                        e
                          ...
                          .map(function (e) {
                            return (function (e, r) {
                              e = e.trim();
                              var n = r.loose ? i[s.XRANGELOOSE] : i[s.XRANGE];
                              return e.replace(n, function (n, i, o, s, a, E) {
                                t("xRange", e, n, i, o, s, a, E);
                                var u = g(o),
                                  p = u || g(s),
                                  c = p || g(a),
                                  l = c;
                    ...
                    (e = (function (e, r) {
                      return (
                        t("replaceStars", e, r), e.trim().replace(i[s.STAR], "")
                      );
                    })(e, r)),
                    t("stars", e),
                    e
        ...
        (S.prototype.test = function (e) {
          ...
          for (var r = 0; r < this.set.length; r++)
            if (P(this.set[r], e, this.options)) return !0;
          return !1;
        }),
        (r.satisfies = d),
