...
class CommManager(
    ...
    def new_comm(
        self, target_name, data=None, metadata=None, comm_id=None, buffers=None
    ):
        """
...
class Comm(MetaQObjectHasTraits("NewBase", (LoggingConfigurable, SuperQObject), {})):
    """
    Comm base class
    """
    ...
    def open(self, data=None, metadata=None, buffers=None):
        ...
        return self._send_msg(
            "comm_open", {"target_name": self.target_name}, data, metadata, buffers
        )
