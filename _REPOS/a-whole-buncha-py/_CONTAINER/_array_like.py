...
import sys
from typing import Any, overload, Sequence, TYPE_CHECKING, Union, TypeVar, Generic
...
ArrayLike = Union[
    _RecursiveSequence, _ArrayLike[dtype, Union[bool, int, float, complex, str, bytes]]
]
