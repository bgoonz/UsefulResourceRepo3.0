    ...
    tokens = {
        ...
        "base": [
            ...
            (
                ...
                bygroups(
                    Keyword.Namespace, Text, Name.Function, Text, Name.Function, Text
                ),
            ),
            # vocab.private
        ...
        "slots": [
            (r"\s+", Text),
            (r";\s", Keyword, "#pop"),
            (r"(\{\s+)(\S+)(\s[^}]+\s\}\s)", bygroups(Text, Name.Variable, Text)),
            (r"\S+", Name.Variable),
        ],
        "vocabs": [(r"\s+", Text), (r";\s", Keyword, "#pop"), (r"\S+", Name.Namespace)],
        "classes": [(r"\s+", Text), (r";\s", Keyword, "#pop"), (r"\S+", Name.Class)],
        "words": [(r"\s+", Text), (r";\s", Keyword, "#pop"), (r"\S+", Name.Function)],
    }
