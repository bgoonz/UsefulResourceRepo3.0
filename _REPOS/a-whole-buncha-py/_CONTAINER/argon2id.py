...
OPSLIMIT_INTERACTIVE = nacl.bindings.crypto_pwhash_argon2id_OPSLIMIT_INTERACTIVE
MEMLIMIT_INTERACTIVE = nacl.bindings.crypto_pwhash_argon2id_MEMLIMIT_INTERACTIVE
...
def kdf(
    ...
    return encoder.encode(
        nacl.bindings.crypto_pwhash_alg(size, password, salt, opslimit, memlimit, ALG)
    )


def str(password, opslimit=OPSLIMIT_INTERACTIVE, memlimit=MEMLIMIT_INTERACTIVE):
    """
    ...
    .. versionadded:: 1.2
    """
    return nacl.bindings.crypto_pwhash_str_alg(password, opslimit, memlimit, ALG)
