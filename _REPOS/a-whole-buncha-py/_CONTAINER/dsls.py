...
class ProtoBufLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"(message|extend)(\s+)", bygroups(Keyword.Declaration, Text), "message"),
            (r"(enum|group|service)(\s+)", bygroups(Keyword.Declaration, Text), "type"),
            (r"\".*?\"", String),
            (r"\'.*?\'", String),
            ...
            (r"[+-=]", Operator),
            (r"([a-zA-Z_][\w.]*)([ \t]*)(=)", bygroups(Name.Attribute, Text, Operator)),
            (r"[a-zA-Z_][\w.]*", Name),
        ],
    ...
    tokens = {
        ...
        "attrs": [
            ...
            (
                _var + r"(\s*)(=)(\s*)" + _var,
                bygroups(
                    Name.Attribute, Text.Whitespace, Operator, Text.Whitespace, String
                ),
            ),
            (r",", Punctuation),
            include("comments"),
...
class SnowballLexer(ExtendedRegexLexer):
    ...
    def _stringescapes(lexer, match, ctx):
        ...
        return bygroups(Keyword.Reserved, Text, String.Escape, Text, String.Escape)(
            lexer, match, ctx
        )
