...
from googlecloudsdk.third_party.apis.recommender.v1alpha2 import (
    recommender_v1alpha2_messages as messages,
)
...
class RecommenderV1alpha2(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.billingAccounts_locations_insightTypes_insights = self.BillingAccountsLocationsInsightTypesInsightsService(
            self
        )
        self.billingAccounts_locations_insightTypes = self.BillingAccountsLocationsInsightTypesService(
            self
        )
        self.billingAccounts_locations_recommenders_recommendations = self.BillingAccountsLocationsRecommendersRecommendationsService(
            self
        )
        self.billingAccounts_locations_recommenders = self.BillingAccountsLocationsRecommendersService(
            self
        )
        ...
        self.folders_locations_insightTypes_insights = self.FoldersLocationsInsightTypesInsightsService(
            self
        )
        self.folders_locations_insightTypes = self.FoldersLocationsInsightTypesService(
            self
        )
        self.folders_locations_recommenders_recommendations = self.FoldersLocationsRecommendersRecommendationsService(
            self
        )
        self.folders_locations_recommenders = self.FoldersLocationsRecommendersService(
            self
        )
        self.folders_locations = self.FoldersLocationsService(self)
        self.folders = self.FoldersService(self)
        self.organizations_locations_insightTypes_insights = self.OrganizationsLocationsInsightTypesInsightsService(
            self
        )
        self.organizations_locations_insightTypes = self.OrganizationsLocationsInsightTypesService(
            self
        )
        self.organizations_locations_recommenders_recommendations = self.OrganizationsLocationsRecommendersRecommendationsService(
            self
        )
        self.organizations_locations_recommenders = self.OrganizationsLocationsRecommendersService(
            self
        )
        self.organizations_locations = self.OrganizationsLocationsService(self)
        self.organizations = self.OrganizationsService(self)
        self.projects_locations_insightTypes_insights = self.ProjectsLocationsInsightTypesInsightsService(
            self
        )
        self.projects_locations_insightTypes = self.ProjectsLocationsInsightTypesService(
            self
        )
        self.projects_locations_recommenders_config = self.ProjectsLocationsRecommendersConfigService(
            self
        )
        self.projects_locations_recommenders_recommendations = self.ProjectsLocationsRecommendersRecommendationsService(
            self
        )
        self.projects_locations_recommenders = self.ProjectsLocationsRecommendersService(
            self
        )
    ...
    class BillingAccountsLocationsInsightTypesInsightsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                RecommenderV1alpha2.BillingAccountsLocationsInsightTypesInsightsService,
                self,
            ).__init__(client)
    ...
    class BillingAccountsLocationsInsightTypesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                RecommenderV1alpha2.BillingAccountsLocationsInsightTypesService, self
            ).__init__(client)
            self._upload_configs = {}

    class BillingAccountsLocationsRecommendersRecommendationsService(
        ...
        def __init__(self, client):
            super(
                RecommenderV1alpha2.BillingAccountsLocationsRecommendersRecommendationsService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class BillingAccountsLocationsRecommendersService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                RecommenderV1alpha2.BillingAccountsLocationsRecommendersService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class BillingAccountsLocationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(RecommenderV1alpha2.BillingAccountsLocationsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class FoldersLocationsInsightTypesInsightsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                RecommenderV1alpha2.FoldersLocationsInsightTypesInsightsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class FoldersLocationsInsightTypesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                RecommenderV1alpha2.FoldersLocationsInsightTypesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class FoldersLocationsRecommendersRecommendationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                RecommenderV1alpha2.FoldersLocationsRecommendersRecommendationsService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class FoldersLocationsRecommendersService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                RecommenderV1alpha2.FoldersLocationsRecommendersService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class OrganizationsLocationsInsightTypesInsightsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                RecommenderV1alpha2.OrganizationsLocationsInsightTypesInsightsService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class OrganizationsLocationsInsightTypesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                RecommenderV1alpha2.OrganizationsLocationsInsightTypesService, self
            ).__init__(client)
            self._upload_configs = {}

    class OrganizationsLocationsRecommendersRecommendationsService(
        base_api.BaseApiService
    ):
        ...
        def __init__(self, client):
            super(
                RecommenderV1alpha2.OrganizationsLocationsRecommendersRecommendationsService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class OrganizationsLocationsRecommendersService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                RecommenderV1alpha2.OrganizationsLocationsRecommendersService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class OrganizationsLocationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(RecommenderV1alpha2.OrganizationsLocationsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsInsightTypesInsightsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                RecommenderV1alpha2.ProjectsLocationsInsightTypesInsightsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsInsightTypesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                RecommenderV1alpha2.ProjectsLocationsInsightTypesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsRecommendersConfigService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                RecommenderV1alpha2.ProjectsLocationsRecommendersConfigService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsRecommendersRecommendationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                RecommenderV1alpha2.ProjectsLocationsRecommendersRecommendationsService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsRecommendersService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                RecommenderV1alpha2.ProjectsLocationsRecommendersService, self
            ).__init__(client)
            self._upload_configs = {}
