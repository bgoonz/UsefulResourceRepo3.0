...
from googlecloudsdk.third_party.apis.kubernetesedge.v1alpha1 import (
    kubernetesedge_v1alpha1_messages as messages,
)
...
class KubernetesedgeV1alpha1(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_locations_clusters_nodePools = self.ProjectsLocationsClustersNodePoolsService(
            self
        )
        ...
        self.projects_locations_sites_machines = self.ProjectsLocationsSitesMachinesService(
            self
        )
        self.projects_locations_sites = self.ProjectsLocationsSitesService(self)
        self.projects_locations_vpnConnections = self.ProjectsLocationsVpnConnectionsService(
            self
        )
    ...
    class ProjectsLocationsClustersNodePoolsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                KubernetesedgeV1alpha1.ProjectsLocationsClustersNodePoolsService, self
            ).__init__(client)
    ...
    class ProjectsLocationsClustersService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                KubernetesedgeV1alpha1.ProjectsLocationsClustersService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsMachinesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                KubernetesedgeV1alpha1.ProjectsLocationsMachinesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsNodePoolsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                KubernetesedgeV1alpha1.ProjectsLocationsNodePoolsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                KubernetesedgeV1alpha1.ProjectsLocationsOperationsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsSitesMachinesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                KubernetesedgeV1alpha1.ProjectsLocationsSitesMachinesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsSitesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(KubernetesedgeV1alpha1.ProjectsLocationsSitesService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsVpnConnectionsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                KubernetesedgeV1alpha1.ProjectsLocationsVpnConnectionsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(KubernetesedgeV1alpha1.ProjectsLocationsService, self).__init__(
                client
            )
            self._upload_configs = {}
