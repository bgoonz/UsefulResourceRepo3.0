...
from googlecloudsdk.third_party.apis.metastore.v1beta import (
    metastore_v1beta_messages as messages,
)
...
class MetastoreV1beta(base_api.BaseApiClient):
    ...
    class ProjectsLocationsOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(MetastoreV1beta.ProjectsLocationsOperationsService, self).__init__(
                client
            )
    ...
    class ProjectsLocationsServicesBackupsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                MetastoreV1beta.ProjectsLocationsServicesBackupsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsServicesMetadataImportsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                MetastoreV1beta.ProjectsLocationsServicesMetadataImportsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsServicesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(MetastoreV1beta.ProjectsLocationsServicesService, self).__init__(
                client
            )
            self._upload_configs = {}
