...
from googlecloudsdk.third_party.apis.dataflow.v1b3 import (
...
class DataflowV1b3(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_catalogTemplates_templateVersions = self.ProjectsCatalogTemplatesTemplateVersionsService(
            self
        )
        ...
        self.projects_locations_flexTemplates = self.ProjectsLocationsFlexTemplatesService(
            self
        )
        ...
        self.projects_locations_jobs_snapshots = self.ProjectsLocationsJobsSnapshotsService(
            self
        )
        self.projects_locations_jobs_stages = self.ProjectsLocationsJobsStagesService(
            self
        )
    ...
    class ProjectsCatalogTemplatesTemplateVersionsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                DataflowV1b3.ProjectsCatalogTemplatesTemplateVersionsService, self
            ).__init__(client)
    ...
    class ProjectsLocationsFlexTemplatesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(DataflowV1b3.ProjectsLocationsFlexTemplatesService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsJobsSnapshotsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(DataflowV1b3.ProjectsLocationsJobsSnapshotsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsJobsStagesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(DataflowV1b3.ProjectsLocationsJobsStagesService, self).__init__(
                client
            )
            self._upload_configs = {}
