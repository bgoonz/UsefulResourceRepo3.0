...
class ServicedirectoryProjectsLocationsNamespacesServicesDeleteRequest(
    _messages.Message
):
...
class ServicedirectoryProjectsLocationsNamespacesServicesPatchRequest(
    _messages.Message
):
...
class ServicedirectoryProjectsLocationsNamespacesTestIamPermissionsRequest(
    _messages.Message
):
