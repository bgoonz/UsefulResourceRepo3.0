...
from googlecloudsdk.third_party.apis.anthosevents.v1beta1 import (
    anthosevents_v1beta1_messages as messages,
)
...
class AnthoseventsV1beta1(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.namespaces_customresourcedefinitions = self.NamespacesCustomresourcedefinitionsService(
            self
        )
    ...
    class CustomresourcedefinitionsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(AnthoseventsV1beta1.CustomresourcedefinitionsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class NamespacesApiserversourcesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(AnthoseventsV1beta1.NamespacesApiserversourcesService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class NamespacesCloudauditlogssourcesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                AnthoseventsV1beta1.NamespacesCloudauditlogssourcesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class NamespacesCloudpubsubsourcesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                AnthoseventsV1beta1.NamespacesCloudpubsubsourcesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class NamespacesCloudschedulersourcesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                AnthoseventsV1beta1.NamespacesCloudschedulersourcesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class NamespacesCloudstoragesourcesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                AnthoseventsV1beta1.NamespacesCloudstoragesourcesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class NamespacesCustomresourcedefinitionsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                AnthoseventsV1beta1.NamespacesCustomresourcedefinitionsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class NamespacesPingsourcesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(AnthoseventsV1beta1.NamespacesPingsourcesService, self).__init__(
                client
            )
            self._upload_configs = {}
