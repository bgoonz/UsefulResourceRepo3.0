...
class NotificationConfig(_messages.Message):
  ...
  """
    ...
    eventTypes = _messages.EnumField(
        "EventTypesValueListEntryValuesEnum", 1, repeated=True
    )
...
class StoragetransferTransferOperationsPauseRequest(_messages.Message):
  ...
  """
    ...
    name = _messages.StringField(1, required=True)
    pauseTransferOperationRequest = _messages.MessageField(
        "PauseTransferOperationRequest", 2
    )
...
class StoragetransferTransferOperationsResumeRequest(_messages.Message):
  ...
  """
    ...
    name = _messages.StringField(1, required=True)
    resumeTransferOperationRequest = _messages.MessageField(
        "ResumeTransferOperationRequest", 2
    )
