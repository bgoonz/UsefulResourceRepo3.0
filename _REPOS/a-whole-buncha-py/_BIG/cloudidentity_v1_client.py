...
from googlecloudsdk.third_party.apis.cloudidentity.v1 import (
    cloudidentity_v1_messages as messages,
)
...
class CloudidentityV1(base_api.BaseApiClient):
    ...
    class DevicesDeviceUsersClientStatesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(CloudidentityV1.DevicesDeviceUsersClientStatesService, self).__init__(
                client
            )
