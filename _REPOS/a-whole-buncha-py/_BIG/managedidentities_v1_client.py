...
from googlecloudsdk.third_party.apis.managedidentities.v1 import (
    managedidentities_v1_messages as messages,
)
...
class ManagedidentitiesV1(base_api.BaseApiClient):
    ...
    class ProjectsLocationsGlobalDomainsSqlIntegrationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ManagedidentitiesV1.ProjectsLocationsGlobalDomainsSqlIntegrationsService,
                self,
            ).__init__(client)
    ...
    class ProjectsLocationsGlobalDomainsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ManagedidentitiesV1.ProjectsLocationsGlobalDomainsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsGlobalOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ManagedidentitiesV1.ProjectsLocationsGlobalOperationsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsGlobalPeeringsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ManagedidentitiesV1.ProjectsLocationsGlobalPeeringsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsGlobalService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(ManagedidentitiesV1.ProjectsLocationsGlobalService, self).__init__(
                client
            )
            self._upload_configs = {}
