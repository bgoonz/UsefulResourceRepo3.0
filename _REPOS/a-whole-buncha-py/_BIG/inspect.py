...
def isgeneratorfunction(object):
    ...
    return bool(
        ...
        and object.func_code.co_flags & CO_GENERATOR
    )
...
def getmoduleinfo(path):
    ...
    suffixes = map(
        lambda info: (-len(info[0]), info[0], info[1], info[2]), imp.get_suffixes()
    )
