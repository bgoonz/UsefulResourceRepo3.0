...
from googlecloudsdk.third_party.apis.networkconnectivity.v1alpha1 import (
    networkconnectivity_v1alpha1_messages as messages,
)
...
class NetworkconnectivityV1alpha1(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_locations_global_hubs = self.ProjectsLocationsGlobalHubsService(
            self
        )
        self.projects_locations_global = self.ProjectsLocationsGlobalService(self)
        self.projects_locations_internalRanges = self.ProjectsLocationsInternalRangesService(
            self
        )
    ...
    class ProjectsLocationsGlobalHubsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                NetworkconnectivityV1alpha1.ProjectsLocationsGlobalHubsService, self
            ).__init__(client)
    ...
    class ProjectsLocationsGlobalService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                NetworkconnectivityV1alpha1.ProjectsLocationsGlobalService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsInternalRangesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                NetworkconnectivityV1alpha1.ProjectsLocationsInternalRangesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                NetworkconnectivityV1alpha1.ProjectsLocationsOperationsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsSpokesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                NetworkconnectivityV1alpha1.ProjectsLocationsSpokesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(NetworkconnectivityV1alpha1.ProjectsLocationsService, self).__init__(
                client
            )
            self._upload_configs = {}
