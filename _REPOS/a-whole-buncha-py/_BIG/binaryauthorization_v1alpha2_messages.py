...
class BinaryauthorizationProjectsAttestorsAttestationsGetIamPolicyRequest(
    _messages.Message
):
...
class BinaryauthorizationProjectsAttestorsAttestationsSetIamPolicyRequest(
    _messages.Message
):
...
class BinaryauthorizationProjectsAttestorsAttestationsTestIamPermissionsRequest(
    _messages.Message
):
    r"""A
...
class BinaryauthorizationProjectsAttestorsValidateAttestationOccurrenceRequest(
  ...
  """
    ...
    validateAttestationOccurrenceRequest = _messages.MessageField(
        "ValidateAttestationOccurrenceRequest", 2
    )


class BinaryauthorizationProjectsContinuousValidationConfigGetIamPolicyRequest(
    _messages.Message
):
    r"""A
...
class BinaryauthorizationProjectsContinuousValidationConfigSetIamPolicyRequest(
    _messages.Message
):
    r"""A
...
class BinaryauthorizationProjectsContinuousValidationConfigTestIamPermissionsRequest(
    _messages.Message
):
...
class BinaryauthorizationProjectsGetContinuousValidationConfigRequest(
    _messages.Message
):
...
class Policy(_messages.Message):
  ...
  """
    ...
    istioServiceIdentityAdmissionRules = _messages.MessageField(
        "IstioServiceIdentityAdmissionRulesValue", 6
    )
    kubernetesNamespaceAdmissionRules = _messages.MessageField(
        "KubernetesNamespaceAdmissionRulesValue", 7
    )
    kubernetesServiceAccountAdmissionRules = _messages.MessageField(
        "KubernetesServiceAccountAdmissionRulesValue", 8
    )
