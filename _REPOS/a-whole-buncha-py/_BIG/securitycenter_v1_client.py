...
from googlecloudsdk.third_party.apis.securitycenter.v1 import (
    securitycenter_v1_messages as messages,
)
...
class SecuritycenterV1(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.organizations_notificationConfigs = self.OrganizationsNotificationConfigsService(
            self
        )
        self.organizations_operations = self.OrganizationsOperationsService(self)
        self.organizations_sources_findings = self.OrganizationsSourcesFindingsService(
            self
        )
    ...
    class OrganizationsMuteConfigsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(SecuritycenterV1.OrganizationsMuteConfigsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class OrganizationsNotificationConfigsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                SecuritycenterV1.OrganizationsNotificationConfigsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class OrganizationsOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(SecuritycenterV1.OrganizationsOperationsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class OrganizationsSourcesFindingsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(SecuritycenterV1.OrganizationsSourcesFindingsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsSourcesFindingsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(SecuritycenterV1.ProjectsSourcesFindingsService, self).__init__(
                client
            )
            self._upload_configs = {}
