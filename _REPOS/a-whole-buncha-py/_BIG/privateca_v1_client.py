...
from googlecloudsdk.third_party.apis.privateca.v1 import (
    privateca_v1_messages as messages,
)
...
class PrivatecaV1(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_locations_caPools_certificateAuthorities_certificateRevocationLists = self.ProjectsLocationsCaPoolsCertificateAuthoritiesCertificateRevocationListsService(
            self
        )
        self.projects_locations_caPools_certificateAuthorities = self.ProjectsLocationsCaPoolsCertificateAuthoritiesService(
            self
        )
        self.projects_locations_caPools_certificates = self.ProjectsLocationsCaPoolsCertificatesService(
            self
        )
        self.projects_locations_caPools = self.ProjectsLocationsCaPoolsService(self)
        self.projects_locations_certificateTemplates = self.ProjectsLocationsCertificateTemplatesService(
            self
        )
    ...
    class ProjectsLocationsCaPoolsCertificateAuthoritiesCertificateRevocationListsService(
        ...
        def __init__(self, client):
            super(
                PrivatecaV1.ProjectsLocationsCaPoolsCertificateAuthoritiesCertificateRevocationListsService,
                self,
            ).__init__(client)
    ...
    class ProjectsLocationsCaPoolsCertificateAuthoritiesService(
        base_api.BaseApiService
    ):
        ...
        def __init__(self, client):
            super(
                PrivatecaV1.ProjectsLocationsCaPoolsCertificateAuthoritiesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsCaPoolsCertificatesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                PrivatecaV1.ProjectsLocationsCaPoolsCertificatesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsCertificateTemplatesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                PrivatecaV1.ProjectsLocationsCertificateTemplatesService, self
            ).__init__(client)
            self._upload_configs = {}
