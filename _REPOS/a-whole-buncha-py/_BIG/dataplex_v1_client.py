...
class DataplexV1(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_locations_lakes_actions = self.ProjectsLocationsLakesActionsService(
            self
        )
        self.projects_locations_lakes_content = self.ProjectsLocationsLakesContentService(
            self
        )
        self.projects_locations_lakes_environments = self.ProjectsLocationsLakesEnvironmentsService(
            self
        )
        self.projects_locations_lakes_tasks = self.ProjectsLocationsLakesTasksService(
            self
        )
        self.projects_locations_lakes_zones_actions = self.ProjectsLocationsLakesZonesActionsService(
            self
        )
        self.projects_locations_lakes_zones_assets_actions = self.ProjectsLocationsLakesZonesAssetsActionsService(
            self
        )
        self.projects_locations_lakes_zones_assets = self.ProjectsLocationsLakesZonesAssetsService(
            self
        )
        self.projects_locations_lakes_zones = self.ProjectsLocationsLakesZonesService(
            self
        )
    ...
    class ProjectsLocationsLakesActionsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(DataplexV1.ProjectsLocationsLakesActionsService, self).__init__(
                client
            )
    ...
    class ProjectsLocationsLakesContentService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(DataplexV1.ProjectsLocationsLakesContentService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsLakesEnvironmentsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(DataplexV1.ProjectsLocationsLakesEnvironmentsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsLakesZonesActionsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(DataplexV1.ProjectsLocationsLakesZonesActionsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsLakesZonesAssetsActionsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                DataplexV1.ProjectsLocationsLakesZonesAssetsActionsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsLakesZonesAssetsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(DataplexV1.ProjectsLocationsLakesZonesAssetsService, self).__init__(
                client
            )
            self._upload_configs = {}
