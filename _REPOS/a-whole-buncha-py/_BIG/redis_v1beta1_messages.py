...
class Instance(_messages.Message):
  ...
  """
    ...
    transitEncryptionMode = _messages.EnumField(
        "TransitEncryptionModeValueValuesEnum", 24
    )
...
class MaintenancePolicy(_messages.Message):
  ...
  """
    ...
    weeklyMaintenanceWindow = _messages.MessageField(
        "WeeklyMaintenanceWindow", 4, repeated=True
    )
...
class RedisProjectsLocationsInstancesRescheduleMaintenanceRequest(_messages.Message):
  ...
  """
    ...
    name = _messages.StringField(1, required=True)
    rescheduleMaintenanceRequest = _messages.MessageField(
        "RescheduleMaintenanceRequest", 2
    )
