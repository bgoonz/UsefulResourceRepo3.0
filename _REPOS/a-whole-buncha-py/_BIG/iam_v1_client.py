...
class IamV1(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.locations_workforcePools_providers = self.LocationsWorkforcePoolsProvidersService(
            self
        )
        self.locations_workforcePools_subject = self.LocationsWorkforcePoolsSubjectService(
            self
        )
        ...
        self.projects_locations_workloadIdentityPools_operations = self.ProjectsLocationsWorkloadIdentityPoolsOperationsService(
            self
        )
        self.projects_locations_workloadIdentityPools_providers_operations = self.ProjectsLocationsWorkloadIdentityPoolsProvidersOperationsService(
            self
        )
        self.projects_locations_workloadIdentityPools_providers = self.ProjectsLocationsWorkloadIdentityPoolsProvidersService(
            self
        )
        self.projects_locations_workloadIdentityPools = self.ProjectsLocationsWorkloadIdentityPoolsService(
            self
        )
        self.projects_locations = self.ProjectsLocationsService(self)
        self.projects_roles = self.ProjectsRolesService(self)
        self.projects_serviceAccounts_identityBindings = self.ProjectsServiceAccountsIdentityBindingsService(
            self
        )
        self.projects_serviceAccounts_keys = self.ProjectsServiceAccountsKeysService(
            self
        )
    ...
    class ProjectsLocationsWorkloadIdentityPoolsOperationsService(
        ...
        def __init__(self, client):
            super(
                IamV1.ProjectsLocationsWorkloadIdentityPoolsOperationsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsWorkloadIdentityPoolsProvidersOperationsService(
        base_api.BaseApiService
    ):
        ...
        def __init__(self, client):
            super(
                IamV1.ProjectsLocationsWorkloadIdentityPoolsProvidersOperationsService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsWorkloadIdentityPoolsProvidersService(
        base_api.BaseApiService
    ):
        ...
        def __init__(self, client):
            super(
                IamV1.ProjectsLocationsWorkloadIdentityPoolsProvidersService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsWorkloadIdentityPoolsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(IamV1.ProjectsLocationsWorkloadIdentityPoolsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsServiceAccountsIdentityBindingsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(IamV1.ProjectsServiceAccountsIdentityBindingsService, self).__init__(
                client
            )
            self._upload_configs = {}
