...
def is_in_rfc_3339_bounds(microseconds):
    return (
        RFC_3339_MIN_MICROSECONDS_INCLUSIVE
        <= microseconds
...
class IdResolver(object):
    ...
    """
        check_conversion(
            project_id in self._resolver_map,
...
class _EntityConverter(object):
    ...
    """
        ...
        for v3_property in v3_entity.property_list():
            self.__add_v4_property_to_entity(
                v4_entity, v4_properties, v3_property, True
            )
        for v3_property in v3_entity.raw_property_list():
            self.__add_v4_property_to_entity(
                v4_entity, v4_properties, v3_property, False
            )
    ...
    """
        ...
        if v4_value.has_boolean_value():
            ...
            if (
                v4_meaning == MEANING_GEORSS_POINT
                or v4_meaning == MEANING_PREDEFINED_ENTITY_POINT
            ):
                self.__v4_to_v3_point_value(
                    v4_entity_value, v3_value.mutable_pointvalue()
                )
            elif v4_meaning == MEANING_PREDEFINED_ENTITY_USER:
                self.v4_entity_to_v3_user_value(
                    v4_entity_value, v3_value.mutable_uservalue()
                )
            else:
    ...
    """
        ...
        if v3_property_value.has_booleanvalue():
            ...
            if v3_meaning == MEANING_GEORSS_POINT:
                ...
                self.__v3_to_v4_point_entity(
                    v3_property_value.pointvalue(), v4_value.mutable_entity_value()
                )
                v4_value.set_meaning(MEANING_PREDEFINED_ENTITY_POINT)

            v3_meaning = None
        elif v3_property_value.has_uservalue():
            self.v3_user_value_to_v4_entity(
                v3_property_value.uservalue(), v4_value.mutable_entity_value()
            )
    ...
    def v4_to_v3_property(
        self, property_name, is_multi, is_projection, v4_value, v3_property
    ):
    ...
    """
        ...
        if v4_value.has_timestamp_microseconds_value():
            ...
            if v4_meaning != MEANING_GEORSS_POINT:
                if (
                    v4_meaning != MEANING_PREDEFINED_ENTITY_POINT
    ...
    def __add_v3_property_from_v4(
        self, property_name, is_multi, is_projection, v4_value, v3_entity
    ):
    ...
    def __add_v4_property_to_entity(
        self, v4_entity, property_map, v3_property, indexed
    ):
    ...
    """
        ...
        if v3_property.multiple():
            self.v3_property_to_v4_value(
                v3_property, indexed, v4_property.mutable_value().add_list_value()
            )
        else:
            self.v3_property_to_v4_value(
                v3_property, indexed, v4_property.mutable_value()
            )
    ...
    """
        check_conversion(
            v4_property.value().has_integer_value(),
    ...
    """
        check_conversion(
            v4_property.value().has_double_value(),
    ...
    """
        check_conversion(
            v4_property.value().has_string_value(),
    ...
    """
        ...
        v3_user_value.set_email(
            self.__get_v4_string_value(name_to_v4_property[PROPERTY_NAME_EMAIL])
        )
        v3_user_value.set_auth_domain(
            self.__get_v4_string_value(name_to_v4_property[PROPERTY_NAME_AUTH_DOMAIN])
        )
        if PROPERTY_NAME_USER_ID in name_to_v4_property:
            v3_user_value.set_obfuscated_gaiaid(
                self.__get_v4_string_value(name_to_v4_property[PROPERTY_NAME_USER_ID])
            )
        if PROPERTY_NAME_INTERNAL_ID in name_to_v4_property:
            v3_user_value.set_gaiaid(
                self.__get_v4_integer_value(
    ...
    """
        v4_entity.Clear()
        v4_entity.property_list().append(
            self.__v4_string_property(PROPERTY_NAME_EMAIL, v3_user_value.email(), False)
        )
        v4_entity.property_list().append(
            self.__v4_string_property(
                PROPERTY_NAME_AUTH_DOMAIN, v3_user_value.auth_domain(), False
            )
        )
        # Ignore nickname.
        if v3_user_value.gaiaid() != 0:
            v4_entity.property_list().append(
                self.__v4_integer_property(
                    PROPERTY_NAME_INTERNAL_ID, v3_user_value.gaiaid(), False
                )
            )
        if v3_user_value.has_obfuscated_gaiaid():
            v4_entity.property_list().append(
                self.__v4_string_property(
                    PROPERTY_NAME_USER_ID, v3_user_value.obfuscated_gaiaid(), False
                )
            )
        ...
        for property_name, v1_value in six.iteritems(v1_entity.properties):
            ...
            if v1_value.HasField("array_value"):
                if len(v1_value.array_value.values) == 0:
                    empty_list = self.__new_v3_property(
    ...
    """
        ...
        if field == "boolean_value":
            ...
            v3_value.set_int64value(
                googledatastore.helper.micros_from_timestamp(v1_value.timestamp_value)
            )
            ...
            if v1_meaning == MEANING_PREDEFINED_ENTITY_USER:
                self.v1_entity_to_v3_user_value(
                    v1_entity_value, v3_value.mutable_uservalue()
                )
            else:
                v3_entity_value = entity_pb.EntityProto()
    ...
    """
        ...
        if v3_property.meaning() == entity_pb.Property.EMPTY_LIST:
            ...
            if v3_meaning == entity_pb.Property.GD_WHEN and is_in_rfc_3339_bounds(
                v3_property_value.int64value()
            ):
            ...
            self.v3_user_value_to_v1_entity(
                v3_property_value.uservalue(), v1_value.entity_value
            )
    ...
    def v1_to_v3_property(
        self, property_name, is_multi, is_projection, v1_value, v3_property
    ):
    ...
    """
        ...
        if v3_property.multiple():
            self.v3_property_to_v1_value(
                v3_property, indexed, v1_value.array_value.values.add()
            )
        else:
    ...
    """
        check_conversion(
            v1_value.HasField("integer_value"),
    ...
    """
        check_conversion(
            v1_value.HasField("double_value"), "Value does not contain a double value."
        )
    ...
    """
        check_conversion(
            v1_value.HasField("string_value"), "Value does not contain a string value."
        )
    ...
    """
        ...
        v3_user_value.set_email(
            self.__get_v1_string_value(properties[PROPERTY_NAME_EMAIL])
        )
        v3_user_value.set_auth_domain(
            self.__get_v1_string_value(properties[PROPERTY_NAME_AUTH_DOMAIN])
        )
        ...
        if PROPERTY_NAME_INTERNAL_ID in properties:
            v3_user_value.set_gaiaid(
                self.__get_v1_integer_value(properties[PROPERTY_NAME_INTERNAL_ID])
            )
        else:
            # Field gaiaid is required. Set it to a default value.
            v3_user_value.set_gaiaid(0)
        if PROPERTY_NAME_FEDERATED_IDENTITY in properties:
            v3_user_value.set_federated_identity(
                self.__get_v1_string_value(properties[PROPERTY_NAME_FEDERATED_IDENTITY])
            )
    ...
    """
        ...
        self.__v1_string_property(
            v1_entity, PROPERTY_NAME_EMAIL, v3_user_value.email(), False
        )
        self.__v1_string_property(
            v1_entity, PROPERTY_NAME_AUTH_DOMAIN, v3_user_value.auth_domain(), False
        )
        # Ignore nickname.
        if v3_user_value.gaiaid() != 0:
            self.__v1_integer_property(
                v1_entity, PROPERTY_NAME_INTERNAL_ID, v3_user_value.gaiaid(), False
            )
        if v3_user_value.has_obfuscated_gaiaid():
            self.__v1_string_property(
                v1_entity,
    ...
    def __is_v3_property_value_union_valid(self, v3_property_value):
        ...
        num_sub_values = (
            v3_property_value.has_booleanvalue()
...
class _QueryConverter(object):
    ...
    """
        ...
        check_conversion(
            v3_filter.op() <= 5, "unsupported filter op: %d" % v3_filter.op()
        )
    ...
    """
        ...
        v1_property_filter.set_operator(
            v3_query.shallow()
            and googledatastore.PropertyFilter.HAS_PARENT
            or googledatastore.PropertyFilter.HAS_ANCESTOR
        )
        ...
        if v3_query.has_ancestor():
            self._entity_converter.v3_to_v1_key(
                v3_query.ancestor(), v1_property_filter.value.mutable_key_value
            )
        else:
    ...
    """
        ...
        self._entity_converter.v3_to_v4_key(
            v3_query.ancestor(), v4_property_filter.mutable_value().mutable_key_value()
        )
