...
class ApigatewayApiConfig(_messages.Message):
  ...
  """
    ...
    grpcServices = _messages.MessageField(
        "ApigatewayApiConfigGrpcServiceDefinition", 5, repeated=True
    )
    labels = _messages.MessageField("LabelsValue", 6)
    managedServiceConfigs = _messages.MessageField(
        "ApigatewayApiConfigFile", 7, repeated=True
    )
    name = _messages.StringField(8)
    openapiDocuments = _messages.MessageField(
        "ApigatewayApiConfigOpenApiDocument", 9, repeated=True
    )
    serviceConfigId = _messages.StringField(10)
    serviceRollout = _messages.MessageField(
        "ApigatewayApiConfigManagedServiceRollout", 11
    )
...
class ApigatewayAuditConfig(_messages.Message):
  ...
  """
    ...
    auditLogConfigs = _messages.MessageField(
        "ApigatewayAuditLogConfig", 1, repeated=True
    )
...
class ApigatewayOperationMetadata(_messages.Message):
  ...
  """
    ...
    createTime = _messages.StringField(2)
    diagnostics = _messages.MessageField(
        "ApigatewayOperationMetadataDiagnostic", 3, repeated=True
    )
...
class ApigatewayProjectsLocationsApisConfigsSetIamPolicyRequest(_messages.Message):
  ...
  """
    ...
    apigatewaySetIamPolicyRequest = _messages.MessageField(
        "ApigatewaySetIamPolicyRequest", 1
    )
    resource = _messages.StringField(2, required=True)


class ApigatewayProjectsLocationsApisConfigsTestIamPermissionsRequest(
    _messages.Message
):
  ...
  """
    ...
    apigatewayTestIamPermissionsRequest = _messages.MessageField(
        "ApigatewayTestIamPermissionsRequest", 1
    )
    resource = _messages.StringField(2, required=True)
...
class ApigatewayProjectsLocationsOperationsCancelRequest(_messages.Message):
  ...
  """
    ...
    apigatewayCancelOperationRequest = _messages.MessageField(
        "ApigatewayCancelOperationRequest", 1
    )
    name = _messages.StringField(2, required=True)
