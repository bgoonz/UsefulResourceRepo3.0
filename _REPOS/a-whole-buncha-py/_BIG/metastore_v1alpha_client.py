...
from googlecloudsdk.third_party.apis.metastore.v1alpha import (
    metastore_v1alpha_messages as messages,
)
...
class MetastoreV1alpha(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_locations_services_backups = self.ProjectsLocationsServicesBackupsService(
            self
        )
        self.projects_locations_services_databases_tables = self.ProjectsLocationsServicesDatabasesTablesService(
            self
        )
        self.projects_locations_services_databases = self.ProjectsLocationsServicesDatabasesService(
            self
        )
        self.projects_locations_services_metadataImports = self.ProjectsLocationsServicesMetadataImportsService(
            self
        )
    ...
    class ProjectsLocationsOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(MetastoreV1alpha.ProjectsLocationsOperationsService, self).__init__(
                client
            )
    ...
    class ProjectsLocationsServicesBackupsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                MetastoreV1alpha.ProjectsLocationsServicesBackupsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsServicesDatabasesTablesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                MetastoreV1alpha.ProjectsLocationsServicesDatabasesTablesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsServicesDatabasesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                MetastoreV1alpha.ProjectsLocationsServicesDatabasesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsServicesMetadataImportsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                MetastoreV1alpha.ProjectsLocationsServicesMetadataImportsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsServicesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(MetastoreV1alpha.ProjectsLocationsServicesService, self).__init__(
                client
            )
            self._upload_configs = {}
