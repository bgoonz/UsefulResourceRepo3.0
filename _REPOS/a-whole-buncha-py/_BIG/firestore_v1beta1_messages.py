...
class DocumentChange(_messages.Message):
  ...
  """
    ...
    removedTargetIds = _messages.IntegerField(
        2, repeated=True, variant=_messages.Variant.INT32
    )
    targetIds = _messages.IntegerField(
        3, repeated=True, variant=_messages.Variant.INT32
    )
...
class FirestoreProjectsDatabasesExportDocumentsRequest(_messages.Message):
  ...
  """
    ...
    googleFirestoreAdminV1beta1ExportDocumentsRequest = _messages.MessageField(
        "GoogleFirestoreAdminV1beta1ExportDocumentsRequest", 1
    )
    name = _messages.StringField(2, required=True)
...
class FirestoreProjectsDatabasesImportDocumentsRequest(_messages.Message):
  ...
  """
    ...
    googleFirestoreAdminV1beta1ImportDocumentsRequest = _messages.MessageField(
        "GoogleFirestoreAdminV1beta1ImportDocumentsRequest", 1
    )
    name = _messages.StringField(2, required=True)
...
class FirestoreProjectsDatabasesIndexesCreateRequest(_messages.Message):
  ...
  """
    ...
    googleFirestoreAdminV1beta1Index = _messages.MessageField(
        "GoogleFirestoreAdminV1beta1Index", 1
    )
    parent = _messages.StringField(2, required=True)
...
class GoogleFirestoreAdminV1beta1Index(_messages.Message):
  ...
  """
    ...
    fields = _messages.MessageField(
        "GoogleFirestoreAdminV1beta1IndexField", 2, repeated=True
    )
    name = _messages.StringField(3)
...
class GoogleFirestoreAdminV1beta1ListIndexesResponse(_messages.Message):
  ...
  """
    ...
    indexes = _messages.MessageField(
        "GoogleFirestoreAdminV1beta1Index", 1, repeated=True
    )
...
class TargetChange(_messages.Message):
  ...
  """
    ...
    targetIds = _messages.IntegerField(
        5, repeated=True, variant=_messages.Variant.INT32
    )
...
encoding.AddCustomJsonFieldMapping(StructuredQuery, "from_", "from")
