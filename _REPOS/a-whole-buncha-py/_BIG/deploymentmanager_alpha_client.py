...
from googlecloudsdk.third_party.apis.deploymentmanager.alpha import (
    deploymentmanager_alpha_messages as messages,
)
    ...
    class TypesService(base_api.BaseApiService):
      ...
      """
        ...
        Get.method_config = lambda: base_api.ApiMethodInfo(
            ...
            query_params=[],
            relative_path="projects/{project}/global/types/{type}",
            request_field="",
