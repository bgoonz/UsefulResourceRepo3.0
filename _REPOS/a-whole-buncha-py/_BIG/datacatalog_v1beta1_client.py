...
from googlecloudsdk.third_party.apis.datacatalog.v1beta1 import (
    datacatalog_v1beta1_messages as messages,
)
...
class DatacatalogV1beta1(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_locations_entryGroups_entries_tags = self.ProjectsLocationsEntryGroupsEntriesTagsService(
            self
        )
        self.projects_locations_entryGroups_entries = self.ProjectsLocationsEntryGroupsEntriesService(
            self
        )
        self.projects_locations_entryGroups_tags = self.ProjectsLocationsEntryGroupsTagsService(
            self
        )
        self.projects_locations_entryGroups = self.ProjectsLocationsEntryGroupsService(
            self
        )
        self.projects_locations_tagTemplates_fields_enumValues = self.ProjectsLocationsTagTemplatesFieldsEnumValuesService(
            self
        )
        self.projects_locations_tagTemplates_fields = self.ProjectsLocationsTagTemplatesFieldsService(
            self
        )
        self.projects_locations_tagTemplates = self.ProjectsLocationsTagTemplatesService(
            self
        )
        self.projects_locations_taxonomies_policyTags = self.ProjectsLocationsTaxonomiesPolicyTagsService(
            self
        )
        self.projects_locations_taxonomies = self.ProjectsLocationsTaxonomiesService(
            self
        )
    ...
    class ProjectsLocationsEntryGroupsEntriesTagsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                DatacatalogV1beta1.ProjectsLocationsEntryGroupsEntriesTagsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsEntryGroupsEntriesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                DatacatalogV1beta1.ProjectsLocationsEntryGroupsEntriesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsEntryGroupsTagsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                DatacatalogV1beta1.ProjectsLocationsEntryGroupsTagsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsEntryGroupsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                DatacatalogV1beta1.ProjectsLocationsEntryGroupsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsTagTemplatesFieldsEnumValuesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                DatacatalogV1beta1.ProjectsLocationsTagTemplatesFieldsEnumValuesService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsTagTemplatesFieldsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                DatacatalogV1beta1.ProjectsLocationsTagTemplatesFieldsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsTagTemplatesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                DatacatalogV1beta1.ProjectsLocationsTagTemplatesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsTaxonomiesPolicyTagsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                DatacatalogV1beta1.ProjectsLocationsTaxonomiesPolicyTagsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsTaxonomiesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(DatacatalogV1beta1.ProjectsLocationsTaxonomiesService, self).__init__(
                client
            )
            self._upload_configs = {}
