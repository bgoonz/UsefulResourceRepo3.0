...
class SourceProjectsReposAliasesFilesGetRequest(_messages.Message):
  ...
  """
    ...
    sourceContext_cloudWorkspace_workspaceId_repoId_projectRepoId_projectId = _messages.StringField(
        13
    )
    sourceContext_cloudWorkspace_workspaceId_repoId_projectRepoId_repoName = _messages.StringField(
        14
    )
    sourceContext_cloudWorkspace_workspaceId_repoId_uid = _messages.StringField(15)
    sourceContext_gerrit_aliasContext_kind = _messages.EnumField(
        "SourceContextGerritAliasContextKindValueValuesEnum", 16
    )
...
class SourceProjectsReposAliasesListFilesRequest(_messages.Message):
  ...
  """
    ...
    sourceContext_gerrit_aliasContext_kind = _messages.EnumField(
        "SourceContextGerritAliasContextKindValueValuesEnum", 15
    )
...
class SourceProjectsReposRevisionsFilesGetRequest(_messages.Message):
  ...
  """
    ...
    sourceContext_cloudRepo_aliasContext_kind = _messages.EnumField(
        "SourceContextCloudRepoAliasContextKindValueValuesEnum", 7
    )
...
class SourceProjectsReposRevisionsListFilesRequest(_messages.Message):
  ...
  """
    ...
    sourceContext_cloudRepo_aliasContext_kind = _messages.EnumField(
        "SourceContextCloudRepoAliasContextKindValueValuesEnum", 6
    )
...
class SourceProjectsReposWorkspacesSnapshotsFilesGetRequest(_messages.Message):
  ...
  """
    ...
    sourceContext_cloudRepo_aliasContext_kind = _messages.EnumField(
        "SourceContextCloudRepoAliasContextKindValueValuesEnum", 8
    )
