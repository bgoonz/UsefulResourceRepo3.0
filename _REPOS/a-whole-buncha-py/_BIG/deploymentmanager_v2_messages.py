...
class DeploymentmanagerDeploymentsCancelPreviewRequest(_messages.Message):
  ...
  """
    ...
    deploymentsCancelPreviewRequest = _messages.MessageField(
        "DeploymentsCancelPreviewRequest", 2
    )
...
class DeploymentmanagerDeploymentsDeleteRequest(_messages.Message):
  ...
  """
    ...
    deletePolicy = _messages.EnumField(
        "DeletePolicyValueValuesEnum", 1, default="DELETE"
    )
...
class DeploymentmanagerDeploymentsInsertRequest(_messages.Message):
  ...
  """
    ...
    createPolicy = _messages.EnumField(
        "CreatePolicyValueValuesEnum", 1, default="CREATE_OR_ACQUIRE"
    )
...
class DeploymentmanagerDeploymentsListRequest(_messages.Message):
  ...
  """
    ...
    maxResults = _messages.IntegerField(
        2, variant=_messages.Variant.UINT32, default=500
    )
...
class DeploymentmanagerDeploymentsPatchRequest(_messages.Message):
  ...
  """
    ...
    deletePolicy = _messages.EnumField(
        "DeletePolicyValueValuesEnum", 2, default="DELETE"
    )
...
class DeploymentmanagerManifestsListRequest(_messages.Message):
  ...
  """
    ...
    maxResults = _messages.IntegerField(
        3, variant=_messages.Variant.UINT32, default=500
    )
...
class LogConfigCounterOptions(_messages.Message):
  ...
  """
    ...
    customFields = _messages.MessageField(
        "LogConfigCounterOptionsCustomField", 1, repeated=True
    )
