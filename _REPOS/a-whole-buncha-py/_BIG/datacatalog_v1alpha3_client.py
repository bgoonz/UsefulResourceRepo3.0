...
from googlecloudsdk.third_party.apis.datacatalog.v1alpha3 import (
    datacatalog_v1alpha3_messages as messages,
)
...
class DatacatalogV1alpha3(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_crawlers_crawlerRuns = self.ProjectsCrawlersCrawlerRunsService(
            self
        )
        self.projects_crawlers = self.ProjectsCrawlersService(self)
        self.projects_taxonomies_categories = self.ProjectsTaxonomiesCategoriesService(
            self
        )
    ...
    class ProjectsCrawlersCrawlerRunsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                DatacatalogV1alpha3.ProjectsCrawlersCrawlerRunsService, self
            ).__init__(client)
    ...
    class ProjectsTaxonomiesCategoriesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                DatacatalogV1alpha3.ProjectsTaxonomiesCategoriesService, self
            ).__init__(client)
            self._upload_configs = {}
