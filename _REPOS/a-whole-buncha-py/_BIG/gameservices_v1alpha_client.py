...
from googlecloudsdk.third_party.apis.gameservices.v1alpha import (
    gameservices_v1alpha_messages as messages,
)
...
class GameservicesV1alpha(base_api.BaseApiClient):
    ...
    class ProjectsLocationsGameServerDeploymentsConfigsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                GameservicesV1alpha.ProjectsLocationsGameServerDeploymentsConfigsService,
                self,
            ).__init__(client)
    ...
    class ProjectsLocationsGameServerDeploymentsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                GameservicesV1alpha.ProjectsLocationsGameServerDeploymentsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                GameservicesV1alpha.ProjectsLocationsOperationsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsRealmsGameServerClustersService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                GameservicesV1alpha.ProjectsLocationsRealmsGameServerClustersService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsRealmsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(GameservicesV1alpha.ProjectsLocationsRealmsService, self).__init__(
                client
            )
            self._upload_configs = {}
