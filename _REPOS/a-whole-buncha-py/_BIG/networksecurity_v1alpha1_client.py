...
from googlecloudsdk.third_party.apis.networksecurity.v1alpha1 import (
    networksecurity_v1alpha1_messages as messages,
)
...
class NetworksecurityV1alpha1(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_locations_addressGroups = self.ProjectsLocationsAddressGroupsService(
            self
        )
        self.projects_locations_authorizationPolicies = self.ProjectsLocationsAuthorizationPoliciesService(
            self
        )
        self.projects_locations_clientTlsPolicies = self.ProjectsLocationsClientTlsPoliciesService(
            self
        )
        self.projects_locations_operations = self.ProjectsLocationsOperationsService(
            self
        )
        self.projects_locations_serverTlsPolicies = self.ProjectsLocationsServerTlsPoliciesService(
            self
        )
    ...
    class ProjectsLocationsAddressGroupsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                NetworksecurityV1alpha1.ProjectsLocationsAddressGroupsService, self
            ).__init__(client)
    ...
    class ProjectsLocationsAuthorizationPoliciesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                NetworksecurityV1alpha1.ProjectsLocationsAuthorizationPoliciesService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsClientTlsPoliciesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                NetworksecurityV1alpha1.ProjectsLocationsClientTlsPoliciesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                NetworksecurityV1alpha1.ProjectsLocationsOperationsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsServerTlsPoliciesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                NetworksecurityV1alpha1.ProjectsLocationsServerTlsPoliciesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(NetworksecurityV1alpha1.ProjectsLocationsService, self).__init__(
                client
            )
            self._upload_configs = {}
