...
from googlecloudsdk.third_party.apis.managedidentities.v1alpha1 import (
    managedidentities_v1alpha1_messages as messages,
)
...
class ManagedidentitiesV1alpha1(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_locations_global_domains_backups = self.ProjectsLocationsGlobalDomainsBackupsService(
            self
        )
        self.projects_locations_global_domains_sqlIntegrations = self.ProjectsLocationsGlobalDomainsSqlIntegrationsService(
            self
        )
        self.projects_locations_global_domains = self.ProjectsLocationsGlobalDomainsService(
            self
        )
        self.projects_locations_global_operations = self.ProjectsLocationsGlobalOperationsService(
            self
        )
        self.projects_locations_global_peerings = self.ProjectsLocationsGlobalPeeringsService(
            self
        )
    ...
    class ProjectsLocationsGlobalDomainsBackupsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ManagedidentitiesV1alpha1.ProjectsLocationsGlobalDomainsBackupsService,
                self,
            ).__init__(client)
    ...
    class ProjectsLocationsGlobalDomainsSqlIntegrationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ManagedidentitiesV1alpha1.ProjectsLocationsGlobalDomainsSqlIntegrationsService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsGlobalDomainsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ManagedidentitiesV1alpha1.ProjectsLocationsGlobalDomainsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsGlobalOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ManagedidentitiesV1alpha1.ProjectsLocationsGlobalOperationsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsGlobalPeeringsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ManagedidentitiesV1alpha1.ProjectsLocationsGlobalPeeringsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsGlobalService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ManagedidentitiesV1alpha1.ProjectsLocationsGlobalService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(ManagedidentitiesV1alpha1.ProjectsLocationsService, self).__init__(
                client
            )
            self._upload_configs = {}
