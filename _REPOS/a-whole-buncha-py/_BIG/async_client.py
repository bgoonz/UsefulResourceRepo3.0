...
from googlecloudsdk.third_party.gapic_clients.logging_v2.services.logging_service_v2 import (
    pagers,
)
...
class LoggingServiceV2AsyncClient:
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        """
        return LoggingServiceV2Client.from_service_account_info.__func__(
            LoggingServiceV2AsyncClient, info, *args, **kwargs
        )  # type: ignore
    ...
    def from_service_account_file(cls, filename: str, *args, **kwargs):
        ...
        Returns:
            LoggingServiceV2AsyncClient: The constructed client.
        """
        return LoggingServiceV2Client.from_service_account_file.__func__(
            LoggingServiceV2AsyncClient, filename, *args, **kwargs
        )  # type: ignore
    ...
    async def delete_log(
        ...
        *,
        ...
        Args:
            request (:class:`googlecloudsdk.third_party.gapic_clients.logging_v2.types.DeleteLogRequest`):
    ...
    async def write_log_entries(
        ...
        *,
        ...
        Args:
            request (:class:`googlecloudsdk.third_party.gapic_clients.logging_v2.types.WriteLogEntriesRequest`):
            ...
            resource (:class:`google.api.monitored_resource_pb2.MonitoredResource`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            labels (:class:`Sequence[googlecloudsdk.third_party.gapic_clients.logging_v2.types.WriteLogEntriesRequest.LabelsEntry]`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            entries (:class:`Sequence[googlecloudsdk.third_party.gapic_clients.logging_v2.types.LogEntry]`):
    ...
    async def list_log_entries(
        ...
        *,
        ...
        Args:
            request (:class:`googlecloudsdk.third_party.gapic_clients.logging_v2.types.ListLogEntriesRequest`):
        ...
        Returns:
            googlecloudsdk.third_party.gapic_clients.logging_v2.services.logging_service_v2.pagers.ListLogEntriesAsyncPager:
    ...
    async def list_monitored_resource_descriptors(
        ...
        *,
        ...
        Args:
            request (:class:`googlecloudsdk.third_party.gapic_clients.logging_v2.types.ListMonitoredResourceDescriptorsRequest`):
        ...
        Returns:
            googlecloudsdk.third_party.gapic_clients.logging_v2.services.logging_service_v2.pagers.ListMonitoredResourceDescriptorsAsyncPager:
    ...
    async def list_logs(
        ...
        *,
        ...
        Args:
            request (:class:`googlecloudsdk.third_party.gapic_clients.logging_v2.types.ListLogsRequest`):
        ...
        Returns:
            googlecloudsdk.third_party.gapic_clients.logging_v2.services.logging_service_v2.pagers.ListLogsAsyncPager:
    ...
    def tail_log_entries(
        ...
        *,
        ...
        Args:
            requests (AsyncIterator[`googlecloudsdk.third_party.gapic_clients.logging_v2.types.TailLogEntriesRequest`]):
        ...
        Returns:
            AsyncIterable[googlecloudsdk.third_party.gapic_clients.logging_v2.types.TailLogEntriesResponse]:
