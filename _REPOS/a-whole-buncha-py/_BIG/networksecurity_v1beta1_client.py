...
from googlecloudsdk.third_party.apis.networksecurity.v1beta1 import (
    networksecurity_v1beta1_messages as messages,
)
...
class NetworksecurityV1beta1(base_api.BaseApiClient):
    ...
    class ProjectsLocationsAuthorizationPoliciesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                NetworksecurityV1beta1.ProjectsLocationsAuthorizationPoliciesService,
                self,
            ).__init__(client)
    ...
    class ProjectsLocationsClientTlsPoliciesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                NetworksecurityV1beta1.ProjectsLocationsClientTlsPoliciesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                NetworksecurityV1beta1.ProjectsLocationsOperationsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsServerTlsPoliciesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                NetworksecurityV1beta1.ProjectsLocationsServerTlsPoliciesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(NetworksecurityV1beta1.ProjectsLocationsService, self).__init__(
                client
            )
            self._upload_configs = {}
