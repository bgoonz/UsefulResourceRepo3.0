...
class Config(_messages.Message):
  ...
  """
    ...
    moduleEnablementState = _messages.EnumField(
        "ModuleEnablementStateValueValuesEnum", 1
    )
...
class ContainerThreatDetectionSettings(_messages.Message):
  ...
  """
    ...
    serviceEnablementState = _messages.EnumField(
        "ServiceEnablementStateValueValuesEnum", 4
    )
...
class Cvssv3(_messages.Message):
  ...
  """
    ...
    confidentialityImpact = _messages.EnumField(
        "ConfidentialityImpactValueValuesEnum", 5
    )
...
class EventThreatDetectionSettings(_messages.Message):
  ...
  """
    ...
    name = _messages.StringField(2)
    serviceEnablementState = _messages.EnumField(
        "ServiceEnablementStateValueValuesEnum", 3
    )
...
class GoogleCloudSecuritycenterV1p1beta1Finding(_messages.Message):
  ...
  """
    ...
    securityMarks = _messages.MessageField(
        "GoogleCloudSecuritycenterV1p1beta1SecurityMarks", 9
    )
...
class GoogleCloudSecuritycenterV1p1beta1Resource(_messages.Message):
  ...
  """
    ...
    folders = _messages.MessageField(
        "GoogleCloudSecuritycenterV1p1beta1Folder", 1, repeated=True
    )
    name = _messages.StringField(2)
    parent = _messages.StringField(3)
    parentDisplayName = _messages.StringField(4)
...
class SecuritycenterFoldersContainerThreatDetectionSettingsCalculateRequest(
    _messages.Message
):
...
class SecuritycenterFoldersEventThreatDetectionSettingsCalculateRequest(
    _messages.Message
):
...
class SecuritycenterFoldersGetContainerThreatDetectionSettingsRequest(
    _messages.Message
):
...
class SecuritycenterFoldersSecurityHealthAnalyticsSettingsCalculateRequest(
    _messages.Message
):
...
class SecuritycenterFoldersUpdateContainerThreatDetectionSettingsRequest(
    _messages.Message
):
  ...
  """
    ...
    containerThreatDetectionSettings = _messages.MessageField(
        "ContainerThreatDetectionSettings", 1
    )
...
class SecuritycenterFoldersUpdateEventThreatDetectionSettingsRequest(_messages.Message):
  ...
  """
    ...
    eventThreatDetectionSettings = _messages.MessageField(
        "EventThreatDetectionSettings", 1
    )
    name = _messages.StringField(2, required=True)
    updateMask = _messages.StringField(3)


class SecuritycenterFoldersUpdateSecurityHealthAnalyticsSettingsRequest(
    _messages.Message
):
  ...
  """
    ...
    name = _messages.StringField(1, required=True)
    securityHealthAnalyticsSettings = _messages.MessageField(
        "SecurityHealthAnalyticsSettings", 2
    )
    updateMask = _messages.StringField(3)
...
class SecuritycenterFoldersWebSecurityScannerSettingsCalculateRequest(
    _messages.Message
):
...
class SecuritycenterOrganizationsContainerThreatDetectionSettingsCalculateRequest(
    _messages.Message
):
    r"""A
...
class SecuritycenterOrganizationsEventThreatDetectionSettingsCalculateRequest(
    _messages.Message
):
    r"""A
...
class SecuritycenterOrganizationsGetContainerThreatDetectionSettingsRequest(
    _messages.Message
):
...
class SecuritycenterOrganizationsGetEventThreatDetectionSettingsRequest(
    _messages.Message
):
...
class SecuritycenterOrganizationsGetSecurityHealthAnalyticsSettingsRequest(
    _messages.Message
):
...
class SecuritycenterOrganizationsGetWebSecurityScannerSettingsRequest(
    _messages.Message
):
...
class SecuritycenterOrganizationsSecurityHealthAnalyticsSettingsCalculateRequest(
    _messages.Message
):
    r"""A
...
class SecuritycenterOrganizationsUpdateContainerThreatDetectionSettingsRequest(
    _messages.Message
):
    r"""A
...
class SecuritycenterOrganizationsUpdateEventThreatDetectionSettingsRequest(
    _messages.Message
):
...
class SecuritycenterOrganizationsUpdateSecurityHealthAnalyticsSettingsRequest(
    _messages.Message
):
    r"""A
...
class SecuritycenterOrganizationsUpdateWebSecurityScannerSettingsRequest(
    _messages.Message
):
...
class SecuritycenterOrganizationsWebSecurityScannerSettingsCalculateRequest(
    _messages.Message
):
...
class SecuritycenterProjectsContainerThreatDetectionSettingsCalculateRequest(
    _messages.Message
):
...
class SecuritycenterProjectsEventThreatDetectionSettingsCalculateRequest(
    _messages.Message
):
...
class SecuritycenterProjectsGetContainerThreatDetectionSettingsRequest(
    _messages.Message
):
...
class SecuritycenterProjectsGetSecurityHealthAnalyticsSettingsRequest(
    _messages.Message
):
...
class SecuritycenterProjectsLocationsClustersContainerThreatDetectionSettingsCalculateRequest(
    _messages.Message
):
...
class SecuritycenterProjectsSecurityHealthAnalyticsSettingsCalculateRequest(
    _messages.Message
):
...
class SecuritycenterProjectsUpdateContainerThreatDetectionSettingsRequest(
    _messages.Message
):
...
class SecuritycenterProjectsUpdateEventThreatDetectionSettingsRequest(
    _messages.Message
):
...
class SecuritycenterProjectsUpdateSecurityHealthAnalyticsSettingsRequest(
    _messages.Message
):
