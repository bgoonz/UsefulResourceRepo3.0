...
class PyDBFrame:
                ...
                if not should_stop:
                    ...
                    for exc_break, is_user_uncaught in check_excs:
                        ...
                        if (
                            ...
                            should_stop = (
                                False
                            )  # I.e.: we stop only when we're at the caller of a method that throws an exception
                            ...
                            should_stop = (
                                False
                            )  # I.e.: we stop only when it was just raised
                    ...
                    if (
                        ...
                        try:
                            line = linecache.getline(
                                filename, exc_lineno, check_trace_obj.tb_frame.f_globals
                            )
                        except:
                            # Jython 2.1
    ...
    def trace_dispatch(self, frame, event, arg):
        ...
        main_debugger, filename, info, thread, frame_skips_cache, frame_cache_key = (
            self._args
        )
            ...
            try:
                ...
                if should_skip:
                    ...
                    if info.pydev_smart_step_stop is frame:
                        info.pydev_func_name = (
                            ".invalid."
                        )  # Must match the type in cython
