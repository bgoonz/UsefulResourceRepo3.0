...
from googlecloudsdk.third_party.apis.apigateway.v1alpha1 import (
    apigateway_v1alpha1_messages as messages,
)
...
class ApigatewayV1alpha1(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_locations_apis_configs = self.ProjectsLocationsApisConfigsService(
            self
        )
    ...
    class ProjectsLocationsApisConfigsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ApigatewayV1alpha1.ProjectsLocationsApisConfigsService, self
            ).__init__(client)
    ...
    class ProjectsLocationsApisService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(ApigatewayV1alpha1.ProjectsLocationsApisService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsGatewaysService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(ApigatewayV1alpha1.ProjectsLocationsGatewaysService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(ApigatewayV1alpha1.ProjectsLocationsOperationsService, self).__init__(
                client
            )
            self._upload_configs = {}
