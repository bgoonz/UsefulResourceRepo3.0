...
class ExecStepConfig(_messages.Message):
  ...
  """
    ...
    allowedSuccessCodes = _messages.IntegerField(
        1, repeated=True, variant=_messages.Variant.INT32
    )
...
class ListPatchJobInstanceDetailsResponse(_messages.Message):
  ...
  """
    ...
    nextPageToken = _messages.StringField(1)
    patchJobInstanceDetails = _messages.MessageField(
        "PatchJobInstanceDetails", 2, repeated=True
    )
...
class PatchInstanceFilter(_messages.Message):
  ...
  """
    ...
    groupLabels = _messages.MessageField(
        "PatchInstanceFilterGroupLabel", 2, repeated=True
    )
...
class WindowsUpdateSettings(_messages.Message):
  ...
  """
    ...
    classifications = _messages.EnumField(
        "ClassificationsValueListEntryValuesEnum", 1, repeated=True
    )
