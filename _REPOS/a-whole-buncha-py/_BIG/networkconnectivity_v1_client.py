...
from googlecloudsdk.third_party.apis.networkconnectivity.v1 import (
    networkconnectivity_v1_messages as messages,
)
...
class NetworkconnectivityV1(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_locations_global_policyBasedRoutes = self.ProjectsLocationsGlobalPolicyBasedRoutesService(
            self
        )
    ...
    class ProjectsLocationsGlobalHubsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                NetworkconnectivityV1.ProjectsLocationsGlobalHubsService, self
            ).__init__(client)
    ...
    class ProjectsLocationsGlobalPolicyBasedRoutesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                NetworkconnectivityV1.ProjectsLocationsGlobalPolicyBasedRoutesService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsGlobalService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(NetworkconnectivityV1.ProjectsLocationsGlobalService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                NetworkconnectivityV1.ProjectsLocationsOperationsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsSpokesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(NetworkconnectivityV1.ProjectsLocationsSpokesService, self).__init__(
                client
            )
            self._upload_configs = {}
