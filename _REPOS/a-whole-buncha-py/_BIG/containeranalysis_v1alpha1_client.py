...
from googlecloudsdk.third_party.apis.containeranalysis.v1alpha1 import (
    containeranalysis_v1alpha1_messages as messages,
)
...
class ContaineranalysisV1alpha1(base_api.BaseApiClient):
    ...
    class ProjectsNotesOccurrencesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ContaineranalysisV1alpha1.ProjectsNotesOccurrencesService, self
            ).__init__(client)
    ...
    class ProjectsOccurrencesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(ContaineranalysisV1alpha1.ProjectsOccurrencesService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(ContaineranalysisV1alpha1.ProjectsOperationsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsScanConfigsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(ContaineranalysisV1alpha1.ProjectsScanConfigsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProvidersNotesOccurrencesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ContaineranalysisV1alpha1.ProvidersNotesOccurrencesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProvidersNotesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(ContaineranalysisV1alpha1.ProvidersNotesService, self).__init__(
                client
            )
            self._upload_configs = {}
