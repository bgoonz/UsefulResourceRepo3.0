...
from googlecloudsdk.third_party.apis.gameservices.v1beta import (
    gameservices_v1beta_messages as messages,
)
...
class GameservicesV1beta(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_locations_gameServerDeployments_configs = self.ProjectsLocationsGameServerDeploymentsConfigsService(
            self
        )
        self.projects_locations_gameServerDeployments = self.ProjectsLocationsGameServerDeploymentsService(
            self
        )
        self.projects_locations_operations = self.ProjectsLocationsOperationsService(
            self
        )
        self.projects_locations_realms_gameServerClusters = self.ProjectsLocationsRealmsGameServerClustersService(
            self
        )
    ...
    class ProjectsLocationsGameServerDeploymentsConfigsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                GameservicesV1beta.ProjectsLocationsGameServerDeploymentsConfigsService,
                self,
            ).__init__(client)
    ...
    class ProjectsLocationsGameServerDeploymentsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                GameservicesV1beta.ProjectsLocationsGameServerDeploymentsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(GameservicesV1beta.ProjectsLocationsOperationsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsRealmsGameServerClustersService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                GameservicesV1beta.ProjectsLocationsRealmsGameServerClustersService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsRealmsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(GameservicesV1beta.ProjectsLocationsRealmsService, self).__init__(
                client
            )
            self._upload_configs = {}
