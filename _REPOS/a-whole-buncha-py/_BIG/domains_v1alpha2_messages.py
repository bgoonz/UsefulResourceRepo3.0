...
class ConfigureContactSettingsRequest(_messages.Message):
  ...
  """
    ...
    contactNotices = _messages.EnumField(
        "ContactNoticesValueListEntryValuesEnum", 1, repeated=True
    )
...
class DomainsProjectsLocationsRegistrationsConfigureContactSettingsRequest(
  ...
  """
    ...
    configureContactSettingsRequest = _messages.MessageField(
        "ConfigureContactSettingsRequest", 1
    )
...
class DomainsProjectsLocationsRegistrationsConfigureDnsSettingsRequest(
  ...
  """
    ...
    configureDnsSettingsRequest = _messages.MessageField(
        "ConfigureDnsSettingsRequest", 1
    )
    registration = _messages.StringField(2, required=True)
...
class DomainsProjectsLocationsRegistrationsConfigureManagementSettingsRequest(
  ...
  """
    ...
    configureManagementSettingsRequest = _messages.MessageField(
        "ConfigureManagementSettingsRequest", 1
    )
    registration = _messages.StringField(2, required=True)
...
class DomainsProjectsLocationsRegistrationsResetAuthorizationCodeRequest(
  ...
  """
    ...
    resetAuthorizationCodeRequest = _messages.MessageField(
        "ResetAuthorizationCodeRequest", 2
    )
...
class RegisterDomainRequest(_messages.Message):
  ...
  """
    ...
    domainNotices = _messages.EnumField(
        "DomainNoticesValueListEntryValuesEnum", 2, repeated=True
    )
...
class RegisterParameters(_messages.Message):
  ...
  """
    ...
    domainNotices = _messages.EnumField(
        "DomainNoticesValueListEntryValuesEnum", 3, repeated=True
    )
    supportedPrivacy = _messages.EnumField(
        "SupportedPrivacyValueListEntryValuesEnum", 4, repeated=True
    )
    yearlyPrice = _messages.MessageField("Money", 5)
...
class Registration(_messages.Message):
  ...
  """
    ...
    supportedPrivacy = _messages.EnumField(
        "SupportedPrivacyValueListEntryValuesEnum", 12, repeated=True
    )
...
class TransferDomainRequest(_messages.Message):
  ...
  """
    ...
    contactNotices = _messages.EnumField(
        "ContactNoticesValueListEntryValuesEnum", 2, repeated=True
    )
    registration = _messages.MessageField("Registration", 3)
    validateOnly = _messages.BooleanField(4)
    yearlyPrice = _messages.MessageField("Money", 5)
