...
from googlecloudsdk.third_party.apis.gkebackup.v1alpha1 import (
    gkebackup_v1alpha1_messages as messages,
)
...
class GkebackupV1alpha1(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_locations_restores_volumeRestores = self.ProjectsLocationsRestoresVolumeRestoresService(
            self
        )
    ...
    class ProjectsLocationsBackupPlansBackupsVolumeBackupsService(
        ...
        def __init__(self, client):
            super(
                GkebackupV1alpha1.ProjectsLocationsBackupPlansBackupsVolumeBackupsService,
                self,
            ).__init__(client)
    ...
    class ProjectsLocationsBackupPlansBackupsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                GkebackupV1alpha1.ProjectsLocationsBackupPlansBackupsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsBackupPlansService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(GkebackupV1alpha1.ProjectsLocationsBackupPlansService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(GkebackupV1alpha1.ProjectsLocationsOperationsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsRestoresVolumeRestoresService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                GkebackupV1alpha1.ProjectsLocationsRestoresVolumeRestoresService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsRestoresService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(GkebackupV1alpha1.ProjectsLocationsRestoresService, self).__init__(
                client
            )
            self._upload_configs = {}
