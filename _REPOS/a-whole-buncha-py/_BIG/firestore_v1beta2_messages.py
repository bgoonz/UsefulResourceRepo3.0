...
class FirestoreProjectsDatabasesCollectionGroupsFieldsPatchRequest(_messages.Message):
  ...
  """
    ...
    googleFirestoreAdminV1beta2Field = _messages.MessageField(
        "GoogleFirestoreAdminV1beta2Field", 1
    )
...
class FirestoreProjectsDatabasesCollectionGroupsIndexesCreateRequest(_messages.Message):
  ...
  """
    ...
    googleFirestoreAdminV1beta2Index = _messages.MessageField(
        "GoogleFirestoreAdminV1beta2Index", 1
    )
...
class FirestoreProjectsDatabasesExportDocumentsRequest(_messages.Message):
  ...
  """
    ...
    googleFirestoreAdminV1beta2ExportDocumentsRequest = _messages.MessageField(
        "GoogleFirestoreAdminV1beta2ExportDocumentsRequest", 1
    )
    name = _messages.StringField(2, required=True)
...
class FirestoreProjectsDatabasesImportDocumentsRequest(_messages.Message):
  ...
  """
    ...
    googleFirestoreAdminV1beta2ImportDocumentsRequest = _messages.MessageField(
        "GoogleFirestoreAdminV1beta2ImportDocumentsRequest", 1
    )
    name = _messages.StringField(2, required=True)
...
class GoogleFirestoreAdminV1beta2FieldOperationMetadata(_messages.Message):
  ...
  """
    ...
    indexConfigDeltas = _messages.MessageField(
        "GoogleFirestoreAdminV1beta2IndexConfigDelta", 5, repeated=True
    )
...
class GoogleFirestoreAdminV1beta2Index(_messages.Message):
  ...
  """
    ...
    fields = _messages.MessageField(
        "GoogleFirestoreAdminV1beta2IndexField", 1, repeated=True
    )
    name = _messages.StringField(2)
...
class GoogleFirestoreAdminV1beta2IndexConfig(_messages.Message):
  ...
  """
    ...
    indexes = _messages.MessageField(
        "GoogleFirestoreAdminV1beta2Index", 2, repeated=True
    )
...
class GoogleFirestoreAdminV1beta2ListFieldsResponse(_messages.Message):
  ...
  """
    ...
    fields = _messages.MessageField(
        "GoogleFirestoreAdminV1beta2Field", 1, repeated=True
    )
...
class GoogleFirestoreAdminV1beta2ListIndexesResponse(_messages.Message):
  ...
  """
    ...
    indexes = _messages.MessageField(
        "GoogleFirestoreAdminV1beta2Index", 1, repeated=True
    )
    nextPageToken = _messages.StringField(2)
