...
class NetworkconnectivityProjectsLocationsInternalRangesDeleteRequest(
    _messages.Message
):
...
class NetworkconnectivityProjectsLocationsInternalRangesGetIamPolicyRequest(
    _messages.Message
):
...
class NetworkconnectivityProjectsLocationsInternalRangesSetIamPolicyRequest(
    _messages.Message
):
...
class NetworkconnectivityProjectsLocationsInternalRangesTestIamPermissionsRequest(
    _messages.Message
):
    r"""A
...
class Spoke(_messages.Message):
  ...
  """
    ...
    linkedRouterApplianceInstances = _messages.MessageField(
        "RouterApplianceInstance", 6, repeated=True
    )
