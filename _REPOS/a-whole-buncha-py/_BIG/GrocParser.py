...
class GrocParser(Parser):
    ...
    def specifictime(self,):
        ...
        try:
            try:
                ...
                TIME1 = self.match(
                    self.input, TIME, self.FOLLOW_TIME_in_specifictime117
                )
                # action start
                ...
                if alt7 == 1:
                    ...
                    while True:  # loop6
                        ...
                        if alt6 == 1:
                            ...
                            pass
                            self.match(
                                self.input, COMMA, self.FOLLOW_COMMA_in_ordinals229
                            )
                            self._state.following.append(
                ...
                if alt10 == 1:
                    ...
                    while True:  # loop9
                        ...
                        if alt9 == 1:
                            ...
                            pass
                            self.match(
                                self.input, COMMA, self.FOLLOW_COMMA_in_weekdays376
                            )
                            self._state.following.append(
        ...
        try:
            try:
                ...
                if alt13 == 1:
                    ...
                    pass
                    self.match(
                        self.input, QUARTER, self.FOLLOW_QUARTER_in_quarterspec583
                    )
                    # action start
                    ...
                    self.match(
                        self.input, QUARTER, self.FOLLOW_QUARTER_in_quarterspec601
                    )
            ...
            try:
                ...
                while True:  # loop14
                    ...
                    if alt14 == 1:
                        ...
                        pass
                        self.match(
                            self.input, COMMA, self.FOLLOW_COMMA_in_quarter_ordinals623
                        )
                        self._state.following.append(
                            self.FOLLOW_month_of_quarter_ordinal_in_quarter_ordinals625
                        )
                        self.month_of_quarter_ordinal()
    ...
    def time_range(self,):
        ...
        try:
            try:
                ...
                pass
                start_time = self.match(
                    self.input, TIME, self.FOLLOW_TIME_in_time_range680
                )
                # action start
                ...
                pass
                end_time = self.match(
                    self.input, TIME, self.FOLLOW_TIME_in_time_range698
                )
                # action start
    ...
    DFA4_min = DFA.unpack(u"\1\6\1\23\1\12\1\uffff\2\4\1\13\1\uffff\1\24\1\12\1\4")

    DFA4_max = DFA.unpack(u"\1\20\2\32\1\uffff\1\5\1\12\1\20\1\uffff\2\32\1\12")
