...
from googlecloudsdk.third_party.apis.container.v1beta1 import (
    container_v1beta1_messages as messages,
)
...
class ContainerV1beta1(base_api.BaseApiClient):
    ...
    class ProjectsAggregatedUsableSubnetworksService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ContainerV1beta1.ProjectsAggregatedUsableSubnetworksService, self
            ).__init__(client)
    ...
    class ProjectsLocationsClustersNodePoolsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ContainerV1beta1.ProjectsLocationsClustersNodePoolsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsClustersWellKnownService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ContainerV1beta1.ProjectsLocationsClustersWellKnownService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsClustersService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(ContainerV1beta1.ProjectsLocationsClustersService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(ContainerV1beta1.ProjectsLocationsOperationsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsZonesClustersNodePoolsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ContainerV1beta1.ProjectsZonesClustersNodePoolsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsZonesOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(ContainerV1beta1.ProjectsZonesOperationsService, self).__init__(
                client
            )
            self._upload_configs = {}
