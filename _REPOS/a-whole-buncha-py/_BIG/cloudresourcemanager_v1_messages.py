...
class CloudresourcemanagerFoldersGetEffectiveOrgPolicyRequest(_messages.Message):
  ...
  """
    ...
    getEffectiveOrgPolicyRequest = _messages.MessageField(
        "GetEffectiveOrgPolicyRequest", 2
    )
...
class CloudresourcemanagerFoldersListAvailableOrgPolicyConstraintsRequest(
    _messages.Message
):
  ...
  """
    ...
    foldersId = _messages.StringField(1, required=True)
    listAvailableOrgPolicyConstraintsRequest = _messages.MessageField(
        "ListAvailableOrgPolicyConstraintsRequest", 2
    )
...
class CloudresourcemanagerOrganizationsGetEffectiveOrgPolicyRequest(_messages.Message):
  ...
  """
    ...
    getEffectiveOrgPolicyRequest = _messages.MessageField(
        "GetEffectiveOrgPolicyRequest", 1
    )
    organizationsId = _messages.StringField(2, required=True)
...
class CloudresourcemanagerOrganizationsListAvailableOrgPolicyConstraintsRequest(
    _messages.Message
):
    r"""A
  ...
  """
    ...
    listAvailableOrgPolicyConstraintsRequest = _messages.MessageField(
        "ListAvailableOrgPolicyConstraintsRequest", 1
    )
    organizationsId = _messages.StringField(2, required=True)
