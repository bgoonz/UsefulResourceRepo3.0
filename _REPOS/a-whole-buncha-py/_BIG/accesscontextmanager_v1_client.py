...
from googlecloudsdk.third_party.apis.accesscontextmanager.v1 import (
    accesscontextmanager_v1_messages as messages,
)
...
class AccesscontextmanagerV1(base_api.BaseApiClient):
    ...
    class AccessPoliciesAccessLevelsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                AccesscontextmanagerV1.AccessPoliciesAccessLevelsService, self
            ).__init__(client)
    ...
    class AccessPoliciesServicePerimetersService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                AccesscontextmanagerV1.AccessPoliciesServicePerimetersService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class OrganizationsGcpUserAccessBindingsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                AccesscontextmanagerV1.OrganizationsGcpUserAccessBindingsService, self
            ).__init__(client)
            self._upload_configs = {}
