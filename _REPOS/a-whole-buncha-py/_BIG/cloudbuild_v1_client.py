...
from googlecloudsdk.third_party.apis.cloudbuild.v1 import (
    cloudbuild_v1_messages as messages,
)
...
class CloudbuildV1(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.github_installations_installations = self.GithubInstallationsInstallationsService(
            self
        )
        self.github_installations_projects = self.GithubInstallationsProjectsService(
            self
        )
        ...
        self.projects_github_installations = self.ProjectsGithubInstallationsService(
            self
        )
        ...
        self.projects_locations_github_installations = self.ProjectsLocationsGithubInstallationsService(
            self
        )
        ...
        self.projects_locations_installations = self.ProjectsLocationsInstallationsService(
            self
        )
    ...
    class GithubInstallationsInstallationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(CloudbuildV1.GithubInstallationsInstallationsService, self).__init__(
                client
            )
    ...
    class GithubInstallationsProjectsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(CloudbuildV1.GithubInstallationsProjectsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsGithubInstallationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(CloudbuildV1.ProjectsGithubInstallationsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsGithubEnterpriseConfigsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(CloudbuildV1.ProjectsGithubEnterpriseConfigsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsBitbucketServerConfigsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                CloudbuildV1.ProjectsLocationsBitbucketServerConfigsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsGithubInstallationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                CloudbuildV1.ProjectsLocationsGithubInstallationsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsGithubEnterpriseConfigsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                CloudbuildV1.ProjectsLocationsGithubEnterpriseConfigsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsInstallationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(CloudbuildV1.ProjectsLocationsInstallationsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(CloudbuildV1.ProjectsLocationsOperationsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsWorkerPoolsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(CloudbuildV1.ProjectsLocationsWorkerPoolsService, self).__init__(
                client
            )
            self._upload_configs = {}
