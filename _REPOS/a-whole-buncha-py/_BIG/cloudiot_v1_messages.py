...
class CloudiotProjectsLocationsRegistriesDevicesListRequest(_messages.Message):
  ...
  """
    ...
    deviceNumIds = _messages.IntegerField(
        2, repeated=True, variant=_messages.Variant.UINT64
    )
    ...
    gatewayListOptions_gatewayType = _messages.EnumField(
        "GatewayListOptionsGatewayTypeValueValuesEnum", 6
    )
...
class CloudiotProjectsLocationsRegistriesDevicesModifyCloudToDeviceConfigRequest(
  ...
  """
    ...
    modifyCloudToDeviceConfigRequest = _messages.MessageField(
        "ModifyCloudToDeviceConfigRequest", 1
    )
    name = _messages.StringField(2, required=True)
...
class CloudiotProjectsLocationsRegistriesUnbindDeviceFromGatewayRequest(
  ...
  """
    ...
    unbindDeviceFromGatewayRequest = _messages.MessageField(
        "UnbindDeviceFromGatewayRequest", 2
    )
...
class DeviceRegistry(_messages.Message):
  ...
  """
    ...
    eventNotificationConfigs = _messages.MessageField(
        "EventNotificationConfig", 2, repeated=True
    )
