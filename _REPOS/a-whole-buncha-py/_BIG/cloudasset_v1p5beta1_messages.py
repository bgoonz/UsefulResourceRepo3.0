...
class Asset(_messages.Message):
  ...
  """
    ...
    accessLevel = _messages.MessageField(
        "GoogleIdentityAccesscontextmanagerV1AccessLevel", 1
    )
    accessPolicy = _messages.MessageField(
        "GoogleIdentityAccesscontextmanagerV1AccessPolicy", 2
    )
    ...
    servicePerimeter = _messages.MessageField(
        "GoogleIdentityAccesscontextmanagerV1ServicePerimeter", 10
    )
...
class GoogleIdentityAccesscontextmanagerV1AccessLevel(_messages.Message):
  ...
  """
    ...
    custom = _messages.MessageField(
        "GoogleIdentityAccesscontextmanagerV1CustomLevel", 2
    )
...
class GoogleIdentityAccesscontextmanagerV1BasicLevel(_messages.Message):
  ...
  """
    ...
    conditions = _messages.MessageField(
        "GoogleIdentityAccesscontextmanagerV1Condition", 2, repeated=True
    )
...
class GoogleIdentityAccesscontextmanagerV1Condition(_messages.Message):
  ...
  """
    ...
    devicePolicy = _messages.MessageField(
        "GoogleIdentityAccesscontextmanagerV1DevicePolicy", 1
    )
...
class GoogleIdentityAccesscontextmanagerV1DevicePolicy(_messages.Message):
  ...
  """
    ...
    allowedDeviceManagementLevels = _messages.EnumField(
        "AllowedDeviceManagementLevelsValueListEntryValuesEnum", 1, repeated=True
    )
    allowedEncryptionStatuses = _messages.EnumField(
        "AllowedEncryptionStatusesValueListEntryValuesEnum", 2, repeated=True
    )
    osConstraints = _messages.MessageField(
        "GoogleIdentityAccesscontextmanagerV1OsConstraint", 3, repeated=True
    )
...
class GoogleIdentityAccesscontextmanagerV1ServicePerimeter(_messages.Message):
  ...
  """
    ...
    spec = _messages.MessageField(
        "GoogleIdentityAccesscontextmanagerV1ServicePerimeterConfig", 4
    )
    status = _messages.MessageField(
        "GoogleIdentityAccesscontextmanagerV1ServicePerimeterConfig", 5
    )
...
class GoogleIdentityAccesscontextmanagerV1ServicePerimeterConfig(_messages.Message):
  ...
  """
    ...
    vpcAccessibleServices = _messages.MessageField(
        "GoogleIdentityAccesscontextmanagerV1VpcAccessibleServices", 4
    )
