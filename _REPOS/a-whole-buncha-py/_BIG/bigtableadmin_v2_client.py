...
from googlecloudsdk.third_party.apis.bigtableadmin.v2 import (
    bigtableadmin_v2_messages as messages,
)
...
class BigtableadminV2(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.operations_projects_operations = self.OperationsProjectsOperationsService(
            self
        )
        self.operations_projects = self.OperationsProjectsService(self)
        self.operations = self.OperationsService(self)
        self.projects_instances_appProfiles = self.ProjectsInstancesAppProfilesService(
            self
        )
        self.projects_instances_clusters_backups = self.ProjectsInstancesClustersBackupsService(
            self
        )
        self.projects_instances_clusters_hotTablets = self.ProjectsInstancesClustersHotTabletsService(
            self
        )
    ...
    class OperationsProjectsOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(BigtableadminV2.OperationsProjectsOperationsService, self).__init__(
                client
            )
    ...
    class ProjectsInstancesAppProfilesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(BigtableadminV2.ProjectsInstancesAppProfilesService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsInstancesClustersBackupsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                BigtableadminV2.ProjectsInstancesClustersBackupsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsInstancesClustersHotTabletsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                BigtableadminV2.ProjectsInstancesClustersHotTabletsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsInstancesClustersService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(BigtableadminV2.ProjectsInstancesClustersService, self).__init__(
                client
            )
            self._upload_configs = {}
