...
from googlecloudsdk.third_party.apis.osconfig.v1alpha1 import (
    osconfig_v1alpha1_messages as messages,
)
...
Replaces any existing policy.
    ...
    class OrganizationsAssignmentsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(OsconfigV1alpha1.OrganizationsAssignmentsService, self).__init__(
                client
            )
            self._upload_configs = {}
...
Replaces any existing policy.
    ...
    class ProjectsPatchJobsInstanceDetailsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                OsconfigV1alpha1.ProjectsPatchJobsInstanceDetailsService, self
            ).__init__(client)
            self._upload_configs = {}
