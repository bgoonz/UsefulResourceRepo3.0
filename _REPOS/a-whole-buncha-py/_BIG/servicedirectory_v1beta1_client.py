...
from googlecloudsdk.third_party.apis.servicedirectory.v1beta1 import (
    servicedirectory_v1beta1_messages as messages,
)
...
class ServicedirectoryV1beta1(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_locations_namespaces_services_endpoints = self.ProjectsLocationsNamespacesServicesEndpointsService(
            self
        )
        self.projects_locations_namespaces_services = self.ProjectsLocationsNamespacesServicesService(
            self
        )
    ...
    class ProjectsLocationsNamespacesServicesEndpointsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ServicedirectoryV1beta1.ProjectsLocationsNamespacesServicesEndpointsService,
                self,
            ).__init__(client)
    ...
    class ProjectsLocationsNamespacesServicesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ServicedirectoryV1beta1.ProjectsLocationsNamespacesServicesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsNamespacesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ServicedirectoryV1beta1.ProjectsLocationsNamespacesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(ServicedirectoryV1beta1.ProjectsLocationsService, self).__init__(
                client
            )
            self._upload_configs = {}
