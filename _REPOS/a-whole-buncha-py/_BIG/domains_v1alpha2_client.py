...
from googlecloudsdk.third_party.apis.domains.v1alpha2 import (
    domains_v1alpha2_messages as messages,
)
...
class DomainsV1alpha2(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_locations_registrations = self.ProjectsLocationsRegistrationsService(
            self
        )
    ...
    class ProjectsLocationsOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(DomainsV1alpha2.ProjectsLocationsOperationsService, self).__init__(
                client
            )
    ...
    class ProjectsLocationsRegistrationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(DomainsV1alpha2.ProjectsLocationsRegistrationsService, self).__init__(
                client
            )
            self._upload_configs = {}
