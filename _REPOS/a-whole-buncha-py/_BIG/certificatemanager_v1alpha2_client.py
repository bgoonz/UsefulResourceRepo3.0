...
from googlecloudsdk.third_party.apis.certificatemanager.v1alpha2 import (
    certificatemanager_v1alpha2_messages as messages,
)
...
class CertificatemanagerV1alpha2(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_locations_certificateMaps_certificateMapEntries = self.ProjectsLocationsCertificateMapsCertificateMapEntriesService(
            self
        )
        self.projects_locations_certificateMaps = self.ProjectsLocationsCertificateMapsService(
            self
        )
        self.projects_locations_certificates = self.ProjectsLocationsCertificatesService(
            self
        )
        self.projects_locations_dnsAuthorizations = self.ProjectsLocationsDnsAuthorizationsService(
            self
        )
    ...
    class ProjectsLocationsCertificateMapsCertificateMapEntriesService(
        ...
        def __init__(self, client):
            super(
                CertificatemanagerV1alpha2.ProjectsLocationsCertificateMapsCertificateMapEntriesService,
                self,
            ).__init__(client)
    ...
    class ProjectsLocationsCertificateMapsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                CertificatemanagerV1alpha2.ProjectsLocationsCertificateMapsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsCertificatesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                CertificatemanagerV1alpha2.ProjectsLocationsCertificatesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsDnsAuthorizationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                CertificatemanagerV1alpha2.ProjectsLocationsDnsAuthorizationsService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                CertificatemanagerV1alpha2.ProjectsLocationsOperationsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(CertificatemanagerV1alpha2.ProjectsLocationsService, self).__init__(
                client
            )
            self._upload_configs = {}
