...
class NetworkconnectivityProjectsLocationsGlobalHubsGetIamPolicyRequest(
    _messages.Message
):
...
class NetworkconnectivityProjectsLocationsGlobalHubsSetIamPolicyRequest(
    _messages.Message
):
...
class NetworkconnectivityProjectsLocationsGlobalHubsTestIamPermissionsRequest(
    _messages.Message
):
    r"""A
...
class NetworkconnectivityProjectsLocationsGlobalPolicyBasedRoutesGetIamPolicyRequest(
    _messages.Message
):
...
class NetworkconnectivityProjectsLocationsGlobalPolicyBasedRoutesSetIamPolicyRequest(
    _messages.Message
):
...
class NetworkconnectivityProjectsLocationsGlobalPolicyBasedRoutesTestIamPermissionsRequest(
    _messages.Message
):
...
class Spoke(_messages.Message):
  ...
  * linked_router_appliance_instances
  ...
  """
    ...
    linkedInterconnectAttachments = _messages.MessageField(
        "LinkedInterconnectAttachments", 5
    )
    linkedRouterApplianceInstances = _messages.MessageField(
        "LinkedRouterApplianceInstances", 6
    )
