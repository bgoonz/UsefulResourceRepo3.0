...
class EssentialcontactsFoldersContactsCreateRequest(_messages.Message):
  ...
  """
    ...
    googleCloudEssentialcontactsV1Contact = _messages.MessageField(
        "GoogleCloudEssentialcontactsV1Contact", 1
    )
...
class EssentialcontactsFoldersContactsSendTestMessageRequest(_messages.Message):
  ...
  """
    ...
    googleCloudEssentialcontactsV1SendTestMessageRequest = _messages.MessageField(
        "GoogleCloudEssentialcontactsV1SendTestMessageRequest", 1
    )
...
class GoogleCloudEssentialcontactsV1ComputeContactsResponse(_messages.Message):
  ...
  """
    ...
    contacts = _messages.MessageField(
        "GoogleCloudEssentialcontactsV1Contact", 1, repeated=True
    )
