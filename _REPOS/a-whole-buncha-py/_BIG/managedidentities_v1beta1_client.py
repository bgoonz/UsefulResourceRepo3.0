...
from googlecloudsdk.third_party.apis.managedidentities.v1beta1 import (
    managedidentities_v1beta1_messages as messages,
)
...
class ManagedidentitiesV1beta1(base_api.BaseApiClient):
    ...
    class ProjectsLocationsGlobalDomainsBackupsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ManagedidentitiesV1beta1.ProjectsLocationsGlobalDomainsBackupsService,
                self,
            ).__init__(client)
    ...
    class ProjectsLocationsGlobalDomainsSqlIntegrationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ManagedidentitiesV1beta1.ProjectsLocationsGlobalDomainsSqlIntegrationsService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsGlobalDomainsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ManagedidentitiesV1beta1.ProjectsLocationsGlobalDomainsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsGlobalOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ManagedidentitiesV1beta1.ProjectsLocationsGlobalOperationsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsGlobalPeeringsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ManagedidentitiesV1beta1.ProjectsLocationsGlobalPeeringsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsGlobalService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ManagedidentitiesV1beta1.ProjectsLocationsGlobalService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(ManagedidentitiesV1beta1.ProjectsLocationsService, self).__init__(
                client
            )
            self._upload_configs = {}
