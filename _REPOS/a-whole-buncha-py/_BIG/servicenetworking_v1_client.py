...
from googlecloudsdk.third_party.apis.servicenetworking.v1 import (
    servicenetworking_v1_messages as messages,
)
...
class ServicenetworkingV1(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.services_projects_global_networks_peeredDnsDomains = self.ServicesProjectsGlobalNetworksPeeredDnsDomainsService(
            self
        )
        self.services_projects_global_networks = self.ServicesProjectsGlobalNetworksService(
            self
        )
    ...
    class ServicesDnsRecordSetsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(ServicenetworkingV1.ServicesDnsRecordSetsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ServicesProjectsGlobalNetworksPeeredDnsDomainsService(
        ...
        def __init__(self, client):
            super(
                ServicenetworkingV1.ServicesProjectsGlobalNetworksPeeredDnsDomainsService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ServicesProjectsGlobalNetworksService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ServicenetworkingV1.ServicesProjectsGlobalNetworksService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ServicesProjectsGlobalService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(ServicenetworkingV1.ServicesProjectsGlobalService, self).__init__(
                client
            )
            self._upload_configs = {}
