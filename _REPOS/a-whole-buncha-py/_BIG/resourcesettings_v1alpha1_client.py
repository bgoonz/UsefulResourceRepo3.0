...
from googlecloudsdk.third_party.apis.resourcesettings.v1alpha1 import (
    resourcesettings_v1alpha1_messages as messages,
)
...
class ResourcesettingsV1alpha1(base_api.BaseApiClient):
    ...
    class FoldersSettingsValueService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(ResourcesettingsV1alpha1.FoldersSettingsValueService, self).__init__(
                client
            )
    ...
    class FoldersSettingsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(ResourcesettingsV1alpha1.FoldersSettingsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class OrganizationsSettingsValueService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ResourcesettingsV1alpha1.OrganizationsSettingsValueService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class OrganizationsSettingsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(ResourcesettingsV1alpha1.OrganizationsSettingsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsSettingsValueService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(ResourcesettingsV1alpha1.ProjectsSettingsValueService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsSettingsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(ResourcesettingsV1alpha1.ProjectsSettingsService, self).__init__(
                client
            )
            self._upload_configs = {}
