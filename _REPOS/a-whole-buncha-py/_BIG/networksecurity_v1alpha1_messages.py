...
class ClientTlsPolicy(_messages.Message):
  ...
  """
    ...
    clientCertificate = _messages.MessageField(
        "GoogleCloudNetworksecurityV1alpha1CertificateProvider", 1
    )
    createTime = _messages.StringField(2)
    description = _messages.StringField(3)
    labels = _messages.MessageField("LabelsValue", 4)
...
class GoogleCloudNetworksecurityV1alpha1CertificateProvider(_messages.Message):
  ...
  """
    ...
    certificateProviderInstance = _messages.MessageField(
        "CertificateProviderInstance", 1
    )
    grpcEndpoint = _messages.MessageField(
        "GoogleCloudNetworksecurityV1alpha1GrpcEndpoint", 2
    )
...
class GoogleIamV1AuditConfig(_messages.Message):
  ...
  """
    ...
    auditLogConfigs = _messages.MessageField(
        "GoogleIamV1AuditLogConfig", 1, repeated=True
    )
...
class ListAuthorizationPoliciesResponse(_messages.Message):
  ...
  """
    ...
    authorizationPolicies = _messages.MessageField(
        "AuthorizationPolicy", 1, repeated=True
    )
    nextPageToken = _messages.StringField(2)
...
class NetworksecurityProjectsLocationsAddressGroupsGetIamPolicyRequest(
    _messages.Message
):
...
class NetworksecurityProjectsLocationsAddressGroupsSetIamPolicyRequest(
    _messages.Message
):
  ...
  """
    ...
    googleIamV1SetIamPolicyRequest = _messages.MessageField(
        "GoogleIamV1SetIamPolicyRequest", 1
    )
    resource = _messages.StringField(2, required=True)


class NetworksecurityProjectsLocationsAddressGroupsTestIamPermissionsRequest(
    _messages.Message
):
  ...
  """
    ...
    googleIamV1TestIamPermissionsRequest = _messages.MessageField(
        "GoogleIamV1TestIamPermissionsRequest", 1
    )
    resource = _messages.StringField(2, required=True)


class NetworksecurityProjectsLocationsAuthorizationPoliciesCreateRequest(
    _messages.Message
):
...
class NetworksecurityProjectsLocationsAuthorizationPoliciesDeleteRequest(
    _messages.Message
):
...
class NetworksecurityProjectsLocationsAuthorizationPoliciesGetIamPolicyRequest(
    _messages.Message
):
    r"""A
...
class NetworksecurityProjectsLocationsAuthorizationPoliciesGetRequest(
    _messages.Message
):
...
class NetworksecurityProjectsLocationsAuthorizationPoliciesPatchRequest(
    _messages.Message
):
...
class NetworksecurityProjectsLocationsAuthorizationPoliciesSetIamPolicyRequest(
    _messages.Message
):
    r"""A
...
class NetworksecurityProjectsLocationsAuthorizationPoliciesTestIamPermissionsRequest(
    _messages.Message
):
...
class NetworksecurityProjectsLocationsClientTlsPoliciesGetIamPolicyRequest(
    _messages.Message
):
...
class NetworksecurityProjectsLocationsClientTlsPoliciesSetIamPolicyRequest(
    _messages.Message
):
...
class NetworksecurityProjectsLocationsClientTlsPoliciesTestIamPermissionsRequest(
    _messages.Message
):
    r"""A
...
class ServerTlsPolicy(_messages.Message):
  ...
  """
    ...
    serverCertificate = _messages.MessageField(
        "GoogleCloudNetworksecurityV1alpha1CertificateProvider", 7
    )
    updateTime = _messages.StringField(8)
...
class ValidationCA(_messages.Message):
  ...
  """
    ...
    certificateProviderInstance = _messages.MessageField(
        "CertificateProviderInstance", 2
    )
    grpcEndpoint = _messages.MessageField(
        "GoogleCloudNetworksecurityV1alpha1GrpcEndpoint", 3
    )
