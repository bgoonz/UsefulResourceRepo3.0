...
from googlecloudsdk.third_party.apis.mediaasset.v1alpha import (
    mediaasset_v1alpha_messages as messages,
)
...
class MediaassetV1alpha(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_locations_assetTypes_assets_actions = self.ProjectsLocationsAssetTypesAssetsActionsService(
            self
        )
        self.projects_locations_assetTypes_assets_annotationSets_annotations = self.ProjectsLocationsAssetTypesAssetsAnnotationSetsAnnotationsService(
            self
        )
        self.projects_locations_assetTypes_assets_annotationSets = self.ProjectsLocationsAssetTypesAssetsAnnotationSetsService(
            self
        )
        self.projects_locations_assetTypes_assets = self.ProjectsLocationsAssetTypesAssetsService(
            self
        )
        self.projects_locations_assetTypes_rules = self.ProjectsLocationsAssetTypesRulesService(
            self
        )
        self.projects_locations_assetTypes = self.ProjectsLocationsAssetTypesService(
            self
        )
        self.projects_locations_catalogs = self.ProjectsLocationsCatalogsService(self)
        self.projects_locations_complexTypes = self.ProjectsLocationsComplexTypesService(
            self
        )
        ...
        self.projects_locations_transformers = self.ProjectsLocationsTransformersService(
            self
        )
    ...
    class ProjectsLocationsAssetTypesAssetsActionsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                MediaassetV1alpha.ProjectsLocationsAssetTypesAssetsActionsService, self
            ).__init__(client)
    ...
    class ProjectsLocationsAssetTypesAssetsAnnotationSetsAnnotationsService(
        ...
        def __init__(self, client):
            super(
                MediaassetV1alpha.ProjectsLocationsAssetTypesAssetsAnnotationSetsAnnotationsService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsAssetTypesAssetsAnnotationSetsService(
        base_api.BaseApiService
    ):
        ...
        def __init__(self, client):
            super(
                MediaassetV1alpha.ProjectsLocationsAssetTypesAssetsAnnotationSetsService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsAssetTypesAssetsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                MediaassetV1alpha.ProjectsLocationsAssetTypesAssetsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsAssetTypesRulesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                MediaassetV1alpha.ProjectsLocationsAssetTypesRulesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsAssetTypesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(MediaassetV1alpha.ProjectsLocationsAssetTypesService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsCatalogsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(MediaassetV1alpha.ProjectsLocationsCatalogsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsComplexTypesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                MediaassetV1alpha.ProjectsLocationsComplexTypesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsModulesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(MediaassetV1alpha.ProjectsLocationsModulesService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(MediaassetV1alpha.ProjectsLocationsOperationsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsTransformersService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                MediaassetV1alpha.ProjectsLocationsTransformersService, self
            ).__init__(client)
            self._upload_configs = {}
