...
from googlecloudsdk.third_party.apis.osconfig.v1alpha2 import (
    osconfig_v1alpha2_messages as messages,
)
...
class OsconfigV1alpha2(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_patchJobs_instanceDetails = self.ProjectsPatchJobsInstanceDetailsService(
            self
        )
    ...
    class OrganizationsGuestPoliciesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(OsconfigV1alpha2.OrganizationsGuestPoliciesService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsPatchDeploymentsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(OsconfigV1alpha2.ProjectsPatchDeploymentsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsPatchJobsInstanceDetailsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                OsconfigV1alpha2.ProjectsPatchJobsInstanceDetailsService, self
            ).__init__(client)
            self._upload_configs = {}
