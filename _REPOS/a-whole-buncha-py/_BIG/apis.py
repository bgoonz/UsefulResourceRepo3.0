...
class Jobs(object):
    ...
    AGGREGATED_LIST_REQUEST = GetMessagesModule().DataflowProjectsJobsAggregatedRequest
    UPDATE_REQUEST = GetMessagesModule().DataflowProjectsLocationsJobsUpdateRequest
    ...
    """
        ...
        job = GetMessagesModule().Job(
            requestedState=(
                GetMessagesModule().Job.RequestedStateValueValuesEnum.JOB_STATE_CANCELLED
            )
        )
    ...
    @staticmethod
    def ResumeUnsupportedSDK(
        job_id, experiment_with_token, project_id=None, region_id=None
    ):
    ...
    @staticmethod
    def Snapshot(
        job_id, project_id=None, region_id=None, ttl="604800s", snapshot_sources=False
    ):
...
class Metrics(object):
    ...
    GET_REQUEST = GetMessagesModule().DataflowProjectsLocationsJobsGetMetricsRequest
    ...
    """
        ...
        # TODO(b/139889563): Remove default when args region is changed to required
        region_id = region_id or DATAFLOW_API_DEFAULT_REGION
        request = GetMessagesModule().DataflowProjectsLocationsJobsGetMetricsRequest(
            jobId=job_id, location=region_id, projectId=project_id, startTime=start_time
        )
        try:
...
class Templates(object):
    ...
    IP_CONFIGURATION_ENUM_VALUE = (
        GetMessagesModule().FlexTemplateRuntimeEnvironment.IpConfigurationValueValuesEnum
    )
    FLEXRS_GOAL_ENUM_VALUE = (
        GetMessagesModule().FlexTemplateRuntimeEnvironment.FlexrsGoalValueValuesEnum
    )
    ...
    FLEX_TEMPLATE_JAVA11_BASE_IMAGE = (
        "gcr.io/dataflow-templates-base/" "java11-template-launcher-base:latest"
    )
    FLEX_TEMPLATE_JAVA8_BASE_IMAGE = (
        "gcr.io/dataflow-templates-base/" "java8-template-launcher-base:latest"
    )
    FLEX_TEMPLATE_PYTHON3_BASE_IMAGE = (
        "gcr.io/dataflow-templates-base/" "python3-template-launcher-base:latest"
    )
    ...
    def ModifyDynamicTemplatesLaunchRequest(req):
        ...
        for req_field, mapped_param in Templates._CUSTOM_JSON_FIELD_MAPPINGS.items():
            encoding.AddCustomJsonFieldMapping(
                updated_request_type, req_field, mapped_param
            )
        return req
    ...
    """
        ...
        ip_configuration_enum = (
            GetMessagesModule().RuntimeEnvironment.IpConfigurationValueValuesEnum
        )
        ...
        request = GetMessagesModule().DataflowProjectsLocationsTemplatesCreateRequest(
    ...
    """
        ...
        dockerfile_contents = textwrap.dedent(dockerfile_template).format(
            base_image=Templates._GetFlexTemplateBaseImage(flex_template_base_image),
            env=env_list,
            copy=copy_command,
            commands="\n".join(commands),
        )
    ...
    """
        ...
        if "FLEX_TEMPLATE_PYTHON_REQUIREMENTS_FILE" in env:
            ...
            commands.append(
                "pip install --no-cache-dir -U -r {}".format(
                    env["FLEX_TEMPLATE_PYTHON_REQUIREMENTS_FILE"]
                )
            )
    ...
    """
        if sdk_language == "JAVA" and "FLEX_TEMPLATE_JAVA_MAIN_CLASS" not in env:
            ...
            raise ValueError(
                (
                    "FLEX_TEMPLATE_PYTHON_PY_FILE environment variable "
    ...
    Raises:
      ValueError: If is any of the required field is not set.
    """
        template_metadata = encoding.JsonToMessage(
            Templates.TEMPLATE_METADATA, template_metadata_json
        )
    ...
    @staticmethod
    def BuildAndStoreFlexTemplateFile(
        template_file_gcs_location,
        image,
    ...
    """
        ...
        try:
            Templates._StoreFlexTemplateFile(
                template_file_gcs_location, container_spec_pretty_json
            )
            log.status.Print(
    ...
    def BuildAndStoreFlexTemplateImage(
        image_gcr_path, flex_template_base_image, jar_paths, py_paths, env, sdk_language
    ):
    ...
    """
        ...
        request = GetMessagesModule().DataflowProjectsLocationsFlexTemplatesLaunchRequest(
            projectId=template_args.project_id or GetProject(),
            location=region_id,
...
class Messages(object):
    ...
    LIST_REQUEST = GetMessagesModule().DataflowProjectsLocationsJobsMessagesListRequest
    ...
    """
        ...
        # TODO(b/139889563): Remove default when args region is changed to required
        region_id = region_id or DATAFLOW_API_DEFAULT_REGION
        request = GetMessagesModule().DataflowProjectsLocationsJobsMessagesListRequest(
            jobId=job_id,
            location=region_id,
            projectId=project_id,
...
class Snapshots(object):
    ...
    """
        ...
        # TODO(b/139889563): Remove default when args region is changed to required
        region_id = region_id or DATAFLOW_API_DEFAULT_REGION
        request = GetMessagesModule().DataflowProjectsLocationsSnapshotsDeleteRequest(
