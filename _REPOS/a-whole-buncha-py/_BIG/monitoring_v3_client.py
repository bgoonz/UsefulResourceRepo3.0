...
from googlecloudsdk.third_party.apis.monitoring.v3 import (
    monitoring_v3_messages as messages,
)
...
class MonitoringV3(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_monitoredResourceDescriptors = self.ProjectsMonitoredResourceDescriptorsService(
            self
        )
        self.projects_notificationChannelDescriptors = self.ProjectsNotificationChannelDescriptorsService(
            self
        )
        self.projects_notificationChannels = self.ProjectsNotificationChannelsService(
            self
        )
    ...
    class ProjectsMonitoredResourceDescriptorsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                MonitoringV3.ProjectsMonitoredResourceDescriptorsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsNotificationChannelDescriptorsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                MonitoringV3.ProjectsNotificationChannelDescriptorsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsNotificationChannelsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(MonitoringV3.ProjectsNotificationChannelsService, self).__init__(
                client
            )
            self._upload_configs = {}
