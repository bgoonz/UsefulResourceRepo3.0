...
from googlecloudsdk.third_party.apis.toolresults.v1beta3 import (
    toolresults_v1beta3_messages as messages,
)
...
class ToolresultsV1beta3(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_histories_executions_clusters = self.ProjectsHistoriesExecutionsClustersService(
            self
        )
        self.projects_histories_executions_environments = self.ProjectsHistoriesExecutionsEnvironmentsService(
            self
        )
        self.projects_histories_executions_steps_perfMetricsSummary = self.ProjectsHistoriesExecutionsStepsPerfMetricsSummaryService(
            self
        )
        self.projects_histories_executions_steps_perfSampleSeries_samples = self.ProjectsHistoriesExecutionsStepsPerfSampleSeriesSamplesService(
            self
        )
        self.projects_histories_executions_steps_perfSampleSeries = self.ProjectsHistoriesExecutionsStepsPerfSampleSeriesService(
            self
        )
        self.projects_histories_executions_steps_testCases = self.ProjectsHistoriesExecutionsStepsTestCasesService(
            self
        )
        self.projects_histories_executions_steps_thumbnails = self.ProjectsHistoriesExecutionsStepsThumbnailsService(
            self
        )
        self.projects_histories_executions_steps = self.ProjectsHistoriesExecutionsStepsService(
            self
        )
        self.projects_histories_executions = self.ProjectsHistoriesExecutionsService(
            self
        )
    ...
    class ProjectsHistoriesExecutionsClustersService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ToolresultsV1beta3.ProjectsHistoriesExecutionsClustersService, self
            ).__init__(client)
    ...
    class ProjectsHistoriesExecutionsEnvironmentsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ToolresultsV1beta3.ProjectsHistoriesExecutionsEnvironmentsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsHistoriesExecutionsStepsPerfMetricsSummaryService(
        ...
        def __init__(self, client):
            super(
                ToolresultsV1beta3.ProjectsHistoriesExecutionsStepsPerfMetricsSummaryService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsHistoriesExecutionsStepsPerfSampleSeriesSamplesService(
        base_api.BaseApiService
    ):
        ...
        def __init__(self, client):
            super(
                ToolresultsV1beta3.ProjectsHistoriesExecutionsStepsPerfSampleSeriesSamplesService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsHistoriesExecutionsStepsPerfSampleSeriesService(
        base_api.BaseApiService
    ):
        ...
        def __init__(self, client):
            super(
                ToolresultsV1beta3.ProjectsHistoriesExecutionsStepsPerfSampleSeriesService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsHistoriesExecutionsStepsTestCasesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ToolresultsV1beta3.ProjectsHistoriesExecutionsStepsTestCasesService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsHistoriesExecutionsStepsThumbnailsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ToolresultsV1beta3.ProjectsHistoriesExecutionsStepsThumbnailsService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsHistoriesExecutionsStepsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ToolresultsV1beta3.ProjectsHistoriesExecutionsStepsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsHistoriesExecutionsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(ToolresultsV1beta3.ProjectsHistoriesExecutionsService, self).__init__(
                client
            )
            self._upload_configs = {}
