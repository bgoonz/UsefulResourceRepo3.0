...
from googlecloudsdk.third_party.apis.bigquerydatatransfer.v1 import (
    bigquerydatatransfer_v1_messages as messages,
)
...
class BigquerydatatransferV1(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_locations_dataSources = self.ProjectsLocationsDataSourcesService(
            self
        )
        self.projects_locations_transferConfigs_runs_transferLogs = self.ProjectsLocationsTransferConfigsRunsTransferLogsService(
            self
        )
        self.projects_locations_transferConfigs_runs = self.ProjectsLocationsTransferConfigsRunsService(
            self
        )
        self.projects_locations_transferConfigs = self.ProjectsLocationsTransferConfigsService(
            self
        )
        self.projects_locations = self.ProjectsLocationsService(self)
        self.projects_transferConfigs_runs_transferLogs = self.ProjectsTransferConfigsRunsTransferLogsService(
            self
        )
        self.projects_transferConfigs_runs = self.ProjectsTransferConfigsRunsService(
            self
        )
    ...
    class ProjectsDataSourcesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(BigquerydatatransferV1.ProjectsDataSourcesService, self).__init__(
                client
            )
    ...
    class ProjectsLocationsDataSourcesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                BigquerydatatransferV1.ProjectsLocationsDataSourcesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsTransferConfigsRunsTransferLogsService(
        ...
        def __init__(self, client):
            super(
                BigquerydatatransferV1.ProjectsLocationsTransferConfigsRunsTransferLogsService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsTransferConfigsRunsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                BigquerydatatransferV1.ProjectsLocationsTransferConfigsRunsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsTransferConfigsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                BigquerydatatransferV1.ProjectsLocationsTransferConfigsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(BigquerydatatransferV1.ProjectsLocationsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsTransferConfigsRunsTransferLogsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                BigquerydatatransferV1.ProjectsTransferConfigsRunsTransferLogsService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsTransferConfigsRunsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                BigquerydatatransferV1.ProjectsTransferConfigsRunsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsTransferConfigsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(BigquerydatatransferV1.ProjectsTransferConfigsService, self).__init__(
                client
            )
            self._upload_configs = {}
