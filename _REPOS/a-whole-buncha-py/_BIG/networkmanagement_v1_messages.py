...
class LoadBalancerBackend(_messages.Message):
  ...
  """
    ...
    healthCheckFirewallState = _messages.EnumField(
        "HealthCheckFirewallStateValueValuesEnum", 4
    )
...
class NetworkmanagementProjectsLocationsGlobalConnectivityTestsDeleteRequest(
    _messages.Message
):
...
class NetworkmanagementProjectsLocationsGlobalConnectivityTestsGetRequest(
    _messages.Message
):
...
class NetworkmanagementProjectsLocationsGlobalConnectivityTestsRerunRequest(
  ...
  """
    ...
    name = _messages.StringField(1, required=True)
    rerunConnectivityTestRequest = _messages.MessageField(
        "RerunConnectivityTestRequest", 2
    )
