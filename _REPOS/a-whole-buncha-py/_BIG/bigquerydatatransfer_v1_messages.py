...
class BigquerydatatransferProjectsLocationsTransferConfigsCreateRequest(
    _messages.Message
):
...
class BigquerydatatransferProjectsLocationsTransferConfigsDeleteRequest(
    _messages.Message
):
...
class BigquerydatatransferProjectsLocationsTransferConfigsListRequest(
    _messages.Message
):
...
class BigquerydatatransferProjectsLocationsTransferConfigsPatchRequest(
    _messages.Message
):
...
class BigquerydatatransferProjectsLocationsTransferConfigsRunsDeleteRequest(
    _messages.Message
):
...
class BigquerydatatransferProjectsLocationsTransferConfigsRunsGetRequest(
    _messages.Message
):
...
class BigquerydatatransferProjectsLocationsTransferConfigsRunsListRequest(
    _messages.Message
):
...
class BigquerydatatransferProjectsLocationsTransferConfigsRunsTransferLogsListRequest(
    _messages.Message
):
...
class BigquerydatatransferProjectsLocationsTransferConfigsScheduleRunsRequest(
    _messages.Message
):
    r"""A
  ...
  """
    ...
    scheduleTransferRunsRequest = _messages.MessageField(
        "ScheduleTransferRunsRequest", 2
    )


class BigquerydatatransferProjectsLocationsTransferConfigsStartManualRunsRequest(
    _messages.Message
):
    r"""A
  ...
  """
    ...
    parent = _messages.StringField(1, required=True)
    startManualTransferRunsRequest = _messages.MessageField(
        "StartManualTransferRunsRequest", 2
    )
...
class DataSource(_messages.Message):
  ...
  """
    ...
    defaultDataRefreshWindowDays = _messages.IntegerField(
