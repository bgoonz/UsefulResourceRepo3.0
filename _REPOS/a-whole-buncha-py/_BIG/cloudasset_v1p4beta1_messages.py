...
class AnalyzeIamPolicyResponse(_messages.Message):
  ...
  """
    ...
    nonCriticalErrors = _messages.MessageField(
        "GoogleCloudAssetV1p4beta1AnalysisState", 3, repeated=True
    )
    serviceAccountImpersonationAnalysis = _messages.MessageField(
        "IamPolicyAnalysis", 4, repeated=True
    )
...
class CloudassetExportIamPolicyAnalysisRequest(_messages.Message):
  ...
  """
    ...
    exportIamPolicyAnalysisRequest = _messages.MessageField(
        "ExportIamPolicyAnalysisRequest", 1
    )
...
class GoogleCloudAssetV1p4beta1AccessControlList(_messages.Message):
  ...
  """
    ...
    accesses = _messages.MessageField(
        "GoogleCloudAssetV1p4beta1Access", 1, repeated=True
    )
    resourceEdges = _messages.MessageField(
        "GoogleCloudAssetV1p4beta1Edge", 2, repeated=True
    )
    resources = _messages.MessageField(
        "GoogleCloudAssetV1p4beta1Resource", 3, repeated=True
    )
...
class GoogleCloudAssetV1p4beta1IdentityList(_messages.Message):
  ...
  """
    ...
    groupEdges = _messages.MessageField(
        "GoogleCloudAssetV1p4beta1Edge", 1, repeated=True
    )
    identities = _messages.MessageField(
        "GoogleCloudAssetV1p4beta1Identity", 2, repeated=True
    )
...
class IamPolicyAnalysis(_messages.Message):
  ...
  """
    ...
    analysisQuery = _messages.MessageField("IamPolicyAnalysisQuery", 1)
    analysisResults = _messages.MessageField(
        "IamPolicyAnalysisResult", 2, repeated=True
    )
...
class IamPolicyAnalysisResult(_messages.Message):
  ...
  """
    ...
    accessControlLists = _messages.MessageField(
        "GoogleCloudAssetV1p4beta1AccessControlList", 1, repeated=True
    )
