...
from googlecloudsdk.third_party.apis.container.v1 import (
    container_v1_messages as messages,
)
...
class ContainerV1(base_api.BaseApiClient):
    ...
    class ProjectsAggregatedUsableSubnetworksService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ContainerV1.ProjectsAggregatedUsableSubnetworksService, self
            ).__init__(client)
    ...
    class ProjectsLocationsClustersNodePoolsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(ContainerV1.ProjectsLocationsClustersNodePoolsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsClustersWellKnownService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(ContainerV1.ProjectsLocationsClustersWellKnownService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsZonesClustersNodePoolsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(ContainerV1.ProjectsZonesClustersNodePoolsService, self).__init__(
                client
            )
            self._upload_configs = {}
