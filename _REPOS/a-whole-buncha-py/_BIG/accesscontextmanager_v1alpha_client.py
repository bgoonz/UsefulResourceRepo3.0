...
from googlecloudsdk.third_party.apis.accesscontextmanager.v1alpha import (
    accesscontextmanager_v1alpha_messages as messages,
)
...
class AccesscontextmanagerV1alpha(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.accessPolicies_servicePerimeters = self.AccessPoliciesServicePerimetersService(
            self
        )
        self.accessPolicies = self.AccessPoliciesService(self)
        self.operations = self.OperationsService(self)
        self.organizations_gcpUserAccessBindings = self.OrganizationsGcpUserAccessBindingsService(
            self
        )
    ...
    class AccessPoliciesAccessLevelsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                AccesscontextmanagerV1alpha.AccessPoliciesAccessLevelsService, self
            ).__init__(client)
    ...
    class AccessPoliciesServicePerimetersService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                AccesscontextmanagerV1alpha.AccessPoliciesServicePerimetersService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class AccessPoliciesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(AccesscontextmanagerV1alpha.AccessPoliciesService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class OrganizationsGcpUserAccessBindingsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                AccesscontextmanagerV1alpha.OrganizationsGcpUserAccessBindingsService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class OrganizationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(AccesscontextmanagerV1alpha.OrganizationsService, self).__init__(
                client
            )
            self._upload_configs = {}
