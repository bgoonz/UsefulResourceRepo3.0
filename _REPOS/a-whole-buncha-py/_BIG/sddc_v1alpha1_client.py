...
from googlecloudsdk.third_party.apis.sddc.v1alpha1 import (
    sddc_v1alpha1_messages as messages,
)
...
class SddcV1alpha1(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_locations_clusterGroupBackups = self.ProjectsLocationsClusterGroupBackupsService(
            self
        )
        self.projects_locations_clusterGroups_clusters = self.ProjectsLocationsClusterGroupsClustersService(
            self
        )
        self.projects_locations_clusterGroups_ipAddresses = self.ProjectsLocationsClusterGroupsIpAddressesService(
            self
        )
        self.projects_locations_clusterGroups = self.ProjectsLocationsClusterGroupsService(
            self
        )
    ...
    class ProjectsLocationsClusterGroupBackupsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                SddcV1alpha1.ProjectsLocationsClusterGroupBackupsService, self
            ).__init__(client)
    ...
    class ProjectsLocationsClusterGroupsClustersService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                SddcV1alpha1.ProjectsLocationsClusterGroupsClustersService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsClusterGroupsIpAddressesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                SddcV1alpha1.ProjectsLocationsClusterGroupsIpAddressesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsClusterGroupsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(SddcV1alpha1.ProjectsLocationsClusterGroupsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(SddcV1alpha1.ProjectsLocationsOperationsService, self).__init__(
                client
            )
            self._upload_configs = {}
