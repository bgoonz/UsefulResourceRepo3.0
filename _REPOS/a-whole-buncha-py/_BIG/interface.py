...
class CommandLineInterface(object):
    ...
    def reset(self, reset_current_buffer=False):
        ...
        self.search_state = SearchState(
            ignore_case=Condition(lambda: self.is_ignoring_case)
        )
    ...
    def run_application_generator(self, coroutine, render_cli_done=False):
        ...
        def step_next(send_value=None):
            ...
            try:
                ...
                self.run_sub_application(
                    result, done_callback=step_next, _from_application_generator=True
                )
    ...
    def run_system_command(self, command):
        ...
        def wait_for_enter():
            ...
            application = create_prompt_application(
                message="Press ENTER to continue...", key_bindings_registry=registry
            )
    ...
    def _create_async_completer(self, buffer):
        ...
        def async_completer(
            ...
            def run():
                completions = list(
                    buffer.completer.get_completions(document, complete_event)
                )
                ...
                def callback():
                    ...
                    if (
                        ...
                        and buffer.cursor_position == document.cursor_position
                        and not buffer.complete_state
                    ):
