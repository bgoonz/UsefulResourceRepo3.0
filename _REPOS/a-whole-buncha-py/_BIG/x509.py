...
class PersonalName(Set):
    _fields = [
        ...
        (
            "generation_qualifier",
            PrintableString,
            {"tag_type": "implicit", "tag": 3, "optional": True},
        ),
    ]
...
class BuiltInStandardAttributes(Sequence):
    _fields = [
        ...
        (
            ...
            NumericString,
            {"tag_type": "implicit", "tag": 4, "optional": True},
        ),
        (
            "personal_name",
            PersonalName,
            {"tag_type": "implicit", "tag": 5, "optional": True},
        ),
        (
            "organizational_unit_names",
            OrganizationalUnitNames,
            {"tag_type": "implicit", "tag": 6, "optional": True},
        ),
    ]
...
class CertificateAux(Sequence):
    _fields = [
        ...
        (
            "other",
            SequenceOfAlgorithmIdentifiers,
            {"tag_type": "implicit", "tag": 1, "optional": True},
        ),
    ]
