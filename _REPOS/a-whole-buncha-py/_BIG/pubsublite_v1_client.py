...
from googlecloudsdk.third_party.apis.pubsublite.v1 import (
    pubsublite_v1_messages as messages,
)
...
class PubsubliteV1(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.admin_projects_locations_operations = self.AdminProjectsLocationsOperationsService(
            self
        )
        self.admin_projects_locations_reservations_topics = self.AdminProjectsLocationsReservationsTopicsService(
            self
        )
        self.admin_projects_locations_reservations = self.AdminProjectsLocationsReservationsService(
            self
        )
        self.admin_projects_locations_subscriptions = self.AdminProjectsLocationsSubscriptionsService(
            self
        )
        self.admin_projects_locations_topics_subscriptions = self.AdminProjectsLocationsTopicsSubscriptionsService(
            self
        )
        self.admin_projects_locations_topics = self.AdminProjectsLocationsTopicsService(
            self
        )
        ...
        self.cursor_projects_locations_subscriptions_cursors = self.CursorProjectsLocationsSubscriptionsCursorsService(
            self
        )
        self.cursor_projects_locations_subscriptions = self.CursorProjectsLocationsSubscriptionsService(
            self
        )
        ...
        self.topicStats_projects_locations_topics = self.TopicStatsProjectsLocationsTopicsService(
            self
        )
        self.topicStats_projects_locations = self.TopicStatsProjectsLocationsService(
            self
        )
    ...
    class AdminProjectsLocationsOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(PubsubliteV1.AdminProjectsLocationsOperationsService, self).__init__(
                client
            )
    ...
    class AdminProjectsLocationsReservationsTopicsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                PubsubliteV1.AdminProjectsLocationsReservationsTopicsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class AdminProjectsLocationsReservationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                PubsubliteV1.AdminProjectsLocationsReservationsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class AdminProjectsLocationsSubscriptionsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                PubsubliteV1.AdminProjectsLocationsSubscriptionsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class AdminProjectsLocationsTopicsSubscriptionsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                PubsubliteV1.AdminProjectsLocationsTopicsSubscriptionsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class AdminProjectsLocationsTopicsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(PubsubliteV1.AdminProjectsLocationsTopicsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class CursorProjectsLocationsSubscriptionsCursorsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                PubsubliteV1.CursorProjectsLocationsSubscriptionsCursorsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class CursorProjectsLocationsSubscriptionsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                PubsubliteV1.CursorProjectsLocationsSubscriptionsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class TopicStatsProjectsLocationsTopicsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(PubsubliteV1.TopicStatsProjectsLocationsTopicsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class TopicStatsProjectsLocationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(PubsubliteV1.TopicStatsProjectsLocationsService, self).__init__(
                client
            )
            self._upload_configs = {}
