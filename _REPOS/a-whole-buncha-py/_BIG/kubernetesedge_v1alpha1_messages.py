...
class KubernetesedgeProjectsLocationsClustersTestIamPermissionsRequest(
    _messages.Message
):
...
class KubernetesedgeProjectsLocationsMachinesTestIamPermissionsRequest(
    _messages.Message
):
...
class KubernetesedgeProjectsLocationsNodePoolsTestIamPermissionsRequest(
    _messages.Message
):
