...
class GoogleCloudRecommenderV1Impact(_messages.Message):
  ...
  """
    ...
    securityProjection = _messages.MessageField(
        "GoogleCloudRecommenderV1SecurityProjection", 3
    )
...
class GoogleCloudRecommenderV1Insight(_messages.Message):
  ...
  """
    ...
    associatedRecommendations = _messages.MessageField(
        "GoogleCloudRecommenderV1InsightRecommendationReference", 1, repeated=True
    )
...
class GoogleCloudRecommenderV1ListInsightsResponse(_messages.Message):
  ...
  """
    ...
    insights = _messages.MessageField(
        "GoogleCloudRecommenderV1Insight", 1, repeated=True
    )
...
class GoogleCloudRecommenderV1ListRecommendationsResponse(_messages.Message):
  ...
  """
    ...
    recommendations = _messages.MessageField(
        "GoogleCloudRecommenderV1Recommendation", 2, repeated=True
    )
...
class GoogleCloudRecommenderV1OperationGroup(_messages.Message):
  ...
  """
    ...
    operations = _messages.MessageField(
        "GoogleCloudRecommenderV1Operation", 1, repeated=True
    )
...
class GoogleCloudRecommenderV1Recommendation(_messages.Message):
  ...
  """
    ...
    additionalImpact = _messages.MessageField(
        "GoogleCloudRecommenderV1Impact", 1, repeated=True
    )
    associatedInsights = _messages.MessageField(
        "GoogleCloudRecommenderV1RecommendationInsightReference", 2, repeated=True
    )
    ...
    stateInfo = _messages.MessageField(
        "GoogleCloudRecommenderV1RecommendationStateInfo", 11
    )
...
class GoogleCloudRecommenderV1RecommendationContent(_messages.Message):
  ...
  """
    ...
    operationGroups = _messages.MessageField(
        "GoogleCloudRecommenderV1OperationGroup", 1, repeated=True
    )
...
class RecommenderBillingAccountsLocationsInsightTypesInsightsMarkAcceptedRequest(
  ...
  """
    ...
    googleCloudRecommenderV1MarkInsightAcceptedRequest = _messages.MessageField(
        "GoogleCloudRecommenderV1MarkInsightAcceptedRequest", 1
    )
...
class RecommenderBillingAccountsLocationsRecommendersRecommendationsMarkClaimedRequest(
  ...
  """
    ...
    googleCloudRecommenderV1MarkRecommendationClaimedRequest = _messages.MessageField(
        "GoogleCloudRecommenderV1MarkRecommendationClaimedRequest", 1
    )
    name = _messages.StringField(2, required=True)
...
class RecommenderBillingAccountsLocationsRecommendersRecommendationsMarkFailedRequest(
  ...
  """
    ...
    googleCloudRecommenderV1MarkRecommendationFailedRequest = _messages.MessageField(
        "GoogleCloudRecommenderV1MarkRecommendationFailedRequest", 1
    )
    name = _messages.StringField(2, required=True)
...
class RecommenderBillingAccountsLocationsRecommendersRecommendationsMarkSucceededRequest(
  ...
  """
    ...
    googleCloudRecommenderV1MarkRecommendationSucceededRequest = _messages.MessageField(
        "GoogleCloudRecommenderV1MarkRecommendationSucceededRequest", 1
    )
    name = _messages.StringField(2, required=True)
