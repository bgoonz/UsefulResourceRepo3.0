...
class MetadataLabelMatcher(_messages.Message):
  ...
  """
    ...
    metadataLabelMatchCriteria = _messages.EnumField(
        "MetadataLabelMatchCriteriaValueValuesEnum", 1
    )
...
class NetworkservicesProjectsLocationsEndpointPoliciesGetIamPolicyRequest(
    _messages.Message
):
...
class NetworkservicesProjectsLocationsEndpointPoliciesSetIamPolicyRequest(
    _messages.Message
):
...
class NetworkservicesProjectsLocationsEndpointPoliciesTestIamPermissionsRequest(
    _messages.Message
):
    r"""A
