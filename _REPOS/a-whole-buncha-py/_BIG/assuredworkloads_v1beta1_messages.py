...
class AssuredworkloadsOrganizationsLocationsWorkloadsCreateRequest(_messages.Message):
  ...
  """
    ...
    googleCloudAssuredworkloadsV1beta1Workload = _messages.MessageField(
        "GoogleCloudAssuredworkloadsV1beta1Workload", 2
    )
...
class AssuredworkloadsOrganizationsLocationsWorkloadsPatchRequest(_messages.Message):
  ...
  """
    ...
    googleCloudAssuredworkloadsV1beta1Workload = _messages.MessageField(
        "GoogleCloudAssuredworkloadsV1beta1Workload", 1
    )
    name = _messages.StringField(2, required=True)
    updateMask = _messages.StringField(3)


class AssuredworkloadsOrganizationsLocationsWorkloadsRestrictAllowedServicesRequest(
    _messages.Message
):
  ...
  """
    ...
    googleCloudAssuredworkloadsV1beta1RestrictAllowedServicesRequest = _messages.MessageField(
        "GoogleCloudAssuredworkloadsV1beta1RestrictAllowedServicesRequest", 1
    )
    name = _messages.StringField(2, required=True)
...
class GoogleCloudAssuredworkloadsV1Workload(_messages.Message):
  ...
  """
    ...
    kmsSettings = _messages.MessageField(
        "GoogleCloudAssuredworkloadsV1WorkloadKMSSettings", 6
    )
    labels = _messages.MessageField("LabelsValue", 7)
    name = _messages.StringField(8)
    provisionedResourcesParent = _messages.StringField(9)
    resourceSettings = _messages.MessageField(
        "GoogleCloudAssuredworkloadsV1WorkloadResourceSettings", 10, repeated=True
    )
    resources = _messages.MessageField(
        "GoogleCloudAssuredworkloadsV1WorkloadResourceInfo", 11, repeated=True
    )
...
class GoogleCloudAssuredworkloadsV1beta1CreateWorkloadOperationMetadata(
  ...
  """
    ...
    parent = _messages.StringField(4)
    resourceSettings = _messages.MessageField(
        "GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettings", 5, repeated=True
    )
...
class GoogleCloudAssuredworkloadsV1beta1ListWorkloadsResponse(_messages.Message):
  ...
  """
    ...
    workloads = _messages.MessageField(
        "GoogleCloudAssuredworkloadsV1beta1Workload", 2, repeated=True
    )


class GoogleCloudAssuredworkloadsV1beta1RestrictAllowedServicesRequest(
    _messages.Message
):
...
class GoogleCloudAssuredworkloadsV1beta1RestrictAllowedServicesResponse(
    _messages.Message
):
...
class GoogleCloudAssuredworkloadsV1beta1Workload(_messages.Message):
  ...
  """
    ...
    billingAccount = _messages.StringField(1)
    cjisSettings = _messages.MessageField(
        "GoogleCloudAssuredworkloadsV1beta1WorkloadCJISSettings", 2
    )
    complianceRegime = _messages.EnumField("ComplianceRegimeValueValuesEnum", 3)
    createTime = _messages.StringField(4)
    displayName = _messages.StringField(5)
    etag = _messages.StringField(6)
    fedrampHighSettings = _messages.MessageField(
        "GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampHighSettings", 7
    )
    fedrampModerateSettings = _messages.MessageField(
        "GoogleCloudAssuredworkloadsV1beta1WorkloadFedrampModerateSettings", 8
    )
    il4Settings = _messages.MessageField(
        "GoogleCloudAssuredworkloadsV1beta1WorkloadIL4Settings", 9
    )
    kmsSettings = _messages.MessageField(
        "GoogleCloudAssuredworkloadsV1beta1WorkloadKMSSettings", 10
    )
    labels = _messages.MessageField("LabelsValue", 11)
    name = _messages.StringField(12)
    provisionedResourcesParent = _messages.StringField(13)
    resourceSettings = _messages.MessageField(
        "GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettings", 14, repeated=True
    )
    resources = _messages.MessageField(
        "GoogleCloudAssuredworkloadsV1beta1WorkloadResourceInfo", 15, repeated=True
    )
...
class GoogleCloudAssuredworkloadsV1beta1WorkloadCJISSettings(_messages.Message):
  ...
  """
    ...
    kmsSettings = _messages.MessageField(
        "GoogleCloudAssuredworkloadsV1beta1WorkloadKMSSettings", 1
    )
