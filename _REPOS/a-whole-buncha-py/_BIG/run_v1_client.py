...
class RunV1(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.namespaces_authorizeddomains = self.NamespacesAuthorizeddomainsService(
            self
        )
        ...
        self.projects_locations_authorizeddomains = self.ProjectsLocationsAuthorizeddomainsService(
            self
        )
        self.projects_locations_configurations = self.ProjectsLocationsConfigurationsService(
            self
        )
        self.projects_locations_domainmappings = self.ProjectsLocationsDomainmappingsService(
            self
        )
    ...
    class ProjectsLocationsAuthorizeddomainsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(RunV1.ProjectsLocationsAuthorizeddomainsService, self).__init__(
                client
            )
            self._upload_configs = {}
