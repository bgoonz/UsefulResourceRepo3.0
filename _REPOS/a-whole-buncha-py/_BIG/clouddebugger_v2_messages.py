...
class ClouddebuggerControllerDebuggeesBreakpointsUpdateRequest(_messages.Message):
  ...
  """
    ...
    updateActiveBreakpointRequest = _messages.MessageField(
        "UpdateActiveBreakpointRequest", 3
    )
...
class Debuggee(_messages.Message):
  ...
  """
    ...
    extSourceContexts = _messages.MessageField(
        "ExtendedSourceContext", 4, repeated=True
    )
