...
class SourceV1(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_repos_revisions_files = self.ProjectsReposRevisionsFilesService(
            self
        )
        self.projects_repos_revisions = self.ProjectsReposRevisionsService(self)
        self.projects_repos_workspaces_files = self.ProjectsReposWorkspacesFilesService(
            self
        )
        self.projects_repos_workspaces_snapshots_files = self.ProjectsReposWorkspacesSnapshotsFilesService(
            self
        )
        self.projects_repos_workspaces_snapshots = self.ProjectsReposWorkspacesSnapshotsService(
            self
        )
      ...
      """
        ...
        Get.method_config = lambda: base_api.ApiMethodInfo(
            ...
            query_params=[
                ...
                "sourceContext_cloudRepo_repoId_uid",
                "sourceContext_cloudRepo_revisionId",
                ...
                "sourceContext_gerrit_aliasName",
      ...
      """
        ...
        Get.method_config = lambda: base_api.ApiMethodInfo(
            ...
            query_params=[
                ...
                "sourceContext_cloudRepo_aliasContext_name",
                "sourceContext_cloudRepo_aliasName",
                "sourceContext_cloudRepo_repoId_uid",
                "sourceContext_cloudWorkspace_snapshotId",
                "sourceContext_cloudWorkspace_workspaceId_name",
...
file or directory information about that path.
      ...
      """
        ...
        Get.method_config = lambda: base_api.ApiMethodInfo(
            ...
            query_params=[
                ...
                "sourceContext_cloudRepo_repoId_projectRepoId_repoName",
                "sourceContext_cloudRepo_repoId_uid",
                "sourceContext_cloudRepo_revisionId",
                "sourceContext_cloudWorkspace_snapshotId",
                "sourceContext_cloudWorkspace_workspaceId_repoId_uid",
    ...
    class ProjectsReposWorkspacesSnapshotsFilesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(SourceV1.ProjectsReposWorkspacesSnapshotsFilesService, self).__init__(
                client
            )
            self._upload_configs = {}
...
file or directory information about that path.
    ...
    class ProjectsReposWorkspacesSnapshotsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(SourceV1.ProjectsReposWorkspacesSnapshotsService, self).__init__(
                client
            )
            self._upload_configs = {}
