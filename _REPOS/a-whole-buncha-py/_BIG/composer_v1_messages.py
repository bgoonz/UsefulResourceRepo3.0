...
class CheckUpgradeResponse(_messages.Message):
  ...
  """
    ...
    containsPypiModulesConflict = _messages.EnumField(
        "ContainsPypiModulesConflictValueValuesEnum", 2
    )
  ...
  Fields:
    ...
    updateMask: Required. A comma-separated list of paths, relative to
      ...
      * Replace all custom custom PyPI packages. If a replacement package map
      ...
      `DatabaseConfig`. * `config.webServerConfig` * Replace the environment's
...
class EnvironmentConfig(_messages.Message):
  ...
  """
    ...
    webServerNetworkAccessControl = _messages.MessageField(
        "WebServerNetworkAccessControl", 11
    )
