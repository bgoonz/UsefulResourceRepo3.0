...
from googlecloudsdk.third_party.apis.apigateway.v1beta import (
    apigateway_v1beta_messages as messages,
)
...
class ApigatewayV1beta(base_api.BaseApiClient):
    ...
    class ProjectsLocationsApisConfigsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(ApigatewayV1beta.ProjectsLocationsApisConfigsService, self).__init__(
                client
            )
    ...
    class ProjectsLocationsGatewaysService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(ApigatewayV1beta.ProjectsLocationsGatewaysService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(ApigatewayV1beta.ProjectsLocationsOperationsService, self).__init__(
                client
            )
            self._upload_configs = {}
