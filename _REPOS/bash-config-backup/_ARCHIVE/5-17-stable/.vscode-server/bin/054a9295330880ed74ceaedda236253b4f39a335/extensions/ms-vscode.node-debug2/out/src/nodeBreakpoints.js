...
class NodeBreakpoints extends vscode_chrome_debug_core_1.Breakpoints {
  ...
  addBreakpoints(url, breakpoints, scripts) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      const responses = yield _super.addBreakpoints.call(
        this,
        url,
        breakpoints,
        scripts
      ...
      if (
        ...
        const bpAtEntryLocationIdx = responses.findIndex((response) => {
          ...
          return (
            ...
            response.actualLocation.lineNumber === entryLocation.lineNumber &&
        ...
        if (bpAtEntryLocation) {
          ...
          if (bpAtEntryLocation.condition) {
            const evalConditionResponse =
              yield this.nodeDebugAdapter.evaluateOnCallFrame(
  ...
  validateBreakpointsPath(args) {
    return super.validateBreakpointsPath(args).catch((e) => {
      if (
        ...
        args.source.path &&
        this.nodeDebugAdapter.jsDeterminant.isJavaScript(args.source.path)
      ) {
        return undefined;
      } else {
