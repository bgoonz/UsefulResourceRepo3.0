  ...
  (function (e) {
    ...
    function (e, t, i) {
      ...
      function y(e, t) {
        var i,
          r,
          s,
          n = c.join(o.cacheRoot, e.id + "-" + e.hash + ".json"),
          a = !1,
          l = !1;
        try {
          return (
            (i = JSON.parse(
              u.readFileSync(n, { encoding: "utf8", flag: "r" })
            )),
            (r = n),
            (s = new Date()),
            u.utimes(r, s, s, function () {}),
            i
          );
        } catch (e) {
        ...
        if (
          !(i = (function (e, t) {
            var i = o.translationsConfig[e.id];
            if (i) {
              var r = g(i).contents,
                s = g(c.join(t, "nls.metadata.json")),
                n = Object.create(null);
              for (var a in s) {
                var u = s[a],
                  l = r[e.outDir + "/" + a];
                if (l) {
                  for (var d = [], h = 0; h < u.keys.length; h++) {
                    var p = u.keys[h],
                      f = l[v(p) ? p : p.key];
                    void 0 === f && (f = u.messages[h]), d.push(f);
                  }
                  n[a] = d;
                } else n[a] = u.messages;
              }
        ...
        if (l)
          try {
            u.writeFileSync(n, JSON.stringify(i), {
              encoding: "utf8",
              flag: "wx",
            });
          } catch (e) {
      ...
      function S(e) {
        try {
          return (function (e) {
            var t = g(c.join(e, "nls.metadata.json")),
      ...
      function b(e, t) {
        ...
        if (!i) {
          if (o.languagePackSupport) return S(t);
          var r = (function (e) {
            for (var t = o.locale; t; ) {
              var i = c.join(e, "nls.bundle." + t + ".json");
              if (u.existsSync(i)) return i;
              var r = t.lastIndexOf("-");
              t = r > 0 ? t.substring(0, r) : void 0;
            }
            if (void 0 === t) {
              i = c.join(e, "nls.bundle.json");
              if (u.existsSync(i)) return i;
            }
          })(t);
          if (r)
      ...
      function _(e) {
        ...
        if (
          ...
          o.messageFormat === r.both || o.messageFormat === r.bundle)
        ) {
          var i = (function (e) {
            for (
              var t, i = c.dirname(e);
              (t = c.join(i, "nls.metadata.header.json")), !u.existsSync(t);
          ...
          if (i) {
            ...
            if (void 0 === l)
              try {
                var h = JSON.parse(u.readFileSync(i, "utf8"));
                try {
                  var v = b(h, s);
                  l = w(s, v ? { header: h, nlsBundle: v } : null);
                } catch (e) {
        ...
        if (o.messageFormat === r.both || o.messageFormat === r.file)
          try {
            var S = g(
              (function (e) {
                var t;
                if (o.cacheLanguageResolution && t) t = t;
                  ...
                  if (a || !o.locale) t = ".nls.json";
                  else
                    for (var i = o.locale; i; ) {
                      var r = ".nls." + i + ".json";
                      if (u.existsSync(e + r)) {
                        t = r;
                        break;
      ...
      !(function (e) {
        ...
        (function () {
          if (
            ...
            v(process.env.VSCODE_NLS_CONFIG))
          )
            try {
              var e = JSON.parse(process.env.VSCODE_NLS_CONFIG);
              if (
                (v(e.locale) && (o.locale = e.locale.toLowerCase()),
                (!0 === (t = e._languagePackSupport) || !1 === t) &&
                  (o.languagePackSupport = e._languagePackSupport),
                v(e._cacheRoot) && (o.cacheRoot = e._cacheRoot),
                v(e._languagePackId) && (o.languagePackId = e._languagePackId),
                v(e._translationsConfigFile))
              ) {
                o.translationsConfigFile = e._translationsConfigFile;
                try {
                  o.translationsConfig = g(o.translationsConfigFile);
                } catch (t) {
                  e._corruptedFile &&
                    u.writeFile(
                      e._corruptedFile,
          ...
          var t;
          (a = "pseudo" === o.locale), void 0, (n = Object.create(null));
        })(),
    ...
    function (e, t, i) {
      ...
      class n extends s.Disposable {
        constructor(e) {
          super(),
            (this.entry = this._register(r.window.createStatusBarItem(e)));
        }
        showItem(e, t) {
    ...
    function (e, t, i) {
      ...
      t.activate = function (e) {
        const t = new o.SizeStatusBarEntry();
        e.subscriptions.push(t);
        const i = new s.BinarySizeStatusBarEntry();
        e.subscriptions.push(i);
        const c = new a.ZoomStatusBarEntry();
        e.subscriptions.push(c);
        const u = new n.PreviewManager(e.extensionUri, t, i, c);
        e.subscriptions.push(
          r.window.registerCustomEditorProvider(n.PreviewManager.viewType, u, {
            supportsMultipleEditorsPerDocument: !0,
          })
        ),
          e.subscriptions.push(
            r.commands.registerCommand("imagePreview.zoomIn", () => {
              var e;
              null === (e = u.activePreview) || void 0 === e || e.zoomIn();
            })
          ),
          e.subscriptions.push(
            r.commands.registerCommand("imagePreview.zoomOut", () => {
              var e;
              null === (e = u.activePreview) || void 0 === e || e.zoomOut();
            })
          );
      };
    },
    function (e, t, i) {
      ...
      const r = i(0),
        s = i(2),
        n = i(3),
        o = s.loadMessageBundle(
          i(1).join(__dirname, "binarySizeStatusBarEntry.ts")
        );
      class a {
        static formatSize(e) {
          return e < a.KB
            ? o(0, null, e)
            : e < a.MB
            ? o(1, null, (e / a.KB).toFixed(2))
            : e < a.GB
            ? o(2, null, (e / a.MB).toFixed(2))
            : e < a.TB
            ? o(3, null, (e / a.GB).toFixed(2))
            : o(4, null, (e / a.TB).toFixed(2));
        }
      }
      (a.KB = 1024),
        (a.MB = a.KB * a.KB),
        (a.GB = a.MB * a.KB),
        (a.TB = a.GB * a.KB);
      class c extends n.PreviewStatusBarEntry {
        constructor() {
          super({
        ...
        show(e, t) {
          "number" == typeof t
            ? super.showItem(e, a.formatSize(t))
            : this.hide(e);
        }
      }
      t.BinarySizeStatusBarEntry = c;
    },
    function (e, t) {
    ...
    function (e, t, i) {
      ...
      const r = i(0),
        s = i(2),
        n = i(4),
        o = s.loadMessageBundle(i(1).join(__dirname, "preview.ts"));
      class a {
        constructor(e, t, i, r) {
          (this.extensionRoot = e),
            (this.sizeStatusBarEntry = t),
            (this.binarySizeStatusBarEntry = i),
            (this.zoomStatusBarEntry = r),
        ...
        setPreviewActiveContext(e) {
          r.commands.executeCommand("setContext", "imagePreviewFocus", e);
        }
      }
      (t.PreviewManager = a), (a.viewType = "imagePreview.previewEditor");
      class c extends n.Disposable {
        constructor(e, t, i, s, n, o) {
          super(),
            ...
            (this.sizeStatusBarEntry = s),
            (this.binarySizeStatusBarEntry = n),
            (this.zoomStatusBarEntry = o),
          ...
          const a = t.with({ path: t.path.replace(/\/[^\/]+?\.\w+$/, "/") });
          (i.webview.options = {
            enableScripts: !0,
            localResourceRoots: [a, e],
          }),
            this._register(
          ...
          const c = this._register(
            r.workspace.createFileSystemWatcher(t.fsPath)
          );
          this._register(
            c.onDidChange((e) => {
            ...
            r.workspace.fs.stat(t).then(({ size: e }) => {
        ...
        async getWebviewContents() {
          const e = Date.now().toString(),
            ...
            i = Date.now().toString(),
            r = this.webviewEditor.webview.cspSource;
          return `<!DOCTYPE html>\n<html lang="en">\n<head>\n\t<meta charset="UTF-8">\n\t\x3c!-- Disable pinch zooming --\x3e\n\t<meta name="viewport"\n\t\tcontent="width=device-width, initial-scale=1.0, maximum-scale=1.0, minimum-scale=1.0, user-scalable=no">\n\t<title>Image Preview</title>\n\t<link rel="stylesheet" href="${u(
            this.extensionResource("/media/main.css")
          )}" type="text/css" media="screen" nonce="${i}">\n\t<meta http-equiv="Content-Security-Policy" content="default-src 'none'; img-src data: ${r}; script-src 'nonce-${i}'; style-src ${r} 'nonce-${i}';">\n\t<meta id="image-preview-settings" data-settings="${u(
            JSON.stringify(t)
          )}">\n</head>\n<body class="container image scale-to-fit loading">\n\t<div class="loading-indicator"></div>\n\t<div class="image-load-error">\n\t\t<p>${o(
            0,
            null
          )}</p>\n\t\t<a href="#" class="open-file-link">${o(
            1,
            null
          )}</a>\n\t</div>\n\t<script src="${u(
        ...
        async getResourcePath(e, t, i) {
          if ("git" === t.scheme) {
            if (0 === (await r.workspace.fs.stat(t)).size)
    ...
    function (e, t, i) {
      ...
      const r = i(0),
        s = i(2),
        n = i(3),
        o = s.loadMessageBundle(i(1).join(__dirname, "sizeStatusBarEntry.ts"));
      class a extends n.PreviewStatusBarEntry {
        constructor() {
          super({
    ...
    function (e, t, i) {
      ...
      const r = i(0),
        s = i(2),
        n = i(3),
        o = s.loadMessageBundle(i(1).join(__dirname, "zoomStatusBarEntry.ts"));
      class a extends n.PreviewStatusBarEntry {
        constructor() {
          super({
            ...
            (this._onDidChangeScale = this._register(new r.EventEmitter())),
            (this.onDidChangeScale = this._onDidChangeScale.event),
            this._register(
              r.commands.registerCommand(
                "_imagePreview.selectZoomLevel",
                async () => {
                  const e = [10, 5, 2, 1, 0.5, 0.2, "fit"].map((e) => ({
                      label: this.zoomLabel(e),
                      scale: e,
                    })),
                    t = await r.window.showQuickPick(e, {
                      placeHolder: o(1, null),
                    });
                  t && this._onDidChangeScale.fire({ scale: t.scale });
                }
              )
            ),
            (this.entry.command = "_imagePreview.selectZoomLevel");
        }
        show(e, t) {
          this.showItem(e, this.zoomLabel(t));
        }
        zoomLabel(e) {
          return "fit" === e ? o(2, null) : Math.round(100 * e) + "%";
        }
      }
      t.ZoomStatusBarEntry = a;
    },
  ])
);
//# sourceMappingURL=https://ticino.blob.core.windows.net/sourcemaps/054a9295330880ed74ceaedda236253b4f39a335/extensions/image-preview/dist/extension.js.map
