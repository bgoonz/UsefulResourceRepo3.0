  ...
  (function (e) {
    ...
    function (e, t, n) {
      ...
      global.diagnosticsSource ||
        ...
        (n(37).prototype.require = r.makePatchingRequire(
        ...
        l = (function () {
          ...
          return (
            ...
            (e.makeRequest = function (t, n, a, u) {
              ...
              var h = "https:" === l.protocol && !d;
              return (
                h && void 0 !== t.httpsAgent
                  ? (p.agent = t.httpsAgent)
                  : h || void 0 === t.httpAgent
                  ? h && (p.agent = e.tlsRestrictedAgent)
                  : (p.agent = t.httpAgent),
                h ? i.request(p, u) : o.request(p, u)
              );
            }),
    ...
    function (e, t, n) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        })((o = t.PerformanceCounter || (t.PerformanceCounter = {}))),
        (t.PerformanceToQuickPulseCounter =
          (((i = {})[o.PROCESSOR_TIME] = r.PROCESSOR_TIME),
          (i[o.REQUEST_RATE] = r.REQUEST_RATE),
          (i[o.REQUEST_DURATION] = r.REQUEST_DURATION),
    ...
    function (e, t, n) {
      ...
      const i = new (class {
        constructor() {
          this.output = r.window.createOutputChannel("GitHub Authentication");
        }
        data2String(e) {
          return e instanceof Error
            ? e.stack || e.message
          ...
          return (
            (e.prototype.enable = function (e) {
              (this._isEnabled = e),
                ...
                d.IsInitialized &&
                  (n(128).enable(e, this._client),
                  n(129).enable(e, this._client),
                  n(130).enable(e, this._client),
                  n(131).enable(e, this._client));
            }),
            ...
            (e.trackRequest = function (t, n) {
              if (n.options && n.request && t) {
                var r,
                  ...
                  f = u.CorrelationContextManager.getCurrentContext();
                if (
                  f &&
                  f.operation &&
                  f.operation.traceparent &&
                  p.isValidTraceId(f.operation.traceparent.traceId)
                )
                  f.operation.traceparent.updateSpanId(),
                    (r = f.operation.traceparent.getBackCompatRequestId());
                  ...
                  r =
                    f &&
                    f.operation &&
                    f.operation.parentId + e.requestNumber++ + ".";
                if (
                  s.canIncludeCorrelationHeader(t, d.getUrl()) &&
                  n.request.getHeader &&
                  n.request.setHeader &&
                  t.config &&
                  t.config.correlationId
                ) {
                  var h = n.request.getHeader(a.requestContextHeader);
                  try {
                    s.safeIncludeCorrelationHeader(t, n.request, h);
                  } catch (e) {
                    i.warn(
                  ...
                  if (f && f.operation)
                    try {
                      if (
                        ...
                        n.request.setHeader(a.parentIdHeader, f.operation.id),
                        n.request.setHeader(a.rootIdHeader, r),
                        o || f.operation.traceparent)
                      )
                        n.request.setHeader(
                          a.traceparentHeader,
                          o || f.operation.traceparent.toString()
                        );
                      else if (l.w3cEnabled) {
                        var m = new p().toString();
                        n.request.setHeader(a.traceparentHeader, m);
                      }
                      if (f.operation.tracestate) {
                        var y = f.operation.tracestate.toString();
                        y && n.request.setHeader(a.traceStateHeader, y);
                      }
                      var v = f.customProperties.serializeToHeader();
                ...
                n.request.on &&
                  (n.request.on("response", function (e) {
                    d.onResponse(e);
                    var o = d.getDependencyTelemetry(n, r);
    ...
    function (e, t, n) {
      ...
      if (t.IsInitialized) {
        ...
        for (var c in a)
          -1 === s.indexOf(c) &&
            (a[c].enable(), r.info(o, "Subscribed to " + c + " events"));
      ...
      t.registerContextPreservation = function (e) {
        t.IsInitialized && n(0).channel.addContextPreservation(e);
      };
    },
    function (e, t) {
      var n;
      ...
      i[O] = "(?:~>?)";
      var A = s++;
      (i[A] = "(\\s*)" + i[O] + "\\s+"), (o[A] = new RegExp(i[A], "g"));
      var R = s++;
      i[R] = "^" + i[O] + i[x] + "$";
      var D = s++;
      i[D] = "^" + i[O] + i[I] + "$";
      ...
      i[N] = "(?:\\^)";
      var M = s++;
      (i[M] = "(\\s*)" + i[N] + "\\s+"), (o[M] = new RegExp(i[M], "g"));
      var j = s++;
      i[j] = "^" + i[N] + i[x] + "$";
      var L = s++;
      i[L] = "^" + i[N] + i[I] + "$";
      ...
      i[$] = "(<|>)?=?\\s*\\*";
      for (var V = 0; V < 35; V++)
        n(V, i[V]), o[V] || (o[V] = new RegExp(i[V]));
      function z(e, t) {
        if (
          ((t && "object" == typeof t) ||
        ...
        if (!(t.loose ? o[E] : o[g]).test(e)) return null;
        try {
          return new G(e, t);
        } catch (e) {
          return null;
      ...
      function G(e, t) {
        ...
        var i = e.trim().match(t.loose ? o[E] : o[g]);
      ...
      (t.parse = z),
        ...
        (G.prototype.compareMain = function (e) {
          return (
            e instanceof G || (e = new G(e, this.options)),
            Q(this.major, e.major) ||
              Q(this.minor, e.minor) ||
              Q(this.patch, e.patch)
          );
        }),
      ...
      function ae(e, t, n, r, o, i, s, a, c, u, l, p, d) {
        return (
          (t = se(n)
            ? ""
            : se(r)
      ...
      function le(e, t, n, r) {
        var o, i, s, a, c;
        switch (((e = new G(e, r)), (t = new ie(t, r)), n)) {
          case ">":
            (o = Y), (i = te), (s = W), (a = ">"), (c = ">=");
            break;
          case "<":
      ...
      (re.prototype.parse = function (e) {
        var t = this.options.loose ? o[q] : o[F],
          n = e.match(t);
        if (!n) throw new TypeError("Invalid comparator: " + e);
        (this.operator = n[1]),
          "=" === this.operator && (this.operator = ""),
          n[2]
            ? (this.semver = new G(n[2], this.options.loose))
            : (this.semver = oe);
      }),
        ...
        (ie.prototype.parseRange = function (e) {
          ...
          (e = e.replace(r, ae)),
            n("hyphen replace", e),
            (e = e.replace(o[H], "$1$2$3")),
            n("comparator trim", e, o[H]),
            (e = (e = (e = e.replace(o[A], "$1~")).replace(o[M], "$1^"))
              .split(/\s+/)
              .join(" "));
          var i = t ? o[q] : o[F],
            s = e
              ...
              .map(function (e) {
                return (function (e, t) {
                  return (
                    ...
                    (e = (function (e, t) {
                      return (
                        n("replaceStars", e, t), e.trim().replace(o[$], "")
                      );
                    })(e, t)),
                    n("stars", e),
                    e
            ...
            o(e, "emit", function (e) {
              return function (t) {
                ...
                try {
                  ...
                  i(this, "removeListener"), (this._events[t] = r);
                }
              };
            }),
    ...
    function (e, t, n) {
      ...
      function s(e) {
        e &&
          ...
          (r(e.logger)
            ? (o = e.logger)
            : o("new logger isn't a function, not replacing"));
      }
      function a(e, t, n) {
        if (e && e[t]) {
          if (!n) return o("no wrapper function"), void o(new Error().stack);
          if (r(e[t]) && r(n)) {
            var s = e[t],
              a = n(s, t);
            return (
              i(a, "__original", s),
              i(a, "__unwrap", function () {
                e[t] === a && i(e, t, s);
              }),
              i(a, "__wrapped", !0),
              i(e, t, a),
        ...
        } else o("no original function " + t + " to wrap");
      }
      function c(e, t) {
        return e && e[t]
          ? e[t].__unwrap
          ...
          : (o("no function to unwrap."), void o(new Error().stack));
      }
      (s.wrap = a),
        (s.massWrap = function (e, t, n) {
          if (!e)
            return (
              o("must provide one or more modules to patch"),
              void o(new Error().stack)
            );
          Array.isArray(e) || (e = [e]),
            t && Array.isArray(t)
              ? e.forEach(function (e) {
            ...
            (e.prototype._trackCpu = function () {
              ...
              if (
                ...
                if ("function" == typeof process.cpuUsage) {
                  var h = process.cpuUsage(),
                    m = process.hrtime(),
                    y =
                      h.user -
                        this._lastAppCpuUsage.user +
                        (h.system - this._lastAppCpuUsage.system) || 0;
                  if (
                    ...
                    f =
                      ...
                      ((1e6 * (m[0] - this._lastHrtime[0]) +
                        ...
                        e.length);
                  (this._lastAppCpuUsage = h), (this._lastHrtime = m);
                }
                var v = t + n + i + s + a || 1;
    ...
    function (e, t, n) {
      ...
      function b(e, t) {
        var n,
          r,
          o,
          i = u.join(a.cacheRoot, e.id + "-" + e.hash + ".json"),
          s = !1,
          c = !1;
        try {
          return (
            (n = JSON.parse(
              l.readFileSync(i, { encoding: "utf8", flag: "r" })
            )),
            (r = i),
            (o = new Date()),
            l.utimes(r, o, o, function () {}),
            n
          );
        } catch (e) {
        ...
        if (
          !(n = (function (e, t) {
            ...
            if (n) {
              var r = m(n).contents,
                o = m(u.join(t, "nls.metadata.json")),
              ...
              for (var s in o) {
                ...
                if (l) {
                  for (var p = [], d = 0; d < c.keys.length; d++) {
                    var f = c.keys[d],
                      y = l[h(f) ? f : f.key];
                    void 0 === y && (y = c.messages[d]), p.push(y);
                  }
                  i[s] = p;
                } else i[s] = c.messages;
              }
        ...
        if (c)
          try {
            l.writeFileSync(i, JSON.stringify(n), {
              encoding: "utf8",
              flag: "wx",
            });
          } catch (e) {
      ...
      function E(e) {
        try {
          return (function (e) {
            var t = m(u.join(e, "nls.metadata.json")),
          ...
          if (n) {
            ...
            if (void 0 === i)
              try {
                ...
                try {
                  var f = C(p, o);
                  i = _(o, f ? { header: p, nlsBundle: f } : null);
                } catch (e) {
      ...
      !(function (e) {
        ...
        })((o = t.BundleFormat || (t.BundleFormat = {}))),
        (function (e) {
          e.is = function (e) {
            var t = e;
        ...
        (function () {
          if (
            ...
            try {
              ...
              if (
                (h(e.locale) && (a.locale = e.locale.toLowerCase()),
                void 0 === t
                  ? (a.language = a.locale)
                  : "en" !== t && (a.language = t),
                (function (e) {
                ...
                h(e._cacheRoot) && (a.cacheRoot = e._cacheRoot),
                h(e._languagePackId) && (a.languagePackId = e._languagePackId),
                ...
                try {
                  ...
                  if (e._corruptedFile) {
                    var o = u.dirname(e._corruptedFile);
                    l.exists(o, function (t) {
                      t &&
                        l.writeFile(
                          e._corruptedFile,
                          "corrupted",
    ...
    function (e, t, n) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.GitHubServer = t.uriHandler = t.NETWORK_ERROR = void 0);
      const r = n(33),
        o = n(7),
        i = n(66),
        s = n(61),
        a = n(35),
        c = n(20),
        u = r.loadMessageBundle(n(10).join(__dirname, "githubServer.ts"));
      ...
      t.uriHandler = new l();
      const p = new o.EventEmitter();
      t.GitHubServer = class {
        constructor(e) {
          (this.telemetryReporter = e),
            (this._pendingStates = new Map()),
            (this._codeExchangePromises = new Map()),
            (this.exchangeCodeForToken = (e) => async (t, n, r) => {
              c.default.info("Exchanging code for token...");
              const s = (function (e) {
                  return e.query.split("&").reduce((e, t) => {
                    const n = t.split("=");
                    return (e[n[0]] = n[1]), e;
                  }, {});
                })(t),
                a = s.code;
              if (!(this._pendingStates.get(e) || []).includes(s.state))
                return void r("Received mismatched state");
              const u = `https://vscode-auth.github.com/token?code=${a}&state=${s.state}`;
              if (s.nocors)
                try {
                  const e = await o.commands.executeCommand(
                    "_workbench.fetchJSON",
                    u,
                    "POST"
                  );
                  c.default.info("Token exchange success!"), n(e.access_token);
                } catch (e) {
                  r(e);
                }
              else
                try {
                  const e = await (0, i.default)(u, {
                    method: "POST",
                    headers: { Accept: "application/json" },
                  });
                  if (e.ok) {
                    const t = await e.json();
                    c.default.info("Token exchange success!"),
                      n(t.access_token);
                  } else r(e.statusText);
                } catch (e) {
                  r(e);
        ...
        isTestEnvironment(e) {
          return (
            /\.azurewebsites\.net$/.test(e.authority) ||
            e.authority.startsWith("localhost:")
          );
        }
        async isNoCorsEnvironment() {
          const e = await o.env.asExternalUri(
            o.Uri.parse(
              o.env.uriScheme +
                "://vscode.github-authentication/did-authenticate"
            )
          );
          return "https" === e.scheme && /^vscode\./.test(e.authority);
        }
        async login(e) {
          c.default.info("Logging in..."), this.updateStatusBarItem(!0);
          const n = (0, s.v4)(),
            r = await this.isNoCorsEnvironment(),
            i = await o.env.asExternalUri(
              o.Uri.parse(
                `${
                  o.env.uriScheme
                }://vscode.github-authentication/did-authenticate${
          ...
          if (this.isTestEnvironment(i)) {
            const t = await o.window.showInputBox({
              prompt: "GitHub Personal Access Token",
              ignoreFocusOut: !0,
            });
            if (!t) throw new Error("Sign in failed: No token provided");
            const n = await this.getScopes(t);
            if (
              !e.split(" ").every((e) => {
                const t = n.includes(e);
                return t || !e.includes(":")
                  ? t
                  : e.split(":").some((e) => n.includes(e));
              })
            )
              throw new Error(
                "The provided token is does not match the requested scopes: " +
                  e
              );
            return this.updateStatusBarItem(!1), t;
          }
          {
            const t = this._pendingStates.get(e) || [];
            this._pendingStates.set(e, [...t, n]);
            const s = o.Uri.parse(
              `https://vscode-auth.github.com/authorize/?callbackUri=${encodeURIComponent(
                i.toString()
              )}&scope=${e}&state=${n}&responseType=code&authServer=https://github.com${
                r ? "&nocors=true" : ""
              }`
            );
            await o.env.openExternal(s);
          }
          let u = this._codeExchangePromises.get(e);
          return (
            u ||
              ((u = (0, a.promiseFromEvent)(
                t.uriHandler.event,
                this.exchangeCodeForToken(e)
              )),
              this._codeExchangePromises.set(e, u)),
            Promise.race([
              u.promise,
              (0, a.promiseFromEvent)(p.event, (e, t, n) => {
                e ? t(e) : n("Cancelled");
              }).promise,
            ]).finally(() => {
              this._pendingStates.delete(e),
                null == u || u.cancel.fire(),
                this._codeExchangePromises.delete(e),
                this.updateStatusBarItem(!1);
            })
          );
        }
        updateStatusBarItem(e) {
          e &&
            !this._statusBarItem &&
            ((this._statusBarItem = o.window.createStatusBarItem(
              o.StatusBarAlignment.Left
            )),
            (this._statusBarItem.text = u(0, null)),
            (this._statusBarItem.command = "github.provide-token"),
            this._statusBarItem.show()),
            !e &&
              this._statusBarItem &&
              (this._statusBarItem.dispose(), (this._statusBarItem = void 0));
        }
        async manuallyProvideToken() {
          const e = await o.window.showInputBox({
            prompt: "Token",
            ignoreFocusOut: !0,
          });
          if (e)
            try {
              const n = o.Uri.parse(e.trim());
              if (!n.scheme || "file" === n.scheme) throw new Error();
              t.uriHandler.handleUri(n);
            } catch (t) {
              c.default.info("Treating input as token"), p.fire(e);
            }
          else p.fire(void 0);
        }
        async getScopes(e) {
          try {
            c.default.info("Getting token scopes...");
            const t = await (0, i.default)("https://api.github.com", {
              headers: {
            ...
            if (t.ok) {
              const e = t.headers.get("X-OAuth-Scopes");
              return e ? e.split(",").map((e) => e.trim()) : [];
            }
            throw (
              (c.default.error("Getting scopes failed: " + t.statusText),
              new Error(t.statusText))
            );
          } catch (e) {
            throw (c.default.error(e.message), new Error(t.NETWORK_ERROR));
          }
        }
        async getUserInfo(e) {
          let n;
          try {
            c.default.info("Getting user info..."),
              (n = await (0, i.default)("https://api.github.com/user", {
                headers: {
                  Authorization: "token " + e,
                  "User-Agent": "Visual-Studio-Code",
                },
          ...
          if (n.ok) {
            ...
            return (
              c.default.info("Got account info!"),
              { id: e.id, accountName: e.login }
            );
          }
          throw (
            (c.default.error("Getting account info failed: " + n.statusText),
            new Error(n.statusText))
          );
        }
        async checkIsEdu(e) {
          if (!(await this.isNoCorsEnvironment()))
            try {
              const t = await (0, i.default)(
              ...
              if (t.ok) {
                ...
                this.telemetryReporter.sendTelemetryEvent("session", {
                  isEdu: e.student ? "student" : e.faculty ? "faculty" : "none",
                });
              }
            } catch (e) {}
        }
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.arrayEquals =
          ...
          t.filterEvent =
            void 0);
      const r = n(7);
      (t.filterEvent = function (e, t) {
        return (n, r = null, o) => e((e) => t(e) && n.call(r, e), null, o);
      }),
        (t.onceEvent = function (e) {
          return (t, n = null, r) => {
            const o = e((e) => (o.dispose(), t.call(n, e)), null, r);
            return o;
          };
        });
      const o = (e, t) => t(e);
      (t.promiseFromEvent = function (e, t = o) {
        let n,
        ...
        return {
          promise: new Promise((r, o) => {
            i.event((e) => o()),
              (n = e((e) => {
                try {
                  Promise.resolve(t(e, r, o)).catch(o);
                } catch (e) {
                  o(e);
                }
              }));
        ...
        (t.arrayEquals = function (e, t, n = (e, t) => e === t) {
          if (e === t) return !0;
          if (!e || !t) return !1;
    ...
    function (e, t, n) {
      ...
      t.makePatchingRequire = function (e) {
        ...
        return function (n) {
          ...
          if (e[n]) {
            var u = i._resolveFilename(n, this);
            ...
            for (var d = c, f = 0, h = e[n]; f < h.length; f++) {
              var m = h[f];
              o.satisfies(l, m.versionSpecifier) && (d = m.patch(d, u));
            }
            return (t[u] = d);
          }
          return c;
    ...
    function (e, t, n) {
      if (global._stackChain) {
        if (global._stackChain.version !== n(41).version)
          throw new Error("Conflicting version of stack-chain found");
        e.exports = global._stackChain;
      } else e.exports = global._stackChain = n(96);
    },
    function (e) {
      e.exports = JSON.parse(
    ...
    function (e, t, n) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.AvailabilityData = n(107)),
        (t.Base = n(44)),
        (t.ContextTagKeys = n(108)),
        (t.Data = n(109)),
        (t.DataPoint = n(110)),
        (t.DataPointType = n(45)),
        (t.Domain = n(11)),
        (t.Envelope = n(111)),
        (t.EventData = n(46)),
        (t.ExceptionData = n(112)),
        (t.ExceptionDetails = n(113)),
        (t.MessageData = n(114)),
        (t.MetricData = n(115)),
        (t.PageViewData = n(116)),
        (t.RemoteDependencyData = n(117)),
        (t.RequestData = n(118)),
        (t.SeverityLevel = n(119)),
        (t.StackFrame = n(120));
    },
    function (e, t, n) {
      "use strict";
          ...
          (e.prototype._setStatus = function (e, t) {
            ...
            if (t)
              if ("string" == typeof t) r.error = t;
                ...
                for (var o in t)
                  r[o] = t[o] && t[o].toString && t[o].toString();
            this.properties = r;
          }),
          ...
          return (
                  ...
                  if (n) {
                    ...
                    return function (r, o) {
                      u.CorrelationContextManager.wrapEmitter(r),
                        u.CorrelationContextManager.wrapEmitter(o);
            ...
            (e.trackRequestSync = function (t, n) {
              if (n.request && n.response && t) {
                ...
                r &&
                  ((r.operation.id =
                    o.getOperationId(t.context.tags) || r.operation.id),
                  (r.operation.name =
                    o.getOperationName(t.context.tags) || r.operation.name),
                  (r.operation.parentId =
                    o.getRequestId() || r.operation.parentId),
                  r.customProperties.addHeaderData(
                    o.getCorrelationContextHeader()
                  )),
            ...
            (e.endRequest = function (e, t, n, r, o) {
              ...
              if (
                ...
                for (var s in n.tagOverrides)
                  i.tagOverrides[s] = n.tagOverrides[s];
    ...
    function (e, t, n) {
      ...
      (t.VSCodeFilterProvider = o),
        ...
        })((i = t.Filters || (t.Filters = {}))),
        (function (e) {
          (e.Team = "team"),
            (e.Internal = "internal"),
            (e.Insiders = "insider"),
            (e.Public = "public");
        })(t.TargetPopulation || (t.TargetPopulation = {}));
    },
    function (e, t, n) {
      "use strict";
    ...
    function (e, t, n) {
      ...
      var p = b("ERR_FR_REDIRECTION_FAILURE", ""),
        d = b(
        ...
        h = b("ERR_STREAM_WRITE_AFTER_END", "write after end");
      function m(e, t) {
        a.call(this),
      ...
      (m.prototype = Object.create(a.prototype)),
        (m.prototype.abort = function () {
          this._currentRequest.removeAllListeners(),
            this._currentRequest.on("error", v),
        ...
        (m.prototype.setTimeout = function (e, t) {
          ...
          function o() {
            clearTimeout(this._timeout),
              ...
              this.socket || n._currentRequest.removeListener("socket", r);
          }
          return (
            t && this.on("timeout", t),
            this.socket ? r() : this._currentRequest.once("socket", r),
            this.once("response", o),
            this.once("error", o),
            this
          );
        }),
        ...
        (m.prototype._performRequest = function () {
          ...
          if (t) {
            ...
            for (var i in ((this._currentUrl = r.format(this._options)),
        ...
        (m.prototype._processResponse = function (e) {
          ...
          if (
            ...
            (((301 === t || 302 === t) && "POST" === this._options.method) ||
              ...
              (this._requestBodyBuffers = []),
              _(/^content-/i, this._options.headers));
            var o =
                _(/^host$/i, this._options.headers) ||
                r.parse(this._currentUrl).hostname,
              i = r.resolve(this._currentUrl, n);
            u("redirecting to", i), (this._isRedirect = !0);
            var s = r.parse(i);
            if (
              (Object.assign(this._options, s),
              s.hostname !== o && _(/^authorization$/i, this._options.headers),
    ...
    function (e, t, n) {
      ...
      function s() {
        return o.a.randomFillSync(i);
      }
      const a = [];
      for (let e = 0; e < 256; ++e) a.push((e + 256).toString(16).substr(1));
      var c = function (e, t) {
        const n = t || 0,
          r = a;
        return (
      ...
      var f = function (e, t, n) {
        ...
        if (null == i || null == a) {
          const t = e.random || (e.rng || s)();
          null == i && (i = u = [1 | t[0], t[1], t[2], t[3], t[4], t[5]]),
            null == a && (a = l = 16383 & ((t[6] << 8) | t[7]));
        }
        ...
        if (
          ...
          (m < 0 || f > p) && void 0 === e.nsecs && (h = 0),
          h >= 1e4)
        )
          throw new Error("uuid.v1(): Can't create more than 10M uuids/sec");
        (p = f), (d = h), (l = a), (f += 122192928e5);
      ...
      var m = h("v3", 48, function (e) {
        return (
          Array.isArray(e)
            ? (e = Buffer.from(e))
            : "string" == typeof e && (e = Buffer.from(e, "utf8")),
          o.a.createHash("md5").update(e).digest()
        );
      });
      ...
      var v = h("v5", 80, function (e) {
        return (
          Array.isArray(e)
            ? (e = Buffer.from(e))
            : "string" == typeof e && (e = Buffer.from(e, "utf8")),
          o.a.createHash("sha1").update(e).digest()
        );
      });
    },
    function (e, t, n) {
      ...
      (t.activate = async function (e) {
        const { name: t, version: u, aiKey: l } = n(189),
          p = new c.ExperimentationTelemetry(new a.default(t, u, l)),
          d = await (0, c.createExperimentationService)(e, p);
        await d.initialFetch,
          e.subscriptions.push(r.window.registerUriHandler(i.uriHandler));
        const f = new o.GitHubAuthenticationProvider(e, p);
        await f.initialize(e),
          e.subscriptions.push(
            r.commands.registerCommand("github.provide-token", () =>
              f.manuallyProvideToken()
            )
          ),
          e.subscriptions.push(
            r.authentication.registerAuthenticationProvider(
              "github",
              "GitHub",
              {
                onDidChangeSessions: o.onDidChangeSessions.event,
                getSessions: (e) => f.getSessions(e),
                createSession: async (e) => {
                  try {
                    p.sendTelemetryEvent("login");
                    const t = await f.createSession(e.sort().join(" "));
                    return (
                      s.default.info("Login success!"),
                      o.onDidChangeSessions.fire({
                        added: [t],
                        removed: [],
                        changed: [],
                      }),
                    ...
                    if ("Cancelled" === e.message)
                      throw (p.sendTelemetryEvent("loginCancelled"), e);
                    throw (
                      (p.sendTelemetryEvent("loginFailed"),
                      r.window.showErrorMessage("Sign in failed: " + e),
                      s.default.error(e),
                      e)
                    );
                  }
                ...
                removeSession: async (e) => {
                  try {
                    p.sendTelemetryEvent("logout");
                    const t = await f.removeSession(e);
                    t &&
                      o.onDidChangeSessions.fire({
                        added: [],
                        removed: [t],
                    ...
                    throw (
                      (p.sendTelemetryEvent("logoutFailed"),
                      r.window.showErrorMessage("Sign out failed: " + e),
                      s.default.error(e),
                      e)
                    );
                  }
    ...
    function (e, t, n) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.GitHubAuthenticationProvider = t.onDidChangeSessions = void 0);
      const r = n(7),
        o = n(61),
        i = n(64),
        s = n(34),
        a = n(20),
        c = n(35);
      t.onDidChangeSessions = new r.EventEmitter();
      t.GitHubAuthenticationProvider = class {
        constructor(e, t) {
          (this._sessions = []),
            (this._keychain = new i.Keychain(e)),
            (this._githubServer = new s.GitHubServer(t));
        }
        async initialize(e) {
          try {
          ...
          e.subscriptions.push(
            e.secrets.onDidChange(() => this.checkForUpdates())
          );
        }
        async getSessions(e) {
          return e
            ? this._sessions.filter((t) => (0, c.arrayEquals)(t.scopes, e))
            : this._sessions;
        }
        async verifySessions() {
          const e = [],
            t = this._sessions.map(async (t) => {
              try {
                await this._githubServer.getUserInfo(t.accessToken),
                  this._githubServer.checkIsEdu(t.accessToken),
                  e.push(t);
              } catch (n) {
                "Unauthorized" !== n.message && e.push(t);
              }
            });
          Promise.all(t).then((t) => {
            this._sessions.length !== e.length &&
              ((this._sessions = e), this.storeSessions());
          });
        }
        async checkForUpdates() {
          let e;
          try {
            e = await this.readSessions();
          } catch (e) {
            return;
          }
          const n = [],
            r = [];
          e.forEach((e) => {
            this._sessions.some((t) => t.id === e.id) ||
              (a.default.info("Adding session found in keychain"),
              this._sessions.push(e),
              n.push(e));
          }),
            this._sessions.map((t) => {
              if (!e.some((e) => e.id === t.id)) {
                a.default.info("Removing session no longer found in keychain");
                const e = this._sessions.findIndex((e) => e.id === t.id);
                e > -1 && this._sessions.splice(e, 1), r.push(t);
              }
            }),
            (n.length || r.length) &&
              t.onDidChangeSessions.fire({ added: n, removed: r, changed: [] });
        }
        async readSessions() {
          const e =
            (await this._keychain.getToken()) ||
            (await this._keychain.tryMigrate());
          if (e)
            try {
              const t = JSON.parse(e).map(async (e) => {
                var t, n;
                let r;
                return (
                  !e.account &&
                    (r = await this._githubServer.getUserInfo(e.accessToken)),
                  {
                    id: e.id,
                    account: {
                      label: e.account
                        ? e.account.label || e.account.displayName
                        : r.accountName,
                      id:
                        null !==
                          (n =
                            null === (t = e.account) || void 0 === t
                              ? void 0
                              : t.id) && void 0 !== n
                          ? n
                          : r.id,
              ...
              if (e === s.NETWORK_ERROR) return [];
              a.default.error("Error reading sessions: " + e),
        ...
        async createSession(e) {
          const t = await this._githubServer.login(e),
            n = await this.tokenToSession(t, e.split(" "));
          return this._githubServer.checkIsEdu(t), await this.setToken(n), n;
        }
        async manuallyProvideToken() {
          this._githubServer.manuallyProvideToken();
        }
        async tokenToSession(e, t) {
          const n = await this._githubServer.getUserInfo(e);
          return {
            id: (0, o.v4)(),
            accessToken: e,
            account: { label: n.accountName, id: n.id },
            scopes: t,
          };
        }
        async setToken(e) {
          const t = this._sessions.findIndex((t) => t.id === e.id);
          t > -1 ? this._sessions.splice(t, 1, e) : this._sessions.push(e),
            await this.storeSessions();
        }
        async removeSession(e) {
          a.default.info("Logging out of " + e);
          const t = this._sessions.findIndex((t) => t.id === e);
          let n;
          return (
            t > -1
              ? ((n = this._sessions[t]), this._sessions.splice(t, 1))
              : a.default.error("Session not found"),
            await this.storeSessions(),
            n
          );
        }
    ...
    function (e, t, n) {
      ...
      const r = n(7),
        o = n(20),
        i = n(33).loadMessageBundle(
          n(10).join(__dirname, "common/keychain.ts")
        );
      t.Keychain = class {
        constructor(e) {
          this.context = e;
        ...
        async setToken(e) {
          try {
            return await this.context.secrets.store("github.auth", e);
          } catch (e) {
            o.default.error("Setting token failed: " + e);
            const t = i(0, null);
            (await r.window.showErrorMessage(i(1, null, e.message), t)) === t &&
              r.env.openExternal(
                r.Uri.parse(
        ...
        async getToken() {
          try {
            return await this.context.secrets.get("github.auth");
          } catch (e) {
            return (
              o.default.error("Getting token failed: " + e),
        ...
        async deleteToken() {
          try {
            return await this.context.secrets.delete("github.auth");
          } catch (e) {
            return (
              o.default.error("Deleting token failed: " + e),
              Promise.resolve(void 0)
            );
          }
        }
        async tryMigrate() {
          try {
            ...
            if (!e) throw new Error("keytar unavailable");
            const t = await e.getPassword(
              r.env.uriScheme + "-github.login",
              "account"
            );
            return (
              t &&
    ...
    function (e, t, n) {
      ...
      class p {
        ...
        slice() {
          ...
          (r = void 0 === t ? 0 : t < 0 ? Math.max(e + t, 0) : Math.min(t, e)),
            (o =
              void 0 === n ? e : n < 0 ? Math.max(e + n, 0) : Math.min(n, e));
          const i = Math.max(o - r, 0),
            s = this[u].slice(r, r + i),
      ...
      (y.prototype = {
        ...
        arrayBuffer() {
          return v.call(this).then(function (e) {
            return e.buffer.slice(e.byteOffset, e.byteOffset + e.byteLength);
          });
        },
        blob() {
          let e = (this.headers && this.headers.get("content-type")) || "";
          return v.call(this).then(function (t) {
      ...
      class P {
        constructor() {
          let e =
            arguments.length > 0 && void 0 !== arguments[0]
              ? arguments[0]
              : void 0;
          if (((this[k] = Object.create(null)), e instanceof P)) {
            const t = e.raw(),
              n = Object.keys(t);
        ...
        get(e) {
          x((e = "" + e));
          const t = S(this[k], e);
          return void 0 === t ? null : this[k][t].join(", ");
        }
        forEach(e) {
          let t =
          ...
          for (; r < n.length; ) {
            ...
            const i = o[0],
              s = o[1];
            e.call(t, s, i, this), (n = O(this)), r++;
          }
        }
        set(e, t) {
          (t = "" + t), x((e = "" + e)), I(t);
          const n = S(this[k], e);
          this[k][void 0 !== n ? n : e] = [t];
        }
        append(e, t) {
          (t = "" + t), x((e = "" + e)), I(t);
          const n = S(this[k], e);
          void 0 !== n ? this[k][n].push(t) : (this[k][e] = [t]);
        }
        has(e) {
          return x((e = "" + e)), void 0 !== S(this[k], e);
        }
        delete(e) {
          x((e = "" + e));
          const t = S(this[k], e);
          void 0 !== t && delete this[k][t];
        }
        raw() {
          return this[k];
        }
      ...
      function O(e) {
        ...
        return n.map(
          "key" === t
            ...
            : function (t) {
                return [t.toLowerCase(), e[k][t].join(", ")];
              }
        );
      }
      ...
      function R(e, t) {
        ...
        return (n[A] = { target: e, kind: t, index: 0 }), n;
      }
      const D = Object.setPrototypeOf(
        {
          next() {
            if (!this || Object.getPrototypeOf(this) !== D)
            ...
            return r >= o.length
              ? { value: void 0, done: !0 }
              : ((this[A].index = r + 1), { value: o[r], done: !1 });
          },
        },
        Object.getPrototypeOf(Object.getPrototypeOf([][Symbol.iterator]()))
      );
      function N(e) {
        const t = Object.assign({ __proto__: null }, e[k]),
          n = S(e[k], "Host");
      ...
      const M = Symbol("Response internals"),
        j = o.STATUS_CODES;
      class L {
        constructor() {
          let e =
        ...
        get ok() {
          return this[M].status >= 200 && this[M].status < 300;
        }
        get redirected() {
          return this[M].counter > 0;
        }
        get statusText() {
      ...
      const q = Symbol("Request internals"),
        F = i.parse,
        H = i.format,
        U = "destroy" in r.Readable.prototype;
      function B(e) {
          ...
          new K.Promise(function (n, i) {
            const c = new $(e, t),
              u = (function (e) {
                ...
                if (e.signal && e.body instanceof r.Readable && !U)
                  throw new Error(
              ...
              l = ("https:" === u.protocol ? s : o).request,
              p = c.signal;
            let f = null;
            const h = function () {
              let e = new V("The user aborted a request.");
              i(e),
                c.body && c.body instanceof r.Readable && c.body.destroy(e),
                f && f.body && f.body.emit("error", e);
            };
            if (p && p.aborted) return void h();
            const m = function () {
                h(), g();
              },
              y = l(u);
            ...
            p && p.addEventListener("abort", m),
              c.timeout &&
                y.once("socket", function (e) {
                  v = setTimeout(function () {
                    i(new d("network timeout at: " + c.url, "request-timeout")),
                      g();
                  }, c.timeout);
                }),
              ...
              y.on("response", function (e) {
                ...
                if (K.isRedirect(e.statusCode)) {
                  ...
                  switch (c.redirect) {
                    ...
                    case "follow":
                      ...
                      return 303 !== e.statusCode && c.body && null === C(c)
                        ? (i(
                            new d(
                ...
                if ("deflate" != s && "x-deflate" != s) {
                  if (
                    "br" == s &&
                    "function" == typeof a.createBrotliDecompress
                  )
                    return (
                  ...
                  e.pipe(new z()).once("data", function (e) {
                    (r =
                      8 == (15 & e[0])
                        ? r.pipe(a.createInflate())
                        : r.pipe(a.createInflateRaw())),
                      (f = new L(r, o)),
                      n(f);
                  });
                }
        ...
        return (
          t.defaultClient
            ? ((M = !0),
              ...
              g.enable(I),
              _.enable(R, m),
              b.useAutoCorrelation(O, h),
              b.enable(S),
              E.enable(k),
              t.liveMetricsClient && A && t.liveMetricsClient.enable(A))
      ...
      (t.setup = function (e) {
        return (
          ...
          t.defaultClient &&
            ...
            t.defaultClient.channel.setUseDiskRetryCaching(P, D, N),
          L
        );
      }),
        (t.start = j),
        (t.getCorrelationContext = function () {
          return O ? o.CorrelationContextManager.getCurrentContext() : null;
        }),
      ...
      var L = (function () {
        ...
        return (
          ...
          (e.setAutoCollectConsole = function (t, n) {
            return (
              void 0 === n && (n = !1), (T = t), (w = n), M && y.enable(t, n), e
            );
          }),
          (e.setAutoCollectExceptions = function (t) {
            return (x = t), M && v.enable(t), e;
          }),
          (e.setAutoCollectPerformance = function (t, n) {
            void 0 === n && (n = !0), (I = t);
            var r = f.AutoCollectNativePerformance.parseEnabled(n);
            return (
              (R = r.isEnabled),
              (m = r.disabledMetrics),
              M && (g.enable(t), _.enable(r.isEnabled, r.disabledMetrics)),
              e
            );
          }),
          (e.setAutoCollectRequests = function (t) {
            return (S = t), M && b.enable(t), e;
          }),
          (e.setAutoCollectDependencies = function (t) {
            return (k = t), M && E.enable(t), e;
          }),
          (e.setAutoDependencyCorrelation = function (t, n) {
            return (O = t), (h = n), M && b.useAutoCorrelation(t, n), e;
          }),
          (e.setUseDiskRetryCaching = function (n, r, o) {
            return (
              ...
              t.defaultClient &&
                t.defaultClient.channel &&
                t.defaultClient.channel.setUseDiskRetryCaching(n, r, o),
              e
            );
          }),
              ...
              t.defaultClient
                ? (!t.liveMetricsClient && n
                    ? ((t.liveMetricsClient = new d(
                      ...
                      (C = new a(t.liveMetricsClient, 1e3, !0)),
                      t.liveMetricsClient.addCollector(C),
          ...
          return (
            (e.prototype._emit = function (e, n) {
              ...
              if (!n) {
                var i = o;
                i || (i = t.call(this, e, !0)),
                  r.channel.publish("bunyan", { level: e.level, result: i });
              }
              return o;
            }),
            e
    ...
    function (e, t, n) {
      ...
      (t.console = {
        ...
        (t.enable = function () {
          r.channel.registerMonkeyPatch("console", t.console), n(75);
        });
    },
    function (e, t) {
    ...
    function (e, t, n) {
      ...
      (t.mongo2 = {
        ...
        (t.enable = function () {
          o.channel.registerMonkeyPatch("mongodb", t.mongo2),
            o.channel.registerMonkeyPatch("mongodb", t.mongo3),
            o.channel.registerMonkeyPatch("mongodb", t.mongo330);
        });
    },
    function (e, t, n) {
      "use strict";
      ...
      (t.mysql = {
        ...
        patch: function (e, t) {
          var i = function (e, t) {
            ...
            a = n(79)(o.dirname(t) + "/lib/Connection");
          ...
          var c = n(80)(o.dirname(t) + "/lib/Pool");
          return (
    ...
    function (e, t, n) {
      ...
      (t.postgres6 = {
        ...
        patch: function (e, t) {
          ...
          return (
            (e.Client.prototype.query = function (e, t, i) {
              var s,
                a = {
                  query: {},
                  database: {
              ...
              function u(e) {
                ...
                var t = r.channel.bindToContext(function (t, n) {
                  ...
                  if (
                    ...
                    (a.error = t),
                    (a.duration = Math.ceil(1e3 * i[0] + i[1] / 1e6)),
                    r.channel.publish("postgres", a),
                    t)
                  ) {
                    if (e) return e.apply(this, arguments);
                    s && s instanceof o.EventEmitter && s.emit("error", t);
              ...
              try {
                "string" == typeof e
                  ? t instanceof Array
                    ? ((a.query.preparable = { text: e, args: t }), (i = u(i)))
                    : ((a.query.text = e), i ? (i = u(i)) : (t = u(t)))
      ...
      (t.winston3 = {
        ...
        patch: function (e) {
          ...
          function n() {
            ...
            for (var o in r)
              r.hasOwnProperty(o) && (n = void 0 === n || r[o] > r[n] ? o : n);
          ...
          e.createLogger = function () {
            ...
            for (var s in i)
              i.hasOwnProperty(s) && (o = void 0 === o || i[s] > i[o] ? s : o);
            var a = r.apply(this, arguments);
            a.add(new t(e, { level: o }));
            var c = a.configure;
            return (
    ...
    function (e, t, n) {
      ...
      (e.exports = {
            ...
            s
              .createHook({
                init(n, o, i, u) {
                  ...
                  if (t.active) {
                    ...
                    if (a) {
                      ...
                      d(
                        `${s}INIT [${o}] (${e}) asyncId:${n} currentUid:${c} triggerId:${i} active:${r.inspect(
                          t.active,
                    ...
                    const l = t._contexts.get(i);
                    if (l) {
                      t._contexts.set(n, l);
                      if (a) {
                        const s = " ".repeat(t._indent < 0 ? 0 : t._indent);
                        d(
                          `${s}INIT USING CONTEXT FROM TRIGGERID [${o}] (${e}) asyncId:${n} currentUid:${c} triggerId:${i} active:${r.inspect(
                            t.active,
                            { showHidden: true, depth: 2, colors: true }
                          )} resource:${u}`
                        );
                      ...
                      const s = " ".repeat(t._indent < 0 ? 0 : t._indent);
                      d(
                        `${s}INIT MISSING CONTEXT [${o}] (${e}) asyncId:${n} currentUid:${c} triggerId:${i} active:${r.inspect(
                          t.active,
                          { showHidden: true, depth: 2, colors: true }
                        )} resource:${u}`
                      );
                  ...
                  if (a && o === "PROMISE") {
                    ...
                    d(
                      `${a}INIT RESOURCE-PROMISE [${o}] (${e}) parentId:${s} asyncId:${n} currentUid:${c} triggerId:${i} active:${r.inspect(
                        t.active,
                        { showHidden: true, depth: 2, colors: true }
                      )} resource:${u}`
                    );
                ...
                before(n) {
                  c = s.executionAsyncId();
                  let o;
                  o = t._contexts.get(n) || t._contexts.get(c);
                  if (o) {
                    if (a) {
                      const i = s.triggerAsyncId();
                      const a = " ".repeat(t._indent < 0 ? 0 : t._indent);
                      d(
                        `${a}BEFORE (${e}) asyncId:${n} currentUid:${c} triggerId:${i} active:${r.inspect(
                          t.active,
                          { showHidden: true, depth: 2, colors: true }
                        )} context:${r.inspect(o)}`
                      );
                    ...
                    const i = " ".repeat(t._indent < 0 ? 0 : t._indent);
                    d(
                      `${i}BEFORE MISSING CONTEXT (${e}) asyncId:${n} currentUid:${c} triggerId:${o} active:${r.inspect(
                        t.active,
                        { showHidden: true, depth: 2, colors: true }
                ...
                after(n) {
                  ...
                  if (o) {
                    if (a) {
                      ...
                      const a = " ".repeat(t._indent < 0 ? 0 : t._indent);
                      d(
                        `${a}AFTER (${e}) asyncId:${n} currentUid:${c} triggerId:${i} active:${r.inspect(
                          t.active,
                          { showHidden: true, depth: 2, colors: true }
                        )} context:${r.inspect(o)}`
                      );
                    ...
                    const a = " ".repeat(t._indent < 0 ? 0 : t._indent);
                    d(
                      `${a}AFTER MISSING CONTEXT (${e}) asyncId:${n} currentUid:${c} triggerId:${i} active:${r.inspect(
                        t.active,
                        { showHidden: true, depth: 2, colors: true }
                      )} context:${r.inspect(o)}`
                    );
                ...
                destroy(n) {
                  ...
                  if (a) {
                    ...
                    const i = " ".repeat(t._indent < 0 ? 0 : t._indent);
                    d(
                      `${i}DESTROY (${e}) currentUid:${c} asyncId:${n} triggerId:${o} active:${r.inspect(
                        t.active,
                        { showHidden: true, depth: 2, colors: true }
        ...
        (u.prototype.enter = function (e) {
          if ((o.ok(e, "context must be provided for entering"), a)) {
            const t = s.executionAsyncId(),
              n = s.triggerAsyncId();
            d(
              `${" ".repeat(
        ...
        (u.prototype.exit = function (e) {
          if ((o.ok(e, "context must be provided for exiting"), a)) {
            const t = s.executionAsyncId(),
              n = s.triggerAsyncId();
            d(
              `${" ".repeat(
          ...
          t < 0
            ...
            : (o.ok(t, "can't remove top context"), this._set.splice(t, 1));
        }),
    ...
    function (e, t, n) {
      ...
      if (
        ...
        var m = n(40);
        for (var y in m.filter._modifiers) m.filter.deattach(y);
      }
    },
    function (e, t, n) {
      "use strict";
    ...
    function (e, t, n) {
      ...
      const r = process.binding("async_wrap"),
        ...
        i = { nextTick: n(93), promise: n(94), timers: n(95) },
        s = new Set();
      function a() {
    ...
    function (e, t, n) {
      ...
      e.exports = function () {
        ...
        n.prototype.then = function (n, s) {
          if (!t.enabled) return o.call(this, n, s);
          const a = new r(),
            c = --t.counter;
          return (
            e.init.call(a, c, 0, null, null),
            o.call(this, i(n, a, c, !0), i(s, a, c, !1))
          );
        };
      };
    },
    function (e, t, n) {
            ...
            (n[0] = function () {
              ...
              try {
                ...
                t &&
                  process.listenerCount("uncaughtException") > 0 &&
                  process.once("uncaughtException", function () {
                    e.post.call(u, d, !0), s.delete(f), e.destroy.call(null, d);
                  });
              }
              e.post.call(u, d, !1),
                (l = null),
                (a || p) && ((p = !1), s.delete(f), e.destroy.call(null, d));
            }),
            (f = c.apply(r, n)),
            s.set(f, d),
            f
      ...
      e.exports = function () {
        d(this._hooks, this._state, "setTimeout", "clearTimeout", o, a, !0),
          d(this._hooks, this._state, "setInterval", "clearInterval", i, c, !1),
          d(
            this._hooks,
            this._state,
            "setImmediate",
    ...
    function (e, t, n) {
      ...
      process.addAsyncListener || n(99),
        ...
        (i.prototype.runAndReturn = function (e) {
          var t;
          return (
            this.run(function (n) {
              t = e(n);
        ...
        (i.prototype.bindEmitter = function (e) {
        ...
        (i.prototype.fromException = function (e) {
          return e["error@context"];
        }),
    ...
    function (e, t, n) {
      ...
      var r = n(27),
        ...
        a = n(100),
        c = n(21),
        u = o.gte(process.version, "6.0.0"),
        l = o.gte(process.version, "7.0.0"),
        p = o.gte(process.version, "8.0.0"),
        d = o.gte(process.version, "11.0.0"),
        f = n(101);
      function h(e) {
        return function () {
      ...
      l && !f._normalizeArgs
        ...
        : l ||
          f._normalizeConnectArgs ||
          (f._normalizeConnectArgs = function (e) {
            var t,
              n = {};
        ...
        "_setUpListenHandle" in f.Server.prototype
          ? i(f.Server.prototype, "_setUpListenHandle", h)
          : i(f.Server.prototype, "_listen2", h),
        i(f.Socket.prototype, "connect", function (e) {
          return function () {
            var t;
            (t =
              p &&
              ...
              Object.getOwnPropertySymbols(arguments[0]).length > 0
                ? arguments[0]
                : l
                ? f._normalizeArgs(arguments)
                : f._normalizeConnectArgs(arguments))[1] && (t[1] = a(t[1]));
            var n = e.apply(this, t);
            return m(this), n;
          };
        });
      var y = n(9);
      i(y.Agent.prototype, "addRequest", function (e) {
        return function (t) {
          var n = t.onSocket;
          return (
            (t.onSocket = a(function (e) {
              return m(e), n.apply(this, arguments);
            })),
      ...
      v.ChildProcess
        ? i(v.ChildProcess.prototype, "spawn", function (e) {
            return function () {
      ...
      process._nextDomainTick && _.push("_nextDomainTick"),
        ...
        s(process, _, A),
        i(process, "nextTick", R);
      var b = ["setTimeout", "setInterval"];
      global.setImmediate && b.push("setImmediate");
      var E = n(38),
        C = global.setTimeout === E.setTimeout;
      s(E, b, R), C && s(global, b, R);
      var T = n(102);
      s(
        T,
        [
        ...
        T.resolveNaptr && i(T, "resolveNaptr", A);
      var w,
        x,
        I = n(16);
      s(
        ...
        I.lchown && i(I, "lchown", A),
        I.lchmod && i(I, "lchmod", A),
        I.ftruncate && i(I, "ftruncate", A);
      try {
        w = n(6);
      } catch (e) {}
      if (w && w.Deflate && w.Deflate.prototype) {
        var S = Object.getPrototypeOf(w.Deflate.prototype);
        S._transform
          ? i(S, "_transform", A)
          : S.write && S.flush && S.end && s(S, ["write", "flush", "end"], A);
      }
      try {
        x = n(13);
      } catch (e) {}
      if (x) {
        var k = ["pbkdf2", "randomBytes"];
        d || k.push("pseudoRandomBytes"), s(x, k, A);
      }
      var P =
        !!global.Promise &&
      ...
      if (P) {
        var O = process.addAsyncListener({
          create: function () {
            P = !1;
          },
        });
      ...
      P &&
        (function () {
          ...
          function o(t, n, i, s) {
            var a;
            try {
              return { returnVal: (a = n.call(t, i)), error: !1 };
            } catch (e) {
              return { errorVal: e, error: !0 };
            } finally {
              a instanceof e
                ? (s.__asl_wrapper = function () {
                    var e = a.__asl_wrapper || o;
                    return e.apply(this, arguments);
                  })
                : r(s, !0);
            }
    ...
    function (e, t, n) {
      ...
      if (process._fatalException) {
        ...
        (r = function (e) {
          ...
          return (d = !1), u.length > 0 && (s = u.pop()), (p = void 0), n && !c;
        }),
          (o = function (e, t, n) {
            var r = [];
            c = !0;
            ...
            return (
              (c = !1),
              function () {
                (p = r), u.push(s), (s = l(t, s)), (c = !0);
                for (var o = 0; o < n; ++o)
                  (2 & t[o].flags) > 0 && t[o].before(this, r[t[o].uid]);
                c = !1;
                var i = e.apply(this, arguments);
                for (c = !0, o = 0; o < n; ++o)
                  (4 & t[o].flags) > 0 && t[o].after(this, r[t[o].uid]);
                return (c = !1), (s = u.pop()), (p = void 0), i;
              }
            );
          }),
          ...
          (o = function (e, t, n) {
            ...
            return (
              ...
              function () {
                ...
                for (var d = 0; d < n; ++d)
                  (2 & t[d].flags) > 0 && t[d].before(this, o[t[d].uid]);
                c = !1;
                try {
                  ...
                  if (!a || p) {
                    for (c = !0, d = 0; d < n; ++d)
                      (4 & t[d].flags) > 0 && t[d].after(this, o[t[d].uid]);
                    c = !1;
                  }
                  s = u.pop();
                }
      ...
      (h.prototype.create = void 0),
        (h.prototype.before = void 0),
        (h.prototype.after = void 0),
        (h.prototype.error = void 0),
        (h.prototype.data = void 0),
        (h.prototype.uid = 0),
        (h.prototype.flags = 0),
        (process.createAsyncListener = m),
        (process.addAsyncListener = function (e, t) {
          var n;
          n = e instanceof h ? e : m(e, t);
        ...
        o = (function () {
          ...
          return (
            (e.prototype.enable = function (e, t) {
              r.IsInitialized &&
                (n(105).enable(e && t, this._client),
                n(123).enable(e, this._client),
                n(124).enable(e, this._client));
            }),
            (e.prototype.isInitialized = function () {
              return this._isInitialized;
            }),
    ...
    function (e, t, n) {
      ...
      (t.enable = function (e, t) {
        e
          ? (0 === i.length && o.channel.subscribe("console", s), i.push(t))
          : 0 ===
        ...
        (t.dispose = function () {
          o.channel.unsubscribe("console", s), (i = []);
        });
    },
    function (e, t, n) {
      "use strict";
    ...
    function (e, t, n) {
      ...
      (t.enable = function (e, t) {
        e
          ? (0 === i.length && o.channel.subscribe("bunyan", a), i.push(t))
          : 0 ===
              (i = i.filter(function (e) {
                return e != t;
        ...
        (t.dispose = function () {
          o.channel.unsubscribe("bunyan", a), (i = []);
        });
    },
    function (e, t, n) {
      "use strict";
      ...
      (t.enable = function (e, t) {
        e
          ? (0 === i.length && o.channel.subscribe("winston", a), i.push(t))
          : 0 ===
              (i = i.filter(function (e) {
                return e != t;
        ...
        (t.dispose = function () {
          o.channel.unsubscribe("winston", a), (i = []);
        });
    },
    function (e, t, n) {
      "use strict";
              ...
              if (!this._exceptionListenerHandle) {
                var r = function (t, r, o) {
                  void 0 === o && (o = new Error(e._FALLBACK_ERROR_MESSAGE)),
                    n._client.trackException({ exception: o }),
    ...
    function (e, t, n) {
      ...
      (t.subscriber = function (e) {
        ...
        (t.enable = function (e, n) {
          e
            ? (0 === o.length && r.channel.subscribe("mongodb", t.subscriber),
              o.push(n))
            : 0 ===
    ...
    function (e, t, n) {
      ...
      (t.subscriber = function (e) {
        ...
        (t.enable = function (e, n) {
          e
            ? (0 === o.length && r.channel.subscribe("mysql", t.subscriber),
              o.push(n))
            : 0 ===
                (o = o.filter(function (e) {
                  return e != n;
    ...
    function (e, t, n) {
      ...
      (t.subscriber = function (e) {
        ...
        (t.enable = function (e, n) {
          e
            ? (0 === o.length && r.channel.subscribe("redis", t.subscriber),
              o.push(n))
            : 0 ===
                (o = o.filter(function (e) {
                  return e != n;
    ...
    function (e, t, n) {
      ...
      (t.subscriber = function (e) {
        ...
        (t.enable = function (e, n) {
          e
            ? (0 === o.length && r.channel.subscribe("postgres", t.subscriber),
              o.push(n))
            : 0 ===
                (o = o.filter(function (e) {
                  return e != n;
            ...
            (e.parse = function (t) {
              ...
              if (Object.keys(n).length > 0) {
                if (n.endpointsuffix) {
                  ...
                  (n.ingestionendpoint =
                    n.ingestionendpoint ||
                    "https://" + o + "dc." + n.endpointsuffix),
                    (n.liveendpoint =
                      n.liveendpoint ||
                      "https://" + o + "live." + n.endpointsuffix);
                }
                (n.ingestionendpoint =
        ...
        l = (function () {
          ...
          return (
            (e.createQuickPulseEnvelope = function (e, t, n, r) {
              var i =
                  (o && "function" == typeof o.hostname && o.hostname()) ||
                  "Unknown",
                s =
                  (r.tags &&
                    r.keys &&
            ...
            (e.createQuickPulseExceptionDocument = function (t) {
              ...
              return (
                o &&
                  o.length > 0 &&
                  (o[0].parsedStack && o[0].parsedStack.length > 0
                    ? o[0].parsedStack.forEach(function (e) {
                        i += e.assembly + "\n";
                      })
                    : o[0].stack && o[0].stack.length > 0 && (i = o[0].stack),
                  (s = o[0].message),
                  (a = o[0].typeName)),
                r({}, n, {
                  Exception: i,
          ...
          return (
            ...
            (e.prototype._submitData = function (t, n, u) {
              var l,
                ...
                f = JSON.stringify(t),
                h =
                  (((l = {})[o.disableCollectionRequestOption] = !0),
                  ...
                  (l.headers =
                    ...
                    (p["Content-Length"] = Buffer.byteLength(f)),
                    p)),
                  l),
                m = r.request(h, function (e) {
      ...
      (t.samplingTelemetryProcessor = function (e, t) {
        ...
        return (
          ...
          (t.correlationContext && t.correlationContext.operation
            ? o(t.correlationContext.operation.id) < n
            : 100 * Math.random() < n)
        );
      }),
          ...
          return (
            ...
            (e.prototype.send = function (t, n) {
              ...
              s.gzip(t, function (s, a) {
                ...
                var d = l.makeRequest(r._config, o, i, function (o) {
                  o.setEncoding("utf-8");
                  var i = "";
                ...
                d.on("error", function (o) {
                  ...
                  if ((r._onErrorHelper(o), "function" == typeof n)) {
                ...
                ? void 0 !== e.ACLED_DIRECTORIES[t]
                  ...
                  : ((e.ACLED_DIRECTORIES[t] = !1),
                    void this._getACLIdentity(function (o, i) {
                      if (o) return (e.ACLED_DIRECTORIES[t] = !1), n(o);
              ...
              r.readdir(e, function (n, o) {
                ...
                if (0 !== o.length)
                  for (var u = 0; u < o.length; u++)
                    r.stat(i.join(e, o[u]), function (e, n) {
                      c++,
          ...
          return (
                  ...
                  if (c.baseData.properties)
                    for (var u in i)
                      c.baseData.properties[u] ||
                        (c.baseData.properties[u] = i[u]);
                  else c.baseData.properties = i;
                c.baseData.properties = o.validateStringMap(
            ...
            (e.createExceptionData = function (e) {
              ...
              (i.message = e.exception.message),
                ...
                (i.hasFullStack =
                  o.isArray(i.parsedStack) && i.parsedStack.length > 0),
                t.exceptions.push(i);
              var s = new r.Data();
              return (
            ...
            (e.parseStack = function (e) {
              ...
              if ("string" == typeof e) {
                ...
                if (o > 32768)
                  for (
                    var u = 0, l = t.length - 1, p = 0, d = u, f = l;
                    u < l;
    ...
    function (e, t, n) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.createExperimentationService = t.ExperimentationTelemetry = void 0);
      const r = n(7),
        o = n(149);
      (t.ExperimentationTelemetry = class {
        constructor(e) {
          (this.baseReporter = e), (this.sharedProperties = {});
        }
        sendTelemetryEvent(e, t, n) {
          this.baseReporter.sendTelemetryEvent(
            e,
            { ...this.sharedProperties, ...t },
            n
          );
        }
        sendTelemetryErrorEvent(e, t, n) {
          this.baseReporter.sendTelemetryErrorEvent(e, {
            ...this.sharedProperties,
            ...t,
          });
        }
        setSharedProperty(e, t) {
          this.sharedProperties[e] = t;
        }
        postEvent(e, t) {
          const n = {};
          for (const [e, r] of t) n[e] = r;
          this.sendTelemetryEvent(e, n);
        }
        dispose() {
          return this.baseReporter.dispose();
        }
      }),
        (t.createExperimentationService = async function (e, t) {
          const n = e.extension.id,
            i = e.extension.packageJSON.version;
          return (0, o.getExperimentationService)(
            n,
            i,
            (function () {
              switch (r.env.uriScheme) {
                case "vscode":
                  return o.TargetPopulation.Public;
                case "vscode-insiders":
                  return o.TargetPopulation.Insiders;
                case "vscode-exploration":
                  return o.TargetPopulation.Internal;
                case "code-oss":
                  return o.TargetPopulation.Team;
                default:
                  return o.TargetPopulation.Public;
              }
            })(),
    ...
    function (e, t, n) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 });
      var r = n(150);
      (t.getExperimentationService = r.getExperimentationService),
        (t.getExperimentationServiceAsync = r.getExperimentationServiceAsync);
      var o = n(50);
      t.TargetPopulation = o.TargetPopulation;
    },
    function (e, t, n) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 });
      ...
      function c(e, t, n, c, u, ...l) {
        ...
        const p = i.workspace.getConfiguration("telemetry");
        if (
          !(void 0 === i.env.isTelemetryEnabled
            ? p.get("enableTelemetry", !0)
            : i.env.isTelemetryEnabled)
        )
          return new a.default();
        const d = [new r.VSCodeFilterProvider(e, t, n), ...l],
          f = new s.MementoKeyValueStorage(u);
    ...
    function (e, t, n) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 });
      var r = n(152);
      t.ExperimentationService = r.ExperimentationService;
    },
    function (e, t, n) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 });
      const r = n(153),
        o = n(156),
        i = n(183);
      class s extends i.ExperimentationServiceAutoPolling {
        constructor(e) {
          super(
            e.telemetry,
            e.filterProviders || [],
            null != e.refetchInterval ? e.refetchInterval : 0,
            e.featuresTelemetryPropertyName,
          ...
          (this.featureProviders = []),
            this.addFeatureProvider(
              new r.TasApiFeatureProvider(
                new o.AxiosHttpClient(this.options.endpoint),
                this.telemetry,
    ...
    function (e, t, n) {
      ...
      class o extends r.FilteredFeatureProvider {
        ...
        async fetch() {
          ...
          let n = await this.httpClient.get({ headers: t });
          e.keys.length > 0 && this.PostEventToTelemetry(t);
          let r = n.data,
            o = r.Configs,
            i = [];
          for (let e of o)
          ...
          return {
            features: i,
            assignmentContext: r.AssignmentContext,
            configs: o,
          };
        }
      }
      ...
      t.AxiosHttpClient = class {
        ...
        get(e) {
          return r.default.get(
            this.endpoint,
            Object.assign(Object.assign({}, e), { proxy: !1 })
          );
        }
      };
    },
      ...
      e.exports = function (e) {
        return new Promise(function (t, n) {
          ...
          if (
            (b["User-Agent"] ||
              b["user-agent"] ||
              (b["User-Agent"] = "axios/" + f.version),
            _ && !r.isStream(_))
          ) {
            if (Buffer.isBuffer(_));
            else if (r.isArrayBuffer(_)) _ = Buffer.from(new Uint8Array(_));
            else {
              if (!r.isString(_))
                return g(
                  h(
            ...
            b["Content-Length"] = _.length;
          }
          var E = void 0;
          e.auth &&
            (E = (e.auth.username || "") + ":" + (e.auth.password || ""));
          ...
          E && delete b.Authorization;
          var I = y.test(w),
            S = I ? e.httpsAgent : e.httpAgent,
            k = {
          ...
          e.socketPath
            ...
            : ((k.hostname = T.hostname), (k.port = T.port));
          var P,
            O = e.proxy;
          if (!O && !1 !== O) {
            var A = w.slice(0, -1) + "_proxy",
              R = process.env[A] || process.env[A.toUpperCase()];
            if (R) {
              var D = p.parse(R),
                ...
                M = !N.split(",")
                  ...
                  .some(function (e) {
                    return (
                      ...
                      ("*" === e ||
                        ("." === e[0] &&
                          T.hostname.substr(T.hostname.length - e.length) ===
                            e) ||
                        T.hostname === e)
                    );
                  });
          ...
          O &&
            ((k.headers.host = T.hostname + (T.port ? ":" + T.port : "")),
            (function e(t, n, r) {
              if (
                ((t.hostname = n.host),
                (t.host = n.host),
              ...
              k,
              O,
              w + "//" + T.hostname + (T.port ? ":" + T.port : "") + k.path
            ));
          var L = I && (!O || y.test(O.protocol));
          e.transport
            ? (P = e.transport)
            : 0 === e.maxRedirects
            ? (P = L ? c : a)
          ...
          var q = P.request(k, function (t) {
            if (!q.aborted) {
              ...
              if ("stream" === e.responseType) (s.data = n), o(v, g, s);
              else {
                var a = [];
          ...
          q.on("error", function (t) {
            (q.aborted && "ERR_FR_TOO_MANY_REDIRECTS" !== t.code) ||
              g(m(t, e, null, q));
          }),
            e.timeout &&
    ...
    function (e, t, n) {
      ...
      const r = n(184),
        o = n(186);
      class i extends r.ExperimentationServiceBase {
        constructor(e, t, n, r, i, s, a, c) {
          if (
            ...
            (this.featuresTelemetryPropertyName = r),
      ...
      t.ExperimentationServiceAutoPolling = i;
    },
    function (e, t, n) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 });
      ...
      t.ExperimentationServiceBase = class {
        constructor(e, t, n, o, i, s) {
          (this.telemetry = e),
            (this.featuresTelemetryPropertyName = t),
            (this.assignmentContextTelemetryPropertyName = n),
            ...
            this.storage || (s = new r.MemoryKeyValueStorage()),
          ...
          (this._features = e),
            this.telemetry &&
              (this.telemetry.setSharedProperty(
                this.featuresTelemetryPropertyName,
        ...
        getTreatmentVariable(e, t) {
          var n;
          (this.featuresConsumed = !0), this.PostEventToTelemetry(`${e}.${t}`);
          return null === (n = this.features.configs.find((t) => t.Id === e)) ||
            void 0 === n
            ? void 0
            : n.Parameters[t];
        }
...
//# sourceMappingURL=https://ticino.blob.core.windows.net/sourcemaps/054a9295330880ed74ceaedda236253b4f39a335/extensions/github-authentication/dist/extension.js.map
