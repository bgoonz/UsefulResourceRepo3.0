  ...
  (function (e) {
    ...
    function (e, t, r) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.keywords = t.compiletimeconstants = t.globalvariables = void 0),
        (t.globalvariables = {
          $GLOBALS: {
            description:
          ...
          $this: { description: "Refers to the current object" },
        }),
        (t.compiletimeconstants = {
          __CLASS__: {
            description:
          ...
          __LINE__: { description: "The current line number of the file." },
          __METHOD__: {
            description:
          ...
          FALSE: {},
          NULL: {},
          M_PI: { description: "The constant Pi: 3.14159265358979323846" },
          M_E: { description: "The constant e: 2.7182818284590452354" },
          M_LOG2E: {
          ...
          M_PI_2: { description: "The constant pi/2: 1.57079632679489661923" },
          M_PI_4: { description: "The constant pi/4: 0.78539816339744830962" },
          M_1_PI: { description: "The constant 1/pi: 0.31830988618379067154" },
          M_2_PI: { description: "The constant 2/pi: 0.63661977236758134308" },
          M_SQRTPI: {
          ...
          M_EULER: { description: "Euler constant: 0.57721566490153286061" },
          PHP_ROUND_HALF_UP: { description: "Round halves up = 1" },
          PHP_ROUND_HALF_DOWN: { description: "Round halves down = 2" },
          PHP_ROUND_HALF_EVEN: {
            description: "Round halves to even numbers = 3",
          },
          PHP_ROUND_HALF_ODD: { description: "Round halvesto odd numbers = 4" },
          NAN: { description: "NAN (as a float): Not A Number" },
          INF: { description: "INF (as a float): The infinite" },
          PASSWORD_BCRYPT: {
            description:
    ...
    function (e, t, r) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        (t.globalfunctions = {
          ...
          user_error: { description: "Alias of trigger_error" },
          ...
          get_required_files: { description: "Alias of get_included_files" },
          get_resources: {
          ...
          ini_alter: { description: "Alias of ini_set" },
          ini_get_all: {
          ...
          main: { description: "Dummy for main" },
          ...
          gzputs: { description: "Alias of gzwrite" },
          gzread: {
          ...
          hash: {
            ...
            signature:
              "( string $algo , string $data [, bool $raw_output ]): string",
          },
          ...
          openssl_csr_export_to_file: {
            ...
            signature:
              "( mixed $csr , string $outfilename [, bool $notext ]): bool",
          },
          openssl_csr_export: {
          ...
          openssl_digest: {
            ...
            signature:
              "( string $data , string $method [, bool $raw_output ]): string",
          },
          openssl_encrypt: {
          ...
          openssl_x509_export_to_file: {
            ...
            signature:
              "( mixed $x509 , string $outfilename [, bool $notext ]): bool",
          },
          openssl_x509_export: {
            description: "Exports a certificate as a string",
            signature:
              "( mixed $x509 , string $output [, bool $notext ]): bool",
          },
          ...
          password_hash: {
            ...
            signature:
              "( string $password , int $algo [, array $options ]): integer",
          },
          ...
          sodium_crypto_sign_verify_detached: {
            ...
            signature:
              "( string $signature , string $msg , string $public_key ): bool",
          },
          sodium_crypto_sign: {
          ...
          date_add: {
            ...
            signature:
              "( DateInterval $interval , DateTime $object ): DateTime",
          },
          date_create: {
          ...
          date_date_set: {
            ...
            signature:
              "( int $year , int $month , int $day , DateTime $object ): DateTime",
          },
          date_isodate_set: {
            description: "Sets the ISO date",
            signature:
              "( int $year , int $week [, int $day = 1 , DateTime $object ]): DateTime",
          },
          date_time_set: {
            description: "Sets the time",
            signature:
              "( int $hour , int $minute [, int $second = 0 [, int $microseconds = 0 , DateTime $object ]]): DateTime",
          },
          date_timestamp_set: {
          ...
          timezone_offset_get: {
            ...
            signature:
              "( DateTimeInterface $datetime , DateTimeZone $object ): int",
          },
          ...
          localtime: {
            ...
            signature:
              "([ int $timestamp = time() [, bool $is_associative ]]): array",
          },
          microtime: {
          ...
          clearstatcache: {
            ...
            signature:
              "([ bool $clear_realpath_cache [, string $filename ]]): void",
          },
          copy: {
          ...
          delete: { description: "See unlink or unset" },
          dirname: {
          ...
          diskfreespace: { description: "Alias of disk_free_space" },
          fclose: {
          ...
          file_get_contents: {
            ...
            signature:
              "( string $filename [, bool $use_include_path [, resource $context [, int $offset = 0 [, int $maxlen ]]]]): string",
          },
          file_put_contents: {
          ...
          fopen: {
            ...
            signature:
              "( string $filename , string $mode [, bool $use_include_path [, resource $context ]]): resource",
          },
          fpassthru: {
          ...
          fputs: { description: "Alias of fwrite" },
          fread: {
          ...
          is_writeable: { description: "Alias of is_writable" },
          lchgrp: {
          ...
          set_file_buffer: { description: "Alias of stream_set_write_buffer" },
          stat: {
          ...
          collator_asort: {
            ...
            signature:
              "( array $arr [, int $sort_flag , Collator $coll ]): bool",
          },
          collator_compare: {
          ...
          numfmt_format: {
            ...
            signature:
              "( number $value [, int $type , NumberFormatter $fmt ]): string",
          },
          ...
          numfmt_set_attribute: {
            ...
            signature:
              "( int $attr , int $value , NumberFormatter $fmt ): bool",
          },
          numfmt_set_pattern: {
          ...
          numfmt_set_symbol: {
            ...
            signature:
              "( int $attr , string $value , NumberFormatter $fmt ): bool",
          },
          ...
          mb_substitute_character: {
            ...
            signature:
              "([ mixed $substchar = mb_substitute_character() ]): integer",
          },
          mb_substr_count: {
          ...
          asin: { description: "Arc sine", signature: "( float $arg ): float" },
          asinh: {
          ...
          cos: { description: "Cosine", signature: "( float $arg ): float" },
          cosh: {
          ...
          max: {
            ...
            signature:
              "( array $values , mixed $value1 [, mixed $... ]): string",
          },
          min: {
          ...
          pi: { description: "Get value of pi", signature: "(void): float" },
          pow: {
          ...
          sin: { description: "Sine", signature: "( float $arg ): float" },
          sinh: {
          ...
          tan: { description: "Tangent", signature: "( float $arg ): float" },
          tanh: {
          ...
          pcntl_errno: { description: "Alias of pcntl_get_last_error" },
          pcntl_exec: {
          ...
          posix_errno: { description: "Alias of posix_get_last_error" },
          ...
          die: { description: "Equivalent to exit" },
          eval: {
          ...
          show_source: { description: "Alias of highlight_file" },
          sleep: {
          ...
          set_socket_blocking: { description: "Alias of stream_set_blocking" },
          ...
          ftp_quit: { description: "Alias of ftp_close" },
          ftp_raw: {
          ...
          dns_check_record: { description: "Alias of checkdnsrr" },
          dns_get_mx: { description: "Alias of getmxrr" },
          dns_get_record: {
            description:
          ...
          socket_get_status: { description: "Alias of stream_get_meta_data" },
          socket_set_blocking: { description: "Alias of stream_set_blocking" },
          socket_set_timeout: { description: "Alias of stream_set_timeout" },
          syslog: {
          ...
          socket_getopt: { description: "Alias of socket_get_option" },
          socket_getpeername: {
            description:
          ...
          socket_setopt: { description: "Alias of socket_set_option" },
          socket_shutdown: {
          ...
          session_commit: { description: "Alias of session_write_close" },
          session_create_id: {
          ...
          chop: { description: "Alias of rtrim" },
          chr: {
          ...
          fprintf: {
            ...
            signature:
              "( resource $handle , string $format [, mixed $... ]): int",
          },
          ...
          join: { description: "Alias of implode" },
          lcfirst: {
          ...
          setlocale: {
            ...
            signature:
              "( int $category , array $locale [, string $... ]): string",
          },
          sha1_file: {
          ...
          strchr: { description: "Alias of strstr" },
          strcmp: {
          ...
          array_chunk: {
            ...
            signature:
              "( array $array , int $size [, bool $preserve_keys ]): array",
          },
          array_column: {
            description:
          ...
          array_keys: {
            ...
            signature:
              "( array $array , mixed $search_value [, bool $strict ]): array",
          },
          array_map: {
            description:
          ...
          array_search: {
            ...
            signature:
              "( mixed $needle , array $haystack [, bool $strict ]): mixed",
          },
          array_shift: {
          ...
          in_array: {
            ...
            signature:
              "( mixed $needle , array $haystack [, bool $strict ]): bool",
          },
          key_exists: { description: "Alias of array_key_exists" },
          key: {
          ...
          pos: { description: "Alias of current" },
          prev: {
          ...
          sizeof: { description: "Alias of count" },
          sort: {
          ...
          call_user_method: {
            ...
            signature:
              "( string $method_name , object $obj [, mixed $... ]): mixed",
          },
          class_alias: {
            description: "Creates an alias for a class",
            signature:
              "( string $original , string $alias [, bool $autoload ]): bool",
          },
          class_exists: {
          ...
          filter_input_array: {
            ...
            signature:
              "( int $type [, mixed $definition [, bool $add_empty ]]): mixed",
          },
          filter_input: {
            description:
          ...
          doubleval: { description: "Alias of floatval" },
          empty: {
          ...
          is_double: { description: "Alias of is_float" },
          is_float: {
          ...
          is_integer: { description: "Alias of is_int" },
          is_iterable: {
            description:
              "Verify that the contents of a variable is an iterable value",
            signature: "( mixed $var ): array",
          },
          is_long: { description: "Alias of is_int" },
          is_null: {
          ...
          is_real: { description: "Alias of is_float" },
          is_resource: {
          ...
          com_load_typelib: {
            ...
            signature:
              "( string $typelib_name [, bool $case_sensitive ]): bool",
          },
          com_message_pump: {
            description:
          ...
          xml_parse: {
            ...
            signature:
              "( resource $parser , string $data [, bool $is_final ]): int",
          },
          ...
          xmlwriter_start_dtd_entity: {
            ...
            signature:
              "( string $name , bool $isparam , resource $xmlwriter ): bool",
          },
          xmlwriter_start_dtd: {
          ...
          xmlwriter_write_attribute: {
            ...
            signature:
              "( string $name , string $value , resource $xmlwriter ): bool",
          },
    ...
    function (e, t, r) {
      ...
      t.activate = function (e) {
        new o.default(e.workspaceState).activate(e.subscriptions),
          ...
          e.subscriptions.push(
            i.languages.registerHoverProvider("php", new s.default())
          ),
          e.subscriptions.push(
          ...
          i.languages.setLanguageConfiguration("php", {
            wordPattern:
              /(-?\d*\.\d\w*)|([^\-\`\~\!\@\#\%\^\&\*\(\)\=\+\[\{\]\}\\\|\;\:\'\"\,\.\<\>\/\?\s]+)/g,
            onEnterRules: [
              {
              ...
              },
              {
                beforeText: /^\s*\/\*\*(?!\/)([^\*]|\*(?!\/))*$/,
                action: {
                  indentAction: i.IndentAction.None,
                  appendText: " * ",
                },
              },
              {
                beforeText: /^(\t|(\ \ ))*\ \*(\ ([^\*]|\*(?!\/))*)?$/,
                action: { indentAction: i.IndentAction.None, appendText: "* " },
              },
              {
                beforeText: /^(\t|(\ \ ))*\ \*\/\s*$/,
                action: { indentAction: i.IndentAction.None, removeText: 1 },
              },
              {
                beforeText: /^(\t|(\ \ ))*\ \*[^/]*\*\/\s*$/,
                action: { indentAction: i.IndentAction.None, removeText: 1 },
    ...
    function (e, t, r) {
      ...
      const i = r(0),
        ...
        s = r(4);
      t.default = class {
        provideCompletionItems(e, t, r, a) {
          let o = [];
          if (!i.workspace.getConfiguration("php").get("suggest.basic", !0))
            return Promise.resolve(o);
          let c = e.getWordRangeAtPosition(t),
            d = c ? e.getText(c) : "";
          if ((c || (c = new i.Range(t, t)), ">" === a.triggerCharacter)) {
            const r = new i.Position(t.line, Math.max(0, t.character - 2));
            if ("->" !== e.getText(new i.Range(r, t)))
              return Promise.resolve(o);
          }
          let l = {},
            g = function (e, t, r) {
              let n = new i.CompletionItem(t);
              return (
                (n.kind = e),
                r &&
                  (r.description && (n.documentation = r.description),
                  r.signature && (n.detail = r.signature)),
                n
              );
            },
            u = (e) =>
              0 === d.length ||
              (e.length >= d.length && e.substr(0, d.length) === d);
          if (u("php") && c.start.character >= 2) {
            let r = new i.Position(c.start.line, c.start.character - 2);
            if ("<?" === e.getText(new i.Range(r, c.start))) {
              let e = g(i.CompletionItemKind.Class, "<?php", null);
              return (
                (e.textEdit = new i.TextEdit(new i.Range(r, t), "<?php")),
                o.push(e),
                Promise.resolve(o)
              );
            }
          }
          for (let e in n.globalvariables)
            n.globalvariables.hasOwnProperty(e) &&
              u(e) &&
              ((l[e] = !0),
              o.push(
                g(i.CompletionItemKind.Variable, e, n.globalvariables[e])
              ));
          for (let e in s.globalfunctions)
            s.globalfunctions.hasOwnProperty(e) &&
              u(e) &&
              ((l[e] = !0),
              o.push(
                g(i.CompletionItemKind.Function, e, s.globalfunctions[e])
              ));
          for (let e in n.compiletimeconstants)
            n.compiletimeconstants.hasOwnProperty(e) &&
              u(e) &&
              ((l[e] = !0),
              o.push(
                g(i.CompletionItemKind.Field, e, n.compiletimeconstants[e])
              ));
          for (let e in n.keywords)
            n.keywords.hasOwnProperty(e) &&
              u(e) &&
              ((l[e] = !0),
              o.push(g(i.CompletionItemKind.Keyword, e, n.keywords[e])));
          let p = e.getText();
          if ("$" === d[0]) {
            let e = /\$([a-zA-Z_\x7f-\xff][a-zA-Z0-9_\x7f-\xff]*)/g,
              t = null;
            for (; (t = e.exec(p)); ) {
              let e = t[0];
              l[e] ||
                ((l[e] = !0),
                o.push(g(i.CompletionItemKind.Variable, e, null)));
            }
          }
          let m = /function\s+([a-zA-Z_\x7f-\xff][a-zA-Z0-9_\x7f-\xff]*)\s*\(/g,
            _ = null;
          for (; (_ = m.exec(p)); ) {
            let e = _[1];
            l[e] ||
              ((l[e] = !0), o.push(g(i.CompletionItemKind.Function, e, null)));
          }
          return Promise.resolve(o);
        }
      };
    ...
    function (e, t, r) {
      ...
      t.default = class {
        provideHover(e, t, r) {
          if (!i.workspace.getConfiguration("php").get("suggest.basic", !0))
            return;
          let o = e.getWordRangeAtPosition(t);
          if (!o) return;
          let c = e.getText(o),
            d =
              a.globalfunctions[c] ||
              s.compiletimeconstants[c] ||
              s.globalvariables[c] ||
              s.keywords[c];
          if (d && d.description) {
            let e = c + (d.signature || ""),
              t = [
                (0, n.textToMarkedString)(d.description),
                { language: "php", value: e },
              ];
            return new i.Hover(t, o);
          }
        }
      };
    },
    function (e, t, r) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.textToMarkedString = void 0),
        (t.textToMarkedString = function (e) {
    ...
    function (e, t, r) {
      ...
      class C {
        constructor(e, t, r) {
          (this.lineNumber = r),
            (this.offset = t),
            (this.line = e.lineAt(this.lineNumber).text),
            (this.model = e);
        }
        hasNext() {
          ...
          if (this.offset < 0)
            return this.lineNumber > 0
              ? (this.lineNumber--,
                ...
                a)
              : ((this.lineNumber = -1), 0);
          let e = this.line.charCodeAt(this.offset);
          return this.offset--, e;
        }
      }
      t.default = class {
        provideSignatureHelp(e, t, r) {
          if (!i.workspace.getConfiguration("php").get("suggest.basic", !0))
            return null;
          let a = new C(e, t.character - 1, t.line),
            o = this.readArguments(a);
          if (o < 0) return null;
          let c = this.readIdent(a);
          if (!c) return null;
          let d = s.globalfunctions[c] || n.keywords[c];
          if (!d || !d.signature) return null;
          let l = d.signature.substring(0, d.signature.lastIndexOf(")") + 1),
            g = new i.SignatureInformation(c + l, d.description),
            u = /\w*\s+\&?\$[\w_\.]+|void/g,
            p = null;
          for (; null !== (p = u.exec(l)); )
            g.parameters.push({ label: p[0], documentation: "" });
          let m = new i.SignatureHelp();
          return (
            m.signatures.push(g),
            (m.activeSignature = 0),
            (m.activeParameter = Math.min(o, g.parameters.length - 1)),
            Promise.resolve(m)
          );
        }
        readArguments(e) {
        ...
        readIdent(e) {
          ...
          for (; e.hasNext(); ) {
            let i = e.next();
            if (t || (i !== c && i !== o && i !== a))
              if (this.isIdentPart(i))
                (t = !0), (r = String.fromCharCode(i) + r);
              else if (t) return r;
          }
          return r;
        }
    ...
    function (e, t, r) {
      ...
      const i = r(11),
        ...
        o = r(0),
        c = r(17);
      let d = r(18).loadMessageBundle(
        r(1).join(__dirname, "features/validationProvider.ts")
      );
      class l {
        constructor(e = "utf8") {
          (this.stringDecoder = new n.StringDecoder(e)),
            (this.remaining = null);
        }
        write(e) {
          let t = [],
            r = this.remaining
              ? this.remaining + this.stringDecoder.write(e)
              : this.stringDecoder.write(e);
          if (r.length < 1) return t;
          let i,
            n = 0;
          for (; n < r.length && (13 === (i = r.charCodeAt(n)) || 10 === i); )
            n++;
          let s = n;
          for (; s < r.length; )
            if (((i = r.charCodeAt(s)), 13 === i || 10 === i)) {
              for (
                t.push(r.substring(n, s)), s++;
                s < r.length && (13 === (i = r.charCodeAt(s)) || 10 === i);

              )
                s++;
              n = s;
            } else s++;
          return (this.remaining = n < r.length ? r.substr(n) : null), t;
        }
        end() {
      ...
      (t.LineDecoder = l),
        (function (e) {
          (e[(e.onSave = 0)] = "onSave"), (e[(e.onType = 1)] = "onType");
        })(g || (g = {})),
        (function (e) {
          (e.strings = { onSave: "onSave", onType: "onType" }),
            (e.from = function (t) {
              return "onType" === t ? e.onType : e.onSave;
            });
        })(g || (g = {}));
      class u {
        constructor(e) {
          (this.workspaceStore = e),
            (this.documentListener = null),
            (this.validationEnabled = !0),
            (this.pauseValidation = !1),
            (this.loadConfigP = this.loadConfiguration());
        }
        activate(e) {
          (this.diagnosticCollection =
            o.languages.createDiagnosticCollection()),
            e.push(this),
            e.push(
              o.workspace.onDidChangeConfiguration(
                () => (this.loadConfigP = this.loadConfiguration())
              )
            ),
            o.workspace.onDidOpenTextDocument(this.triggerValidate, this, e),
            o.workspace.onDidCloseTextDocument(
              (e) => {
                this.diagnosticCollection.delete(e.uri),
                  delete this.delayers[e.uri.toString()];
              },
              null,
              e
            ),
        ...
        dispose() {
          this.diagnosticCollection &&
            ...
            this.documentListener &&
              (this.documentListener.dispose(), (this.documentListener = null));
        }
        async loadConfiguration() {
          ...
          const t = o.workspace.getConfiguration(),
            r =
              null === (e = this.config) || void 0 === e
                ? void 0
                : e.executable;
          (this.validationEnabled = t.get("php.validate.enable", !0)),
            (this.config = await (async function () {
              const e = o.workspace.getConfiguration();
              let t, r;
              const i = e.inspect("php.validate.executablePath");
              i && i.workspaceValue
                ? ((t = i.workspaceValue), (r = !1))
                : i && i.globalValue
                ? ((t = i.globalValue), (r = !0))
                : ((t = void 0), (r = void 0));
              if (t && !a.isAbsolute(t)) {
                const e =
                  o.workspace.workspaceFolders &&
                  o.workspace.workspaceFolders[0];
                t = e ? o.Uri.joinPath(e.uri, t).fsPath : void 0;
              } else
                t ||
              ...
              const n = g.from(e.get("php.validate.run", g.strings.onSave));
              return { executable: t, executableIsUserDefined: r, trigger: n };
            })()),
            !0 !== this.config.executableIsUserDefined &&
              void 0 !==
                this.workspaceStore.get(
          ...
          o.workspace
            ...
            o.workspace.requestWorkspaceTrust(),
            (this.delayers = Object.create(null)),
            this.pauseValidation &&
              (this.pauseValidation = r === this.config.executable),
            this.documentListener &&
              (this.documentListener.dispose(), (this.documentListener = null)),
            this.diagnosticCollection.clear(),
            this.validationEnabled &&
              (this.config.trigger === g.onType
                ? (this.documentListener = o.workspace.onDidChangeTextDocument(
                    (e) => {
                      this.triggerValidate(e.document);
                    }
                  ))
                : (this.documentListener = o.workspace.onDidSaveTextDocument(
                    this.triggerValidate,
                    this
                  )),
              o.workspace.textDocuments.forEach(this.triggerValidate, this));
        }
        ...
        async triggerValidate(e) {
          ...
          if (
            ...
            o.workspace.isTrusted && t();
          else if (
            void 0 !== this.config.executableIsUserDefined &&
            !this.config.executableIsUserDefined
          ) {
            const e = this.workspaceStore.get(
              "php.validate.checkedExecutablePath",
              void 0
            );
            if (!e || e !== this.config.executable) {
              if (!(await this.showCustomTrustDialog()))
                return void (this.pauseValidation = !0);
              this.workspaceStore.update(
                "php.validate.checkedExecutablePath",
        ...
        async showCustomTrustDialog() {
          const e = await o.window.showInformationMessage(
            d(0, null, this.config.executable),
            { title: d(1, null), id: "yes" },
            { title: d(2, null), isCloseAffordance: !0, id: "no" }
          );
          return !(!e || "yes" !== e.id);
        }
        doValidate(e) {
          return new Promise(async (t) => {
            const r = this.config.executable;
            if (!r)
              return (
                this.showErrorMessage(d(3, null)),
                (this.pauseValidation = !0),
                void t()
              );
            if (!a.isAbsolute(r)) return;
            let n,
              s = new l(),
              c = [],
              p = (e) => {
                let t = e.match(u.MatchExpression);
                if (t) {
                  let e = t[1],
                    r = parseInt(t[3]) - 1,
                    i = new o.Diagnostic(
                      new o.Range(r, 0, r, Number.MAX_VALUE),
                      e
                    );
                  c.push(i);
                }
              ...
              m =
                o.workspace.workspaceFolders && o.workspace.workspaceFolders[0]
                  ? { cwd: o.workspace.workspaceFolders[0].uri.fsPath }
                  : void 0;
            this.config.trigger === g.onSave
              ? ((n = u.FileArgs.slice(0)), n.push(e.fileName))
              : (n = u.BufferArgs);
            try {
              let a = i.spawn(r, n, m);
              a.on("error", (e) => {
                this.pauseValidation ||
                  (this.showError(e, r), (this.pauseValidation = !0)),
                  t();
              }),
                a.pid
                  ? (this.config.trigger === g.onType &&
                      (a.stdin.write(e.getText()), a.stdin.end()),
                    a.stdout.on("data", (e) => {
                      s.write(e).forEach(p);
                    }),
                    a.stdout.on("end", () => {
                      let r = s.end();
                      r && p(r), this.diagnosticCollection.set(e.uri, c), t();
                    }))
                  : t();
            } catch (e) {
              this.showError(e, r);
        ...
        async showError(e, t) {
          ...
          if (
            ...
            return this.showErrorMessage(r);
        }
        async showErrorMessage(e) {
          const t = d(7, null);
          (await o.window.showInformationMessage(e, t)) === t &&
            o.commands.executeCommand(
      ...
      const i =
        ...
        c = (e, t) => {
          const r = t.colon || s,
            ...
            o = i ? a.split(r) : [""];
          return (
            i && -1 !== e.indexOf(".") && "" !== o[0] && o.unshift(""),
            { pathEnv: n, pathExt: o, pathExtExe: a }
          );
        },
        d = (e, t, r) => {
          "function" == typeof t && ((r = t), (t = {})), t || (t = {});
          const { pathEnv: i, pathExt: s, pathExtExe: d } = c(e, t),
            l = [],
            g = (r) =>
              new Promise((s, a) => {
                if (r === i.length) return t.all && l.length ? s(l) : a(o(e));
                const c = i[r],
                  d = /^".*"$/.test(c) ? c.slice(1, -1) : c,
                  g = n.join(d, e),
                  p = !d && /^\.[\\\/]/.test(e) ? e.slice(0, 2) + g : g;
                s(u(p, r, 0));
              }),
            u = (e, r, i) =>
              new Promise((n, o) => {
                if (i === s.length) return n(g(r + 1));
                const c = s[i];
                a(e + c, { pathExt: d }, (s, a) => {
                  if (!s && a) {
                    if (!t.all) return n(e + c);
                    l.push(e + c);
                  }
                  return n(u(e, r, i + 1));
                });
              });
          return r ? g(0).then((e) => r(null, e), r) : g(0);
        };
      (e.exports = d),
        (d.sync = (e, t) => {
          t = t || {};
          const { pathEnv: r, pathExt: i, pathExtExe: s } = c(e, t),
            d = [];
          for (let o = 0; o < r.length; o++) {
            const c = r[o],
              l = /^".*"$/.test(c) ? c.slice(1, -1) : c,
              g = n.join(l, e),
              u = !l && /^\.[\\\/]/.test(e) ? e.slice(0, 2) + g : g;
            for (let e = 0; e < i.length; e++) {
              const r = u + i[e];
              try {
                if (a.sync(r, { pathExt: s })) {
                  if (!t.all) return r;
                  d.push(r);
                }
              } catch (e) {}
    ...
    function (e, t, r) {
      ...
      (i =
        "win32" === process.platform || global.TESTING_WINDOWS ? r(15) : r(16)),
        (e.exports = n),
        (n.sync = function (e, t) {
          try {
            return i.sync(e, t || {});
        ...
        return (
          ...
          (function (e, t) {
            var r = e.mode,
              ...
              a = void 0 !== t.gid ? t.gid : process.getgid && process.getgid(),
              o = parseInt("100", 8),
              c = parseInt("010", 8),
              d = parseInt("001", 8),
              l = o | c;
    ...
    function (e, t, r) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.ThrottledDelayer = t.Delayer = t.Throttler = void 0);
      class i {
        constructor() {
      ...
      class n {
          ...
          return (
            ...
            this.completionPromise ||
              (this.completionPromise = new Promise((e) => {
                ...
                (this.completionPromise = null), (this.onResolve = null);
                let e = this.task();
                return (this.task = null), e;
              })),
            (this.timeout = setTimeout(() => {
              (this.timeout = null), this.onResolve(void 0);
            }, t)),
            this.completionPromise
          );
        }
        ...
        cancel() {
          this.cancelTimeout(),
            this.completionPromise && (this.completionPromise = null);
        }
        cancelTimeout() {
          null !== this.timeout &&
      ...
      t.Delayer = n;
      t.ThrottledDelayer = class extends n {
        constructor(e) {
          super(e), (this.throttler = new i());
        }
        trigger(e, t) {
          return super.trigger(() => this.throttler.queue(e), t);
        }
      };
    },
    function (e, t, r) {
      ...
      function m(e) {
        return JSON.parse(d.readFileSync(e, "utf8"));
      }
      function _(e, t) {
        return (
          o && (e = "［" + e.replace(/[aouei]/g, "$&$&") + "］"),
          0 === t.length
            ? e
      ...
      function y(e, t) {
        ...
        try {
          return (
            (r = JSON.parse(
              d.readFileSync(s, { encoding: "utf8", flag: "r" })
            )),
            (i = s),
            (n = new Date()),
            d.utimes(i, n, n, function () {}),
            r
          );
        } catch (e) {
        ...
        if (
          !(r = (function (e, t) {
            var r = a.translationsConfig[e.id];
            if (r) {
              var i = m(r).contents,
                n = m(c.join(t, "nls.metadata.json")),
                s = Object.create(null);
              for (var o in n) {
                var d = n[o],
                  l = i[e.outDir + "/" + o];
                if (l) {
                  for (var g = [], u = 0; u < d.keys.length; u++) {
                    var _ = d.keys[u],
                      $ = l[p(_) ? _ : _.key];
                    void 0 === $ && ($ = d.messages[u]), g.push($);
                  }
                  s[o] = g;
                } else s[o] = d.messages;
              }
      ...
      function x(e) {
        ...
        if (
          ...
          a.messageFormat === i.both || a.messageFormat === i.bundle)
        ) {
          var r = (function (e) {
            for (
              var t, r = c.dirname(e);
              (t = c.join(r, "nls.metadata.header.json")), !d.existsSync(t);
          ...
          if (r) {
            ...
            if (void 0 === l)
              try {
                var u = JSON.parse(d.readFileSync(r, "utf8"));
                try {
                  var p = v(u, n);
                  l = h(n, p ? { header: u, nlsBundle: p } : null);
                } catch (e) {
            ...
            if (l) {
              var _ = e.substr(n.length + 1).replace(/\\/g, "/"),
                y = l.nlsBundle[_];
              return void 0 === y
                ? (console.error(
                    "Messages for file " +
        ...
        if (a.messageFormat === i.both || a.messageFormat === i.file)
          try {
            var b = m(
              (function (e) {
                var t;
                if (a.cacheLanguageResolution && t) t = t;
                  ...
                  if (o || !a.locale) t = ".nls.json";
                  else
                    for (var r = a.locale; r; ) {
                      var i = ".nls." + r + ".json";
                      if (d.existsSync(e + i)) {
                        t = i;
                        break;
      ...
      })((i = t.MessageFormat || (t.MessageFormat = {}))),
        (function (e) {
          e.is = function (e) {
            var t = e;
            return t && g(t.key) && g(t.comment);
          };
        })(n || (n = {})),
        (function () {
          if (
          ...
          var t;
          (o = "pseudo" === a.locale), void 0, (s = Object.create(null));
        })(),
          ...
          return (
            e &&
              ...
              void 0 !== e.messageFormat &&
                (a.messageFormat = e.messageFormat)),
            (o = "pseudo" === a.locale),
            x
          );
        });
...
//# sourceMappingURL=https://ticino.blob.core.windows.net/sourcemaps/054a9295330880ed74ceaedda236253b4f39a335/extensions/php-language-features/dist/phpMain.js.map
