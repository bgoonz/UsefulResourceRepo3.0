  ...
  (function (e) {
    ...
    function (e, t, n) {
      ...
      global.diagnosticsSource ||
        ...
        (n(32).prototype.require = r.makePatchingRequire(
          ...
          return (
            (e.prototype.enable = function (e) {
              (this._isEnabled = e),
                ...
                d.IsInitialized &&
                  (n(117).enable(e, this._client),
                  n(118).enable(e, this._client),
                  n(119).enable(e, this._client),
                  n(120).enable(e, this._client));
            }),
                  ...
                  if (h && h.operation)
                    try {
                      if (
                        ...
                        var y = new p().toString();
                        n.request.setHeader(a.traceparentHeader, y);
                      }
                      if (h.operation.tracestate) {
                        var v = h.operation.tracestate.toString();
                        v && n.request.setHeader(a.traceStateHeader, v);
                      }
                      var m = h.customProperties.serializeToHeader();
                      m && n.request.setHeader(a.correlationContextHeader, m);
                    } catch (e) {
                      i.warn(
    ...
    function (e, t) {
      ...
      i[P] = "(?:~>?)";
      var O = s++;
      (i[O] = "(\\s*)" + i[P] + "\\s+"), (o[O] = new RegExp(i[O], "g"));
      var D = s++;
      i[D] = "^" + i[P] + i[C] + "$";
      var R = s++;
      i[R] = "^" + i[P] + i[x] + "$";
      ...
      i[N] = "(?:\\^)";
      var L = s++;
      (i[L] = "(\\s*)" + i[N] + "\\s+"), (o[L] = new RegExp(i[L], "g"));
      var M = s++;
      i[M] = "^" + i[N] + i[C] + "$";
      var q = s++;
      i[q] = "^" + i[N] + i[x] + "$";
      ...
      (re.prototype.parse = function (e) {
        var t = this.options.loose ? o[j] : o[H],
          n = e.match(t);
              ...
              .map(function (e) {
                return (function (e, t) {
                  return (
                    ...
                    (e = (function (e, t) {
                      return (
                        n("replaceStars", e, t), e.trim().replace(o[B], "")
                      );
                    })(e, t)),
                    n("stars", e),
                    e
              ...
              if (
                ...
                if ("function" == typeof process.cpuUsage) {
                  ...
                  if (
                    ...
                    h =
                      (100 * v) /
                      ((1e6 * (y[0] - this._lastHrtime[0]) +
                        (y[1] - this._lastHrtime[1]) / 1e3 || 0) *
                        e.length);
                  (this._lastAppCpuUsage = f), (this._lastHrtime = y);
                }
                var m = t + n + i + s + a || 1;
    ...
    function (e, t, n) {
      ...
      const i = new (class {
        constructor() {
          this.output = r.window.createOutputChannel(
    ...
    function (e, t, n) {
      ...
      function b(e, t) {
        ...
        if (
          !(n = (function (e, t) {
            ...
            if (n) {
              var r = y(n).contents,
                o = y(u.join(t, "nls.metadata.json")),
              ...
              for (var s in o) {
                ...
                if (l) {
                  for (var p = [], d = 0; d < c.keys.length; d++) {
                    var h = c.keys[d],
                      v = l[f(h) ? h : h.key];
                    void 0 === v && (v = c.messages[d]), p.push(v);
                  }
                  i[s] = p;
                } else i[s] = c.messages;
              }
      ...
      function E(e) {
        try {
          return (function (e) {
            var t = y(u.join(e, "nls.metadata.json")),
          ...
          if (n) {
            ...
            if (void 0 === i)
              try {
                ...
                try {
                  var h = T(p, o);
                  i = _(o, h ? { header: p, nlsBundle: h } : null);
                } catch (e) {
          ...
          if (
            ...
            try {
              ...
              if (
                ...
                try {
                  a.translationsConfig = y(a.translationsConfigFile);
                } catch (t) {
                  e._corruptedFile &&
                    l.writeFile(
                      e._corruptedFile,
        ...
        return function (n) {
          ...
          if (e[n]) {
            ...
            for (var d = c, h = 0, f = e[n]; h < f.length; h++) {
              var y = f[h];
              o.satisfies(l, y.versionSpecifier) && (d = y.patch(d, u));
            }
            return (t[u] = d);
          }
          return c;
    ...
    function (e, t, n) {
      if (global._stackChain) {
        if (global._stackChain.version !== n(36).version)
          throw new Error("Conflicting version of stack-chain found");
        e.exports = global._stackChain;
      } else e.exports = global._stackChain = n(85);
    },
    function (e) {
      e.exports = JSON.parse(
    ...
    function (e, t, n) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.AvailabilityData = n(96)),
        (t.Base = n(39)),
        (t.ContextTagKeys = n(97)),
        (t.Data = n(98)),
        (t.DataPoint = n(99)),
        (t.DataPointType = n(40)),
        (t.Domain = n(9)),
        (t.Envelope = n(100)),
        (t.EventData = n(41)),
        (t.ExceptionData = n(101)),
        (t.ExceptionDetails = n(102)),
        (t.MessageData = n(103)),
        (t.MetricData = n(104)),
        (t.PageViewData = n(105)),
        (t.RemoteDependencyData = n(106)),
        (t.RequestData = n(107)),
        (t.SeverityLevel = n(108)),
        (t.StackFrame = n(109));
    },
    function (e, t, n) {
      "use strict";
    ...
    function (e, t, n) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.deactivate = t.activate = t.DEFAULT_SCOPES = void 0);
      const r = n(14),
        o = n(46),
        i = n(56);
      (t.DEFAULT_SCOPES =
        ...
        (t.activate = async function (e) {
          const { name: t, version: s, aiKey: a } = n(137),
            c = new i.default(t, s, a),
            u = new o.AzureActiveDirectoryService(e);
            ...
            e.subscriptions.push(
              r.authentication.registerAuthenticationProvider(
                ...
                "Microsoft",
                {
                  ...
                  getSessions: (e) => u.getSessions(e),
                  createSession: async (e) => {
                    try {
                      c.sendTelemetryEvent("login");
                      const t = await u.createSession(e.sort().join(" "));
                      return (
                      ...
                      throw (c.sendTelemetryEvent("loginFailed"), e);
                    }
                  },
                  removeSession: async (e) => {
                    try {
                      c.sendTelemetryEvent("logout");
                      const t = await u.removeSession(e);
                      t &&
                        o.onDidChangeSessions.fire({
                          added: [],
                          removed: [t],
                      ...
                      c.sendTelemetryEvent("logoutFailed");
                    }
                  },
                },
                { supportsMultipleAccounts: !0 }
              )
            );
        }),
    ...
    function (e, t, n) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.AzureActiveDirectoryService =
          t.REFRESH_NETWORK_FAILURE =
          t.onDidChangeSessions =
            void 0);
      const r = n(47),
        o = n(48),
        i = n(49),
        ...
        d = n(54),
        h = n(55),
        f = n(30).loadMessageBundle(n(7).join(__dirname, "AADHelper.ts")),
        y = "https://vscode-redirect.azurewebsites.net/",
        v = "https://login.microsoftonline.com/",
        m = "aebc6443-996d-45c2-90f0-388ff96faa56",
        g = "organizations";
      (t.onDidChangeSessions = new s.EventEmitter()),
        (t.REFRESH_NETWORK_FAILURE = "Network failure");
      class _ extends s.EventEmitter {
        handleUri(e) {
          this.fire(e);
        }
      }
      t.AzureActiveDirectoryService = class {
        constructor(e) {
          (this._context = e),
            (this._tokens = []),
            ...
            (this._keychain = new u.Keychain(e)),
            (this._uriHandler = new _()),
            this._disposables.push(
              s.window.registerUriHandler(this._uriHandler)
            );
        }
        async initialize() {
          const e =
          ...
          if (e)
            try {
              const n = this.parseStoredData(e).map(async (e) => {
                var n;
                if (!e.refreshToken) return Promise.resolve();
                try {
                  await this.refreshToken(e.refreshToken, e.scope, e.id);
                } catch (r) {
                  if (r.message === t.REFRESH_NETWORK_FAILURE) {
                    (await this.handleRefreshNetworkError(
                      e.id,
                      e.refreshToken,
                      e.scope
                    )) ||
                      (this._tokens.push({
                        ...
                        account: {
                          label:
                            null !== (n = e.account.label) && void 0 !== n
                              ? n
                      ...
                      this.pollForReconnect(e.id, e.refreshToken, e.scope));
                  } else await this.removeSession(e.id);
                }
              });
              await Promise.all(n);
            } catch (e) {
              l.default.info("Failed to initialize stored data"),
        ...
        async storeTokenData() {
          const e = this._tokens.map((e) => ({
            id: e.sessionId,
            refreshToken: e.refreshToken,
            scope: e.scope,
            account: e.account,
          }));
          await this._keychain.setToken(JSON.stringify(e));
        }
        async checkForUpdates() {
          const e = [];
          let n = [];
          const r = await this._keychain.getToken();
          if (r)
            try {
              const o = this.parseStoredData(r);
              let i = o.map(async (n) => {
                if (
                  !this._tokens.some(
                    (e) => e.scope === n.scope && e.sessionId === n.id
                  ) &&
                  n.refreshToken
                )
                  try {
                    ...
                    e.push(this.convertToSessionSync(t));
                  } catch (e) {
                    e.message === t.REFRESH_NETWORK_FAILURE ||
                      (await this.removeSession(n.id));
                  }
              });
              (i = i.concat(
                this._tokens.map(async (e) => {
                  o.some((t) => e.scope === t.scope && e.sessionId === t.id) ||
                    (await this.removeSession(e.sessionId),
                    n.push(this.convertToSessionSync(e)));
                })
              )),
                await Promise.all(i);
            } catch (e) {
              l.default.error(e.message),
                (n = this._tokens.map(this.convertToSessionSync)),
                this.clearSessions();
            }
          else
            this._tokens.length &&
              ((n = this._tokens.map(this.convertToSessionSync)),
              l.default.info("No stored keychain data, clearing local data"),
              (this._tokens = []),
              this._refreshTimeouts.forEach((e) => {
                clearTimeout(e);
              }),
              this._refreshTimeouts.clear());
          (e.length || n.length) &&
            t.onDidChangeSessions.fire({ added: e, removed: n, changed: [] });
        }
        convertToSessionSync(e) {
          return {
            id: e.sessionId,
        ...
        async convertToSession(e) {
          const t = await this.resolveAccessAndIdTokens(e);
          return {
            id: e.sessionId,
        ...
        async resolveAccessAndIdTokens(e) {
          if (e.accessToken && (!e.expiresAt || e.expiresAt > Date.now()))
            return (
              e.expiresAt
                ? l.default.info(
                    `Token available from cache, expires in ${
                      e.expiresAt - Date.now()
                    } milliseconds`
                  )
                : l.default.info("Token available from cache"),
              Promise.resolve({
                accessToken: e.accessToken,
                idToken: e.idToken,
              })
          ...
          try {
            l.default.info("Token expired or unavailable, trying refresh");
            const t = await this.refreshToken(
              e.refreshToken,
              e.scope,
              e.sessionId
        ...
        getTokenClaims(e) {
          try {
            return JSON.parse(
              i.Buffer.from(e.split(".")[1], "base64").toString()
            );
          } catch (e) {
            throw (
              (l.default.error(e.message),
              new Error("Unable to read token claims"))
            );
          }
        }
        get sessions() {
          return Promise.all(this._tokens.map((e) => this.convertToSession(e)));
        }
        async getSessions(e) {
          if (!e) return this.sessions;
          const t = e.sort().join(" "),
            n = this._tokens.filter((e) => e.scope === t);
          return Promise.all(n.map((e) => this.convertToSession(e)));
        }
        async createSession(e) {
          return (
            l.default.info("Logging in..."),
            e.includes("offline_access") ||
              l.default.info(
                "Warning: The 'offline_access' scope was not included, so the generated token will not be able to be refreshed."
              ),
            new Promise(async (t, n) => {
              const o = void 0 !== s.env.remoteName,
                i =
                  void 0 === s.env.remoteName && s.env.uiKind === s.UIKind.Web;
              if (o || i) return void t(this.loginWithoutLocalServer(e));
              const c = r(16).toString("base64"),
                {
                  server: u,
                  redirectPromise: d,
                  codePromise: f,
              ...
              let _;
              try {
                const o = await (0, a.startServer)(u);
                s.env.openExternal(
                  s.Uri.parse(
                    `http://localhost:${o}/signin?nonce=${encodeURIComponent(
                      c
                    )}`
                  )
                );
                ...
                if ("err" in i) {
                  ...
                  throw (
                    (t.writeHead(302, {
                      Location:
                        "/?error=" +
                        encodeURIComponent((e && e.message) || "Unknown error"),
                    }),
                    t.end(),
                    e)
                  );
                }
                const b = i.req.headers.host || "",
                  E = (/^[^:]+:(\d+)$/.exec(Array.isArray(b) ? b[0] : b) ||
                    [])[1],
                  T = `${E ? parseInt(E, 10) : o},${encodeURIComponent(c)}`,
                  I = (0, p.toBase64UrlEncoding)(r(32).toString("base64")),
                  w = (0, p.toBase64UrlEncoding)(await (0, h.sha256)(I)),
                  C = `${v}${g}/oauth2/v2.0/authorize?response_type=code&response_mode=query&client_id=${encodeURIComponent(
                    m
                  )}&redirect_uri=${encodeURIComponent(
                    y
                  )}&state=${T}&scope=${encodeURIComponent(
                    e
                  )}&prompt=select_account&code_challenge_method=S256&code_challenge=${w}`;
                await i.res.writeHead(302, { Location: C }), i.res.end();
                const x = await f,
                  k = x.res;
                try {
                  if ("err" in x) throw x.err;
                  (_ = await this.exchangeCodeForToken(x.code, I, e)),
                    this.setToken(_, e),
                    l.default.info("Login successful"),
                    k.writeHead(302, { Location: "/" });
                  t(await this.convertToSession(_)), k.end();
                } catch (e) {
                  k.writeHead(302, {
                    Location:
                      "/?error=" +
                ...
                l.default.error(t.message),
                  ("Error listening to server" !== t.message &&
                    "Closed" !== t.message &&
                    "Timeout waiting for port" !== t.message) ||
                    (await this.loginWithoutLocalServer(e)),
                  n(t.message);
              } finally {
                setTimeout(() => {
                  u.close();
        ...
        getCallbackEnvironment(e) {
          if (
            e.authority.endsWith(".workspaces.github.com") ||
            e.authority.endsWith(".github.dev")
          )
            return e.authority + ",";
          switch (e.authority) {
        ...
        async loginWithoutLocalServer(e) {
          const t = await s.env.asExternalUri(
              s.Uri.parse(
                s.env.uriScheme + "://vscode.microsoft-authentication"
              )
            ),
            n = r(16).toString("base64"),
            o =
              (t.authority.match(/:([0-9]*)$/) || [])[1] ||
              ("https" === t.scheme ? 443 : 80),
            i = `${this.getCallbackEnvironment(t)}${o},${encodeURIComponent(
              n
            )},${encodeURIComponent(t.query)}`,
            a = `${v}${g}/oauth2/v2.0/authorize`;
          let c = s.Uri.parse(a);
          const u = (0, p.toBase64UrlEncoding)(r(32).toString("base64")),
            l = (0, p.toBase64UrlEncoding)(await (0, h.sha256)(u));
          (c = c.with({
            query: `response_type=code&client_id=${encodeURIComponent(
              m
            )}&response_mode=query&redirect_uri=${y}&state=${i}&scope=${e}&prompt=select_account&code_challenge_method=S256&code_challenge=${l}`,
          })),
            s.env.openExternal(c);
          const d = new Promise((e, t) => {
              const n = setTimeout(() => {
                clearTimeout(n), t("Login timed out.");
              }, 3e5);
            }),
            f = this._pendingStates.get(e) || [];
          this._pendingStates.set(e, [...f, i]);
          let _ = this._codeExchangePromises.get(e);
          return (
            _ ||
              ((_ = this.handleCodeResponse(e)),
              this._codeExchangePromises.set(e, _)),
            this._codeVerfifiers.set(i, u),
            Promise.race([_, d]).finally(() => {
              this._pendingStates.delete(e),
                this._codeExchangePromises.delete(e),
                this._codeVerfifiers.delete(i);
            })
          );
        }
        async handleCodeResponse(e) {
          let t;
          return new Promise((n, r) => {
            t = this._uriHandler.event(async (t) => {
              var o;
              try {
                const r = (function (e) {
                  ...
                  i = r.code,
                  s = this._pendingStates.get(e) || [];
                if (
                  !s.includes(r.state) &&
                  !s.includes(decodeURIComponent(r.state))
                )
                  throw new Error("State does not match.");
                const a =
                  null !== (o = this._codeVerfifiers.get(r.state)) &&
                  void 0 !== o
                    ? o
                    : this._codeVerfifiers.get(decodeURIComponent(r.state));
                if (!a) throw new Error("No available code verifier");
                const c = await this.exchangeCodeForToken(i, a, e);
                this.setToken(c, e);
                const u = await this.convertToSession(c);
                n(u);
              } catch (e) {
                r(e);
              }
        ...
        async setToken(e, n) {
          const r = this._tokens.findIndex((t) => t.sessionId === e.sessionId);
          r > -1 ? this._tokens.splice(r, 1, e) : this._tokens.push(e),
            this.clearSessionTimeout(e.sessionId),
            e.expiresIn &&
              this._refreshTimeouts.set(
                ...
                setTimeout(async () => {
                  try {
                    ...
                    t.onDidChangeSessions.fire({
                      added: [],
                      removed: [],
                      changed: [this.convertToSessionSync(r)],
                    });
                  } catch (r) {
                    if (r.message === t.REFRESH_NETWORK_FAILURE) {
                      (await this.handleRefreshNetworkError(
                      ...
                      await this.removeSession(e.sessionId),
                        t.onDidChangeSessions.fire({
                          added: [],
                          removed: [this.convertToSessionSync(e)],
                          changed: [],
                        });
                  }
                }, 1e3 * (e.expiresIn - 30))
        ...
        getTokenFromResponse(e, t, n) {
          let r = void 0;
          try {
            r = this.getTokenClaims(e.access_token);
          } catch (t) {
            if (!e.id_token) throw t;
            l.default.info(
              "Failed to fetch token claims from access_token. Attempting to parse id_token instead"
            ),
              (r = this.getTokenClaims(e.id_token));
          }
          return {
            expiresIn: e.expires_in,
            expiresAt: e.expires_in ? Date.now() + 1e3 * e.expires_in : void 0,
            ...
            sessionId:
              n ||
              `${r.tid}/${r.oid || r.altsecid || "" + r.ipd || ""}/${(0,
              c.v4)()}`,
            account: {
              label:
                r.email ||
                ...
                "user@example.com",
              id: `${r.tid}/${r.oid || r.altsecid || "" + r.ipd || ""}`,
            },
          };
        }
        async exchangeCodeForToken(e, t, n) {
          l.default.info("Exchanging login code for token");
          try {
            const r = o.stringify({
              ...
              i = await s.commands.executeCommand(
                "workbench.getCodeExchangeProxyEndpoints"
              ),
              a = (i && i.microsoft) || `${v}${g}/oauth2/v2.0/token`,
              c = await (0, d.default)(a, {
                method: "POST",
                headers: {
            ...
            if (c.ok) {
              l.default.info("Exchanging login code for token success");
              const e = await c.json();
              return this.getTokenFromResponse(e, n);
            }
            throw (
              (l.default.error("Exchanging login code for token failed"),
              new Error("Unable to login."))
            );
          } catch (e) {
            throw (l.default.error(e.message), e);
          }
        }
        async refreshToken(e, n, r) {
          l.default.info("Refreshing token...");
          const i = o.stringify({
            refresh_token: e,
            client_id: m,
          ...
          try {
            a = await (0, d.default)(
              `https://login.microsoftonline.com/${g}/oauth2/v2.0/token`,
              {
                method: "POST",
                headers: {
                  "Content-Type": "application/x-www-form-urlencoded",
            ...
            throw (
              (l.default.error("Refreshing token failed"),
              new Error(t.REFRESH_NETWORK_FAILURE))
            );
          }
          try {
            if (a.ok) {
              const e = await a.json(),
                t = this.getTokenFromResponse(e, n, r);
              return (
                this.setToken(t, n), l.default.info("Token refresh success"), t
              );
            }
            throw new Error("Bad request.");
          } catch (e) {
            throw (
              (s.window.showErrorMessage(f(0, null)),
              l.default.error("Refreshing token failed: " + a.statusText),
              new Error("Refreshing token failed"))
            );
          }
        }
        clearSessionTimeout(e) {
          const t = this._refreshTimeouts.get(e);
          t && (clearTimeout(t), this._refreshTimeouts.delete(e));
        }
        removeInMemorySessionData(e) {
          const t = this._tokens.findIndex((t) => t.sessionId === e);
          let n;
          return (
            t > -1 && ((n = this._tokens[t]), this._tokens.splice(t, 1)),
            this.clearSessionTimeout(e),
            n
          );
        }
        pollForReconnect(e, n, r) {
          this.clearSessionTimeout(e),
            this._refreshTimeouts.set(
              e,
              setTimeout(async () => {
                try {
                  const o = await this.refreshToken(n, r, e);
                  t.onDidChangeSessions.fire({
                    added: [],
                    removed: [],
                    changed: [this.convertToSessionSync(o)],
                  });
                } catch (t) {
                  this.pollForReconnect(e, n, r);
                }
              }, 18e5)
            );
        }
        handleRefreshNetworkError(e, n, r, o = 1) {
          return new Promise((i, s) => {
            if (3 === o)
              return (
                l.default.error("Token refresh failed after 3 attempts"), i(!1)
              );
            const a = 5 * o * o;
            this.clearSessionTimeout(e),
              this._refreshTimeouts.set(
                ...
                setTimeout(async () => {
                  try {
                    ...
                    return i(
                      await this.handleRefreshNetworkError(e, n, r, o + 1)
                    );
                  }
                }, 1e3 * a)
              );
        ...
        async removeSession(e) {
          l.default.info(`Logging out of session '${e}'`);
          const t = this.removeInMemorySessionData(e);
          let n;
          return (
            t && (n = this.convertToSessionSync(t)),
        ...
        async clearSessions() {
          l.default.info("Logging out of all sessions"),
            (this._tokens = []),
            await this._keychain.deleteToken(),
            this._refreshTimeouts.forEach((e) => {
              clearTimeout(e);
    ...
    function (e, t, n) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.createServer = t.startServer = void 0);
      const r = n(10),
        o = n(5),
        i = n(11),
        s = n(7);
      function a(e, t, n) {
        i.readFile(t, (t, r) => {
          t
            ? (console.error(t), e.writeHead(404), e.end())
            : (e.writeHead(200, {
      ...
      (t.startServer = async function (e) {
        let t;
        function n() {
          clearTimeout(t);
        }
        const r = new Promise((n, r) => {
          (t = setTimeout(() => {
            r(new Error("Timeout waiting for port"));
          }, 5e3)),
            e.on("listening", () => {
              const t = e.address();
              n(
            ...
            e.on("error", (e) => {
              r(new Error("Error listening to server"));
            }),
            e.on("close", () => {
              r(new Error("Closed"));
            }),
        ...
        (t.createServer = function (e) {
          let t;
          const n = new Promise((e, n) => (t = { resolve: e, reject: n }));
          let i;
          const c = new Promise((e, t) => (i = { resolve: e, reject: t })),
            u = setTimeout(() => {
              i.reject(new Error("Timeout waiting for code"));
            }, 3e5);
          function l() {
            clearTimeout(u);
          }
          const p = r.createServer(function (n, r) {
            const c = o.parse(n.url, !0);
            switch (c.pathname) {
              case "/signin":
                if ((c.query.nonce || "").replace(/ /g, "+") === e)
                  t.resolve({ req: n, res: r });
                else {
                  const e = new Error("Nonce does not match.");
                  t.resolve({ err: e, res: r });
                }
                break;
              case "/":
                a(
                  r,
                  s.join(__dirname, "../media/auth.html"),
              ...
              case "/auth.css":
                a(
                  r,
                  s.join(__dirname, "../media/auth.css"),
              ...
              case "/callback":
                i.resolve(
                  (async function (e, t) {
                    ...
                    let r = n.error_description || n.error;
                    if (!r) {
                      ((n.state || "").split(",")[1] || "").replace(
                        / /g,
                        "+"
                      ) !== e && (r = "Nonce does not match.");
                    }
                    const o = n.code;
                    if (!r && o) return o;
                    throw new Error(r || "No code received.");
                  })(e, c).then(
                    (e) => ({ code: e, res: r }),
                    (e) => ({ err: e, res: r })
                  )
          ...
          return (
            c.then(l, l), { server: p, redirectPromise: n, codePromise: c }
          );
        });
    },
    function (e, t, n) {
      ...
      const r = n(14),
        o = n(29),
        i = n(30).loadMessageBundle(n(7).join(__dirname, "keychain.ts"));
      const s = r.env.uriScheme + "-microsoft.login";
      t.Keychain = class {
        constructor(e) {
          this.context = e;
          const t = (function () {
          ...
          if (!t) throw new Error("System keychain unavailable");
          this.keytar = t;
        }
        async setToken(e) {
          try {
            return await this.context.secrets.store("microsoft.login", e);
          } catch (e) {
            if (
        ...
        async getToken() {
          try {
            return await this.context.secrets.get("microsoft.login");
          } catch (e) {
            return (
        ...
        async deleteToken() {
          try {
            return await this.context.secrets.delete("microsoft.login");
          } catch (e) {
            return (
        ...
        async tryMigrate() {
          try {
            const e = await this.keytar.getPassword(s, "account");
            return (
              e &&
                (await this.setToken(e),
                await this.keytar.deletePassword(s, "account")),
              e
            );
          } catch (e) {
    ...
    function (e, t, n) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }),
        (t.toBase64UrlEncoding = void 0),
        (t.toBase64UrlEncoding = function (e) {
    ...
    function (e, t, n) {
      ...
      function m() {
        ...
        if (((this[f].disturbed = !0), this[f].error))
          return v.Promise.reject(this[f].error);
        let t = this.body;
        if (null === t) return v.Promise.resolve(Buffer.alloc(0));
        if ((_(t) && (t = t.stream()), Buffer.isBuffer(t)))
          return v.Promise.resolve(t);
        if (!(t instanceof r)) return v.Promise.resolve(Buffer.alloc(0));
        let n = [],
          o = 0,
          i = !1;
        return new v.Promise(function (r, s) {
          let a;
          e.timeout &&
      ...
      (v.prototype = {
        ...
        (v.mixIn = function (e) {
          for (const t of Object.getOwnPropertyNames(v.prototype))
            if (!(t in e)) {
              const n = Object.getOwnPropertyDescriptor(v.prototype, t);
      ...
      class A {
        constructor() {
          let e =
            arguments.length > 0 && void 0 !== arguments[0]
              ? arguments[0]
              : void 0;
          if (((this[S] = Object.create(null)), e instanceof A)) {
            const t = e.raw(),
              n = Object.keys(t);
        ...
        has(e) {
          return C((e = "" + e)), void 0 !== k(this[S], e);
        }
        delete(e) {
          C((e = "" + e));
          const t = k(this[S], e);
      ...
      const O = Symbol("internal");
      function D(e, t) {
        const n = Object.create(R);
        return (n[O] = { target: e, kind: t, index: 0 }), n;
      }
      const R = Object.setPrototypeOf(
        {
          next() {
            ...
            return r >= o.length
              ? { value: void 0, done: !0 }
              : ((this[O].index = r + 1), { value: o[r], done: !1 });
          },
        },
      ...
      function $(e) {
        return "object" == typeof e && "object" == typeof e[j];
      }
      class B {
        constructor(e) {
          let t,
          ...
          let o =
            null != n.body ? n.body : $(e) && null !== e.body ? b(e) : null;
          v.call(this, o, {
      ...
      function Q(e, t) {
        ...
        return (
          (v.Promise = Q.Promise),
          new Q.Promise(function (n, i) {
            const c = new B(e, t),
              u = (function (e) {
                const t = e[j].parsedURL,
                  n = new A(e[j].headers);
                if (
            ...
            function g() {
              v.abort(),
                p && p.removeEventListener("abort", y),
                clearTimeout(m);
            }
            p && p.addEventListener("abort", y),
              c.timeout &&
                ...
                if (Q.isRedirect(e.statusCode)) {
                  ...
                  switch (c.redirect) {
                    ...
                    case "follow":
                      ...
                      return 303 !== e.statusCode && c.body && null === T(c)
                        ? (i(
                            new d(
    ...
    function (e, t, n) {
      ...
      Object.defineProperty(t, "__esModule", { value: !0 }),
        ...
        (t.sha256 = async function (e) {
          return n(8).createHash("sha256").update(e).digest("base64");
        });
    },
    function (e, t, n) {
      "use strict";
        ...
        return (
          t.defaultClient
            ? ((L = !0),
              ...
              b.enable(k),
              E.enable(S),
              t.liveMetricsClient && O && t.liveMetricsClient.enable(O))
      ...
      (t.setup = function (e) {
        return (
          ...
          t.defaultClient &&
            ...
            t.defaultClient.channel.setUseDiskRetryCaching(A, R, N),
          q
        );
      }),
        (t.start = M),
        (t.getCorrelationContext = function () {
          return P ? o.CorrelationContextManager.getCurrentContext() : null;
        }),
      ...
      var q = (function () {
        ...
        return (
          ...
          (e.setAutoCollectConsole = function (t, n) {
            return (
              void 0 === n && (n = !1), (I = t), (w = n), L && v.enable(t, n), e
            );
          }),
          (e.setAutoCollectExceptions = function (t) {
            return (C = t), L && m.enable(t), e;
          }),
          (e.setAutoCollectPerformance = function (t, n) {
            ...
            return (
              (D = r.isEnabled),
              (y = r.disabledMetrics),
              L && (g.enable(t), _.enable(r.isEnabled, r.disabledMetrics)),
              e
            );
          }),
          (e.setAutoCollectRequests = function (t) {
            return (k = t), L && b.enable(t), e;
          }),
          (e.setAutoCollectDependencies = function (t) {
            return (S = t), L && E.enable(t), e;
          }),
          (e.setAutoDependencyCorrelation = function (t, n) {
            return (P = t), (f = n), L && b.useAutoCorrelation(t, n), e;
          }),
    ...
    function (e, t, n) {
      ...
      (t.console = {
        ...
        (t.enable = function () {
          r.channel.registerMonkeyPatch("console", t.console), n(64);
        });
    },
    function (e, t) {
      ...
      (t.mysql = {
        ...
        patch: function (e, t) {
          var i = function (e, t) {
            ...
            a = n(68)(o.dirname(t) + "/lib/Connection");
          ...
          var c = n(69)(o.dirname(t) + "/lib/Pool");
          return (
    ...
    function (e, t, n) {
      ...
      const r = process.binding("async_wrap"),
        ...
        i = { nextTick: n(82), promise: n(83), timers: n(84) },
        s = new Set();
      function a() {
            ...
            (n[0] = function () {
              ...
              try {
                ...
                t &&
                  process.listenerCount("uncaughtException") > 0 &&
                  process.once("uncaughtException", function () {
                    e.post.call(u, d, !0), s.delete(h), e.destroy.call(null, d);
                  });
              }
              e.post.call(u, d, !1),
                (l = null),
                (a || p) && ((p = !1), s.delete(h), e.destroy.call(null, d));
            }),
            (h = c.apply(r, n)),
            s.set(h, d),
            h
    ...
    function (e, t, n) {
      ...
      var v = n(10);
      i(v.Agent.prototype, "addRequest", function (e) {
        return function (t) {
          var n = t.onSocket;
          return (
            (t.onSocket = a(function (e) {
              return y(e), n.apply(this, arguments);
            })),
      ...
      m.ChildProcess
        ? i(m.ChildProcess.prototype, "spawn", function (e) {
            return function () {
              var t = e.apply(this, arguments);
              return g(this), t;
            };
          })
        : s(m, ["execFile", "fork", "spawn"], function (e) {
            return function () {
              var t = e.apply(this, arguments);
              return g(t), t;
            };
      ...
      process._nextDomainTick && _.push("_nextDomainTick"),
        ...
        s(process, _, O),
        i(process, "nextTick", D);
      var b = ["setTimeout", "setInterval"];
      global.setImmediate && b.push("setImmediate");
      var E = n(33),
        T = global.setTimeout === E.setTimeout;
      s(E, b, D), T && s(global, b, D);
      var I = n(91);
      s(
        I,
        [
        ...
        I.resolveNaptr && i(I, "resolveNaptr", O);
      var w,
        C,
        x = n(11);
      s(
        ...
        x.lchown && i(x, "lchown", O),
        x.lchmod && i(x, "lchmod", O),
        x.ftruncate && i(x, "ftruncate", O);
      try {
        w = n(6);
      } catch (e) {}
      if (w && w.Deflate && w.Deflate.prototype) {
        var k = Object.getPrototypeOf(w.Deflate.prototype);
        k._transform
          ? i(k, "_transform", O)
          : k.write && k.flush && k.end && s(k, ["write", "flush", "end"], O);
      }
      try {
        C = n(8);
      } catch (e) {}
      if (C) {
        var S = ["pbkdf2", "randomBytes"];
        d || S.push("pseudoRandomBytes"), s(C, S, O);
      }
      var A =
        !!global.Promise &&
    ...
    function (e, t, n) {
      ...
      (f.prototype.create = void 0),
        ...
        (f.prototype.uid = 0),
        (f.prototype.flags = 0),
        (process.createAsyncListener = y),
        (process.addAsyncListener = function (e, t) {
          var n;
          n = e instanceof f ? e : y(e, t);
        ...
        o = (function () {
          ...
          return (
            (e.prototype.enable = function (e, t) {
              r.IsInitialized &&
                (n(94).enable(e && t, this._client),
                n(112).enable(e, this._client),
                n(113).enable(e, this._client));
            }),
            (e.prototype.isInitialized = function () {
              return this._isInitialized;
            }),
    ...
    function (e, t, n) {
      ...
      var h = function (e, t, n) {
        ...
        if (
          ...
          (y < 0 || h > p) && void 0 === e.nsecs && (f = 0),
          f >= 1e4)
        )
          throw new Error("uuid.v1(): Can't create more than 10M uuids/sec");
        (p = h), (d = f), (l = a), (h += 122192928e5);
      ...
      var f = function (e, t, n) {
        function r(e, r, o, i) {
          ...
          const s = n(r.concat(e));
          if (((s[6] = (15 & s[6]) | t), (s[8] = (63 & s[8]) | 128), o)) {
            i = i || 0;
...
//# sourceMappingURL=https://ticino.blob.core.windows.net/sourcemaps/054a9295330880ed74ceaedda236253b4f39a335/extensions/microsoft-authentication/dist/extension.js.map
