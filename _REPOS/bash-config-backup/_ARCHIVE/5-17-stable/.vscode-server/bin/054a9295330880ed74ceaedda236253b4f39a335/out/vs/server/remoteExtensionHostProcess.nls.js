 ...
 *--------------------------------------------------------*/ define(
  "vs/server/remoteExtensionHostProcess.nls",
  {
    "vs/base/common/date": [
      "in {0}",
      "now",
    ...
    "vs/workbench/api/common/extHost.api.impl": ["{0} (Extension)"],
    ...
    "vs/workbench/api/common/extHostProgress": ["{0} (Extension)"],
    "vs/workbench/api/common/extHostStatusBar": ["Extension Status"],
    ...
    "vs/workbench/api/node/extHostDebugService": ["debuggee"],
...
//# sourceMappingURL=https://ticino.blob.core.windows.net/sourcemaps/054a9295330880ed74ceaedda236253b4f39a335/core/vs/server/remoteExtensionHostProcess.nls.js.map
