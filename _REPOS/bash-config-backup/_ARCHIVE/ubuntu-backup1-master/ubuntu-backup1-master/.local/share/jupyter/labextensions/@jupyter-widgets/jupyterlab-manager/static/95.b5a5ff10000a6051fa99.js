/*! For license information please see 95.b5a5ff10000a6051fa99.js.LICENSE.txt */
(self.webpackChunk_jupyter_widgets_jupyterlab_manager =
  ...
  [95],
  {
    4768: (t, e, i) => {
      ...
      function s(t, e) {
        if (
          (i = (t = e ? t.toExponential(e - 1) : t.toExponential()).indexOf(
            "e"
          )) < 0
        )
          return null;
      ...
      const u = {
        ...
        s: function (t, e) {
          ...
          var a = i[0],
            o = i[1],
            r = o - (n = 3 * Math.max(-8, Math.min(8, Math.floor(o / 3)))) + 1,
            h = a.length;
          return r === h
            ? a
            : r > h
            ? a + new Array(r - h + 1).join("0")
            : r > 0
            ? a.slice(0, r) + "." + a.slice(r)
            : "0." +
              new Array(1 - r).join("0") +
              s(t, Math.max(0, e + r - 1))[0];
        },
        X: function (t) {
          ...
          a =
            void 0 === t.grouping || void 0 === t.thousands
              ...
              : ((e = f.call(t.grouping, Number)),
                ...
                function (t, s) {
                  for (
                    var n = t.length, a = [], o = 0, r = e[0], h = 0;
                    n > 0 &&
                    r > 0 &&
                    (h + r + 1 > s && (r = Math.max(1, s - h)),
                    a.push(t.substring((n -= r), n + r)),
                    !((h += r + 1) > s));
        ...
        function v(t) {
          ...
          function D(t) {
            ...
            if ("c" === b) (l = k(t) + l), (t = "");
              ...
              var g = (t = +t) < 0;
              if (
                ((t = isNaN(t) ? _ : k(Math.abs(t), w)),
                M &&
                  (t = (function (t) {
                    t: for (var e, i = t.length, s = 1, n = -1; s < i; ++s)
                      switch (t[s]) {
                        case ".":
                          n = e = s;
                          break;
                ...
                for (o = -1, r = t.length; ++o < r; )
                  if (48 > (h = t.charCodeAt(o)) || h > 57) {
                    (l = (46 === h ? c + t.slice(o + 1) : t.slice(o)) + l),
                      (t = t.slice(0, o));
                    break;
                  }
            }
            y && !f && (t = a(t, 1 / 0));
            var D = u.length + t.length + l.length,
              O = D < v ? new Array(v - D + 1).join(e) : "";
            switch (
              (y &&
                f &&
                ((t = a(O + t, O.length ? v - l.length : 1 / 0)), (O = "")),
              i)
            ) {
              case "<":
                t = u + t + l + O;
              ...
              case "=":
                ...
                break;
              case "^":
                t = O.slice(0, (D = O.length >> 1)) + u + t + l + O.slice(D);
                break;
              default:
                t = O + u + t + l;
            }
                  ...
                  option: function (e, i) {
                    ...
                    if ("string" == typeof e)
                      if (
                        ...
                        for (
                          n = o[e] = t.widget.extend({}, this.options[e]),
                            a = 0;
                          a < s.length - 1;
                          a++
                        )
                  ...
                  _classes: function (e) {
                    ...
                    function n(n, a) {
                      ...
                      for (r = 0; r < n.length; r++)
                        (o = s.classesElementLookup[n[r]] || t()),
                          (o = e.add
                            ? t(t.unique(o.get().concat(e.element.get())))
                            : t(o.not(e.element).get())),
                          (s.classesElementLookup[n[r]] = o),
                          i.push(n[r]),
                          a && e.classes[n[r]] && i.push(e.classes[n[r]]);
                    }
                    return (
                      (e = t.extend(
                        {
    ...
    7697: (t, e, i) => {
      var s, n, a;
      (n = [i(6006), i(2106), i(7914), i(8220), i(8803)]),
        void 0 ===
          (a =
            "function" ==
            typeof (s = function (t) {
