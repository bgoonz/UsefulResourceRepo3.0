      ...
      (n = t.nmd(n)),
        (function () {
          var u =
              ...
              ("object" == typeof t.g && t.g.global === t.g && t.g) ||
              this ||
              {},
            i = u._,
            o = Array.prototype,
          ...
          r.nodeType
            ? (u._ = g)
            : (!n.nodeType && n.exports && (r = n.exports = g), (r._ = g)),
            (g.VERSION = "1.9.1");
          var m,
            b = function (n, r, t) {
          ...
          var _ = function (n, r) {
            ...
            M = function (n) {
              var r = S(n);
              return "number" == typeof r && r >= 0 && r <= O;
            };
          (g.each = g.forEach =
            function (n, r, t) {
              var e, u;
          ...
          var F = function (n) {
            ...
            return function (n, t, e, u) {
              ...
              return r(n, b(t, u, 4), e, i);
            };
          };
          (g.reduce = g.foldl = g.inject = F(1)),
            (g.reduceRight = g.foldr = F(-1)),
            (g.find = g.detect =
              function (n, r, t) {
                var e = (M(n) ? g.findIndex : g.findKey)(n, r, t);
            ...
            (g.reject = function (n, r, t) {
              return g.filter(n, g.negate(j(r)), t);
            }),
            (g.every = g.all =
              function (n, r, t) {
                r = j(r, t);
                for (
                  var e = !M(n) && g.keys(n), u = (e || n).length, i = 0;
                  i < u;
                  i++
                ) {
                  var o = e ? e[i] : i;
            ...
            (g.invoke = _(function (n, r, t) {
              var e, u;
              return (
                g.isFunction(r)
                  ? (u = r)
                  : g.isArray(r) &&
                    ((e = r.slice(0, -1)), (r = r[r.length - 1])),
                g.map(n, function (n) {
                  var i = u;
                  if (!i) {
                    if ((e && e.length && (n = k(n, e)), null == n)) return;
                    i = n[r];
                  }
            ...
            (g.max = function (n, r, t) {
              ...
              if (
                ...
                for (
                  var a = 0, c = (n = M(n) ? n : g.values(n)).length;
                  a < c;
                  a++
                )
                  null != (e = n[a]) && e > i && (i = e);
            ...
            (g.shuffle = function (n) {
              return g.sample(n, 1 / 0);
            }),
            (g.sample = function (n, r, t) {
              if (null == r || t)
                return M(n) || (n = g.values(n)), n[g.random(n.length - 1)];
              var e = M(n) ? g.clone(n) : g.values(n),
                u = S(e);
          ...
          (g.groupBy = E(function (n, r, t) {
            A(n, t) ? n[t].push(r) : (n[t] = [r]);
          })),
            (g.indexBy = E(function (n, r, t) {
              n[t] = r;
            })),
            (g.countBy = E(function (n, r, t) {
              A(n, t) ? n[t]++ : (n[t] = 1);
            }));
          var N =
            /[^\ud800-\udfff]|[\ud800-\udbff][\udc00-\udfff]|[\ud800-\udfff]/g;
          (g.toArray = function (n) {
            ...
            (g.size = function (n) {
              return null == n ? 0 : M(n) ? n.length : g.keys(n).length;
            }),
            (g.partition = E(function (n, r, t) {
              n[t ? 0 : 1].push(r);
            }, !0)),
            (g.first =
              g.head =
            ...
            (g.last = function (n, r, t) {
              return null == n || n.length < 1
                ...
                : null == r || t
                ? n[n.length - 1]
                : g.rest(n, Math.max(0, n.length - r));
            }),
            (g.rest =
              g.tail =
              g.drop =
          ...
          (g.flatten = function (n, r) {
            ...
            (g.without = _(function (n, r) {
              return g.difference(n, r);
            })),
            (g.uniq = g.unique =
              function (n, r, t, e) {
                g.isBoolean(r) || ((e = t), (t = r), (r = !1)),
                  null != t && (t = j(t, e));
                for (var u = [], i = [], o = 0, a = S(n); o < a; o++) {
                  var c = n[o],
                    l = t ? t(c, o, n) : c;
                  r && !t
                    ? ((o && i === l) || u.push(c), (i = l))
                    : t
                    ? g.contains(i, l) || (i.push(l), u.push(c))
                    : g.contains(u, c) || u.push(c);
                }
                return u;
              }),
            (g.union = _(function (n) {
              return g.uniq(I(n, !0, !0));
            })),
            (g.intersection = function (n) {
              for (
                var r = [], t = arguments.length, e = 0, u = S(n);
                e < u;
                e++
              ) {
                var i = n[e];
                if (!g.contains(r, i)) {
                  var o;
                  for (o = 1; o < t && g.contains(arguments[o], i); o++);
                  o === t && r.push(i);
                }
              }
              return r;
            }),
            (g.difference = _(function (n, r) {
              return (
                (r = I(r, !0, !0)),
                g.filter(n, function (n) {
            ...
            (g.unzip = function (n) {
              for (
                var r = (n && g.max(n, S).length) || 0, t = Array(r), e = 0;
                e < r;
                e++
              )
                t[e] = g.pluck(n, e);
          ...
          var T = function (n) {
            return function (r, t, e) {
              t = j(t, e);
              for (var u = S(r), i = n > 0 ? 0 : u - 1; i >= 0 && i < u; i += n)
          ...
          (g.findIndex = T(1)),
            (g.findLastIndex = T(-1)),
            (g.sortedIndex = function (n, r, t, e) {
              for (var u = (t = j(t, e, 1))(r), i = 0, o = S(n); i < o; ) {
          ...
          var B = function (n, r, t) {
            return function (e, u, i) {
              ...
              if (u != u)
                return (i = r(f.call(e, o, a), g.isNaN)) >= 0 ? i + o : -1;
          ...
          (g.bind = _(function (n, r, t) {
            ...
            (g.memoize = function (n, r) {
              var t = function (e) {
                ...
                return A(u, i) || (u[i] = n.apply(this, arguments)), u[i];
              };
              return (t.cache = {}), t;
            }),
            (g.delay = _(function (n, r, t) {
              return setTimeout(function () {
                return n.apply(null, t);
              }, r);
            })),
            (g.defer = g.partial(g.delay, g, 1)),
            (g.throttle = function (n, r, t) {
              var e,
                u,
                i,
                o,
                  ...
                  return (
                    ...
                    f <= 0 || f > r
                      ? (e && (clearTimeout(e), (e = null)),
                        ...
                        (o = n.apply(u, i)),
                        e || (u = i = null))
                      : e || !1 === t.trailing || (e = setTimeout(c, f)),
                    o
                  );
                };
              return (
          ...
          var q = !{ toString: null }.propertyIsEnumerable("toString"),
            ...
            z = function (n, r) {
              var t = K.length,
                e = n.constructor,
                u = (g.isFunction(e) && e.prototype) || a,
                i = "constructor";
              for (A(n, i) && !g.contains(r, i) && r.push(i); t--; )
                (i = K[t]) in n &&
                  n[i] !== u[i] &&
                  !g.contains(r, i) &&
                  r.push(i);
          ...
          (g.keys = function (n) {
            ...
            (g.values = function (n) {
              for (
                var r = g.keys(n), t = r.length, e = Array(t), u = 0;
                u < t;
                u++
              )
                e[u] = n[r[u]];
            ...
            (g.mapObject = function (n, r, t) {
              r = j(r, t);
              for (var e = g.keys(n), u = e.length, i = {}, o = 0; o < u; o++) {
                var a = e[o];
                i[a] = r(n[a], a, n);
              }
              return i;
            ...
            (g.invert = function (n) {
              for (var r = {}, t = g.keys(n), e = 0, u = t.length; e < u; e++)
                r[n[t[e]]] = t[e];
              return r;
            }),
          ...
          (g.extend = D(g.allKeys)),
            (g.extendOwn = g.assign = D(g.keys)),
            (g.findKey = function (n, r, t) {
              r = j(r, t);
          ...
          (g.pick = _(function (n, r) {
            var t = {},
              e = r[0];
            if (null == n) return t;
            g.isFunction(e)
              ? (r.length > 1 && (e = b(e, r[1])), (r = g.allKeys(n)))
              : ((e = P), (r = I(r, !1, !1)), (n = Object(n)));
            ...
            (g.omit = _(function (n, r) {
              var t,
                e = r[0];
              return (
                g.isFunction(e)
                  ? ((e = g.negate(e)), r.length > 1 && (t = r[1]))
                  : ((r = g.map(I(r, !1, !1), String)),
                    (e = function (n, t) {
            ...
            (g.defaults = D(g.allKeys, !0)),
            (g.create = function (n, r) {
              var t = x(n);
            ...
            (L = function (n, r, t, e) {
              ...
              switch (u) {
                ...
                case "[object Boolean]":
                  return +n == +r;
                case "[object Symbol]":
                  return c.valueOf.call(n) === c.valueOf.call(r);
              }
              ...
              e = e || [];
              for (var l = (t = t || []).length; l--; )
                if (t[l] === n) return e[l] === r;
              if ((t.push(n), e.push(r), i)) {
                if ((l = n.length) !== r.length) return !1;
                for (; l--; ) if (!C(n[l], r[l], t, e)) return !1;
              } else {
                var f,
                  p = g.keys(n);
                if (((l = p.length), g.keys(r).length !== l)) return !1;
                for (; l--; )
                  if (((f = p[l]), !A(r, f) || !C(n[f], r[f], t, e))) return !1;
              }
            ...
            (g.isEmpty = function (n) {
              return (
                null == n ||
                (M(n) && (g.isArray(n) || g.isString(n) || g.isArguments(n))
                  ? 0 === n.length
                  : 0 === g.keys(n).length)
              );
            }),
          ...
          "object" != typeof Int8Array &&
            ...
            (g.has = function (n, r) {
              if (!g.isArray(r)) return A(n, r);
              for (var t = r.length, e = 0; e < t; e++) {
                var u = r[e];
                if (null == n || !p.call(n, u)) return !1;
                n = n[u];
              }
              return !!t;
            }),
            ...
            return (
              g.each(g.functions(n), function (r) {
                ...
                g.prototype[r] = function () {
                  var n = [this._wrapped];
                  return l.apply(n, arguments), Y(this, t.apply(g, n));
                };
              }),
              g
            );
