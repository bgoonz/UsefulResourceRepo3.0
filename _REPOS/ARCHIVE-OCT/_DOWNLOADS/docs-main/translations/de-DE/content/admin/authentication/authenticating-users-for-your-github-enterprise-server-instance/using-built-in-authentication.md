...
{% data reusables.enterprise_management_console.authentication %} 4. Wählen Sie **Built in authentication** (Integrierte Authentifizierung) aus. ![Option zur Auswahl der integrierten Authentifizierung](/assets/images/enterprise/management-console/built-in-auth-select.png)
