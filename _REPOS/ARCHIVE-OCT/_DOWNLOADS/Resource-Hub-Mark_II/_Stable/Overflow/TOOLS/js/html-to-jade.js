...
(function () {
  ...
  Writer = (function () {
          ...
          if (attr && attr.nodeName) {
            ...
            if (attrName === "id" && isValidJadeId(attrValue)) {
              ...
              if (invalidClassNames.length > 0) {
                result.push(
                  this.buildTagAttr(attrName, invalidClassNames.join(" "))
                );
              }
            } else {
    ...
    Writer.prototype.buildTagAttr = function (attrName, attrValue) {
      if (attrValue.indexOf(this.attrQuote) === -1) {
        ...
        return (
          attrName + "=" + this.nonAttrQuote + attrValue + this.nonAttrQuote
        );
      } else {
    ...
    Writer.prototype.writeTextLine = function (node, line, output, options) {
      ...
      encodeEntityRef =
        (_ref3 = options.encodeEntityRef) != null ? _ref3 : false;
      escapeBackslash =
        (_ref4 = options.escapeBackslash) != null ? _ref4 : false;
      ...
      if (
        (node != null
          ? (_ref5 = node.previousSibling) != null
            ? _ref5.nodeType
            : void 0
          : void 0) !== 1
      ) {
  ...
  Converter = (function () {
    function Converter(options) {
      ...
      this.writer =
        (_ref1 = this.options.writer) != null
          ? _ref1
      ...
      if (tagName === "script" || tagName === "style") {
        ...
        if (doNotEncode) {
          ...
          return output.writeln(
            tagHead + tagAttr + " " + Ent.encode(tagText, entOptions)
          );
        }
      } else {
        output.writeln(tagHead + tagAttr);
  ...
  Output = (function () {
    ...
    Output.prototype.enter = function () {
      ...
      if (useTabs) {
        ...
        for (
          i = _i = 1;
          1 <= nspaces ? _i <= nspaces : _i >= nspaces;
          i = 1 <= nspaces ? ++_i : --_i
        ) {
