...
var _statcounter = (function (_1) {
  ...
  function fragmentRrwebContent(_37, _38, _39) {
    ...
    if (_37.attributes) {
      _37.attributes = Object.keys(_37.attributes)
        .sort()
        .reduce(function (_3a, key) {
    ...
    if (
      _37.childNodes &&
      Object.keys(_37.childNodes).length == 0 &&
      _37.type == 2
    ) {
    ...
    if (
      _37.attributes &&
      Object.keys(_37.attributes).length == 0 &&
      _37.type == 2
    ) {
    ...
    if (_3e && _10[_3e] === undefined) {
      ...
      if (_37.tagName == "head") {
        ...
        if (_37.tagName == "body") {
          ...
          if (
            _37.attributes &&
            _37.attributes["_cssText"] &&
            _37.attributes["_originalHref"]
          ) {
    ...
    if (_41) {
      if (
        _39 === undefined &&
        _37.childNodes &&
        _37.childNodes.length &&
        JSON.stringify(_37).length > _13
      ) {
  ...
  function rrwebEmission(_4d) {
    ...
    if (_4d.type !== 2) {
      if (_4d.type === 4) {
        ...
        try {
          _4d.data.config = JSON.parse(
            sessionStorage.getItem("statcounter_config")
          );
          _4d.data.raw_cookie = _2.cookie;
          _4d.data.counter_version = _statcounter.version();
          _4d.data.recorder_version =
            "04544f-86dad65e69ceb880285b4d2d27b9614cf757beb6-74c233a8c3b7f0fe3de06ae96bb092a5b43d8a41";
        } catch (e) {}
      }
      sendEvent(false, _4d);
      return;
  ...
  if (typeof _2.addEventListener === "undefined" || _57 === undefined) {
  } else {
...
_statcounter._rrwebRecord = (function () {
  ...
  function S(t, n, r, o, a, s) {
    switch ((void 0 === a && (a = {}), t.nodeType)) {
      ...
      case t.ELEMENT_NODE:
        ...
        if ("link" === c && o) {
          var g,
            S = Array.from(n.styleSheets).find(function (e) {
              return e.href === t.href;
            });
          (g = u(S)) &&
            (delete d.rel,
            (d._originalHref = d.href),
            delete d.href,
            (d._cssText = y(g, S.href)));
        }
        if (
          "style" === c &&
          t.sheet &&
          ...
          (g = u(t.sheet)) && (d._cssText = y(g, location.href));
        if ("input" === c || "textarea" === c || "select" === c) {
          ...
          "button" !== d.type &&
          m
            ? (d.value = a[d.type] || a[c] ? "*".repeat(m.length) : m)
            : t.checked && (d.checked = t.checked);
        }
        if ("option" === c) {
        ...
        if (
          ("canvas" === c && s && (d.rr_dataURL = t.toDataURL()),
          ("audio" !== c && "video" !== c) ||
            (d.rr_mediaState = t.paused ? "paused" : "played"),
          t.scrollLeft && (d.rr_scrollLeft = t.scrollLeft),
          t.scrollTop && (d.rr_scrollTop = t.scrollTop),
          l)
        ) {
        ...
        return {
          ...
          childNodes: [],
          isSVG:
            ((_ = t), "svg" === _.tagName || _ instanceof SVGElement || void 0),
          needBlock: l,
        };
      case t.TEXT_NODE:
        var I = t.parentNode && t.parentNode.tagName,
          ...
          N = "STYLE" === I || void 0;
        return (
          N && x && (x = y(x, location.href)),
          "SCRIPT" === I && (x = "SCRIPT_PLACEHOLDER"),
          {
            type: e.Text,
            textContent: x || "",
            isStyle: N,
  ...
  function I(e, t, n) {
    ...
    return function (a) {
      ...
      var u = t - (i - o),
        ...
        l = arguments;
      u <= 0 || u > t
        ? (r && (window.clearTimeout(r), (r = null)), (o = i), e.apply(s, l))
        : r ||
          !1 === n.trailing ||
  ...
  function _() {
    for (var e = window; e.parent && e.parent != e; )
      try {
        e.parent.document;
        e = e.parent;
      } catch (e) {
  ...
  function k() {
    ...
    return (
      e.innerWidth ||
      (t.documentElement && t.documentElement.clientWidth) ||
      (t.body && t.body.clientWidth)
    );
  }
  ...
  var V = new ((function () {
        ...
        (this.emit = function () {
          for (
            var t,
              ...
              s = function (t) {
                for (var n = t, r = -2; -2 === r; )
                  r = (n = n.nextSibling) && M.getId(n);
                return (
                  -1 === r && D(t.nextSibling, e.blockClass) && (r = null), r
                );
              },
              l = function (t) {
                if (t.parentNode) {
            ...
            M.removeNodeFromMap(e.mapRemoves.shift());
          try {
          ...
          try {
            for (var p = n(e.addedSet), f = p.next(); !f.done; f = p.next()) {
              var h = f.value;
              j(e.droppedSet, h) || H(e.removes, h)
                ? j(e.movedSet, h)
                  ? l(h)
                  : e.droppedSet.add(h)
                : l(h);
            ...
            switch (t.type) {
              ...
              case "attributes":
                ...
                r ||
                  ...
                  e.attributes.push(r)),
                  (r.attributes[t.attributeName] = b(
                    document,
                    t.attributeName,
                    n
                  ));
                ...
                t.addedNodes.forEach(function (n) {
                  ...
                  t.removedNodes.forEach(function (n) {
                    ...
                    D(n, e.blockClass) ||
                      ...
                      O(n) ||
                      (e.addedSet.has(n)
                        ? (P(e.addedSet, n), e.droppedSet.add(n))
                        : (e.addedSet.has(t.target) && -1 === r) ||
                          ...
                          (e.movedSet.has(n) && e.movedMap[z(r, o)]
                            ? P(e.movedSet, n)
                            : e.removes.push({
                                parentId: o,
                                id: r,
    ...
    return (
      (e.prototype.init = function (e, t, n, r, o, a) {
        (this.blockClass = t),
          (this.inlineStylesheet = n),
          (this.maskInputOptions = r),
          (this.recordCanvas = o),
          (this.emissionCallback = e),
          (this.slimDOMOptions = a);
      }),
  ...
  function U(e, t, n) {
    ...
    var r =
        !0 === n.mouseInteraction || void 0 === n.mouseInteraction
          ? {}
          : n.mouseInteraction,
      o = [];
    return (
      Object.keys(d)
        .filter(function (e) {
          return (
            Number.isNaN(Number(e)) && !e.endsWith("_Departed") && !1 !== r[e]
          );
        })
        .forEach(function (n) {
          var r = n.toLowerCase(),
  ...
  function q(e, r) {
      ...
      (function (e, t) {
        ...
        (e.mutationCb = function () {
          ...
          (e.mouseInteractionCb = function () {
            for (var e = [], n = 0; n < arguments.length; n++)
              e[n] = arguments[n];
            t.mouseInteraction && t.mouseInteraction.apply(t, o(e)),
              a.apply(void 0, o(e));
          }),
          (e.scrollCb = function () {
            for (var e = [], n = 0; n < arguments.length; n++)
          ...
          (e.viewportResizeCb = function () {
            for (var e = [], n = 0; n < arguments.length; n++)
              e[n] = arguments[n];
            t.viewportResize && t.viewportResize.apply(t, o(e)),
              u.apply(void 0, o(e));
          }),
          (e.inputCb = function () {
            for (var e = [], n = 0; n < arguments.length; n++)
          ...
          (e.mediaInteractionCb = function () {
            for (var e = [], n = 0; n < arguments.length; n++)
              e[n] = arguments[n];
            t.mediaInteaction && t.mediaInteaction.apply(t, o(e)),
              l.apply(void 0, o(e));
          }),
          (e.styleSheetRuleCb = function () {
            for (var e = [], n = 0; n < arguments.length; n++)
              e[n] = arguments[n];
            t.styleSheetRule && t.styleSheetRule.apply(t, o(e)),
              c.apply(void 0, o(e));
          }),
          (e.canvasMutationCb = function () {
            for (var e = [], n = 0; n < arguments.length; n++)
              e[n] = arguments[n];
            t.canvasMutation && t.canvasMutation.apply(t, o(e)),
              d.apply(void 0, o(e));
          }),
          (e.fontCb = function () {
            for (var e = [], n = 0; n < arguments.length; n++)
    ...
    var a,
      ...
      s = (function (e, t) {
        ...
        var n,
          r = "number" == typeof t.mousemove ? t.mousemove : 50,
          o = [],
          a = I(function (t) {
            var r = Date.now() - n;
            e(
      ...
      h = (function (e, n, r, a, i) {
        ...
        var l = ("last" === i.input ? ["change"] : ["input", "change"]).map(
            function (e) {
              return w(e, u);
            }
          ),
        ...
        return (
          ...
          function () {
            (CSSStyleSheet.prototype.insertRule = t),
              (CSSStyleSheet.prototype.deleteRule = n);
          }
        );
      })(e.styleSheetRuleCb),
      y = e.recordCanvas
        ? (function (e, t) {
            var r,
              ...
              s = function (n) {
                try {
                  if (
                    "function" != typeof CanvasRenderingContext2D.prototype[n]
                  )
                    return "continue";
                  var r = N(
                    CanvasRenderingContext2D.prototype,
          ...
          })(e.canvasMutationCb, e.blockClass)
        : function () {},
      g = e.collectFonts
        ? (function (e) {
            var t = [],
  ...
  function K(e) {
    ...
    void 0 === O && (O = window),
      "NodeList" in O &&
        !O.NodeList.prototype.forEach &&
        (O.NodeList.prototype.forEach = Array.prototype.forEach),
      "DOMTokenList" in O &&
        !O.DOMTokenList.prototype.forEach &&
        (O.DOMTokenList.prototype.forEach = Array.prototype.forEach);
    var z = 0;
                ...
                left:
                  void 0 !== i.pageXOffset
                    ...
                    : (null == s ? void 0 : s.documentElement.scrollLeft) ||
                      (null ===
                        (n =
                          null === (t = null == s ? void 0 : s.body) ||
                          void 0 === t
                            ? void 0
                            : t.parentElement) || void 0 === n
                        ? void 0
                        : n.scrollLeft) ||
                      (null == s ? void 0 : s.body.scrollLeft) ||
                      0,
                top:
                  void 0 !== i.pageYOffset
                    ...
                    : (null == s ? void 0 : s.documentElement.scrollTop) ||
                      (null ===
                        (a =
                          null === (o = null == s ? void 0 : s.body) ||
                          void 0 === o
                            ? void 0
                            : o.parentElement) || void 0 === a
                        ? void 0
                        : a.scrollTop) ||
                      (null == s ? void 0 : s.body.scrollTop) ||
                      0,
              },
            },
          })
    ...
    W = function (e, t) {
      if (
        (!V.isFrozen() ||
          ...
          (e.type == l.IncrementalSnapshot && e.data.source == c.Mutation) ||
          (V.emit(), V.unfreeze()),
        n(g ? g(e) : e, t),
        e.type === l.FullSnapshot)
      )
    ...
    try {
      ...
      var H = function () {
        ...
        j = _().document;
      return (
        "interactive" === j.readyState || "complete" === j.readyState
          ? H()
          : P.push(
              w(
                "load",
