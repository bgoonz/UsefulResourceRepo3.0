...
(function () {
  ...
  AboutBox.prototype._prepareDialog = function () {
    ...
    this.dialog = new Xinha.Dialog(editor, AboutBox.html, "Xinha", {
      width: 600,
    });

    this.dialog.getElementById("close").onclick = function () {
      self.dialog.hide();
    };
    this.dialog.getElementById("xinha_logo").src =
      _editor_url + "images/xinha_logo.gif";
    ...
    tabs.forEach(function (tab) {
      ...
      tab.onclick = function () {
        if (self.currentTab) {
          ...
          self.dialog.getElementById(self.currentTab.rel).style.display =
            "none";
        }
  ...
  AboutBox.prototype.fillVersion = function () {
    ...
    this.dialog.getElementById("version").innerHTML =
      "<pre>" +
      "\nRelease:         " +
      ver.Release +
      " (" +
  ...
  AboutBox.prototype.show = function () {
    ...
    if (!AboutBox.html) {
      ...
      Xinha._getback(
        Xinha.getPluginDir("AboutBox") + "/dialog.html",
        function (getback) {
          AboutBox.html = getback;
          self.show();
        }
      );
      return;
