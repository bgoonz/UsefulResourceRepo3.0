...
Abbreviation.prototype.fillText = function () {
  ...
  var abbr =
    Xinha.getPluginDir(this.constructor.name) + "/abbr/" + _editor_lang + ".js";
...
Abbreviation.prototype.onGenerateOnce = function (editor) {
  this.editor.addEditorStylesheet(
    Xinha.getPluginDir("Abbreviation") + "/abbreviation.css"
  );
  this.methodsReady = true; //remove this?
  var self = Abbreviation;
  Xinha._getback(
    Xinha.getPluginDir("Abbreviation") + "/dialog.html",
    function (getback) {
      self.html = getback;
