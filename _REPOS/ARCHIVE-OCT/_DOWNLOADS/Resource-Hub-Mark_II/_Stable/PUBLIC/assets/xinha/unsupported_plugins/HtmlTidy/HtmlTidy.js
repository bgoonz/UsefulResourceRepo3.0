  ...
  for (var i = 0; i < bl.length; ++i) {
    ...
    if (btn == "html-tidy") {
      ...
      cfg.registerButton(
        id,
        this._lc("HTML Tidy"),
        editor.imgURL(btn[0] + ".gif", "HtmlTidy"),
        true,
        function (editor, id) {
...
HtmlTidy.prototype.__onSelect = function (editor, obj) {
  ...
  if (elem.value == "auto") this.onMode = this.__onMode;
  else this.onMode = null;
};
    ...
    case "HT-html-tidy":
      {
        ...
        Xinha._postback(
          Xinha.getPluginDir("HtmlTidy") + "/html-tidy-logic.php",
          { htisource_name: oldhtml },
