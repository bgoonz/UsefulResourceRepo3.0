...
function showStatus() {
  ...
  if (mode == "measure") {
    ...
    if (m_sx != null && !isNaN(mx1)) m_sx.value = mx1 + "px";
    if (m_sy != null && !isNaN(my1)) m_sy.value = my1 + "px";
    if (m_w != null && !isNaN(mw)) m_w.value = mw + "px";
    if (m_h != null && !isNaN(mh)) m_h.value = mh + "px";

    if (m_d != null && !isNaN(md)) m_d.value = md + "px";
  ...
  if (mode == "crop") {
    if (t_cx != null) t_cx.value = cx;
    if (t_cy != null) t_cy.value = cy;
    if (t_cw != null) t_cw.value = cw;
    if (t_ch != null) t_ch.value = ch;
  } else if (mode == "scale") {
    var sw = aw,
      sh = ah;
    ...
    if (s_sw != null) s_sw.value = sw;
    if (s_sh != null) s_sh.value = sh;
  }
}
