function FullScreen(editor, args) {
  ...
  cfg.registerIcon("fullscreen", [
    _editor_url + cfg.imgURL + "ed_buttons_main.png",
    8,
    0,
  ]);
  cfg.registerIcon("fullscreenrestore", [
    _editor_url + cfg.imgURL + "ed_buttons_main.png",
    9,
    0,
  ]);
...
FullScreen.prototype._lc = function (string) {
  return Xinha._lc(string, {
    url: _editor_url + "modules/FullScreen/lang/",
    context: "FullScreen",
  });
};
...
Xinha.prototype._fullScreen = function () {
  ...
  function sizeItUp() {
    ...
    var h =
      dim.y - e.config.fullScreenMargins[0] - e.config.fullScreenMargins[2];
    var w =
      dim.x - e.config.fullScreenMargins[1] - e.config.fullScreenMargins[3];
  ...
  function sizeItDown() {
    ...
    if (e.originalSizes != null) {
      ...
      e.sizeEditor(
        nW + "px",
        nH + "px",
        e.config.sizeIncludesBars,
        e.config.sizeIncludesPanels
      );
