...
var server = http.createServer(function (req, res) {
  ...
  if (
    !reqUrl ||
    (!!reqUrl && (reqUrl == "" || reqUrl.toLowerCase() == "index.html"))
  ) {
    var data = fs.readFileSync("index.html");
    dbOperations.addRecord(
      "index",
      function () {
        dbOperations.queryCount(
          function (visitCount) {
            var dom = new JSDOM(`${data}`);
            var visitCountElement =
              dom.window.document.getElementById("visitCount");
