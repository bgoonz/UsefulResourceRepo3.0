...
export class MDCTooltipFoundation extends MDCFoundation<MDCTooltipAdapter> {
  ...
  private readonly richTooltipMouseEnterHandler: SpecificEventListener<"mouseenter">;
  private readonly richTooltipMouseLeaveHandler: SpecificEventListener<"mouseleave">;
  ...
  handleDocumentClick(evt: MouseEvent) {
    const anchorContainsTargetElement =
  ...
  private calculateXTooltipDistance(
    ...
    const positionOptions = this.determineValidPositionOptions(
      centerPos,
      startPos,
      endPos
    );
