  ...
  (function () {
    ...
    airdatepicker.prototype = {
      ...
      init: function () {
        ...
        this.views[this.currentView] = new $.fn.airdatepicker.Body(
          this,
          this.currentView,
          this.opts
        );
      ...
      _defineLocale: function (lang) {
        if (typeof lang == "string") {
          ...
          this.loc = $.extend(
            true,
            {},
            $.fn.airdatepicker.language.ru,
            $.fn.airdatepicker.language[lang]
          );
        } else {
      ...
      _setPositionClasses: function (pos) {
        ...
        var main = pos[0],
          sec = pos[1],
          classes =
            "airdatepicker -" + main + "-" + sec + "- -from-" + main + "-";

        if (this.visible) classes += " active";

        this.$airdatepicker.removeAttr("class").addClass(classes);
      },
      ...
      destroy: function () {
        var _this = this;
        _this.$el.off(".adp").data("airdatepicker", "");
  ...
  (function () {
    ...
    airdatepicker.Timepicker.prototype = {
      ...
      _onMouseEnterRange: function (e) {
        ...
        $(".airdatepicker--time-current-" + name, this.$timepicker).addClass(
          "-focus-"
        );
      },
      ...
      _onMouseOutRange: function (e) {
        ...
        $(".airdatepicker--time-current-" + name, this.$timepicker).removeClass(
          "-focus-"
        );
      },
