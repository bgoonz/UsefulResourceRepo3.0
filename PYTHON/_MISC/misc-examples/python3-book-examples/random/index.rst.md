...
::: {.module synopsis="Pseudorandom number generators"} random :::

Purpose

: Implements several types of pseudorandom number generators.

The `random` module provides a fast pseudorandom number generator based on the _Mersenne Twister_ algorithm. Originally developed to produce inputs for Monte Carlo simulations, Mersenne Twister generates numbers with nearly uniform distribution and a large period, making it suited for a wide range of applications.
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} random_random.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} random_uniform.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} random_seed.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} random_randint.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} random_randrange.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} random_choice.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} random_shuffle.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} random_sample.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} random_random_class.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} random_system_random.py :::
...
The Pareto, or power law, distribution matches many observable phenomena and was popularized by _The Long Tail_, by Chris Anderson. The `paretovariate()` function is useful for simulating allocation of resources to individuals (wealth to people, demand for musicians, attention to blogs, etc.).
...
- [Wikipedia: Uniform distribution](<https://en.wikipedia.org/wiki/Uniform_distribution_(continuous)>) \-- Article about continuous uniform distributions in statistics. :::
