...
::: {.module synopsis="POSIX cultural localization API"} locale :::

Purpose

: Format and parse values that depend on location or language.

The `locale` module is part of Python\'s internationalization and localization support library. It provides a standard way to handle operations that may depend on the language or location of a user. For example, it handles formatting numbers as currency, comparing strings for sorting, and working with dates. It does not cover translation (see the `gettext`{.interpreted-text role="mod"} module) or Unicode encoding (see the `codecs`{.interpreted-text role="mod"} module).
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} locale_env.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} locale_currency.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} locale_grouping.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} locale_delocalize.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} locale_atof.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} locale_date.py :::
...
- `Python 2 to 3 porting notes for locale <porting-locale>`{.interpreted-text role="ref"}
- `gettext`{.interpreted-text role="mod"} \-- Message catalogs for translations. :::
