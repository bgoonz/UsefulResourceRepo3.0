...
::: {.module synopsis="Command line option parsing"} getopt :::
...
`getopt` is not deprecated, but `argparse`{.interpreted-text role="mod"} is more actively maintained and should be used for new development. :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} getopt_short.py :::
...
For a program that takes two options, `--noarg` and `--witharg`, the long-argument sequence should be `[ 'noarg', 'witharg=' ]`.

::: {.literalinclude caption="" start-after="#end_pymotw_header"} getopt_long.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} getopt_example.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} getopt_gnu.py :::
...
- `argparse`{.interpreted-text role="mod"} \-- The `argparse` module replaces `getopt` for newer applications. :::
