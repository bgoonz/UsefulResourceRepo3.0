...
::: {.module synopsis="Clock time"} time :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} time_get_clock_info.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} time_time.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} time_ctime.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} time_monotonic.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} time_process_time.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} time_clock_sleep.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} time_perf_counter.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} time_struct.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} time_timezone.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} time_strptime.py :::
...
- `Python 2 to 3 porting notes for time <porting-time>`{.interpreted-text role="ref"}
- `datetime`{.interpreted-text role="mod"} \-- The `datetime` module includes other classes for doing calculations with dates and times.
- `calendar`{.interpreted-text role="mod"} \-- Work with higher-level date functions to produce calendars or calculate recurring events. :::
