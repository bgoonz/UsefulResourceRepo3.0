...
::: {.module synopsis="Implements an XML-RPC server."} xmlrpc.server :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} xmlrpc_function.py :::

The server can be accessed at the URL `http://localhost:9000` using `xmlrpc.client`{.interpreted-text role="mod"}. This client code illustrates how to call the `list_contents()` service from Python.

::: {.literalinclude caption="" start-after="#end_pymotw_header"} xmlrpc_function_client.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} xmlrpc_alternate_name.py :::

The client should now use the name `dir()` instead of `list_contents()`.

::: {.literalinclude caption="" start-after="#end_pymotw_header"} xmlrpc_alternate_name_client.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} xmlrpc_dotted_name.py :::

To call the service functions in the client, simply refer to them with the dotted name.

::: {.literalinclude caption="" start-after="#end_pymotw_header"} xmlrpc_dotted_name_client.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} xmlrpc_arbitrary_name.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} xmlrpc_arbitrary_name_client.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} xmlrpc_instance.py :::

A client can call the method directly.

::: {.literalinclude caption="" start-after="#end_pymotw_header"} xmlrpc_instance_client.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} xmlrpc_instance_dotted_names.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} xmlrpc_instance_dotted_names_client.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} xmlrpc_instance_with_prefix.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} xmlrpc_instance_with_prefix_client.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} xmlrpc_introspection.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} xmlrpc_introspection_client.py :::
