...
::: {.module synopsis="Compare files and directories on the file system."} filecmp :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} filecmp_mkexamples.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} filecmp_cmp.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} filecmp_cmpfiles.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} filecmp_dircmp_report.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} filecmp_dircmp_report_full_closure.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} filecmp_dircmp_list.py :::

The files and subdirectories contained in the directories being compared are listed in `left_list`{.interpreted-text role="attr"} and `right_list`{.interpreted-text role="attr"}.
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} filecmp_dircmp_list_filter.py :::
...
The names of files common to both input directories are saved in `common`{.interpreted-text role="attr"}, and the files unique to each directory are listed in `left_only`{.interpreted-text role="attr"}, and `right_only`{.interpreted-text role="attr"}.

::: {.literalinclude caption="" start-after="#end_pymotw_header"} filecmp_dircmp_membership.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} filecmp_dircmp_common.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} filecmp_dircmp_diff.py :::

The file `not_the_same` is only being compared via `os.stat()`, and the contents are not examined, so it is included in the `same_files`{.interpreted-text role="attr"} list.
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} filecmp_dircmp_subdirs.py :::

The attribute `subdirs`{.interpreted-text role="attr"} is a dictionary mapping the directory name to new `dircmp` objects.
...
- `difflib`{.interpreted-text role="mod"} \-- Computing the differences between two sequences. :::
