...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} json_simple_types.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} json_simple_types_decode.py :::
...
Another benefit of JSON over `pickle`{.interpreted-text role="mod"} is that the results are human-readable. The `dumps()` function accepts several arguments to make the output even nicer. For example, the `sort_keys` flag tells the encoder to output the keys of a dictionary in sorted, instead of random, order.

::: {.literalinclude caption="" start-after="#end_pymotw_header"} json_sort_keys.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} json_indent.py :::

When indent is a non-negative integer, the output more closely resembles that of `pprint`{.interpreted-text role="mod"}, with leading spaces for each level of the data structure matching the indent level.
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} json_compact_encoding.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} json_skipkeys.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} json_myobj.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} json_dump_default.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} json_load_object_hook.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} json_encoder_iterable.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} json_encoder_default.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} json_decoder_object_hook.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} json_dump_file.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} json_load_file.py :::
...
::: {.literalinclude caption="" start-after="#end_pymotw_header"} json_mixed_data.py :::
...
- `Python 2 to 3 porting notes for json <porting-json>`{.interpreted-text role="ref"}
