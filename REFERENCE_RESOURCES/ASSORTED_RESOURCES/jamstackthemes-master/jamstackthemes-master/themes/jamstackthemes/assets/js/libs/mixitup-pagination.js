    ...
    mixitup.Mixer.registerAction(
      ...
      function () {
        ...
        self.config.callbacks.onMixStart = function (prevState, nextState) {
          if (
            prevState.activePagination.limit !==
              nextState.activePagination.limit ||
            prevState.activePagination.page !== nextState.activePagination.page
          ) {
            didPaginate = true;
          }

          if (typeof onMixStart === 'function')
            onMixStart.apply(self.dom.container, arguments);
          ...
          if (typeof onPaginateStart === 'function')
            onPaginateStart.apply(self.dom.container, arguments);
        };

        self.config.callbacks.onMixEnd = function (state) {
          if (typeof onMixEnd === 'function')
            onMixEnd.apply(self.dom.container, arguments);
          ...
          if (typeof onPaginateEnd === 'function')
            onPaginateEnd.apply(self.dom.container, arguments);
        };
      }
    );
