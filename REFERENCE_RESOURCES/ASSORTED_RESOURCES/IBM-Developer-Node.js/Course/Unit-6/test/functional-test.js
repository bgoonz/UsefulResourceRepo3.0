...
(function mainline() {
  ...
  testItemFindById()
    .then(() => {
      return testItemFindByDescription();
    })
    .then(() => {
      return testItemFindByUpc();
    })
    .then(() => {
      return testListsCreate();
    })
    .then(() => {
      return testListsFindById();
    })
    .then(() => {
      return testListsAddItem();
    })
    .then(() => {
      return testListsFindByIdWithAllItems();
    })
    .then(() => {
      return testListsUpdate();
    })
    .then(() => {
      return testListsUpdateItem();
    })
    .then(() => {
      return testListsRemoveItem();
    });
})();
