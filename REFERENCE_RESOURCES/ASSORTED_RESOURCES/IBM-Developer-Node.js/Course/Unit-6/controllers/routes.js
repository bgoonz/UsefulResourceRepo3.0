...
function routeListsWithItems(
  ...
  switch (request.method) {
    case 'GET':
      ...
      listsHandler.handleListsFindByIdWithAllItems(
        request,
        resolve,
        reject,
        id,
    ...
    case 'POST':
      ...
      listsHandler.handleListsAddItem(
        request,
        resolve,
        reject,
        id,
 ...
 */
function routeListsWithItemsAndItemId(
  request,
  resolve,
  reject,
  parsedUrl,
  ...
  switch (request.method) {
    case 'PUT':
      ...
      listsHandler.handleListsWithItemsUpdate(
        request,
        resolve,
        reject,
        id,
    ...
    case 'DELETE':
      ...
      listsHandler.handleListsWithItemsDelete(
        request,
        resolve,
        reject,
        id,
