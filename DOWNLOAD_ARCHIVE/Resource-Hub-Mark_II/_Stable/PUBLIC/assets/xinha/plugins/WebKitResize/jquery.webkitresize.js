...
(function ($) {
    ...
    return this.each(function () {
      ...
      var methods = {
        ...
        removeResizeElements: function (context) {
          $(".img-resize-selector")
            .filter(methods.guidFilter(context))
            .remove();
        ...
        imageClick: function (context, img) {
          ...
          var ifrmScrollTop = Math.max(
            context.ifrm.contentWindow.document.documentElement.scrollTop,
            context.$ifrmBody.scrollTop()
          );
          var ifrmScrollLeft = Math.max(
            context.ifrm.contentWindow.document.documentElement.scrollLeft,
            context.$ifrmBody.scrollLeft()
          );

          context.$docBody.append(
            "<span data-guid='" +
              context.guid +
              "' class='img-resize-selector' style='margin:10px;position:absolute;top:" +
              (iframePos.top +
                imgPosition.top -
                ifrmScrollTop +
                imgHeight -
              ...
              (iframePos.left +
                ...
                imgWidth -
                10) +
              "px;border:solid 2px red;width:6px;height:6px;cursor:se-resize;z-index:1000;'></span>"
          );

          context.$docBody.append(
            "<span data-guid='" +
              context.guid +
              "' class='img-resize-region region-top-right' style='position:absolute;z-index:1000;top:" +
              (iframePos.top + imgPosition.top - ifrmScrollTop) +
              "px;left:" +
              (iframePos.left + imgPosition.left - ifrmScrollLeft) +
              "px;border:dashed 1px grey;width:" +
              imgWidth +
              "px;height:0px;'></span>"
          );
          context.$docBody.append(
            "<span data-guid='" +
              context.guid +
              "' class='img-resize-region region-top-down' style='position:absolute;z-index:1000;top:" +
              (iframePos.top + imgPosition.top - ifrmScrollTop) +
              "px;left:" +
              (iframePos.left + imgPosition.left - ifrmScrollLeft) +
          ...
          context.$docBody.append(
            "<span data-guid='" +
              context.guid +
              "' class='img-resize-region region-right-down' style='position:absolute;z-index:1000;top:" +
              (iframePos.top + imgPosition.top - ifrmScrollTop) +
              "px;left:" +
              (iframePos.left + imgPosition.left - ifrmScrollLeft + imgWidth) +
              "px;border:dashed 1px grey;width:0px;height:" +
              imgHeight +
              "px;'></span>"
          );
          context.$docBody.append(
            "<span data-guid='" +
              context.guid +
              "' class='img-resize-region region-down-left' style='position:absolute;z-index:1000;top:" +
              (iframePos.top + imgPosition.top - ifrmScrollTop + imgHeight) +
              "px;left:" +
              (iframePos.left + imgPosition.left - ifrmScrollLeft) +
              "px;border:dashed 1px grey;width:" +
              imgWidth +
          ...
          var dragStop = function () {
            if (imageResizeinProgress) {
              ...
              context.$ifrm.trigger("webkitresize-updatecrc", [
                methods.crc(context.$ifrmBody.html()),
              ]);
          ...
          var iframeMouseMove = function (e) {
            if (imageResizeinProgress) {
              ...
              $(".region-top-right")
                .filter(methods.guidFilter(context))
                .css("width", resWidth + "px");
              $(".region-top-down")
                .filter(methods.guidFilter(context))
                .css("height", resHeight + "px");
          ...
          var windowMouseMove = function (e) {
            if (imageResizeinProgress) {
              ...
              resHeight =
                e.pageY - (iframePos.top + imgPosition.top - ifrmScrollTop);
              resWidth =
                e.pageX - (iframePos.left + imgPosition.left - ifrmScrollLeft);
        ...
        refresh: function (context) {
          ...
          context.$docBody.append(
            "<span data-guid='" +
              context.guid +
              "' class='img-resize-selector' style='position:absolute;top:" +
              (iframePos.top + imgPosition.top - ifrmScrollTop + imgHeight) +
              "px;left:" +
              (iframePos.left + imgPosition.left - ifrmScrollLeft + imgWidth) +
              "px;border:solid 2px red;width:6px;height:6px;cursor:se-resize;z-index:1000;'></span>"
          ...
          context.$docBody.append(
            "<span data-guid='" +
              context.guid +
              "' class='img-resize-region' style='position:absolute;z-index:1000;top:" +
              (iframePos.top + imgPosition.top - ifrmScrollTop) +
              "px;left:" +
              (iframePos.left + imgPosition.left - ifrmScrollLeft) +
              "px;border:dashed 1px grey;width:" +
      ...
      $(ifrm.contentWindow.document).mouseup(function (e) {
        if (!imageResizeinProgress) {
          ...
          var mouseUpElement = ifrm.contentWindow.document.elementFromPoint(
            x,
            y
          );
          if (mouseUpElement) {
      ...
      ifrm._WebKitImageResizeEnd = function () {
        methods.reset(context);
        methods.removeResizeElements(context);
        methods.debind(context);
      };
      ifrm._WebKitImageResizeStart = function () {
        methods.reset(context);
        context.$ifrmBody = $ifrm.contents().find("body");
      };
    });
  };
  ...
  $.fn.webkittableresize = function (options) {
    return this.each(function () {
      ...
      var methods = {
        ...
        tableClick: function (context, tbl) {
          ...
          context.$docBody.append(
            "<span data-guid='" +
              context.guid +
              "' class='resize-selector' style='margin:10px;position:absolute;top:" +
              (iframePos.top +
                tblPosition.top -
                ifrmScrollTop +
                tblHeight -
          ...
          context.$docBody.append(
            "<span data-guid='" +
              context.guid +
              "' class='resize-region region-top-right' style='position:absolute;z-index:1000;top:" +
              (iframePos.top + tblPosition.top - ifrmScrollTop) +
              "px;left:" +
              (iframePos.left + tblPosition.left - ifrmScrollLeft) +
              "px;border:dashed 1px grey;width:" +
              tblWidth +
              "px;height:0px;'></span>"
          );
          context.$docBody.append(
            "<span data-guid='" +
              context.guid +
              "' class='resize-region region-top-down' style='position:absolute;z-index:1000;top:" +
              (iframePos.top + tblPosition.top - ifrmScrollTop) +
              "px;left:" +
              (iframePos.left + tblPosition.left - ifrmScrollLeft) +
              "px;border:dashed 1px grey;width:0px;height:" +
          ...
          context.$docBody.append(
            "<span data-guid='" +
              context.guid +
              "' class='resize-region region-right-down' style='position:absolute;z-index:1000;top:" +
              (iframePos.top + tblPosition.top - ifrmScrollTop) +
              "px;left:" +
              (iframePos.left + tblPosition.left - ifrmScrollLeft + tblWidth) +
              "px;border:dashed 1px grey;width:0px;height:" +
              tblHeight +
              "px;'></span>"
          );
          context.$docBody.append(
            "<span data-guid='" +
              context.guid +
              "' class='resize-region region-down-left' style='position:absolute;z-index:1000;top:" +
              (iframePos.top + tblPosition.top - ifrmScrollTop + tblHeight) +
              "px;left:" +
              (iframePos.left + tblPosition.left - ifrmScrollLeft) +
              "px;border:dashed 1px grey;width:" +
              tblWidth +
          ...
          var windowMouseMove = function (e) {
            if (tableResizeinProgress) {
              ...
              resHeight =
                e.pageY - (iframePos.top + tblPosition.top - ifrmScrollTop);
              resWidth =
                e.pageX - (iframePos.left + tblPosition.left - ifrmScrollLeft);
          ...
          context.$ifrm
            ...
            .each(function (i, v) {
              ...
              $(v).click(function (e) {
                if (
                  e.target == v ||
                  (($(e.target).is("td") || $(e.target).is("th")) &&
                    $(e.target).parents("table")[0] == v)
                ) {
        ...
        refresh: function (context) {
          ...
          context.$docBody.append(
            "<span data-guid='" +
              context.guid +
              "' class='resize-selector' style='position:absolute;top:" +
              (iframePos.top + tblPosition.top - ifrmScrollTop + tblHeight) +
              "px;left:" +
              (iframePos.left + tblPosition.left - ifrmScrollLeft + tblWidth) +
              "px;border:solid 2px red;width:6px;height:6px;cursor:se-resize;z-index:1000;'></span>"
          ...
          context.$docBody.append(
            "<span data-guid='" +
              context.guid +
              "' class='resize-region' style='position:absolute;z-index:1000;top:" +
              (iframePos.top + tblPosition.top - ifrmScrollTop) +
              "px;left:" +
              (iframePos.left + tblPosition.left - ifrmScrollLeft) +
              "px;border:dashed 1px grey;width:" +
      ...
      ifrm._WebKitTableResizeEnd = function () {
        methods.reset(context);
        methods.removeResizeElements(context);
        methods.debind(context);
      };
  ...
  $.fn.webkittdresize = function (options) {
    return this.each(function () {
      ...
      var methods = {
        ...
        tdClick: function (context, td) {
          ...
          context.$docBody.append(
            "<span data-guid='" +
              context.guid +
              "' class='td-resize-selector' style='margin:10px;position:absolute;top:" +
              (iframePos.top + tdPosition.top - ifrmScrollTop + tdHeight - 10) +
              "px;left:" +
              (iframePos.left +
                tdPosition.left -
                ifrmScrollLeft +
          ...
          context.$docBody.append(
            "<span data-guid='" +
              context.guid +
              "' class='td-resize-region td-region-top-right' style='position:absolute;z-index:1000;top:" +
              (iframePos.top + tdPosition.top - ifrmScrollTop) +
              "px;left:" +
              (iframePos.left + tdPosition.left - ifrmScrollLeft) +
              "px;border:dashed 1px green;width:" +
              tdWidth +
              "px;height:0px;'></span>"
          );
          context.$docBody.append(
            "<span data-guid='" +
              context.guid +
              "' class='td-resize-region td-region-top-down' style='position:absolute;z-index:1000;top:" +
              (iframePos.top + tdPosition.top - ifrmScrollTop) +
              "px;left:" +
              (iframePos.left + tdPosition.left - ifrmScrollLeft) +
              "px;border:dashed 1px green;width:0px;height:" +
              tdHeight +
              "px;'></span>"
          );
          ...
          context.$docBody.append(
            "<span data-guid='" +
              context.guid +
              "' class='td-resize-region td-region-right-down' style='position:absolute;z-index:1000;top:" +
              (iframePos.top + tdPosition.top - ifrmScrollTop) +
              "px;left:" +
              (iframePos.left + tdPosition.left - ifrmScrollLeft + tdWidth) +
              "px;border:dashed 1px green;width:0px;height:" +
              tdHeight +
              "px;'></span>"
          );
          context.$docBody.append(
            "<span data-guid='" +
              context.guid +
              "' class='td-resize-region td-region-down-left' style='position:absolute;z-index:1000;top:" +
              (iframePos.top + tdPosition.top - ifrmScrollTop + tdHeight) +
              "px;left:" +
              (iframePos.left + tdPosition.left - ifrmScrollLeft) +
              "px;border:dashed 1px green;width:" +
              tdWidth +
          ...
          var windowMouseMove = function (e) {
            if (tdResizeinProgress) {
              ...
              resHeight =
                e.pageY - (iframePos.top + tdPosition.top - ifrmScrollTop);
              resWidth =
                e.pageX - (iframePos.left + tdPosition.left - ifrmScrollLeft);
        ...
        refresh: function (context) {
          ...
          context.$docBody.append(
            "<span data-guid='" +
              context.guid +
              "' class='td-resize-selector' style='position:absolute;top:" +
              (iframePos.top + tdPosition.top - ifrmScrollTop + tdHeight) +
              "px;left:" +
              (iframePos.left + tdPosition.left - ifrmScrollLeft + tdWidth) +
              "px;border:solid 2px red;width:6px;height:6px;cursor:se-resize;z-index:1000;'></span>"
          ...
          context.$docBody.append(
            "<span data-guid='" +
              context.guid +
              "' class='td-resize-region' style='position:absolute;z-index:1000;top:" +
              (iframePos.top + tdPosition.top - ifrmScrollTop) +
              "px;left:" +
              (iframePos.left + tdPosition.left - ifrmScrollLeft) +
              "px;border:dashed 1px green;width:" +
      ...
      ifrm._WebKitTdResizeEnd = function () {
        methods.reset(context);
        methods.removeResizeElements(context);
        methods.debind(context);
      };
