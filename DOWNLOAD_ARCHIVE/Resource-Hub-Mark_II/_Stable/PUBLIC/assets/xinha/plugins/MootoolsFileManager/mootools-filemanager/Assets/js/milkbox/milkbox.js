  ...
  prepare_elements: function () {
    this.items = this.items.map(function (item) {
      ...
      var size_string = output.element
        ...
        : item.size;
      if (size_string) {
        output.size = Object.map(
          this.get_item_props(size_string),
          function (value, key) {
            return value.toInt();
          }
        );
      ...
      var extras = output.element
        ? output.element.get("data-milkbox-extras")
        : item.extras;
...
if (
  typeof __MILKBOX_NO_AUTOINIT__ == "undefined" ||
  __MILKBOX_NO_AUTOINIT__ == false
) {
