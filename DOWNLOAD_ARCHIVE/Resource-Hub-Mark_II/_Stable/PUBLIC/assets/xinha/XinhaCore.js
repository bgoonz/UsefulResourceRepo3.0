...
Xinha.version = {
  Release: "Trunk",
  Head: "$HeadURL: http://svn.xinha.org/trunk/XinhaCore.js $".replace(
    /^[^:]*:\s*(.*)\s*\$$/,
    "$1"
  ),
  Date: "$LastChangedDate: 2019-11-05 22:14:38 +1300 (Tue, 05 Nov 2019) $".replace(
    /^[^:]*:\s*([0-9\-]*) ([0-9:]*) ([+0-9]*) \((.*)\)\s*\$/,
    "$4 $2 $3"
  ),
  Revision: "$LastChangedRevision: 1452 $".replace(
    /^[^:]*:\s*(.*)\s*\$$/,
    "$1"
  ),
 ...
 */
Xinha.is_ie =
  Xinha.agt.indexOf("msie") != -1 && Xinha.agt.indexOf("opera") == -1;
/** Version Number, if browser is Microsoft Internet Explorer
 * @type Float
 */
Xinha.ie_version = parseFloat(
  Xinha.agt.substring(Xinha.agt.indexOf("msie") + 5)
);
/** Browser is Opera
 * @type Boolean
 */
...
Xinha.webkit_version = parseInt(
  navigator.appVersion.replace(/.*?AppleWebKit\/([\d]).*?/, "$1"),
  10
);
...
Xinha.is_ios =
  Xinha.agt.indexOf("iphone") != -1 || Xinha.agt.indexOf("ipad") != -1;
...
Xinha.is_ff2 =
  ...
  parseInt(navigator.productSub.substr(0, 10), 10) < 20071210;
...
Xinha.checkSupportedBrowser = function () {
  return (
    Xinha.is_real_gecko ||
    (Xinha.is_opera && Xinha.opera_version >= 9.2) ||
    Xinha.ie_version >= 5.5 ||
    Xinha.webkit_version >= 522
  );
};
...
if (Xinha.isRunLocally && Xinha.isSupportedBrowser) {
  alert(
    'Xinha *must* be installed on a web server. Locally opened files (those that use the "file://" protocol) cannot properly function. Xinha will try to initialize but may not be correctly loaded.'
  );
}
...
function Xinha(textarea, config) {
  ...
  if (
    document.getElementById("loading_" + textarea.id) ||
 ...
 */
Xinha.RE_url =
  /(https?:\/\/)?(([a-z0-9_]+:[a-z0-9_]+@)?[a-z0-9_\-]{2,}(\.[a-z0-9_\-]{2,}){2,}(:[0-9]+)?(\/\S+)*)/i;
...
Xinha.pluginManifest = {
  ...
  BackgroundImage: {
    url: _editor_url + "unsupported_plugins/BackgroundImage/BackgroundImage.js",
  },
  ...
  ClientsideSpellcheck: {
    url:
      _editor_url +
      "unsupported_plugins/ClientsideSpellcheck/ClientsideSpellcheck.js",
  },
  ...
  DefinitionList: {
    url: _editor_url + "plugins/DefinitionList/DefinitionList.js",
  },
  Dialogs: { url: _editor_url + "modules/Dialogs/dialog.js" },
  DoubleClick: {
    url: _editor_url + "unsupported_plugins/DoubleClick/DoubleClick.js",
  },
  ...
  ExtendedFileManager: {
    url:
      _editor_url +
      "unsupported_plugins/ExtendedFileManager/ExtendedFileManager.js",
  },
  ...
  FormOperations: {
    url: _editor_url + "plugins/FormOperations/FormOperations.js",
  },
  ...
  GenericPlugin: {
    url: _editor_url + "plugins/GenericPlugin/GenericPlugin.js",
  },
  GetHtml: { url: _editor_url + "plugins/GetHtml/GetHtml.js" },
  HorizontalRule: {
    url: _editor_url + "plugins/HorizontalRule/HorizontalRule.js",
  },
  ...
  ImageManager: {
    url: _editor_url + "unsupported_plugins/ImageManager/ImageManager.js",
  },
  ...
  InsertMarquee: {
    url: _editor_url + "unsupported_plugins/InsertMarquee/InsertMarquee.js",
  },
  InsertNote: { url: _editor_url + "plugins/InsertNote/InsertNote.js" },
  InsertPagebreak: {
    url: _editor_url + "plugins/InsertPagebreak/InsertPagebreak.js",
  },
  InsertPicture: {
    url: _editor_url + "unsupported_plugins/InsertPicture/InsertPicture.js",
  },
  InsertSmiley: { url: _editor_url + "plugins/InsertSmiley/InsertSmiley.js" },
  InsertSnippet2: {
    url: _editor_url + "plugins/InsertSnippet2/InsertSnippet2.js",
  },
  InsertSnippet: {
    url: _editor_url + "plugins/InsertSnippet/InsertSnippet.js",
  },
  ...
  ListOperations: {
    url: _editor_url + "plugins/ListOperations/ListOperations.js",
  },
  ListType: { url: _editor_url + "plugins/ListType/ListType.js" },
  MootoolsFileManager: {
    url: _editor_url + "plugins/MootoolsFileManager/MootoolsFileManager.js",
  },
  NoteServer: {
    url: _editor_url + "unsupported_plugins/NoteServer/NoteServer.js",
  },
  ...
  PersistentStorage: {
    url:
      _editor_url +
      "unsupported_plugins/PersistentStorage/PersistentStorage.js",
  },
  PreserveScripts: {
    url: _editor_url + "plugins/PreserveScripts/PreserveScripts.js",
  },
  PreserveSelection: {
    url: _editor_url + "plugins/PreserveSelection/PreserveSelection.js",
  },
  ...
  SpellChecker: {
    url: _editor_url + "unsupported_plugins/SpellChecker/SpellChecker.js",
  },
  Stylist: { url: _editor_url + "plugins/Stylist/Stylist.js" },
  SuperClean: { url: _editor_url + "plugins/SuperClean/SuperClean.js" },
  TableOperations: {
    url: _editor_url + "plugins/TableOperations/TableOperations.js",
  },
  ...
  UnsavedChanges: {
    url: _editor_url + "plugins/UnsavedChanges/UnsavedChanges.js",
  },
...
Xinha.Config = function () {
   ...
   * @return {String} The processed HTML
   */
  this.outwardHtml = function (html) {
    return html;
  };
  ...
  this.btnList = {
    bold: [
      "Bold",
      Xinha._lc(
        { key: "button_bold", string: ["ed_buttons_main.png", 3, 2] },
        "Xinha"
      ),
      false,
      function (e) {
    ...
    italic: [
      "Italic",
      Xinha._lc(
        { key: "button_italic", string: ["ed_buttons_main.png", 2, 2] },
        "Xinha"
      ),
      false,
      function (e) {
    ...
    underline: [
      "Underline",
      Xinha._lc(
        { key: "button_underline", string: ["ed_buttons_main.png", 2, 0] },
        "Xinha"
      ),
      false,
      function (e) {
    ...
    strikethrough: [
      "Strikethrough",
      Xinha._lc(
        { key: "button_strikethrough", string: ["ed_buttons_main.png", 3, 0] },
        "Xinha"
      ),
      false,
      function (e) {
    ...
    subscript: [
      "Subscript",
      Xinha._lc(
        { key: "button_subscript", string: ["ed_buttons_main.png", 3, 1] },
        "Xinha"
      ),
      false,
      function (e) {
    ...
    superscript: [
      "Superscript",
      Xinha._lc(
        { key: "button_superscript", string: ["ed_buttons_main.png", 2, 1] },
        "Xinha"
      ),
      false,
      function (e) {
 ...
 *    });</pre>
 */
Xinha.Config.prototype.registerButton = function (
  id,
  tooltip,
  image,
  textMode,
...
Xinha.Config.prototype.addToolbarElement = function (id, where, position) {
  ...
  if (idIsArray) {
    //find the button/select box in input array
 ...
 * @type Function
 */
Xinha.Config.prototype.removeToolbarElement =
  Xinha.Config.prototype.hideSomeButtons;
  ...
  function noselect(e) {
    ...
    if (e.childNodes) {
      for (var i = 0; i < e.childNodes.length; i++)
        if (e.tagName) noselect(e.childNodes[i]);
    }
  }
    ...
    if (!el && btn) {
      ...
      obj.swapImage = function (newimg) {
        if (typeof newimg != "string") {
          ...
          img.style.top = newimg[2]
            ? "-" + 18 * (newimg[2] + 1) + "px"
            : "-18px";
          img.style.left = newimg[1]
            ? "-" + 18 * (newimg[1] + 1) + "px"
            : "-18px";
        } else {
...
Xinha.makeBtnImg = function (imgDef, doc) {
  ...
  if (
    Xinha.is_ie &&
    (!doc.compatMode || (doc.compatMode && doc.compatMode == "BackCompat"))
  ) {
...
Xinha.prototype._createStatusBar = function () {
  ...
  statusBarTextMode.innerHTML = Xinha.htmlEncode(
    Xinha._lc(
...
Xinha.prototype.generate = function () {
  ...
  if (_editor_skin !== "" && !document.getElementById("XinhaSkin")) {
    ...
    for (i = 0; i < links.length; i++) {
      if (
        links[i].rel == "stylesheet" &&
        links[i].href == _editor_url + "skins/" + _editor_skin + "/skin.css"
      ) {
        found = true;
      }
    }
  ...
  if (Xinha.is_ie) {
    url = _editor_url + "modules/InternetExplorer/InternetExplorer.js";
    if (
      !Xinha.loadPlugins([{ plugin: "InternetExplorer", url: url }], callback)
    ) {
      return false;
    }
  ...
  if (
    ...
    !Xinha._loadback(_editor_url + "modules/Dialogs/dialog.js", callback, this)
  ) {
    return false;
  }

  if (
    typeof Xinha.Dialog == "undefined" &&
    !Xinha._loadback(
      _editor_url + "modules/Dialogs/XinhaDialog.js",
      callback,
      this
    )
  ) {
  ...
  if (!Xinha.loadPlugins([{ plugin: "ColorPicker", url: url }], callback)) {
    ...
    typeof Xinha.getPluginConstructor("ColorPicker") != "undefined" &&
    !this.plugins.colorPicker
  ) {
    ...
    for (var j = toolbar[i].length; --j >= 0; ) {
      switch (toolbar[i][j]) {
        ...
        case "insertimage":
          ...
          if (
            typeof Xinha.prototype._insertImage == "undefined" &&
            !Xinha.loadPlugins([{ plugin: "InsertImage", url: url }], callback)
          ) {
            return false;
          } else if (
            typeof Xinha.getPluginConstructor("InsertImage") != "undefined" &&
            !this.plugins.InsertImage
          ) {
        ...
        case "createlink":
          ...
          if (
            typeof Xinha.getPluginConstructor("Linker") == "undefined" &&
            !Xinha.loadPlugins([{ plugin: "CreateLink", url: url }], callback)
          ) {
            return false;
          } else if (
            typeof Xinha.getPluginConstructor("CreateLink") != "undefined" &&
            !this.plugins.CreateLink
          ) {
        ...
        case "inserttable":
          ...
          if (
            !Xinha.loadPlugins([{ plugin: "InsertTable", url: url }], callback)
          ) {
            return false;
          } else if (
            typeof Xinha.getPluginConstructor("InsertTable") != "undefined" &&
            !this.plugins.InsertTable
          ) {
        ...
        case "about":
          ...
          if (
            !Xinha.loadPlugins([{ plugin: "AboutBox", url: url }], callback)
          ) {
            return false;
          } else if (
            typeof Xinha.getPluginConstructor("AboutBox") != "undefined" &&
            !this.plugins.AboutBox
          ) {
  ...
  var getHtmlMethodPlugin =
    this.config.getHtmlMethod == "TransformInnerHTML"
      ? _editor_url + "modules/GetHtml/TransformInnerHTML.js"
      : _editor_url + "modules/GetHtml/DOMwalk.js";

  if (
    !Xinha.loadPlugins(
      [{ plugin: "GetHtmlImplementation", url: getHtmlMethodPlugin }],
      callback
    )
  ) {
    return false;
  ...
  if (_editor_skin) {
    this.skinInfo = {};
    var skinXML = Xinha._geturlcontent(
      _editor_url + "skins/" + _editor_skin + "/skin.xml",
      true
    );
    if (skinXML) {
      var meta = skinXML.getElementsByTagName("meta");
      for (i = 0; i < meta.length; i++) {
        this.skinInfo[meta[i].getAttribute("name")] =
          meta[i].getAttribute("value");
      }
      var recommendedIcons = skinXML.getElementsByTagName("recommendedIcons");
      if (
        !_editor_icons &&
        recommendedIcons.length &&
        getTextContent(recommendedIcons[0])
      ) {
  ...
  if (_editor_icons) {
    var iconsXML = Xinha._geturlcontent(
      _editor_url + "iconsets/" + _editor_icons + "/iconset.xml",
      true
    );
...
Xinha.prototype.initSize = function () {
  ...
  switch (this.config.width) {
    ...
    default:
      ...
      width = /[^0-9]/.test(this.config.width)
        ? this.config.width
  ...
  height =
    this.config.height == "auto"
      ? this._initial_ta_size.h
      : /[^0-9]/.test(this.config.height)
      ? this.config.height
  ...
  this.sizeEditor(
    width,
    height,
    this.config.sizeIncludesBars,
    this.config.sizeIncludesPanels
  );
...
Xinha.prototype.sizeEditor = function (
  ...
  if (width) {
    ...
    if (!this._htmlArea.sizeIncludesPanels) {
      ...
      if (
        rPanel.on &&
        rPanel.panels.length &&
        Xinha.hasDisplayedChildren(rPanel.div)
      ) {
        this._htmlArea.style.width =
          this.getOverallSize().offsetWidth +
          parseInt(this.config.panel_dimensions.right, 10) +
          "px";
      }
      ...
      if (
        lPanel.on &&
        lPanel.panels.length &&
        Xinha.hasDisplayedChildren(lPanel.div)
      ) {
        this._htmlArea.style.width =
          this.getOverallSize().offsetWidth +
          parseInt(this.config.panel_dimensions.left, 10) +
          "px";
      }
    }
  }
  ...
  if (height) {
    ...
    if (!this._htmlArea.sizeIncludesToolbars) {
      ...
      this._htmlArea.style.height =
        this.getOverallSize().offsetHeight +
        this._toolbar.offsetHeight +
        this._statusBar.offsetHeight +
        "px";
    }
    ...
    if (!this._htmlArea.sizeIncludesPanels) {
      ...
      if (
        tPanel.on &&
        tPanel.panels.length &&
        Xinha.hasDisplayedChildren(tPanel.div)
      ) {
        this._htmlArea.style.height =
          this.getOverallSize().offsetHeight +
          parseInt(this.config.panel_dimensions.top, 10) +
          "px";
      }
      ...
      if (
        bPanel.on &&
        bPanel.panels.length &&
        Xinha.hasDisplayedChildren(bPanel.div)
      ) {
        this._htmlArea.style.height =
          this.getOverallSize().offsetHeight +
          parseInt(this.config.panel_dimensions.bottom, 10) +
          "px";
      }
    }
  }
  ...
  function panel_is_alive(pan) {
    if (
      panels[pan].on &&
      panels[pan].panels.length &&
      Xinha.hasDisplayedChildren(panels[pan].container)
    ) {
  ...
  if (!framework.bp_row.childNodes.length) {
    ...
    if (!Xinha.hasParentNode(framework.bp_row)) {
      framework.tbody.insertBefore(
        framework.bp_row,
        framework.ler_row.nextSibling
      );
    }
  }
  ...
  var edcellheight =
    height - this._toolBar.offsetHeight - this._statusBar.offsetHeight;
  if (panel_is_alive("top")) {
  ...
  var iframeWidth = this.config.iframeWidth
    ? parseInt(this.config.iframeWidth, 10)
    : null;
  this._iframe.style.width =
    iframeWidth && iframeWidth < edcellwidth
      ? iframeWidth + "px"
      : edcellwidth + "px";
...
Xinha.prototype.editorIsActivated = function () {
  try {
    return Xinha.is_designMode
      ? this._doc.designMode == "on"
      : this._doc.body.contentEditable;
  } catch (ex) {
    return false;
  }
};
...
Xinha.prototype.deactivateEditor = function () {
  ...
  if (Xinha.is_ios) {
    this._statusBarTree.innerHTML = Xinha._lc(
...
Xinha.prototype.initIframe = function () {
  ...
  var retryDelay =
    (625 / (editor._iframeWaitingRetries * editor._iframeWaitingRetries)) * 50;
  ...
  try {
    ...
    if (!doc) {
      if (editor._iframeWaitingRetries > 0) {
        ...
        // Give up
        Xinha.debugMsg(
          "Xinha: Unable to access the Iframe document object, this may be the result of a Cross-Origin restriction, very slow network, or some other issue.",
          "warn"
        );
        Xinha.debugMsg(
          "You may wish to try changing xinha_config.URIs.iframe_src from " +
            editor.config.URIs.iframe_src +
            " to a url of a blank page on your server (eg '/blank.html') and see if that helps.",
          "warn"
        );
        editor.setLoadingMessage(
          Xinha._lc(
  ...
  if (!editor.config.fullPage) {
    ...
    html +=
      ...
      '">\n';
    if (
      typeof editor.config.baseHref != "undefined" &&
      editor.config.baseHref !== null
    ) {
      ...
      for (var i = 0; i < editor.config.pageStyleSheets.length; i++) {
        if (editor.config.pageStyleSheets[i].length > 0) {
          html +=
            ...
            editor.config.pageStyleSheets[i] +
            '">';
    ...
    html +=
      "<body" +
      (editor.config.bodyID ? ' id="' + editor.config.bodyID + '"' : "") +
      (editor.config.bodyClass
  ...
  if (
    typeof editor.config.autofocus != "undefined" &&
    editor.config.autofocus !== false &&
    (editor.config.autofocus == editor._textArea.id ||
...
Xinha.prototype.setMode = function (mode) {
  ...
  switch (mode) {
    ...
    case "wysiwyg":
      ...
      this._toolbarObjects.htmlmode.swapImage([
        this.imgURL("images/ed_buttons_main.png"),
        7,
        0,
      ]);
      this.setCC("textarea");
  ...
  editor.whenDocReady(function () {
    if (!resetting_events_for_opera) {
      ...
      if (!Xinha.is_ios) {
        ...
        Xinha._addEvents(editor._statusBar, ["click"], function () {
          editor.activateEditor();
          editor.focusEditor();
          return true;
        });
      ...
      if (Xinha.is_ie) {
        ...
        Xinha._addEvent(
          ...
          function () {
            if (
              editor._iframe.contentWindow.event.srcElement.tagName.toLowerCase() ==
              "html"
            ) {
              // if  clicked below the text (=body), the text cursor does not appear, see #1019
    ...
    Xinha._addEvents(
      ...
      function (event) {
        return editor._editorEvent(
          Xinha.is_ie ? editor._iframe.contentWindow.event : event
        );
      }
    );

    Xinha._addEvents(doc, ["dblclick"], function (event) {
      return editor._onDoubleClick(
        Xinha.is_ie ? editor._iframe.contentWindow.event : event
      );
    });
    ...
    if (Xinha.hasAttribute(editor._textArea, "onxinhaready")) {
      (function () {
        eval(editor._textArea.getAttribute("onxinhaready"));
    ...
    if (
      typeof editor.config.resizableEditor != "undefined" &&
      editor.config.resizableEditor
    ) {
      editor._iframe.style.resize = "both";
      var lastResize = [0, 0];
      Xinha._addEvent(editor._iframe.contentWindow, "resize", function () {
        if (
          lastResize[0] == editor._iframe.style.width &&
          lastResize[1] == editor._iframe.style.height
        ) {
          return;
        }
        ...
        editor.sizeEditor(
          editor._iframe.style.width,
          editor._iframe.style.height,
          false,
          false
        );
      });
...
Xinha.prototype.registerPlugin = function () {
  ...
  if (
    ...
    (typeof plugin == "string" &&
      Xinha.getPluginConstructor(plugin) == "undefined")
  ) {
    return false;
  }
  var args = [];
...
Xinha.prototype.registerPlugin2 = function (plugin, args) {
  if (
    typeof plugin == "string" &&
    typeof Xinha.getPluginConstructor(plugin) == "function"
  ) {
...
Xinha.getPluginDir = function (plugin, forceUnsupported) {
  ...
  if (typeof Xinha.pluginManifest[plugin] != "undefined") {
    return Xinha.pluginManifest[plugin].url.replace(
      /\/[a-zA-Z0-9_-]+\.js$/,
      ""
    );
  }
  ...
  if (
    ...
    (Xinha.getPluginConstructor(plugin) &&
      typeof Xinha.getPluginConstructor(plugin).supported != "undefined" &&
      !Xinha.getPluginConstructor(plugin).supported)
  ) {
    return _editor_url + "unsupported_plugins/" + plugin;
  }
...
Xinha.loadPlugin = function (pluginName, callback, url) {
  ...
  Xinha.setLoadingMessage(
    Xinha._lc("Loading plugin $plugin", "Xinha", { plugin: pluginName })
  );
  ...
  function multiStageLoader(stage, pluginName) {
    ...
    switch (stage) {
      ...
      case "old_naming":
        ...
        file =
          pluginName
            .replace(/([a-z])([A-Z])([a-z])/g, function (str, l1, l2, l3) {
              return l1 + "-" + l2.toLowerCase() + l3;
            })
            .toLowerCase() + ".js";
        success_message =
          "You are using an obsolete naming scheme for the Xinha plugin " +
          pluginName +
          ". Please rename " +
          file +
          " to " +
      ...
      case "unsupported":
        ...
        file = pluginName + ".js";
        success_message =
          "You are using the unsupported Xinha plugin " +
          pluginName +
          ". If you wish continued support, please see http://trac.xinha.org/wiki/Documentation/UnsupportedPlugins";
        break;
      ...
      default:
        ...
        Xinha.debugMsg(
          "Xinha was not able to find the plugin " +
            pluginName +
            ". Please make sure the plugin exists.",
          "warn"
        );
        Xinha.debugMsg(
          "If " +
            pluginName +
            " is located in unsupported_plugins you should also check unsupported_plugins/.htaccess for possible access restrictions.",
          "warn"
        );
    ...
    function statusCallback(pluginName) {
      Xinha.getPluginConstructor(pluginName).supported =
        stage.indexOf("unsupported") !== 0;
      callback(pluginName);
    }
  ...
  if (!url) {
    if (Xinha.externalPlugins[pluginName]) {
      Xinha._loadback(
        Xinha.externalPlugins[pluginName][0] +
          Xinha.externalPlugins[pluginName][1],
        callback,
        this,
        pluginName
      );
      ...
      Xinha._loadback(
        Xinha.pluginManifest[pluginName].url,
        callback,
        this,
        pluginName
      );
...
Xinha.includeAssets = function () {
  ...
  assetLoader.isAlreadyLoaded = function (url, plugin) {
    for (var i = 0; i < this.loadedAssets.length; i++) {
      if (
        this.loadedAssets[i].url == url &&
        this.loadedAssets[i].plugin == plugin
      ) {
    ...
    for (var i = 0; i < this.pendingAssets.length; i++) {
      if (
        this.pendingAssets[i].url == url &&
        this.pendingAssets[i].plugin == plugin
      ) {
        if (!this.loaderRunning) this.loadNext();
  ...
  assetLoader.loadNext = function () {
    ...
    if (this.pendingAssets.length) {
      ...
      switch (nxt.type) {
        case "command/abort":
          if (
            (typeof nxt.condition != "function" && nxt.condition) ||
            (typeof nxt.condition == "function" && nxt.condition())
          ) {
  ...
  assetLoader.abortIf = function (condition) {
    ...
    var waitAsset = {
      ...
      url: null,
      plugin: null,
      chainLoader: Xinha.includeAssets(),
    };
  ...
  switch (libraryName.toLowerCase()) {
    case "jquery":
      if (typeof jQuery == "undefined") {
        ...
        return Xinha._libraryAssetLoader
          .loadScriptOnce("libraries/jquery-3.3.1.js")
          .abortIf(function () {
    ...
    case "mootools":
      if (typeof MooTools == "undefined") {
        Xinha._libraryAssetLoader
          .loadScriptOnce("libraries/MooTools-Core-1.6.0.js")
    ...
    default:
      Xinha.debugMsg(
        "Unknown library " +
          libraryName +
          ", libraries need to be handled by Xinha.loadLibrary, add code there.",
        "warn"
      );
      break;
  }
...
Xinha.prototype._wordClean = function () {
  ...
  function showStats() {
    ...
    txt +=
      "Clean-up took " + (new Date().getTime() - stats.T) / 1000 + " seconds";
    alert(txt);
  }
  ...
  function clearStyle(node) {
    ...
    for (var i = declarations.length; --i >= 0; ) {
      if (
        /^mso|^tab-stops/i.test(declarations[i]) ||
  ...
  function removeElements(el) {
    if (
      ("link" == el.tagName.toLowerCase() &&
        el.attributes &&
        /File-List|Edit-Time-Data|themeData|colorSchemeMapping/.test(
          el.attributes.rel.nodeValue
        )) ||
  ...
  function checkEmpty(el) {
    ...
    if (
      /^(a|span|b|strong|i|em|font|div|p)$/i.test(el.tagName) &&
      !el.firstChild
    ) {
      Xinha.removeFromParent(el);
      ++stats.empty_tags;
  ...
  function parseTree(root) {
    ...
    for (var i = root.firstChild; i; i = next) {
      ...
      if (i.nodeType == 1 && parseTree(i)) {
        if (
          (Xinha.is_ie && root.scopeName != "HTML") ||
          (!Xinha.is_ie && /:/.test(i.tagName))
        ) {
          ...
          for (
            var index = i.childNodes && i.childNodes.length - 1;
            i.childNodes && i.childNodes.length && i.childNodes[index];
            --index
          ) {
            if (i.nextSibling) {
        ...
        if (
          /(\s*\[\s*if\s*(([gl]te?|!)\s*)?(IE|mso)\s*(\d+(\.\d+)?\s*)?\]>)/.test(
            i.nodeValue
          )
        ) {
...
Xinha.prototype._undoTakeSnapshot = function () {
  ...
  try {
    ...
    if (caretNode) {
      ...
      if (caretRestorationData) {
        if (caretParent == this._doc.body) {
          ...
          snapshotData.caretRestorationData =
            JSON.stringify(caretRestorationData);
        } else {
    ...
    if (Xinha.is_gecko || Xinha.is_webkit) {
      Xinha.debugMsg(
        "Caret preservation code for undo snapshot failed. If your browser is modern, developers need to check it out in XinhaCore.js (search for caret preservation).",
        "warn"
      );
    }
  }
  ...
  var existingCarets = Xinha.getElementsByClassName(
    this._doc.body,
    "xinha-undo-caret"
  );
...
Xinha.prototype._restoreCaretForUndoRedo = function (snapshotData) {
  ...
  try {
    ...
    var caretParents = Xinha.getElementsByClassName(
      this._doc.body,
      "xinha-undo-caret"
    );
    ...
    for (var i = 0; i < caretParents.length; i++) {
      if (caretParents[i].getAttribute("xinha-undo-caret").length) {
        var caretRestorationData = JSON.parse(
          caretParents[i].getAttribute("xinha-undo-caret")
        );

        if (
          caretParents[i].childNodes.length > caretRestorationData.caretChild
        ) {
          var rng = this.createRange();
          rng.setStart(
            caretParents[i].childNodes[caretRestorationData.caretChild],
            caretRestorationData.caretOffset
          );
    ...
    if (Xinha.is_gecko || Xinha.is_webkit) {
      Xinha.debugMsg(
        "Caret restoration code for undo failed. If your browser is modern, developers should check it out in XinhaCore.js (search for caret restoration).",
        "warn"
      );
    }
  }
...
Xinha.prototype.updateToolbar = function (noStatus) {
  ...
  if (!text) {
    ...
    if (this.config.statusBar && !noStatus) {
      ...
      this._statusBarTree.appendChild(
        document.createTextNode(Xinha._lc("Path") + ": ")
      );
      for (var i = ancestors.length; --i >= 0; ) {
        ...
        if (i !== 0) {
          this._statusBarTree.appendChild(
            document.createTextNode(String.fromCharCode(0xbb))
          );
        }
        Xinha.freeLater(a);
      }
  ...
  for (var cmd in this._toolbarObjects) {
    ...
    if (btn.context && !text) {
      var contexts =
        typeof btn.context == "object" ? btn.context : [btn.context];
    ...
    switch (cmd) {
        ...
        if (!text) {
          try {
            ...
            if (selectedValue != null) {
              ...
              for (
                var i = 0;
                i < this._toolbarObjects[cmd].element.options.length;
                i++
              ) {
                if (
                  this._toolbarObjects[cmd].element.options[i].value ==
                  selectedValue
                ) {
        ...
        for (var indexBlock in this.config.formatblock) {
          ...
          if (typeof blockname == "string") {
            blocks[blocks.length] =
              this.config.formatblockDetector[blockname] || blockname;
          }
        }
      ...
      case "textindicator":
        if (!text) {
          try {
            ...
            style.backgroundColor = Xinha._makeColor(
              doc.queryCommandValue(Xinha.is_ie ? "backcolor" : "hilitecolor")
            );
            if (/transparent/i.test(style.backgroundColor)) {
              // Mozilla
              style.backgroundColor = Xinha._makeColor(
                doc.queryCommandValue("backcolor")
              );
            }
            style.color = Xinha._makeColor(doc.queryCommandValue("forecolor"));
            style.fontFamily = doc.queryCommandValue("fontname");
            style.fontWeight = doc.queryCommandState("bold")
              ? "bold"
              : "normal";
            style.fontStyle = doc.queryCommandState("italic")
              ? "italic"
              : "normal";
          } catch (ex) {
            // alert(e + "\n\n" + cmd);
      ...
      case "righttoleft":
        ...
        if (eltBlock) {
          btn.state(
            "active",
            eltBlock.style.direction == (cmd == "righttoleft" ? "rtl" : "ltr")
          );
        }
        break;
...
Xinha.getEditor = function (ref) {
  for (var i = __xinhas.length; i--; ) {
    ...
    if (
      editor &&
      (editor._textArea.id == ref ||
        editor._textArea.name == ref ||
        editor._textArea == ref)
    ) {
      return editor;
    }
  }
...
Xinha.prototype.getElementIsOrEnclosingSelection = function (types, sel) {
  ...
  var currentElement = this.activeElement(sel)
    ? this.activeElement(sel)
    : this.getParentElement(sel);
...
Xinha.prototype._getFirstAncestorAndWhy = function (sel, types) {
  ...
  if (prnt === null) {
    ...
    try {
      prnt = Xinha.is_ie
        ? this.createRange(sel).parentElement()
        : this.createRange(sel).commonAncestorContainer;
    } catch (ex) {
      return [null, null];
    }
  }
  ...
  while (prnt) {
    if (prnt.nodeType == 1) {
      ...
      for (var index = 0; index < types.length; ++index) {
        if (
          typeof types[index] == "string" &&
          types[index] == prnt.tagName.toLowerCase()
        ) {
          // Criteria is a tag name.  It matches
          return [prnt, index];
        } else if (
          typeof types[index] == "function" &&
          types[index](this, prnt)
        ) {
...
Xinha.prototype._colorSelector = function (cmdID) {
  ...
  if (cmdID == "hilitecolor") {
    if (Xinha.is_ie) {
      ...
      initcolor = Xinha._colorToRgb(
        editor._doc.queryCommandValue("hilitecolor")
      );
    }
  } else {
  ...
  switch (cmdID) {
    ...
    case "righttoleft":
      if (this.config.changeJustifyWithDirection) {
        this._doc.execCommand(
          cmdID == "righttoleft" ? "justifyright" : "justifyleft",
          UI,
          param
        );
      }
...
Xinha.prototype._onDoubleClick = function (ev) {
  ...
  if (tag) {
    ...
    if (
      className &&
      this.config.dblclickList[tag + "." + className] != undefined
    )
...
Xinha.prototype.scrollElementIntoViewport = function (e) {
  ...
  this._iframe.contentWindow.scrollTo(
    position.left,
    Math.min(position.top, position.top - currentSize.y * 0.1)
  );
};
...
Xinha.prototype.outwardHtml = function (html) {
  ...
  html = html.replace(
    /(<[^>]*on(click|mouse(over|out|up|down))=['"])if\(window\.parent &amp;&amp; window\.parent\.Xinha\)\{return false\}/gi,
    "$1"
  );
  ...
  //  to expect
  html = html.replace(/((href|src|background)=[\'\"])\/+/gi, "$1" + serverBase);
  ...
  html = html.replace(
    /(<script[^>]*((type=[\"\']text\/)|(language=[\"\'])))(freezescript)/gi,
    "$1javascript"
  );
...
Xinha.prototype.inwardHtml = function (html) {
  ...
  html = html.replace(
    /(<[^>]*on(click|mouse(over|out|up|down))=')([^']+')/gi,
    "$1if(window.parent &amp;&amp; window.parent.Xinha){return false}$4"
  );
  html = html.replace(
    /(<[^>]*on(click|mouse(over|out|up|down))=")([^"]+")/gi,
    "$1if(window.parent &amp;&amp; window.parent.Xinha){return false}$4"
  ...
  html = html.replace(
    /(<script)(?![^>]*((type=[\"\']text\/)|(language=[\"\']))javascript[\"\'])/gi,
  ...
  html = html.replace(
    nullRE,
    "$1" + location.href.replace(/(https?:\/\/[^\/]*)\/.*/, "$1") + "/"
  );
...
Xinha.prototype.fixRelativeLinks = function (html) {
  if (
    typeof this.config.stripSelfNamedAnchors != "undefined" &&
    this.config.stripSelfNamedAnchors
  ) {
    var stripRe = new RegExp(
      '((href|src|background)=")(' +
        Xinha.escapeStringForRegExp(
          window.unescape(document.location.href.replace(/&/g, "&amp;"))
        ) +
        ")([#?][^'\" ]*)",
      "g"
    );
  ...
  if (
    typeof this.config.stripBaseHref != "undefined" &&
    this.config.stripBaseHref
  ) {
    var baseRe = null;
    if (
      typeof this.config.baseHref != "undefined" &&
      this.config.baseHref !== null
    ) {
      baseRe = new RegExp(
        '((href|src|background|action)=")(' +
          Xinha.escapeStringForRegExp(
            this.config.baseHref.replace(/([^\/]\/)(?=.+\.)[^\/]*$/, "$1")
          ) +
          ")",
        "g"
      );
  ...
  if (
    typeof this.config.expandRelativeUrl != "undefined" &&
    this.config.expandRelativeUrl
  ) {
    if (html == null) return "";
    ...
    for (var i = 0; i < url_regexp_global.length; i++) {
      ...
      for (var j = 0; j < all_urls.length; j++) {
        ...
        if (
          ...
          candidates[candidates.length] = all_urls[j].match(
            url_regexp_single[i]
          );
        }
      }
...
Xinha.cloneObject = function (obj) {
  ...
  if (
    obj.constructor.toString().match(/\s*function Function\(/) ||
    typeof obj == "function"
  ) {
...
Xinha.addOnloadHandler = function (func, scope) {
  ...
  } else if (/applewebkit|KHTML/i.test(navigator.userAgent)) {
    /* Safari/WebKit/KHTML */
...
Xinha.isBlockElement = function (el) {
  return (
    el &&
    el.nodeType == 1 &&
    Xinha._blockTags.indexOf(" " + el.tagName.toLowerCase() + " ") != -1
  );
};
...
Xinha.isParaContainer = function (el) {
  return (
    el &&
    el.nodeType == 1 &&
    Xinha._paraContainerTags.indexOf(" " + el.tagName.toLowerCase() + " ") != -1
  );
};
 ...
 */
Xinha._closingTags =
  " a abbr acronym address applet b bdo big blockquote button caption center cite code del dfn dir div dl em fieldset font form frameset h1 h2 h3 h4 h5 h6 i iframe ins kbd label legend map menu noframes noscript object ol optgroup pre q s samp script select small span strike strong style sub sup table textarea title tt u ul var ";
...
Xinha.needsClosingTag = function (el) {
  return (
    el &&
    el.nodeType == 1 &&
    Xinha._closingTags.indexOf(" " + el.tagName.toLowerCase() + " ") != -1
  );
};
...
Xinha.stripCoreCSS = function (html) {
  return html
    .replace(/<style[^>]+title="XinhaInternalCSS"(.|\n)*?<\/style>/gi, "")
    .replace(/<link[^>]+title="XinhaInternalCSS"(.|\n)*?>/gi, "");
};
...
Xinha._postback = function (url, data, success, failure) {
  ...
  if (typeof data == "string") {
    ...
    for (var i in data) {
      content +=
        (content.length ? "&" : "") + i + "=" + encodeURIComponent(data[i]);
    }
  }
  ...
  req.setRequestHeader(
    ...
    "application/x-www-form-urlencoded" +
      (Xinha._postback_send_charset ? "; charset=UTF-8" : "")
  );
  ...
  if (langData !== "") {
    ...
    Xinha.debugMsg(
      "Unable to read Language File '" +
        url +
        "' or file blank, either does not exist (which is probably ok) or permissions issue (which is probably not ok).",
      "info"
    );
    lang = {};
  }
...
Xinha._lc = function (string, context, replace) {
  ...
  if (_editor_lang == "en") {
    ...
    if (
      typeof _editor_lang_merged_file == "undefined" ||
      _editor_lang_merged_file === true
    ) {
      _editor_lang_merged_file =
        _editor_url + "lang/merged/" + _editor_lang + ".js";
    }
    ...
    if (typeof _editor_lang_merged_file == "string") {
      ...
      if (typeof Xinha._lc_catalog["__NEW_TRANSLATIONS__"]) {
        for (var moduleName in Xinha._lc_catalog["__NEW_TRANSLATIONS__"]) {
          for (var englishString in Xinha._lc_catalog["__NEW_TRANSLATIONS__"][
            moduleName
          ]) {
            var translatedString =
              Xinha._lc_catalog["__NEW_TRANSLATIONS__"][moduleName][
                englishString
              ];
            if (translatedString.match(/<<([A-Za-z0-9_]+)(:.*)?>>/)) {
              var linkedModule = RegExp.$1;
              if (
                typeof Xinha._lc_catalog[linkedModule] != "undefined" &&
                typeof Xinha._lc_catalog[linkedModule][englishString] ==
                  "string"
              ) {
                translatedString =
                  Xinha._lc_catalog[linkedModule][englishString];
              } else {
                translatedString = "";
              }
            }
    ...
    if (typeof Xinha._lc_catalog[context][key] == "undefined") {
      if (context == "Xinha") {
        ...
        //  because lc_parse_strings.php didn't find it
          ...
          typeof Xinha._lc_catalog[context]["__OBSOLETE__"] != "undefined" &&
          typeof Xinha._lc_catalog[context]["__OBSOLETE__"][key] != "undefined"
        ) {
          ret = Xinha._lc_catalog[context]["__OBSOLETE__"][key];
          Xinha.debugMsg(
            "Using a translation which is marked __OBSOLETE__, likely lc_parse_strings.php did not pick something up that it should have. " +
              context +
              ": " +
              key,
            "warn"
...
Xinha.makeEditors = function (editor_names, default_config, plugin_names) {
  ...
  for (var x = 0; x < editor_names.length; x++) {
    if (typeof editor_names[x] == "string") {
      // the regular case, an id of a textarea
      textarea = Xinha.getElementById("textarea", editor_names[x]);
      if (!textarea) {
        // the id may be specified for a textarea that is maybe on another page; we simply skip it and go on
        editor_names[x] = null;
        continue;
      }
    }
    // make it possible to pass a reference instead of an id, for example from  document.getElementsByTagName('textarea')
      ...
      typeof editor_names[x] == "object" &&
      editor_names[x].tagName &&
      editor_names[x].tagName.toLowerCase() == "textarea"
    ) {
      textarea = editor_names[x];
      if (!textarea.id) {
        // we'd like to have the textarea have an id
  ...
  if (plugin_names) {
    for (var i = 0; i < plugin_names.length; i++) {
      this.setLoadingMessage(
        Xinha._lc("Register plugin $plugin", "Xinha", {
...
Xinha.prototype.scrollPos = function (scope) {
  scope = scope ? scope : window;
  var x, y;
  if (typeof scope.pageYOffset != "undefined") {
    // all except Explorer
    x = scope.pageXOffset;
    y = scope.pageYOffset;
  } else if (
...
Xinha.createLoadingMessages = function (xinha_editors) {
  ...
  for (var i = 0; i < xinha_editors.length; i++) {
    var e =
      typeof xinha_editors[i] == "string"
        ? document.getElementById(xinha_editors[i])
        : xinha_editors[i];
    if (!e) {
      continue;
    }
...
Xinha.createLoadingMessage = function (textarea, text) {
  ...
  loading_message.style.left =
    Xinha.findPosX(textarea) + textarea.offsetWidth / 2 - 106 + "px";
  loading_message.style.top =
    Xinha.findPosY(textarea) + textarea.offsetHeight / 2 - 50 + "px";
  // main static message
  var loading_main = document.createElement("div");
  loading_main.className = "loading_main";
  loading_main.id = "loading_main_" + textarea.id;
  loading_main.appendChild(
    document.createTextNode(Xinha._lc("Loading in progress. Please wait!"))
  );
  // sub dynamic message
...
Xinha.prototype.setLoadingMessage = function (subMessage, mainMessage) {
  ...
  document.getElementById("loading_main_" + this._textArea.id).innerHTML =
    mainMessage ? mainMessage : Xinha._lc("Loading in progress. Please wait!");
  document.getElementById("loading_sub_" + this._textArea.id).innerHTML =
    subMessage;
};
...
Xinha.prototype.removeLoadingMessage = function () {
  if (document.getElementById("loading_" + this._textArea.id)) {
    document.body.removeChild(
      document.getElementById("loading_" + this._textArea.id)
    );
  }
};
...
Xinha.removeLoadingMessages = function (xinha_editors) {
  for (var i = 0; i < xinha_editors.length; i++) {
    ...
    var main = document.getElementById(
      "loading_" + document.getElementById(xinha_editors[i]).id
    );
...
Xinha.free = function (obj, prop) {
  if (obj && !prop) {
    ...
    if (prop.indexOf("src") == -1) {
      // if src (also lowsrc, and maybe dynsrc ) is set to null, a file named "null" is requested from the server (see #1001)
      try {
        obj[prop] = null;
      } catch (x) {}
    }
...
Xinha.prototype.isKeyPressEvent = function (keyEvent) {
  if (typeof Xinha.DOM3NotAKeyPress == "undefined") {
    ...
    Xinha.DOM3NotAKeyPress = {
      modifier:
        /^(Alt|CapsLock|Control|F[0-9]+|FnLock|Hyper|Meta|NumLock|ScrollLock|Shift|Super|Symbol|OS|Scroll)/,
      ...
      device:
        /^(Brightness|Eject|LoghOff|Power|Print|Hibernate|Standby|WakeUp)/,
      ...
      japanese:
        /^(Eisu|Hanakaku|Hirigana|Kana|Kanji|Katakana|Romanji|Zenkaku|RomanCharacters|HalfWidth|FullWidth)/,
      function: /^(F[0-9]+|Soft[0-9]+)/,
      phone:
        /^(AppSwitch|Call|Camera|EndCall|GoBack|GoHome|HeadsetHook|LastNumber|Notification|Manner|Voice|Exit|MozHomeScreen)/,
      multimedia: /^(Channel|Media|FastFwd)/,
      audio: /^(Audio|Microphone|Volume)/,
      tv: /^(TV|Live)/,
      media:
        /^(AVR|Color|ClosedCaption|Dummer|DisplaySwap|DVR|Exit|Favorite|Guide|Info|InstantReplay|Link|List|Live|Lock|Media|Navigate|Next|OnDemand|Pairing|PinP|Play|Random|RcLow|Record|RfBypass|ScanChannels|ScreenMode|Settings|SplitScreen|STBInput|Subtitle|Teletext|VideoMode|Wink|ZoomToggle|Zoom)/,
      speech: /^(Speech)/,
  ...
  if (keyEvent.type == "keypress") {
    ...
    if (typeof keyEvent.key != "undefined") {
      if (keyEvent.key == "Unidentified") {
        ...
        if (typeof keyEvent.keyCode != "undefined" && keyEvent.keyCode == 9)
          return true;
        return false;
      }
     ...
     */
      ...
      0 &&
      typeof keyEvent.keyIdentifier != "undefined" &&
      keyEvent.keyIdentifier.length
    ) {
...
Xinha.prototype.isKeyDownThatShouldGetButDoesNotGetAKeyPressEvent = function (
  keyEvent
) {
  return false;
};
...
Xinha.getXMLHTTPRequestObject = function () {
  try {
    if (
      ...
      typeof XMLHttpRequest.constructor == "function"
    ) {
      // Safari's XMLHttpRequest is typeof object
...
Xinha.notImplemented = function (methodName) {
  throw new Error(
    ...
    "Part of Xinha has tried to call the " +
      methodName +
