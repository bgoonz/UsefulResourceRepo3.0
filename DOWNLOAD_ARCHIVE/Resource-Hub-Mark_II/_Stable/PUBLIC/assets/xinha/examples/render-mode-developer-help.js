...
window.setTimeout(function () {
  if (typeof document.doctype == "undefined" || document.doctype == null)
    return;
  var doctypeHelp =
    '\
  ...
  if (document.compatMode == "BackCompat") {
    ...
    switch (doctypeString) {
      ...
      case '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">':
        doctypeHelp +=
          "Almost Standards Mode<br/>" + Xinha.htmlEncode(doctypeString);
        break;

      default:
        doctypeHelp +=
          "Either Standards Mode, or Almost Standards Mode<br/>" +
          Xinha.htmlEncode(doctypeString);
        break;
    }
  }
  doctypeHelp +=
    ...
    <p>\
      To change the mode alter the doctype on this file, " +
