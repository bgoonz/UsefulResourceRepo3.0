...
var SmartImages = {
  ...
  replace_flash: function (img, params) {
    if (!img) {
      ...
      var i = img;
      if (!i.src.match(SmartImages._flash_meta_re)) return;
      ...
      if (!params) params = {};
      if (!params.embed_params) params.embed_params = { wmode: "transparent" };
      if (!params.flash_params) params.flash_params = {};
      if (!params.embed_attributes) params.embed_attributes = {};
  ...
  attribute_flickr: function (img, params) {
    if (!img) {
      var images = document.getElementsByTagName("img");
      ...
      var i = img;
      if (!i.src.match(SmartImages._flickr_meta_re)) return;
      ...
      i.xFlickrShow = function () {
        ...
        this.xFlickrInfo.style.top =
          p.y + (this.offsetHeight - this.xFlickrInfo.offsetHeight) + "px";
        this.xFlickrInfo.style.left =
          p.x +
          (this.offsetWidth / 2 - this.xFlickrInfo.offsetWidth / 2) +
          "px";
        this.xFlickrInfo.style.visibility = "visible";

        var im = this;
        window.setTimeout(function () {
          im.xFlickrInfo.style.visibility = "hidden";
        }, 4000);
      };

      SmartImages.add_event(i, "mouseover", function () {
        i.xFlickrShow();
      });
      SmartImages.add_event(window, "resize", function () {
        if (i.xFlickrInfo.style.visibility == "visible") i.xFlickrShow();
      });
    }
  },
	...
	*/
    ...
    function hasPlayerVersion(rv) {
      return ua.playerVersion[0] > rv[0] ||
        ...
        (ua.playerVersion[0] == rv[0] &&
          ua.playerVersion[1] == rv[1] &&
          ua.playerVersion[2] >= rv[2])
        ? true
        : false;
    }
