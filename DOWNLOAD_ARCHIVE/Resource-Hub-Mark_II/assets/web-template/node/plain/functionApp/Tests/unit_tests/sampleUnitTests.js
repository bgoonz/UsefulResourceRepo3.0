...
describe("sampleUnitTests", function () {
  ...
  it("Should work with params", function (done) {
    ...
    azfunction(mockContext, mockRequest)
      .then((result) => {
        assert.equal(
          "200",
          mockContext.res.status,
          "Response code should be 200"
        );
        assert.equal(
          "Hello Bill! Welcome to Azure Functions!",
          mockContext.res.body,
  ...
  it("Should work without params", function (done) {
    ...
    azfunction(mockContext, mockRequest)
      .then((result) => {
        ...
        assert.equal(
          "Hello there! Welcome to Azure Functions!",
          mockContext.res.body,
          "Response body is incorrect"
        );
        done();
