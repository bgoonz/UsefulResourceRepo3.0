...
((A, w) => {
  ...
  function ra(a, b) {
    ...
    b.each(function () {
      if (this.nodeName === (a[d] && a[d].nodeName)) {
        let f = c.data(a[d++]);
        const e = c.data(this, f);
        if ((f = f && f.events)) {
          delete e.handle;
          e.events = {};
          for (const j in f)
            for (const i in f[j]) c.event.add(this, j, f[j][i], f[j][i].data);
        }
      }
    });
  }
  ...
  c.extend({
    ...
    ready() {
      if (!c.isReady) {
        ...
        c.isReady = true;
        if (Q) {
          for (let a, b = 0; (a = Q[b++]); ) a.call(s, c);
          Q = null;
        }
    ...
    globalEval(a) {
      if (a && Va.test(a)) {
        const b = s.getElementsByTagName("head")[0] || s.documentElement, d = s.createElement("script");
    ...
    inArray(a, b) {
      ...
      for (let d = 0, f = b.length; d < f; d++) if (b[d] === a) return d;
      return -1;
    },
    merge(a, b) {
      let d = a.length, f = 0;
      if (typeof b.length === "number")
        for (const e = b.length; f < e; f++) a[d++] = b[f];
  ...
  c.fn.extend({
    data(a, b) {
      ...
      d[1] = d[1] ? "." + d[1] : "";
      if (b === w) {
        let f = this.triggerHandler("getData" + d[1] + "!", [d[0]]);
  ...
  c.fn.extend({
    ...
    addClass(a) {
      ...
      if (a && typeof a === "string")
        for (let b = (a || "").split(ca), d = 0, f = this.length; d < f; d++) {
          const e = this[d];
          if (e.nodeType === 1)
            if (e.className) {
              for (
    ...
    toggleClass(a, b) {
      const d = typeof a, f = typeof b === "boolean";
      if (c.isFunction(a))
      ...
      return this.each(function () {
        if (d === "string")
          for (
            let e, j = 0, i = c(this), o = b, k = a.split(ca);
            (e = k[j++]);
  ...
  c.event = {
    ...
    trigger(a, b, d, f) {
      ...
      if (!a.isPropagationStopped() && f) c.event.trigger(a, b, f, true);
        ...
        f = a.target;
        let i;
        const o = c.nodeName(f, "a") && e === "click";
        const k = c.event.special[e] || {};
        if (
  ...
  c.each({ mouseenter: "mouseover", mouseleave: "mouseout" }, (a, b) => {
    c.event.special[a] = {
      setup(d) {
  ...
  if (!c.support.changeBubbles) {
    const da = /textarea|input|select/i;
    let ea;
    ...
    c.event.special.change = {
      ...
      setup() {
        ...
        for (const a in ea) c.event.add(this, a + ".specialChange", ea[a]);
  ...
  s.addEventListener &&
    c.each({ focus: "focusin", blur: "focusout" }, (a, b) => {
      function d(f) {
        f = c.event.fix(f);
        f.type = b;
  ...
  c.each(["bind", "one"], (a, b) => {
    c.fn[b] = function (d, f, e) {
      ...
      if (d === "unload" && b !== "one") this.one(d, f, e);
        ...
        j = 0;
        for (const o = this.length; j < o; j++) c.event.add(this[j], d, i, f);
      }
      return this;
    };
  });
  c.fn.extend({
    unbind(a, b) {
      if (typeof a === "object" && !a.preventDefault)
        ...
        d = 0;
        for (const f = this.length; d < f; d++) c.event.remove(this[d], a, b);
      }
      return this;
    },
    delegate(a, b, d, f) {
    ...
    toggle(a) {
      ...
      return this.click(
        c.proxy(a, function (f) {
          const e = (c.data(this, "lastToggle" + a.guid) || 0) % d;
  ...
  c.each(["live", "die"], (a, b) => {
    c.fn[b] = function (d, f, e, j) {
      ...
      let k;
      let n;
      const r = j || this.selector;
      const u = j ? this : c(this.context);
      if (c.isFunction(f)) {
        e = f;
        f = w;
      }
  ...
  (() => {
    ...
    class k {
      ...
      static find(g, h, l) {
        let m, q;
        if (!g) return [];
        for (let p = 0, v = n.order.length; p < v; p++) {
          const t = n.order[p];
      ...
      static filter(g, h, l, m) {
        for (
          var q = g, p = [], v = h, t, y, S = h && h[0] && x(h[0]);
          g && h.length;

        ) {
          for (const H in n.filter)
    ...
    var n = (k.selectors = {
        ...
        relative: {
          "+": function (g, h) {
            let l = typeof h === "string", m = l && !/\W/.test(h);
            l = l && !m;
            if (m) h = h.toLowerCase();
            m = 0;
            for (let q = g.length, p; m < q; m++)
              if ((p = g[m])) {
        ...
        filter: {
          ...
          POS(g, h, l, m) {
            const q = n.setFilters[h[2]];
            if (q) return q(g, l, h, m);
          },
        },
      }),
      r = n.match.POS;
    for (const u in n.match) {
      n.match[u] = new RegExp(
        n.match[u].source + /(?![^\[]*\])(?![^\(]*\))/.source
      );
      n.leftMatch[u] = new RegExp(
        /(^(?:.|\r|\n)*?)/.source +
          n.match[u].source.replace(/\\(\d+)/g, (g, h) => {
            return "\\" + (h - 0 + 1);
          })
      );
    }
    ...
    if (s.documentElement.compareDocumentPosition)
      ...
      B = (g, h) => {
        ...
        const l = g.ownerDocument.createRange(), m = h.ownerDocument.createRange();
        l.setStart(g, 0);
        l.setEnd(g, 0);
        m.setStart(h, 0);
        m.setEnd(h, 0);
    ...
    (() => {
      ...
      const h = "script" + new Date().getTime();
    ...
    (() => {
      ...
      if (g.getElementsByTagName("*").length > 0)
        n.find.TAG = (h, l) => {
          ...
          if (h[1] === "*") {
            h = [];
            for (let m = 0; l[m]; m++) l[m].nodeType === 1 && h.push(l[m]);
            l = h;
          }
          return l;
        };
    ...
    var E = s.compareDocumentPosition
      ...
      ga = (g, h) => {
        ...
        g = n.relative[g] ? g + "*" : g;
        q = 0;
        for (const p = h.length; q < p; q++) k(g, h[q], l);
        return k.filter(m, l);
      };
    c.find = k;
    c.expr = k.selectors;
  ...
  const eb = /Until$/, fb = /^(?:parents|prevUntil|prevAll)/, gb = /,/;
  ...
  c.fn.extend({
    ...
    closest(a, b) {
      ...
      const k = c.expr.match.POS.test(a) ? c(a, b || this.context) : null;
      return this.map((n, r) => {
  ...
  c.extend({
    ...
    nth(a, b, d) {
      b = b || 1;
      for (let f = 0; a; a = a[d]) if (a.nodeType === 1 && ++f === b) break;
      return a;
    },
    sibling(a, b) {
  ...
  const Ja = / jQuery\d+="(?:\d+|null)"/g;
  const V = /^\s+/;
  const Ka = /(<([\w:]+)[^>]*?)\/>/g;
  const hb = /^(?:area|br|col|embed|hr|img|input|link|meta|param)$/i;
  const La = /<([\w:]+)/;
  const ib = /<tbody/i;
  const jb = /<|&#?\w+;/;
  var ta = /<script|<object|<embed|<option|<style/i;
  var ua = /checked\s*(?:[^=]|=\s*.checked.)/i;
  ...
  c.fn.extend({
    ...
    wrapAll(a) {
      ...
      if (this[0]) {
        const b = c(a, this[0].ownerDocument).eq(0).clone(true);
    ...
    clone(a) {
      const b = this.map(function () {
        if (!c.support.noCloneEvent && !c.isXMLDoc(this)) {
          let d = this.outerHTML;
          const f = this.ownerDocument;
          if (!d) {
    ...
    replaceWith(a) {
      if (this[0] && this[0].parentNode) {
        if (c.isFunction(a))
          return this.each(function (b) {
            const d = c(this), f = d.html();
            d.replaceWith(a.call(this, b, f));
          });
        if (typeof a !== "string") a = c(a).detach();
        return this.each(function () {
          const b = this.nextSibling, d = this.parentNode;
          c(this).remove();
  ...
  c.each(
    ...
    (a, b) => {
      c.fn[a] = function (d) {
        let f = [];
        d = c(d);
        let e = this.length === 1 && this[0].parentNode;
        if (
          e &&
          e.nodeType === 11 &&
          ...
          e = 0;
          for (const j = d.length; e < j; e++) {
            const i = (e > 0 ? this.clone(true) : this).get();
  ...
  c.extend({
      ...
      for (var e = [], j = 0, i; (i = a[j]) != null; j++) {
        ...
        if (i) {
          if (typeof i === "string" && !jb.test(i)) i = b.createTextNode(i);
            ...
            i = i.replace(Ka, Ma);
            let o = (La.exec(i) || ["", ""])[1].toLowerCase(), k = F[o] || F._default, n = k[0], r = b.createElement("div");
    ...
    cleanData(a) {
      for (
        let b, d, f = c.cache, e = c.event.special, j = c.support.deleteExpando, i = 0, o;
        (o = a[i]) != null;
        i++
      )
        if ((d = o[c.expando])) {
  ...
  const kb = /z-?index|font-?weight|opacity|zoom|line-?height/i,
        Na = /alpha\([^)]*\)/,
        Oa = /opacity=([^)]*)/,
        ha = /float/i,
        ia = /-([a-z])/gi,
  ...
  if (c.expr && c.expr.filters) {
    c.expr.filters.hidden = a => {
      const b = a.offsetWidth, d = a.offsetHeight, f = a.nodeName.toLowerCase() === "tr";
      return b === 0 && d === 0 && !f
        ? true
        : b > 0 && d > 0 && !f
        ? false
  ...
  let sb = J();
  const tb = /<script(.|\s)*?\/script>/gi;
  const ub = /select|textarea/i;
  ...
  c.extend({
    ...
    ajax(a) {
      ...
      if (e.cache === false && n === "GET") {
        var r = J();
        const u = e.url.replace(wb, "$1_=" + r + "$2");
        e.url =
      ...
      if (x) {
        ...
        const g = (x.onreadystatechange = q => {
    ...
    httpNotModified(a, b) {
      const d = a.getResponseHeader("Last-Modified"), f = a.getResponseHeader("Etag");
      if (d) c.lastModified[b] = d;
      if (f) c.etag[b] = f;
      return a.status === 304 || a.status === 0;
    },
    httpData(a, b, d) {
      const f = a.getResponseHeader("content-type") || "", e = b === "xml" || (!b && f.indexOf("xml") >= 0);
  ...
  c.fn.extend({
    show(a, b) {
      if (a || a === 0) return this.animate(K("show", 3), a, b);
        ...
        for (b = this.length; a < b; a++) {
          let d = c.data(this[a], "olddisplay");
    ...
    hide(a, b) {
      if (a || a === 0) return this.animate(K("hide", 3), a, b);
        ...
        a = 0;
        for (b = this.length; a < b; a++) {
          const d = c.data(this[a], "olddisplay");
          !d &&
            d !== "none" &&
    ...
    animate(a, b, d, f) {
      const e = c.speed(b, d, f);
      if (c.isEmptyObject(a)) return this.each(e.complete);
      return this[e.queue === false ? "each" : "queue"](function () {
        const j = c.extend({}, e);
        let i;
        const o = this.nodeType === 1 && c(this).is(":hidden");
        const k = this;
        for (i in a) {
          const n = i.replace(ia, ja);
          if (i !== n) {
            a[n] = a[i];
            delete a[i];
            i = n;
  ...
  c.fx.prototype = {
    ...
    step(a) {
      ...
      if (a || b >= this.options.duration + this.startTime) {
        ...
        for (const f in this.options.curAnim)
  ...
  c.offset = {
    initialize() {
      ...
      let f;
      let e;
      const j = parseFloat(c.curCSS(a, "marginTop", true)) || 0;
      c.extend(b.style, {
        position: "absolute",
        top: 0,
        left: 0,
    ...
    bodyOffset(a) {
      let b = a.offsetTop, d = a.offsetLeft;
      c.offset.initialize();
    ...
    setOffset(a, b, d) {
      ...
      const f = c(a), e = f.offset(), j = parseInt(c.curCSS(a, "top", true), 10) || 0, i = parseInt(c.curCSS(a, "left", true), 10) || 0;
...
(c => {
  function p(d, b, a) {
    ...
    c.each("onBeforeClick,onClick".split(","), (f, g) => {
    ...
    if (
      location.hash &&
      a.tabs == "a" &&
      d.find("[href=" + location.hash + "]").length
    )
  ...
  var o = {
      ...
      fade(d, b) {
        const a = this.getConf(), e = a.fadeOutSpeed, l = this.getPanes();
...
(f => {
  function p(a, b, c) {
    let h = c.relative ? a.position().top : a.offset().top, d = c.relative ? a.position().left : a.offset().left, i = c.position[0];
    h -= b.outerHeight() - c.offset[0];
    d += a.outerWidth() + c.offset[1];
    if (/iPad/i.test(navigator.userAgent)) h -= f(window).scrollTop();
    const j = b.outerHeight() + a.outerHeight();
    if (i == "center") h += j / 2;
    if (i == "bottom") h += j;
    i = c.position[1];
  ...
  function u(a, b) {
    ...
    let i = 0;
    let j = 0;
    const m = a.attr("title");
    const q = a.attr("data-tooltip");
    const r = o[b.effect];
    let l;
    const s = a.is(":input");
    const v = s && a.is(":checkbox, :radio, select, :button, :submit");
    const t = a.attr("type");
    let k = b.events[t] || b.events[s ? (v ? "widget" : "input") : "def"];
...
(a => {
  function t(d, b) {
    ...
    let f;
    let m;
    let g = a.tools.expose && (b.mask || b.expose);
    const n = Math.random().toString().slice(10);
    if (g) {
      if (typeof g == "string") g = { color: g };
      g.closeOnClick = g.closeOnEsc = false;
    }
    const p = b.target || d.attr("rel");
    f = p ? a(p) : d;
    ...
    a.extend(c, {
      load(e) {
        ...
        let i = b.top;
        let r = b.left;
        const u = f.outerWidth({ margin: true });
        const v = f.outerHeight({ margin: true });
        if (typeof i == "string")
          i =
            i == "center"
              ? Math.max((o.height() - v) / 2, 0)
              : (parseInt(i, 10) / 100) * o.height();
        if (r == "center") r = Math.max((o.width() - u) / 2, 0);
        h[0].call(c, { top: i, left: r }, () => {
          if (m) {
            e.type = "onLoad";
            j.trigger(e);
          }
        ...
        b.closeOnClick &&
          a(document).bind("click." + n, l => {
            a(l.target).parents(f).length || c.close(l);
          });
        b.closeOnEsc &&
          a(document).bind("keydown." + n, l => {
  ...
  a.tools.overlay.addEffect(
    "default",
    function (d, b) {
      const c = this.getConf(), j = a(window);
      if (!c.fixed) {
        d.top += j.scrollTop();
        d.left += j.scrollLeft();
      }
...
(e => {
  ...
  function u(f, c) {
      ...
      addItem(a) {
        ...
        if (c.circular) {
          ...
          g.children("." + c.clonedClass + ":first").replaceWith(
            a.clone().addClass(c.clonedClass)
          );
        } else g.append(a);
    ...
    e.each(["onBeforeSeek", "onSeek", "onAddItem"], (a, d) => {
    ...
    if (c.circular) {
      const s = b.getItems().slice(-1).clone().prependTo(g), t = b.getItems().eq(1).clone().appendTo(g);
      s.add(t).addClass(c.clonedClass);
      b.onBeforeSeek((a, d, h) => {
    ...
    c.keyboard &&
      e(document).bind("keydown.scrollable", a => {
