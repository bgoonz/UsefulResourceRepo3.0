...
((a, b) => {
  ...
  function cv(a) {
    if (!cj[a]) {
      let b = f("<" + a + ">").appendTo("body"), d = b.css("display");
      b.remove();
      if (d === "none" || d === "") {
        ck ||
  ...
  function bZ(a) {
    return (b, c) => {
      ...
      if (f.isFunction(c)) {
        const d = b.toLowerCase().split(bQ);
        let e = 0;
        const g = d.length;
        let h;
        let i;
    ...
    if (b.nodeType === 1 && !!f.hasData(a)) {
      ...
      if ((d = d[c])) {
        ...
        if (g) {
          ...
          for (const h in g)
            for (let i = 0, j = g[h].length; i < j; i++)
              f.event.add(
                b,
  ...
  function m(a, c, d) {
    const e = c + "defer", g = c + "queue", h = c + "mark", i = f.data(a, e, b, !0);
    i &&
  ...
  function l(a) {
    for (const b in a) if (b !== "toJSON") return !1;
    return !0;
  }
  function k(a, c, d) {
    if (d === b && a.nodeType === 1) {
      const e = "data-" + c.replace(j, "$1-$2").toLowerCase();
      d = a.getAttribute(e);
      if (typeof d == "string") {
        try {
          d =
  ...
  var f = (() => {
    ...
    const n = /^<(\w+)\s*\/?>(?:<\/\1>)?$/;
    const o = /^[\],:{}\s]*$/;
    const p = /\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g;
    const q = /"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g;
    const r = /(?:^|:|,)(?:\s*\[)+/g;
    const s = /(webkit)[ \/]([\w.]+)/;
    const t = /(opera)(?:.*version)?[ \/]([\w.]+)/;
    const u = /(msie) ([\w.]+)/;
    const v = /(mozilla)(?:.*? rv:([\w.]+))?/;
    const w = d.userAgent;
    let x;
    let y;
    let z;
      ...
      e.extend({
        ...
        merge(a, c) {
          ...
          if (typeof c.length == "number")
            for (const f = c.length; e < f; e++) a[d++] = c[e];
        ...
        access(a, c, d, f, g, h) {
          const i = a.length;
          if (typeof c == "object") {
            for (const j in c) e.access(a, j, c[j], f, g, d);
            return a;
          }
          if (d !== b) {
  ...
  var g = "done fail isResolved isRejected promise then always pipe".split(" ");
  const h = [].slice;
  f.extend({
    _Deferred() {
      let a = [];
    ...
    when(a) {
      ...
      const d = b.length;
      var e = d;
      var g = d <= 1 && a && f.isFunction(a.promise) ? a : f.Deferred();
      if (d > 1) {
        for (; c < d; c++)
  ...
  f.extend({
    ...
    data(a, c, d, e) {
      if (!!f.acceptData(a)) {
        ...
        const j = a.nodeType;
        const k = j ? f.cache : a;
        let l = j ? a[f.expando] : a[f.expando] && f.expando;
    ...
    removeData(b, c, d) {
      if (!!f.acceptData(b)) {
        const e = f.expando, g = b.nodeType, h = g ? f.cache : b, i = g ? b[f.expando] : f.expando;
        if (!h[i]) return;
        if (c) {
          const j = d ? h[i][e] : h[i];
          if (j) {
    ...
    f.extend({
      ...
      _unmark(a, c, d) {
        ...
        if (c) {
          d = d || "fx";
          const e = d + "mark", g = a ? 0 : (f.data(c, e, b, !0) || 1) - 1;
  ...
  f.fn.extend({
    ...
    removeClass(a) {
      ...
      if ((a && typeof a == "string") || a === b) {
        const c = (a || "").split(o);
        for (let d = 0, e = this.length; d < e; d++) {
          const g = this[d];
          if (g.nodeType === 1 && g.className)
            if (a) {
              let h = (" " + g.className + " ").replace(n, " ");
    ...
    f.extend({
      valHooks: {
        ...
        select: {
          get(a) {
            let b;
            const c = a.selectedIndex;
            const d = [];
            const e = a.options;
            const g = a.type === "select-one";
            if (c < 0) return null;
            for (let h = g ? c : 0, i = g ? c + 1 : e.length; h < i; h++) {
              const j = e[h];
              if (
                j.selected &&
  ...
  (f.event = {
    ...
    trigger(c, d, e, g) {
      ...
      if ((!!e && !f.event.customEvent[h]) || !!f.event.global[h]) {
        ...
        (c.result = b),
          ...
          d.unshift(c);
        let k = e;
        const l = h.indexOf(":") < 0 ? "on" + h : "";
        do {
          const m = f._data(k, "handle");
          (c.currentTarget = k),
            m && m.apply(k, d),
            l &&
              f.acceptData(k) &&
    ...
    handle(c) {
      ...
      const d = ((f._data(this, "events") || {})[c.type] || []).slice(0), e = !c.exclusive && !c.namespace, g = Array.prototype.slice.call(arguments, 0);
      (g[0] = c), (c.currentTarget = this);
      for (let h = 0, i = d.length; h < i; h++) {
        const j = d[h];
        if (e || c.namespace_re.test(j.namespace)) {
          (c.handler = j.handler), (c.data = j.data), (c.handleObj = j);
          const k = j.handler.apply(this, g);
          k !== b &&
            ((c.result = k),
    ...
    fix(a) {
      ...
      const d = a;
      a = f.Event(d);
      for (let e = this.props.length, g; e; )
      ...
      if (a.pageX == null && a.clientX != null) {
        const h = a.target.ownerDocument || c, i = h.documentElement, j = h.body;
        (a.pageX =
          a.clientX +
  ...
  if (!f.support.changeBubbles) {
    ...
    (f.event.special.change = {
      filters: {
        ...
        beforedeactivate: K,
        click(a) {
          const b = a.target, c = f.nodeName(b, "input") ? b.type : "";
      ...
      setup(a, b) {
        ...
        for (const c in I) f.event.add(this, c + ".specialChange", I[c]);
  ...
  f.support.focusinBubbles ||
    ...
    f.each(["bind", "one"], (a, c) => {
      f.fn[c] = function (a, d, e) {
        let g;
        if (typeof a == "object") {
          for (const h in a) this[c](h, d, a[h], e);
          return this;
        }
    ...
    f.fn.extend({
      unbind(a, b) {
        if (typeof a == "object" && !a.preventDefault)
          for (const c in a) this.unbind(c, a[c]);
        else
          for (let d = 0, e = this.length; d < e; d++)
      ...
      toggle(a) {
        ...
        const e = function (c) {
          const e = (f.data(this, "lastToggle" + a.guid) || 0) % d;
  ...
  f.each(["live", "die"], (a, c) => {
    f.fn[c] = function (a, d, e, g) {
      ...
      let k;
      let l;
      const m = g || this.selector;
      const n = g ? this : f(this.context);
      if (typeof a == "object" && !a.preventDefault) {
        for (const o in a) n[c](o, d, a[o], m);
        return this;
      }
    ...
    (k.uniqueSort = a => {
      ...
      (k.matchesSelector = (a, b) => {
        return k(b, null, null, [a]).length > 0;
      }),
      (k.find = (a, b, c) => {
        let d;
        if (!a) return [];
        for (let e = 0, f = l.order.length; e < f; e++) {
          let g;
          const h = l.order[e];
      ...
      let i = [];
      let j = c;
      const m = c && c[0] && k.isXML(c[0]);
      while (a && c.length) {
        for (const n in l.filter)
    ...
    var l = (k.selectors = {
        ...
        relative: {
          "+": function (a, b) {
            const c = typeof b == "string", d = c && !j.test(b), e = c && !d;
            d && (b = b.toLowerCase());
            for (let f = 0, g = a.length, h; f < g; f++)
              if ((h = a[f])) {
    ...
    try {
      ...
      p = (a, b) => {
        ...
        if (e.call(a) === "[object Array]") Array.prototype.push.apply(d, a);
          ...
          for (const f = a.length; c < f; c++) d.push(a[c]);
    ...
    var v = (a, b) => {
      ...
      const d = [];
      let e = "";
      const f = b.nodeType ? [b] : b;
      while ((c = l.match.PSEUDO.exec(a)))
        (e += c[0]), (a = a.replace(l.match.PSEUDO, ""));
      a = l.relative[a] ? a + "*" : a;
      for (let g = 0, h = f.length; g < h; g++) k(a, f[g], d);
      return k.filter(e, d);
    };
    (f.find = k),
      (f.expr = k.selectors),
  ...
  const P = /Until$/;
  const Q = /^(?:parents|prevUntil|prevAll)/;
  const R = /,/;
  var S = /^.[^:#\[\.,]*$/;
  const T = Array.prototype.slice;
  const U = f.expr.match.POS;
  ...
  f.fn.extend({
    ...
    closest(a, b) {
      ...
      const l = U.test(a) || typeof a != "string" ? f(a, b || this.context) : 0;
  ...
  const ba = /<tbody/i;
  const bb = /<|&#?\w+;/;
  const bc = /<(?:script|object|embed|option|style)/i;
  ...
  (bg.optgroup = bg.option),
    ...
    let g;
    let h;
    const i = b && b[0] ? b[0].ownerDocument || b[0] : c;
    a.length === 1 &&
      typeof a[0] == "string" &&
      a[0].length < 512 &&
      i === c &&
    ...
    f.extend({
        ...
        for (var j = 0, k; (k = a[j]) != null; j++) {
          ...
          if (typeof k == "string")
            if (!bb.test(k)) k = b.createTextNode(k);
              ...
              k = k.replace($, "<$1></$2>");
              const l = (_.exec(k) || ["", ""])[1].toLowerCase();
              const m = bg[l] || bg._default;
              let n = m[0];
      ...
      cleanData(a) {
        ...
        const d = f.cache;
        const e = f.expando;
        const g = f.event.special;
        const h = f.support.deleteExpando;
        for (let i = 0, j; (j = a[i]) != null; i++) {
  ...
  (f.fn.css = function (a, c) {
    ...
    return f.access(this, a, c, !0, (a, c, d) => {
    ...
    f.support.opacity ||
      (f.cssHooks.opacity = {
        ...
        set(a, b) {
          const c = a.style, d = a.currentStyle;
          c.zoom = 1;
          const e = f.isNaN(b) ? "" : "alpha(opacity=" + b * 100 + ")", g = (d && d.filter) || c.filter || "";
    ...
    c.documentElement.currentStyle &&
      (bB = (a, b) => {
      let c;
      let d = a.currentStyle && a.currentStyle[b];
      const e = a.runtimeStyle && a.runtimeStyle[b];
      const f = a.style;
      !bs.test(d) &&
        bt.test(d) &&
        ((c = f.left),
  ...
  const bK = /^(?:about|app|app\-storage|.+\-extension|file|widget):$/;
  const bL = /^(?:GET|HEAD)$/;
  const bM = /^\/\//;
  const bN = /\?/;
  const bO = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi;
  const bP = /^(?:select|textarea)/i;
  var bQ = /\s+/;
  const bR = /([?&])_=[^&]*/;
  const bS = /^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/;
  const bT = f.fn.load;
  ...
  (bX = bS.exec(bW.toLowerCase()) || []),
    ...
    f.extend({
      ...
      ajaxSetup(a, b) {
        ...
        for (const c in { context: 1, url: 1 })
          c in b
            ? (a[c] = b[c])
      ...
      ajax(a, c) {
        ...
        if (!d.hasContent) {
          d.data && (d.url += (bN.test(d.url) ? "&" : "?") + d.data),
            (k = d.url);
          if (d.cache === !1) {
            const x = f.now(), y = d.url.replace(bR, "$1_=" + x);
            d.url =
  ...
  f.fn.extend({
        ...
        if (a || b >= e.duration + this.startTime) {
          ...
          if (c) {
            e.overflow != null &&
              ...
              e.hide && f(d).hide();
            if (e.hide || e.show)
              for (const i in e.animatedProperties) f.style(d, i, e.orig[i]);
            e.complete.call(d);
          }
          return !1;
        }
    ...
    f.expr &&
      f.expr.filters &&
      (f.expr.filters.animated = a => {
        return f.grep(f.timers, b => {
          return a === b.elem;
        }).length;
      });
  ...
  "getBoundingClientRect" in c.documentElement
    ...
    let e = b;
    const g = b.ownerDocument;
    const h = g.documentElement;
    const i = g.body;
    const j = g.defaultView;
    let k = j ? j.getComputedStyle(b, null) : b.currentStyle;
    let l = b.offsetTop;
    let m = b.offsetLeft;
    ...
    (f.offset = {
      initialize() {
        ...
        let g;
        let h;
        const i = parseFloat(f.css(a, "marginTop")) || 0;
    ...
    f.fn.extend({
      position() {
        ...
        const a = this[0], b = this.offsetParent(), c = this.offset(), d = cx.test(b[0].nodeName) ? { top: 0, left: 0 } : b.offset();
    ...
    f.each(["Height", "Width"], (a, c) => {
      ...
      (f.fn["inner" + c] = function () {
        ...
        (f.fn[d] = function (a) {
          ...
          if (f.isWindow(e)) {
            const g = e.document.documentElement["client" + c];
            return (
          ...
          if (a === b) {
            const h = f.css(e, d), i = parseFloat(h);
