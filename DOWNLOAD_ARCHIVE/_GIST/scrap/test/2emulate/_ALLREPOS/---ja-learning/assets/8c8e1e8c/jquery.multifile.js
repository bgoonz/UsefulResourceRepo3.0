  ...
  ($ => {
    ...
    $.fn.MultiFile = function (options) {
      ...
      this.not(".MultiFile-applied")
        ...
        .each(function () {
          ...
          const group_count = window.MultiFile;

          // Copy parent attributes - Thanks to Jonas Wagner
          // we will use this one to create new input elements
          const MultiFile = { e: this, E: $(this), clone: $(this).clone() };
          ...
          $.extend(MultiFile, {
            ...
            trigger(event, element) {
              const handler = MultiFile[event], value = $(element).attr("value");
              if (handler) {
                const returnValue = handler(element, value, MultiFile);
          ...
          // Bind a new element
          MultiFile.addSlave = (slave, slave_count) => {
            ...
            slave.change(function () {
              ...
              const v = String(this.value || "" /*.attr('value)*/);
              ...
              // Disallow duplicates
              for (const f in MultiFile.slaves) //{
              ...
              const newEle = $(MultiFile.clone).clone(); // Copy parent attributes - Thanks to Jonas Wagner
          ...
          MultiFile.addToList = (slave, slave_count) => {
            ...
            const r = $('<div class="MultiFile-label"></div>'),
	...
	*/
    $.extend($.fn.MultiFile, {
       ...
       */
      reset() {
        const settings = $(this).data("MultiFile");
      ...
      /**
			...
			*/
      intercepted: {},
      intercept(methods, context, args) {
        let method, value;
        args = args || [];
