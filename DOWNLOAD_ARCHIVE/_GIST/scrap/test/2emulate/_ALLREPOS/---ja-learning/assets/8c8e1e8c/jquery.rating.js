    ...
    $.fn.rating = function (options) {
      ...
      this.not(".star-rating-applied")
        ...
        if (typeof control.split == "number" && control.split > 0) {
          ...
          const spi = control.count % control.split, spw = Math.floor(stw / control.split);
          star
	...
	*/
    $.extend($.fn.rating, {
      ...
      draw() {
        ...
        control.cancel[
          control.readOnly || control.required ? "hide" : "show"
        ]();
        // Add/remove read-only classes to remove hand pointer
        this.siblings()[control.readOnly ? "addClass" : "removeClass"](
