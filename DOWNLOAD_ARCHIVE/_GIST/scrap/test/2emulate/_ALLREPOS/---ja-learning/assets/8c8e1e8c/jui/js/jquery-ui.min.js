  ...
  if (!a.ui.version) {
    ...
    a.fn.extend({
      ...
      zIndex(g) {
        ...
        if (this.length) {
          g = a(this[0]);
          for (let e; g.length && g[0] !== document; ) {
            e = g.css("position");
    ...
    a.extend(a.expr[":"], {
      ...
      tabbable(g) {
        const e = a.attr(g, "tabindex"), i = isNaN(e);
        return (i || e >= 0) && c(g, !i);
      },
    });
    a(() => {
      const g = document.body;
      let e = g.appendChild((e = document.createElement("div")));
      a.extend(e.style, {
        minHeight: "100px",
        height: "auto",
        padding: 0,
...
((a, d) => {
  if (a.cleanData) {
    const c = a.cleanData;
    a.cleanData = g => {
      for (let e = 0, i; (i = g[e]) != null; e++) a(i).triggerHandler("remove");
      c(g);
    };
  } else {
    const f = a.fn.remove;
  ...
  a.widget.bridge = (g, e) => {
    a.fn[g] = function (i) {
      ...
      b
        ? this.each(function () {
            const l = a.data(this, g), o = l && a.isFunction(l[i]) ? l[i].apply(l, h) : l;
            if (o !== l && o !== d) {
              j = o;
              return false;
            }
...
(a => {
  ...
  a.widget("ui.mouse", {
    ...
    _mouseInit() {
      const c = this;
      this.element
        .bind("mousedown." + this.widgetName, f => {
          return c._mouseDown(f);
        })
        .bind("click." + this.widgetName, f => {
...
(a => {
  a.widget("ui.draggable", a.ui.mouse, {
    ...
    _getParentOffset() {
      ...
      let d = this.offsetParent.offset();
      if (
    ...
    _setContainment() {
      ...
      if (
        ...
        if (c) {
          d.offset();
          const f = a(c).css("overflow") != "hidden";
          this.containment = [
    ...
    _generatePosition(d) {
      ...
      const g = /(html|body)/i.test(f[0].tagName);
      let e = d.pageX;
      let i = d.pageY;
  ...
  a.ui.plugin.add("draggable", "connectToSortable", {
    start(d, c) {
      const f = a(this).data("draggable"), g = f.options, e = a.extend({}, c, { item: f.element });
      f.sortables = [];
      a(g.connectToSortable).each(function () {
        const i = a.data(this, "sortable");
        if (i && !i.options.disabled) {
          f.sortables.push({ instance: i, shouldRevert: i.options.revert });
          i.refreshPositions();
    ...
    stop(d, c) {
      const f = a(this).data("draggable"), g = a.extend({}, c, { item: f.element });
    ...
    drag(d, c) {
      const f = a(this).data("draggable"), g = this;
      a.each(f.sortables, function () {
  ...
  a.ui.plugin.add("draggable", "cursor", {
    start() {
      const d = a("body"), c = a(this).data("draggable").options;
      if (d.css("cursor")) c._cursor = d.css("cursor");
      d.css("cursor", c.cursor);
    },
    stop() {
      const d = a(this).data("draggable").options;
  ...
  a.ui.plugin.add("draggable", "scroll", {
    start() {
      const d = a(this).data("draggable");
      if (d.scrollParent[0] != document && d.scrollParent[0].tagName != "HTML")
        d.overflowOffset = d.scrollParent.offset();
    },
    drag(d) {
      const c = a(this).data("draggable");
      const f = c.options;
      let g = false;
      if (
  ...
  a.ui.plugin.add("draggable", "snap", {
    start() {
      const d = a(this).data("draggable"), c = d.options;
      d.snapElements = [];
      a(
    ...
    drag(d, c) {
      for (
        let f = a(this).data("draggable"), g = f.options, e = g.snapTolerance, i = c.offset.left, b = i + f.helperProportions.width, h = c.offset.top, j = h + f.helperProportions.height, l = f.snapElements.length - 1;
        l >= 0;
        l--
      ) {
        const o = f.snapElements[l].left, n = o + f.snapElements[l].width, k = f.snapElements[l].top, m = k + f.snapElements[l].height;
        if (
          ...
          if (g.snapMode != "inner") {
            ...
            if (q)
              c.position.top =
                f._convertPositionTo("relative", { top: m, left: 0 }).top -
                f.margins.top;
            if (s)
              c.position.left =
                f._convertPositionTo("relative", {
            ...
            if (r)
              c.position.left =
                f._convertPositionTo("relative", { top: 0, left: n }).left -
                f.margins.left;
          }
          const u = p || q || s || r;
          if (g.snapMode != "outer") {
            ...
            if (p)
              c.position.top =
                f._convertPositionTo("relative", { top: k, left: 0 }).top -
                f.margins.top;
            if (q)
              c.position.top =
                f._convertPositionTo("relative", {
            ...
            if (s)
              c.position.left =
                f._convertPositionTo("relative", { top: 0, left: o }).left -
                f.margins.left;
            if (r)
              c.position.left =
                f._convertPositionTo("relative", {
          ...
          if (!f.snapElements[l].snapping && (p || q || s || r || u))
            f.options.snap.snap &&
              f.options.snap.snap.call(
                f.element,
                d,
                a.extend(f._uiHash(), { snapItem: f.snapElements[l].item })
              );
  ...
  a.ui.plugin.add("draggable", "stack", {
    start() {
      let d = a(this).data("draggable").options;
      d = a.makeArray(a(d.stack)).sort((f, g) => {
        return (
      ...
      if (d.length) {
        const c = parseInt(d[0].style.zIndex) || 0;
        a(d).each(function (f) {
...
(a => {
  a.widget("ui.droppable", {
    ...
    _create() {
      const d = this.options, c = d.accept;
      this.isover = 0;
      this.isout = 1;
    ...
    destroy() {
      for (
        let d = a.ui.ddmanager.droppables[this.options.scope], c = 0;
        c < d.length;
        c++
      )
    ...
    _activate(d) {
      const c = a.ui.ddmanager.current;
    ...
    _drop(d, c) {
      const f = c || a.ui.ddmanager.current;
  ...
  a.ui.intersect = (d, c, f) => {
    if (!c.offset) return false;
    const g = (d.positionAbs || d.position.absolute).left, e = g + d.helperProportions.width, i = (d.positionAbs || d.position.absolute).top, b = i + d.helperProportions.height, h = c.offset.left, j = h + c.proportions.width, l = c.offset.top, o = l + c.proportions.height;
    switch (f) {
      case "fit":
  ...
  a.ui.ddmanager = {
    ...
    droppables: { default: [] },
    prepareOffsets(d, c) {
      const f = a.ui.ddmanager.droppables[d.options.scope] || [];
      const g = c ? c.type : null;
      const e = (d.currentItem || d.element).find(":data(droppable)").andSelf();
      let i = 0;
      a: for (; i < f.length; i++)
        if (
          !(
    ...
    drag(d, c) {
      ...
      a.each(a.ui.ddmanager.droppables[d.options.scope] || [], function () {
        if (!(this.options.disabled || this.greedyChild || !this.visible)) {
          let f = a.ui.intersect(d, this, this.options.tolerance);
          if (
            (f =
              !f && this.isover == 1
                ? "isout"
            ...
            if (this.options.greedy) {
              const e = this.element.parents(":data(droppable):eq(0)");
              if (e.length) {
...
(a => {
  a.widget("ui.resizable", a.ui.mouse, {
    ...
    _create() {
      ...
      if (this.handles.constructor == String) {
        ...
        for (let i = 0; i < e.length; i++) {
          ...
          /sw|se|ne|nw/.test(b) && h.css({ zIndex: ++g.zIndex });
      ...
      this._renderAxis = function (j) {
        ...
        for (const l in this.handles) {
          ...
          if (
            ...
            let o = a(this.handles[l], this.element), n = 0;
      ...
      this._handles.mouseover(function () {
        if (!f.resizing) {
          if (this.className)
            const j = this.className.match(/ui-resizable-(se|sw|ne|nw|n|e|s|w)/i);
          f.axis = j && j[1] ? j[1] : "se";
        }
      });
      if (g.autoHide) {
    ...
    _mouseCapture(f) {
      let g = false;
      for (const e in this.handles)
        if (a(this.handles[e])[0] == f.target) g = true;
      return !this.options.disabled && g;
    },
    _mouseStart(f) {
      let g = this.options;
      let e = this.element.position();
      ...
      if (i.is(".ui-draggable") || /absolute/.test(i.css("position")))
        i.css({ position: "absolute", top: e.top, left: e.left });
      a.browser.opera &&
        /relative/.test(i.css("position")) &&
        i.css({ position: "relative", top: "auto", left: "auto" });
      this._renderProxy();
      e = d(this.helper.css("left"));
      let b = d(this.helper.css("top"));
      if (g.containment) {
        e += a(g.containment).scrollLeft() || 0;
        b += a(g.containment).scrollTop() || 0;
      }
      this.offset = this.helper.offset();
      this.position = { left: e, top: b };
      ...
      this.originalSize = this._helper
        ? { width: i.outerWidth(), height: i.outerHeight() }
        : { width: i.width(), height: i.height() };
      this.originalPosition = { left: e, top: b };
      this.sizeDiff = {
    ...
    _mouseDrag(f) {
      const g = this.helper;
      let e = this.originalMousePosition;
      const i = this._change[this.axis];
      if (!i) return false;
    ...
    _mouseStop(f) {
      this.resizing = false;
      const g = this.options, e = this;
      if (this._helper) {
        let i = this._proportionallyResizeElements, b = i.length && /textarea/i.test(i[0].nodeName);
        i = b && a.ui.hasScroll(i[0], "left") ? 0 : e.sizeDiff.height;
        b = b ? 0 : e.sizeDiff.width;
        b = { width: e.helper.width() - b, height: e.helper.height() - i };
        i =
        ...
        g.animate || this.element.css(a.extend(b, { top: h, left: i }));
    ...
    _updateRatio(f) {
      const g = this.position, e = this.size, i = this.axis;
    ...
    _respectSize(f) {
      let g = this.options;
      let e = this.axis;
      const i = c(f.width) && g.maxWidth && g.maxWidth < f.width;
      const b = c(f.height) && g.maxHeight && g.maxHeight < f.height;
      const h = c(f.width) && g.minWidth && g.minWidth > f.width;
      const j = c(f.height) && g.minHeight && g.minHeight > f.height;
      if (h) f.width = g.minWidth;
      if (j) f.height = g.minHeight;
      if (i) f.width = g.maxWidth;
      if (b) f.height = g.maxHeight;
      const l = this.originalPosition.left + this.originalSize.width, o = this.position.top + this.size.height, n = /sw|nw|w/.test(e);
      e = /nw|ne|n/.test(e);
    ...
    _proportionallyResize() {
      if (this._proportionallyResizeElements.length)
        for (
          let f = this.helper || this.element, g = 0;
          g < this._proportionallyResizeElements.length;
          g++
        ) {
          const e = this._proportionallyResizeElements[g];
          if (!this.borderDif) {
            const i = [
    ...
    _renderProxy() {
      ...
      if (this._helper) {
        ...
        let g = a.browser.msie && a.browser.version < 7;
        const e = g ? 1 : 0;
        g = g ? 2 : -1;
        this.helper
  ...
  a.ui.plugin.add("resizable", "alsoResize", {
    start() {
      const f = a(this).data("resizable").options,
            g = e => {
              a(e).each(function () {
                const i = a(this);
      ...
      if (typeof f.alsoResize == "object" && !f.alsoResize.parentNode)
        if (f.alsoResize.length) {
          ...
          a.each(f.alsoResize, e => {
            g(e);
          });
      else g(f.alsoResize);
    },
    resize(f, g) {
      const e = a(this).data("resizable");
      f = e.options;
      ...
      typeof f.alsoResize == "object" && !f.alsoResize.nodeType
        ? a.each(f.alsoResize, (l, o) => {
            j(l, o);
          })
        : j(f.alsoResize);
    },
    stop() {
      const f = a(this).data("resizable"),
            g = f.options,
            e = i => {
              a(i).each(function () {
                const b = a(this);
  ...
  a.ui.plugin.add("resizable", "animate", {
    stop(f) {
      const g = a(this).data("resizable");
      const e = g.options;
      const i = g._proportionallyResizeElements;
      let b = i.length && /textarea/i.test(i[0].nodeName);
      let h = b && a.ui.hasScroll(i[0], "left") ? 0 : g.sizeDiff.height;
      b = {
      ...
      g.element.animate(a.extend(b, j && h ? { top: j, left: h } : {}), {
  ...
  a.ui.plugin.add("resizable", "containment", {
    start() {
      ...
      if (
        ...
        if (/document/.test(e) || e == document) {
          ...
          const i = a(g), b = [];
          a(["Top", "Right", "Left", "Bottom"]).each((l, o) => {
          ...
          e = f.containerOffset;
          let h = f.containerSize.height, j = f.containerSize.width;
    ...
    resize(f) {
      const g = a(this).data("resizable");
      let e = g.options;
      let i = g.containerOffset;
      let b = g.position;
      f = g._aspectRatio || f.shiftKey;
      let h = { top: 0, left: 0 };
      const j = g.containerElement;
    ...
    stop() {
      const f = a(this).data("resizable");
      const g = f.options;
      const e = f.containerOffset;
      const i = f.containerPosition;
      const b = f.containerElement;
      let h = a(f.helper);
      const j = h.offset();
      const l = h.outerWidth() - f.sizeDiff.width;
      h = h.outerHeight() - f.sizeDiff.height;
      f._helper &&
        !g.animate &&
        /relative/.test(b.css("position")) &&
        a(this).css({ left: j.left - i.left - e.left, width: l, height: h });
      f._helper &&
        !g.animate &&
  ...
  a.ui.plugin.add("resizable", "ghost", {
    start() {
      const f = a(this).data("resizable"), g = f.options, e = f.size;
  ...
  a.ui.plugin.add("resizable", "grid", {
    resize() {
      ...
      let g = f.options;
      const e = f.size;
      const i = f.originalSize;
      const b = f.originalPosition;
      const h = f.axis;
  ...
  a.widget("ui.selectable", a.ui.mouse, {
    ...
    _mouseStart(d) {
      ...
      if (!this.options.disabled) {
        ...
        this.selectees.filter(".ui-selected").each(function () {
          const g = a.data(this, "selectable-item");
          ...
          if (!d.metaKey) {
            ...
            g.unselecting = true;
            c._trigger("unselecting", d, { unselecting: g.element });
          }
        });
        a(d.target)
          .parents()
          ...
          .each(function () {
            const g = a.data(this, "selectable-item");
            if (g) {
              const e = !d.metaKey || !g.$element.hasClass("ui-selected");
              g.$element
              ...
              g.selecting = e;
              (g.selected = e)
                ? c._trigger("selecting", d, { selecting: g.element })
                : c._trigger("unselecting", d, { unselecting: g.element });
              return false;
            }
          });
    ...
    _mouseDrag(d) {
      ...
      if (!this.options.disabled) {
        ...
        this.helper.css({ left: g, top: e, width: i - g, height: b - e });
        this.selectees.each(function () {
          const j = a.data(this, "selectable-item");
    ...
    _mouseStop(d) {
      ...
      a(".ui-unselecting", this.element[0]).each(function () {
        const f = a.data(this, "selectable-item");
  ...
  a.widget("ui.sortable", a.ui.mouse, {
    ...
    _mouseDrag(d) {
      ...
      for (c = this.items.length - 1; c >= 0; c--) {
        f = this.items[c];
        const g = f.item[0], e = this._intersectsWithPointer(f);
        if (e)
          if (
    ...
    cancel() {
      ...
      if (this.dragging) {
        ...
        for (let c = this.containers.length - 1; c >= 0; c--) {
    ...
    serialize(d) {
      const c = this._getItemsAsjQuery(d && d.connected), f = [];
      d = d || {};
      a(c).each(function () {
        const g = (a(d.item || this).attr(d.attribute || "id") || "").match(
          d.expression || /(.+)[-=_](.+)/
        );
        if (g)
          f.push(
    ...
    _intersectsWith(d) {
      const c = this.positionAbs.left;
      const f = c + this.helperProportions.width;
      const g = this.positionAbs.top;
      const e = g + this.helperProportions.height;
      const i = d.left;
      const b = i + d.width;
      const h = d.top;
      const j = h + d.height;
      let l = this.offset.click.top;
      const o = this.offset.click.left;
    ...
    _intersectsWithPointer(d) {
      ...
      const f = this._getDragHorizontalDirection();
      if (!c) return false;
    ...
    _intersectsWithSides(d) {
      const c = a.ui.isOverAxis(
        this.positionAbs.top + this.offset.click.top,
        d.top + d.height / 2,
        d.height
      );
      ...
      const f = this._getDragVerticalDirection(), g = this._getDragHorizontalDirection();
      return this.floating && g
        ? (g == "right" && d) || (g == "left" && !d)
        : f && ((f == "down" && c) || (f == "up" && !c));
    },
    _getDragVerticalDirection() {
      const d = this.positionAbs.top - this.lastPositionAbs.top;
      return d != 0 && (d > 0 ? "down" : "up");
    },
    _getDragHorizontalDirection() {
      const d = this.positionAbs.left - this.lastPositionAbs.left;
    ...
    _getItemsAsjQuery(d) {
      const c = [], f = [], g = this._connectWith();
      if (g && d)
        for (d = g.length - 1; d >= 0; d--)
          for (let e = a(g[d]), i = e.length - 1; i >= 0; i--) {
            const b = a.data(e[i], "sortable");
    ...
    _removeCurrentsFromItems() {
      for (
        let d = this.currentItem.find(":data(sortable-item)"), c = 0;
        c < this.items.length;
        c++
      )
    ...
    _createPlaceholder(d) {
      const c = d || this, f = c.options;
      if (!f.placeholder || f.placeholder.constructor == String) {
        const g = f.placeholder;
        f.placeholder = {
          element() {
            const e = a(document.createElement(c.currentItem[0].nodeName))
              .addClass(
    ...
    _getRelativeOffset() {
      if (this.cssPosition == "relative") {
        const d = this.currentItem.position();
        return {
          top:
            d.top -
            (parseInt(this.helper.css("top"), 10) || 0) +
...
jQuery.effects || ((a, d) => {
  ...
  a.effects.animateClass = function (n, k, m, p) {
    ...
    return this.queue(function () {
      const q = a(this);
      const s = q.attr("style") || " ";
      const r = e(g.call(this));
      let u;
      const v = q.attr("class");
      a.each(l, (w, x) => {
        n[x] && q[x + "Class"](n[x]);
      });
      u = e(g.call(this));
  ...
  a.fn.extend({
    ...
    addClass(n, k, m, p) {
      return k
        ? a.effects.animateClass.apply(this, [{ add: n }, k, m, p])
        : this._addClass(n);
    },
    _removeClass: a.fn.removeClass,
    removeClass(n, k, m, p) {
      return k
        ? a.effects.animateClass.apply(this, [{ remove: n }, k, m, p])
        : this._removeClass(n);
    },
    _toggleClass: a.fn.toggleClass,
    toggleClass(n, k, m, p, q) {
      return typeof k == "boolean" || k === d
        ...
        : a.effects.animateClass.apply(this, [{ toggle: n }, k, m, p]);
    },
    switchClass(n, k, m, p, q) {
  ...
  a.extend(a.effects, {
    ...
    createWrapper(n) {
      ...
      if (n.css("position") == "static") {
        ...
        a.each(["top", "left", "bottom", "right"], (p, q) => {
          k[q] = n.css(q);
  ...
  a.fn.extend({
    effect(n) {
      let k = b.apply(this, arguments);
      const m = { options: k[1], duration: k[2], callback: k[3] };
      k = m.options.mode;
      const p = a.effects[n];
      if (a.fx.off || !p)
        return k
    ...
    show(n) {
      if (h(n)) return this._show.apply(this, arguments);
        ...
        const k = b.apply(this, arguments);
        k[1].mode = "show";
...
(a => {
  a.effects.blind = function (d) {
    return this.queue(function () {
      const c = a(this);
      const f = ["position", "top", "bottom", "left", "right"];
      const g = a.effects.setMode(c, d.options.mode || "hide");
      let e = d.options.direction || "vertical";
      a.effects.save(c, f);
      c.show();
      const i = a.effects.createWrapper(c).css({ overflow: "hidden" }), b = e == "vertical" ? "height" : "width";
...
(a => {
  a.effects.bounce = function (d) {
    return this.queue(function () {
      const c = a(this);
      const f = ["position", "top", "bottom", "left", "right"];
      const g = a.effects.setMode(c, d.options.mode || "effect");
      let e = d.options.direction || "up";
      let i = d.options.distance || 20;
      let b = d.options.times || 5;
      const h = d.duration || 250;
      /show|hide/.test(g) && f.push("opacity");
      a.effects.save(c, f);
      c.show();
      a.effects.createWrapper(c);
      const j = e == "up" || e == "down" ? "top" : "left";
      e = e == "up" || e == "left" ? "pos" : "neg";
      i =
        d.options.distance ||
        (j == "top"
          ? c.outerHeight({ margin: true }) / 3
          : c.outerWidth({ margin: true }) / 3);
...
(a => {
  a.effects.clip = function (d) {
    return this.queue(function () {
      const c = a(this);
      const f = ["position", "top", "bottom", "left", "right", "height", "width"];
      const g = a.effects.setMode(c, d.options.mode || "hide");
      let e = d.options.direction || "vertical";
      a.effects.save(c, f);
      c.show();
      let i = a.effects.createWrapper(c).css({ overflow: "hidden" });
...
(a => {
  a.effects.drop = function (d) {
    return this.queue(function () {
      const c = a(this);
      const f = ["position", "top", "bottom", "left", "right", "opacity"];
      const g = a.effects.setMode(c, d.options.mode || "hide");
      let e = d.options.direction || "left";
      a.effects.save(c, f);
      c.show();
      a.effects.createWrapper(c);
      const i = e == "up" || e == "down" ? "top" : "left";
      e = e == "up" || e == "left" ? "pos" : "neg";
      const b =
        d.options.distance ||
        (i == "top"
          ? c.outerHeight({ margin: true }) / 2
          : c.outerWidth({ margin: true }) / 2);
      if (g == "show") c.css("opacity", 0).css(i, e == "pos" ? -b : b);
      const h = { opacity: g == "show" ? 1 : 0 };
      h[i] =
        (g == "show" ? (e == "pos" ? "+=" : "-=") : e == "pos" ? "-=" : "+=") +
        b;
      c.animate(h, {
...
(a => {
  a.effects.explode = function (d) {
    return this.queue(function () {
      const c = d.options.pieces ? Math.round(Math.sqrt(d.options.pieces)) : 3, f = d.options.pieces ? Math.round(Math.sqrt(d.options.pieces)) : 3;
      d.options.mode =
        d.options.mode == "toggle"
          ? a(this).is(":visible")
            ...
            : "show"
          : d.options.mode;
      const g = a(this).show().css("visibility", "hidden"), e = g.offset();
      e.top -= parseInt(g.css("marginTop"), 10) || 0;
      e.left -= parseInt(g.css("marginLeft"), 10) || 0;
      for (
        let i = g.outerWidth(true), b = g.outerHeight(true), h = 0;
        h < c;
        h++
      )
        for (let j = 0; j < f; j++)
...
(a => {
  a.effects.fade = function (d) {
    return this.queue(function () {
      const c = a(this), f = a.effects.setMode(c, d.options.mode || "hide");
      c.animate(
        { opacity: f },
        {
          queue: false,
...
(a => {
  a.effects.fold = function (d) {
    return this.queue(function () {
      ...
      const f = ["position", "top", "bottom", "left", "right"];
      const g = a.effects.setMode(c, d.options.mode || "hide");
      let e = d.options.size || 15;
      let i = !!d.options.horizFirst;
      const b = d.duration ? d.duration / 2 : a.fx.speeds._default / 2;
      a.effects.save(c, f);
      c.show();
      const h = a.effects.createWrapper(c).css({ overflow: "hidden" });
      let j = (g == "show") != i;
      const l = j ? ["width", "height"] : ["height", "width"];
      j = j ? [h.width(), h.height()] : [h.height(), h.width()];
      let o = /([0-9]+)%/.exec(e);
      if (o) e = (parseInt(o[1], 10) / 100) * j[g == "hide" ? 0 : 1];
      if (g == "show")
        h.css(i ? { height: 0, width: e } : { height: e, width: 0 });
      i = {};
      o = {};
      i[l[0]] = g == "show" ? j[0] : e;
      o[l[1]] = g == "show" ? j[1] : 0;
...
(a => {
  a.effects.highlight = function (d) {
    return this.queue(function () {
      const c = a(this), f = ["backgroundImage", "backgroundColor", "opacity"], g = a.effects.setMode(c, d.options.mode || "show"), e = { backgroundColor: c.css("backgroundColor") };
...
(a => {
  a.effects.pulsate = function (d) {
    return this.queue(function () {
      const c = a(this);
      let f = a.effects.setMode(c, d.options.mode || "show");
...
(a => {
  a.effects.puff = function (d) {
    return this.queue(function () {
      const c = a(this), f = a.effects.setMode(c, d.options.mode || "hide"), g = parseInt(d.options.percent, 10) || 150, e = g / 100, i = { height: c.height(), width: c.width() };
      a.extend(d.options, {
        fade: true,
        mode: f,
        percent: f == "hide" ? g : 100,
        from: f == "hide" ? i : { height: i.height * e, width: i.width * e },
      });
  ...
  a.effects.scale = function (d) {
    return this.queue(function () {
      const c = a(this);
      const f = a.extend(true, {}, d.options);
      const g = a.effects.setMode(c, d.options.mode || "effect");
      ...
      const i = d.options.direction || "both";
      let b = d.options.origin;
      if (g != "effect") {
        f.origin = b || ["middle", "center"];
        f.restore = true;
      }
      b = { height: c.height(), width: c.width() };
      c.from = d.options.from || (g == "show" ? { height: 0, width: 0 } : b);
      e = {
        y: i != "horizontal" ? e / 100 : 1,
        x: i != "vertical" ? e / 100 : 1,
      };
      c.to = { height: b.height * e.y, width: b.width * e.x };
      if (d.options.fade) {
        if (g == "show") {
          c.from.opacity = 0;
          c.to.opacity = 1;
  ...
  a.effects.size = function (d) {
    return this.queue(function () {
      ...
      const j = a.effects.setMode(c, d.options.mode || "effect");
      const l = d.options.restore || false;
      const o = d.options.scale || "both";
      let n = d.options.origin;
      const k = { height: c.height(), width: c.width() };
      ...
      if (o == "content" || o == "both") {
        ...
        c.find("*[width]").each(function () {
          ...
          const p = { height: child.height(), width: child.width() };
          child.from = {
...
(a => {
  a.effects.shake = function (d) {
    return this.queue(function () {
      const c = a(this), f = ["position", "top", "bottom", "left", "right"];
      a.effects.setMode(c, d.options.mode || "effect");
      let g = d.options.direction || "left";
      let e = d.options.distance || 20;
      const i = d.options.times || 3;
      const b = d.duration || d.options.duration || 140;
      a.effects.save(c, f);
      c.show();
      a.effects.createWrapper(c);
      const h = g == "up" || g == "down" ? "top" : "left", j = g == "up" || g == "left" ? "pos" : "neg";
      g = {};
      const l = {}, o = {};
      g[h] = (j == "pos" ? "-=" : "+=") + e;
      l[h] = (j == "pos" ? "+=" : "-=") + e * 2;
...
(a => {
  a.effects.slide = function (d) {
    return this.queue(function () {
      const c = a(this);
      const f = ["position", "top", "bottom", "left", "right"];
      const g = a.effects.setMode(c, d.options.mode || "show");
      let e = d.options.direction || "left";
      a.effects.save(c, f);
      c.show();
      ...
      const b =
        d.options.distance ||
        (i == "top"
          ? c.outerHeight({ margin: true })
          : c.outerWidth({ margin: true }));
...
(a => {
  a.effects.transfer = function (d) {
    return this.queue(function () {
      ...
      g = c.offset();
      const e = a('<div class="ui-effects-transfer"></div>')
...
(a => {
  a.widget("ui.accordion", {
    ...
    _create() {
      ...
      if (c.navigation) {
        const f = d.element.find("a").filter(c.navigationFilter).eq(0);
        if (f.length) {
          const g = f.closest(".ui-accordion-header");
    ...
    _keydown(d) {
      if (!(this.options.disabled || d.altKey || d.ctrlKey)) {
        const c = a.ui.keyCode;
        const f = this.headers.length;
        const g = this.headers.index(d.target);
        let e = false;
        switch (d.keyCode) {
          case c.RIGHT:
          case c.DOWN:
      ...
      slide(d, c) {
        ...
        if (d.toHide.size())
          if (d.toShow.size()) {
            ...
            a.each(["height", "paddingTop", "paddingBottom"], (h, j) => {
              i[j] = "hide";
            ...
            d.toHide
              ...
              .animate(i, {
                ...
                complete() {
                  ...
                  d.toShow.css({ width: b, overflow: f });
                  d.complete();
                },
              });
          } else
...
(a => {
  ...
  a.widget("ui.autocomplete", {
    ...
    _create() {
      const c = this;
      const f = this.element[0].ownerDocument;
      let g;
      this.element
        ...
        .bind("keydown.autocomplete", e => {
          if (!(c.options.disabled || c.element.attr("readonly"))) {
            g = false;
            const i = a.ui.keyCode;
            switch (e.keyCode) {
              case i.PAGE_UP:
      ...
      this.menu = a("<ul></ul>")
        ...
        .mousedown(e => {
          const i = c.menu.element[0];
          a(e.target).closest(".ui-menu-item").length ||
            setTimeout(() => {
              a(document).one("mousedown", b => {
        ...
        .menu({
          focus(e, i) {
            ...
            false !== c._trigger("focus", e, { item: i }) &&
              /^key/.test(e.originalEvent.type) &&
              c.element.val(i.value);
          },
          selected(e, i) {
            const b = i.item.data("item.autocomplete"), h = c.previous;
            ...
            false !== c._trigger("select", e, { item: b }) &&
    ...
    _suggest(c) {
      const f = this.menu.element.empty().zIndex(this.element.zIndex() + 1);
  ...
  a.extend(a.ui.autocomplete, {
    ...
    filter(c, f) {
      const g = new RegExp(a.ui.autocomplete.escapeRegex(f), "i");
      return a.grep(c, e => {
...
(a => {
  a.widget("ui.menu", {
    ...
    activate(d, c) {
      this.deactivate();
      if (this.hasScroll()) {
        const f = c.offset().top - this.element.offset().top, g = this.element.scrollTop(), e = this.element.height();
    ...
    nextPage(d) {
      if (this.hasScroll())
        if (!this.active || this.last())
          ...
          const c = this.active.offset().top;
          const f = this.element.height();

          let g = this.element.children(".ui-menu-item").filter(function () {
            const e = a(this).offset().top - c - f + a(this).height();
            return e < 10 && e > -10;
          });
    ...
    previousPage(d) {
      if (this.hasScroll())
        if (!this.active || this.first())
          ...
          const c = this.active.offset().top, f = this.element.height();
          result = this.element.children(".ui-menu-item").filter(function () {
            const g = a(this).offset().top - c + f - a(this).height();
            return g < 10 && g > -10;
          });
          result.length ||
...
(a => {
  ...
  a.widget("ui.button", {
    ...
    _create() {
      ...
      const g = this, e = this.options, i = this.type === "checkbox" || this.type === "radio", b = "ui-state-hover" + (!i ? " ui-state-active" : "");
    ...
    _determineButtonType() {
      ...
      if (this.type === "checkbox" || this.type === "radio") {
        let g = this.element.parents().filter(":last");
        const e = "label[for=" + this.element.attr("id") + "]";
    ...
    refresh() {
      const g = this.element.is(":disabled");
    ...
    _resetButton() {
      if (this.type === "input")
        ...
        const g = this.buttonElement.removeClass(
...
((a, d) => {
  ...
  function g(b, h) {
    a.extend(b, h);
    for (const j in h) if (h[j] == null || h[j] == d) b[j] = h[j];
    return b;
  }
  ...
  a.extend(c.prototype, {
    ...
    _attachments(b, h) {
      let j = this._get(h, "appendText");
      const l = this._get(h, "isRTL");
      ...
      if (j == "button" || j == "both") {
        ...
        const o = this._get(h, "buttonImage");
        h.trigger = a(
          this._get(h, "buttonImageOnly")
            ? a("<img/>")
                .addClass(this._triggerClass)
                .attr({ src: o, alt: j, title: j })
            : a('<button type="button"></button>')
                .addClass(this._triggerClass)
                .html(
                  o == "" ? j : a("<img/>").attr({ src: o, alt: j, title: j })
                )
        );
    ...
    _autoSize(b) {
      if (this._get(b, "autoSize") && !b.inline) {
        const h = new Date(2009, 11, 20), j = this._get(b, "dateFormat");
        if (j.match(/[DM]/)) {
          const l = o => {
    ...
    _destroyDatepicker(b) {
      const h = a(b), j = a.data(b, "datepicker");
    ...
    _enableDatepicker(b) {
      ...
      if (h.hasClass(this.markerClassName)) {
        ...
        this._disabledInputs = a.map(this._disabledInputs, o => {
          return o == b ? null : o;
        });
      }
    },
    ...
    _isDisabledDatepicker(b) {
      if (!b) return false;
      for (let h = 0; h < this._disabledInputs.length; h++)
    ...
    _optionDatepicker(b, h, j) {
      const l = this._getInst(b);
      ...
      if (l) {
        ...
        const n = this._getDateDatepicker(b, true), k = this._getMinMaxDate(l, "min"), m = this._getMinMaxDate(l, "max");
        g(l.settings, o);
    ...
    _getDateDatepicker(b, h) {
      (b = this._getInst(b)) && !b.inline && this._setDateFromField(b, h);
      return b ? this._getDate(b) : null;
    },
    _doKeyDown(b) {
      const h = a.datepicker._getInst(b.target);
      let j = true;
      const l = h.dpDiv.is(".ui-datepicker-rtl");
      h._keyEvent = true;
    ...
    _doKeyPress(b) {
      let h = a.datepicker._getInst(b.target);
      if (a.datepicker._get(h, "constrainInput")) {
        h = a.datepicker._possibleChars(a.datepicker._get(h, "dateFormat"));
        const j = String.fromCharCode(b.charCode == d ? b.keyCode : b.charCode);
    ...
    _showDatepicker(b) {
      ...
      if (
        ...
        if (!h.inline) {
          ...
          const o = a.datepicker._get(h, "duration"),
                n = () => {
                  const k = h.dpDiv.find("iframe.ui-datepicker-cover");
                  if (k.length) {
                    const m = a.datepicker._getBorders(h.dpDiv);
                    k.css({
                      left: -m[0],
                      top: -m[1],
    ...
    _updateDatepicker(b) {
      let h = a.datepicker._getBorders(b.dpDiv);
      i = b;
      b.dpDiv.empty().append(this._generateHTML(b));
      let j = b.dpDiv.find("iframe.ui-datepicker-cover");
      j.length &&
        j.css({
          left: -h[0],
          top: -h[1],
    ...
    _checkOffset(b, h, j) {
      const l = b.dpDiv.outerWidth(), o = b.dpDiv.outerHeight(), n = b.input ? b.input.outerWidth() : 0, k = b.input ? b.input.outerHeight() : 0, m = document.documentElement.clientWidth + a(document).scrollLeft(), p = document.documentElement.clientHeight + a(document).scrollTop();
    ...
    _findPos(b) {
      for (
        const h = this._get(this._getInst(b), "isRTL");
        b &&
    ...
    _updateAlternate(b) {
      const h = this._get(b, "altField");
      if (h) {
        const j = this._get(b, "altFormat") || this._get(b, "dateFormat"), l = this._getDate(b), o = this.formatDate(j, l, this._getFormatConfig(b));
        a(h).each(function () {
          a(this).val(o);
        });
      }
    ...
    parseDate(b, h, j) {
      ...
      if (h == "") return null;
      let l = (j ? j.shortYearCutoff : null) || this._defaults.shortYearCutoff;
      l =
        typeof l != "string"
          ? l
    ...
    formatDate(b, h, j) {
      if (!h) return "";
      const l = (j ? j.dayNamesShort : null) || this._defaults.dayNamesShort, o = (j ? j.dayNames : null) || this._defaults.dayNames, n = (j ? j.monthNamesShort : null) || this._defaults.monthNamesShort;
    ...
    _setDateFromField(b, h) {
      if (b.input.val() != b.lastVal) {
        const j = this._get(b, "dateFormat");
        let l = (b.lastVal = b.input ? b.input.val() : null);
        let o;
        let n;
        o = n = this._getDefaultDate(b);
        const k = this._getFormatConfig(b);
        try {
    ...
    _determineDate(b, h, j) {
      const l = n => {
            ...
            o = n => {
              ...
              m = m.getDate();
              for (
                let s = /([+-]?[0-9]+)\s*(d|D|w|W|m|M|y|Y)?/g, r = s.exec(n);
                r;
    ...
    _setDate(b, h, j) {
      const l = !h, o = b.selectedMonth, n = b.selectedYear;
    ...
    _generateHTML(b) {
      ...
      const j = this._get(b, "isRTL");
      let l = this._get(b, "showButtonPanel");
      let o = this._get(b, "hideIfNoPrevNext");
      let n = this._get(b, "navigationAsDateFormat");
      const k = this._getNumberOfMonths(b);
      let m = this._get(b, "showCurrentAtPos");
      let p = this._get(b, "stepMonths");
      const q = k[0] != 1 || k[1] != 1;

      const s = this._daylightSavingAdjust(
        !b.currentDay
          ? new Date(9999, 9, 9)
          : new Date(b.currentYear, b.currentMonth, b.currentDay)
      );

      const r = this._getMinMaxDate(b, "min");
      const u = this._getMinMaxDate(b, "max");
      m = b.drawMonth - m;
      let v = b.drawYear;
      if (m < 0) {
        m += 12;
      ...
      const z = this._get(b, "dayNamesMin"), G = this._get(b, "monthNames"), C = this._get(b, "monthNamesShort"), y = this._get(b, "beforeShowDay"), H = this._get(b, "showOtherMonths"), N = this._get(b, "selectOtherMonths");
      this._get(b, "calculateWeek");
      for (var J = this._getDefaultDate(b), D = "", E = 0; E < k[0]; E++) {
        for (var P = "", L = 0; L < k[1]; L++) {
          const Q = this._daylightSavingAdjust(new Date(v, m, b.selectedDay));
          let B = " ui-corner-all";
          let F = "";
          if (q) {
    ...
    _generateMonthYearHeader(b, h, j, l, o, n, k, m) {
      const p = this._get(b, "changeMonth");
      const q = this._get(b, "changeYear");
      const s = this._get(b, "showMonthAfterYear");
      let r = '<div class="ui-datepicker-title">';
      let u = "";
      if (n || !p) u += '<span class="ui-datepicker-month">' + k[h] + "</span>";
      else {
        k = l && l.getFullYear() == j;
        const v = o && o.getFullYear() == j;
        u +=
    ...
    _adjustInstDate(b, h, j) {
      let l = b.drawYear + (j == "Y" ? h : 0);
      const o = b.drawMonth + (j == "M" ? h : 0);
      h =
    ...
    _restrictMinMax(b, h) {
      const j = this._getMinMaxDate(b, "min");
      b = this._getMinMaxDate(b, "max");
      h = j && h < j ? j : h;
      return (h = b && h > b ? b : h);
    },
    _notifyChange(b) {
      const h = this._get(b, "onChangeMonthYear");
      if (h)
    ...
    _getFirstDayOfMonth(b, h) {
      return new Date(b, h, 1).getDay();
    },
    _canAdjustMonth(b, h, j, l) {
      const o = this._getNumberOfMonths(b);
    ...
    _getFormatConfig(b) {
      let h = this._get(b, "shortYearCutoff");
      h =
        typeof h != "string"
          ? h
...
((a, d) => {
  const c = {
        ...
        f = { maxHeight: true, maxWidth: true, minHeight: true, minWidth: true },
        g = a.attrFn || {
          val: true,
          css: true,
          html: true,
  ...
  a.widget("ui.dialog", {
    options: {
      ...
      position: {
        ...
        collision: "fit",
        using(e) {
          const i = a(this).css(e).offset().top;
    ...
    _create() {
      ...
      e.element
        ...
        .appendTo(j);
      const l = (e.uiDialogTitlebar = a("<div></div>"))
                .addClass(
    ...
    close(e) {
      ...
      if (false !== i._trigger("beforeClose", e)) {
        ...
        i._isOpen = false;
        if (i.options.hide)
          i.uiDialog.hide(i.options.hide, () => {
            i._trigger("close", e);
          });
        else {
          i.uiDialog.hide();
    ...
    open() {
      if (!this._isOpen) {
        const e = this, i = e.options, b = e.uiDialog;
        ...
        i.modal &&
          b.bind("keypress.ui-dialog", function (h) {
            if (h.keyCode === a.ui.keyCode.TAB) {
              let j = a(":tabbable", this);
              const l = j.filter(":first");
              j = j.filter(":last");
    ...
    _createButtons(e) {
      ...
      const h = a("<div></div>").addClass(
        "ui-dialog-buttonpane ui-widget-content ui-helper-clearfix"
      );

      const j = a("<div></div>").addClass("ui-dialog-buttonset").appendTo(h);
      ...
      if (b) {
        a.each(e, (l, o) => {
          ...
          const n = a('<button type="button"></button>')
            .click(function () {
    ...
    _makeResizable(e) {
      ...
      const b = this, h = b.options, j = b.uiDialog.css("position");
    ...
    _position(e) {
      ...
      if (e) {
        if (typeof e === "string" || (typeof e === "object" && "0" in e)) {
          ...
          e = { my: i.join(" "), at: i.join(" "), offset: b.join(" ") };
        }
    ...
    _size() {
      ...
      let i;
      let b;
      const h = this.uiDialog.is(":visible");
      this.element.show().css({ width: "auto", minHeight: 0, height: 0 });
      if (e.minWidth > e.width) e.width = e.minWidth;
      i = this.uiDialog.css({ height: "auto", width: e.width }).height();
      b = Math.max(0, e.minHeight - i);
      if (e.height === "auto")
        if (a.support.minHeight)
          this.element.css({ minHeight: b, height: "auto" });
        else {
          this.uiDialog.show();
  ...
  a.extend(a.ui.dialog.overlay, {
      ...
      if (this.instances.length === 0) {
        setTimeout(() => {
          a.ui.dialog.overlay.instances.length &&
            a(document).bind(a.ui.dialog.overlay.events, b => {
              if (a(b.target).zIndex() < a.ui.dialog.overlay.maxZ) return false;
            });
        }, 1);
        a(document).bind("keydown.dialog-overlay", b => {
          if (
    ...
    destroy(e) {
      const i = a.inArray(e, this.instances);
...
(a => {
  a.ui = a.ui || {};
  const d = /left|center|right/, c = /top|center|bottom/, f = a.fn.position, g = a.fn.offset;
  a.fn.position = function (e) {
    if (!e || !e.of) return f.apply(this, arguments);
    e = a.extend({}, e);
    const i = a(e.of);
    const b = i[0];
    const h = (e.collision || "flip").split(" ");
    const j = e.offset ? e.offset.split(" ") : [0, 0];
    let l;
    let o;
    let n;
    if (b.nodeType === 9) {
      ...
      e.at = "left top";
      l = o = 0;
      n = { top: e.of.pageY, left: e.of.pageX };
    } else {
      l = i.outerWidth();
      o = i.outerHeight();
      n = i.offset();
    ...
    return this.each(function () {
      const k = a(this);
      const m = k.outerWidth();
      const p = k.outerHeight();
      const q = parseInt(a.curCSS(this, "marginLeft", true)) || 0;
      const s = parseInt(a.curCSS(this, "marginTop", true)) || 0;
      const r = m + q + (parseInt(a.curCSS(this, "marginRight", true)) || 0);
      const u = p + s + (parseInt(a.curCSS(this, "marginBottom", true)) || 0);
      const v = a.extend({}, n);
      let w;
      ...
      k.offset(a.extend(v, { using: e.using }));
    });
  };
  a.ui.position = {
    fit: {
  ...
  if (!a.offset.setOffset) {
    a.offset.setOffset = (e, i) => {
      if (/static/.test(a.curCSS(e, "position"))) e.style.position = "relative";
      const b = a(e);
      let h = b.offset();
      const j = parseInt(a.curCSS(e, "top", true), 10) || 0;
      const l = parseInt(a.curCSS(e, "left", true), 10) || 0;
      h = { top: i.top - h.top + j, left: i.left - h.left + l };
...
((a, d) => {
  a.widget("ui.progressbar", {
    ...
    _refreshValue() {
      const c = this.value(), f = this._percentage();
      if (this.oldValue !== c) {
        this.oldValue = c;
  ...
  a.widget("ui.slider", a.ui.mouse, {
    ...
    _create() {
      ...
      this.handles
        .keydown(function (b) {
        let h = true;
        const j = a(this).data("index.ui-slider-handle");
        let l;
        let o;
        let n;
        ...
        .keyup(function (b) {
          const h = a(this).data("index.ui-slider-handle");
          if (d._keySliding) {
            d._keySliding = false;
            d._stop(b, h);
            d._change(b, h);
    ...
    _mouseDrag(d) {
      const c = this._normValueFromMouse({ x: d.pageX, y: d.pageY });
    ...
    _start(d, c) {
      const f = { handle: this.handles[c], value: this.value() };
    ...
    _trimAlignValue(d) {
      ...
      const c = this.options.step > 0 ? this.options.step : 1, f = (d - this._valueMin()) % c;
      alignValue = d - f;
    ...
    _refreshValue() {
      const d = this.options.range;
      const c = this.options;
      const f = this;
      const g = !this._animateOff ? c.animate : false;
      let e;
      const i = {};
      let b;
      let h;
      ...
      if (this.options.values && this.options.values.length)
          ...
          if (f.options.range === true)
            if (f.orientation === "horizontal") {
              if (o === 0)
                f.range
                  .stop(1, 1)
                  [g ? "animate" : "css"]({ left: e + "%" }, c.animate);
              if (o === 1)
              ...
              if (o === 0)
                f.range
                  .stop(1, 1)
                  [g ? "animate" : "css"]({ bottom: e + "%" }, c.animate);
              if (o === 1)
                f.range[g ? "animate" : "css"](
                  { height: e - b + "%" },
                  { queue: false, duration: c.animate }
        ...
        if (d === "min" && this.orientation === "horizontal")
          this.range
            .stop(1, 1)
            [g ? "animate" : "css"]({ width: e + "%" }, c.animate);
        ...
        if (d === "min" && this.orientation === "vertical")
          this.range
            .stop(1, 1)
            [g ? "animate" : "css"]({ height: e + "%" }, c.animate);
  ...
  a.widget("ui.tabs", {
    ...
    _tabify(i) {
      ...
      if (i) {
        ...
        j.disabled = a
          .unique(
            j.disabled.concat(
              a.map(this.lis.filter(".ui-state-disabled"), r => {
      ...
      this.anchors.bind(j.event + ".tabs", function () {
        const r = this, u = a(r).closest("li"), v = h.panels.filter(":not(.ui-tabs-hide)"), w = h.element.find(h._sanitizeSelector(r.hash));
        if (
    ...
    destroy() {
      ...
      this.anchors.each(function () {
        const b = a.data(this, "href.tabs");
        if (b) this.href = b;
        const h = a(this).unbind(".tabs");
        a.each(["href", "load", "cache"], (j, l) => {
          h.removeData(l + ".tabs");
        });
      });
      this.lis
    ...
    remove(i) {
      i = this._getIndex(i);
      const b = this.options, h = this.lis.eq(i).remove(), j = this.panels.eq(i).remove();
    ...
    enable(i) {
      ...
      if (a.inArray(i, b.disabled) != -1) {
        ...
        b.disabled = a.grep(b.disabled, h => {
          return h != i;
        });
        this._trigger(
          "enable",
    ...
    load(i) {
      i = this._getIndex(i);
      const b = this, h = this.options, j = this.anchors.eq(i)[0], l = a.data(j, "load.tabs");
      this.abort();
      if (
        !l ||
