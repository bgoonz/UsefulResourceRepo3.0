...
setTimeout(function () {
  ...
  t1 = timer.beat(1 / 2, [1, , 1], function (_t, b) {
    ...
    var y = b % 2 == 1 ? 2 : 1 / 2;
    var durations = [60 / bpm / 128, ((bpm / 60) * 1) / 16];
    var opts = {};
    opts.c = Math.sqrt(2);
    opts.m = Math.PI;
    opts.f = 1200;
    ...
    var synth = function (y) {
      return function (t) {
        stringer.m = opts.m + 0.051 * Math.abs(oz.sine(t, y / 2));
        var x = stringer.ring(
          t,
          amod(0, 12, t, 12),
          amod(Math.sqrt(12), 1.25, t, 1 / 4)
        );
        return x;
      };
    };
  ...
  t2 = timer.beat(1 / 8, [, 1, , 1], function (_t, b) {
    ...
    var y = b % 2 == 1 ? 2 : 1 / 2;
    var durations = [60 / bpm / 56, ((bpm / 60) * 1) / 8];
    var opts = {};
    opts.c = Math.sqrt(2);
    ...
    var synth = function (y) {
      return function (t) {
        t += 1e3;
        stringer.m = opts.m + (0.5 + 0.05 * oz.saw(t, y));
        stringer.f = opts.f + (0.5 + oz.sine(t, y / 4));
        var x = stringer.ring(
          t,
          2.15 + oz.saw(t, 4),
          amod(Math.sqrt(12), 1.15, t, 4)
        );
        return x;
      };
    };
    generator.set(_t, synth(0), zmod);
    generator.set(_t + 0.13, synth(3 / 2 / 2), zmod);
    generator.set(_t + 0.26, synth(3 / 2 / 2 / 2), zmod);
    generator.set(_t + 0.39, synth(3 / 2 / 2 / 2 / 2), zmod);
  });
}, 0);
setTimeout(function () {
  bpm = 74 / 2;
...
setTimeout(function () {
  ...
  t1 = timer.beat(1 / 2, [1, , 1], function (_t, b) {
    ...
    var synth = function (y) {
      return function (t) {
        stringer.m = opts.m + 0.251 * Math.abs(oz.sine(t, y / 2));
        var x = stringer.ring(
          t,
          amod(0, 12, t, 12),
          amod(Math.sqrt(12), 1.25, t, 1 / 4)
...
setTimeout(function () {
  ...
  t1 = timer.beat(1 / 2, [1, , 1], function (_t, b) {
    ...
    var synth = function (y) {
      return function (t) {
        stringer.m = opts.m + 0.0051 * Math.abs(oz.sine(t, y / 2));
...
setTimeout(function () {
  ...
  t1 = timer.beat(1 / 2, [1, , 1], function (_t, b) {
    ...
    var y = b % 2 == 1 ? 2 : 1 / 2;
    var durations = [(60 / bpm / 128) * 4, ((bpm / 60) * 1) / 16];
    var opts = {};
    opts.c = Math.sqrt(2);
    opts.m = Math.PI;
    opts.f = 1200;
...
setTimeout(function () {
  ...
  t1 = timer.beat(1 / 2, [1, , 1], function (_t, b) {
    ...
    var y = b % 2 == 1 ? 2 : 1 / 2;
    var durations = [(60 / bpm / 128) * 4, (((bpm / 60) * 1) / 16) * 2];
    var opts = {};
    opts.c = Math.sqrt(2);
    opts.m = Math.PI;
    opts.f = 1200;
