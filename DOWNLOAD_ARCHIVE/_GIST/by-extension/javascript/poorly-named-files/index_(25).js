setTimeout(function () {
  // this is my 666th session using this live code thing I made
  ...
  t1 = timer.beat(1 / 2, [1, , 1], function (_t, b) {
    ...
    var synth = function (y) {
      return function (t) {
        stringer.m = opts.m + 0.051 * Math.abs(oz.sine(t, y / 2)); //amod(opts.m, .05, t, 1/16)
  ...
  t2 = timer.beat(1 / 8, [, 1, , 1], function (_t, b) {
    ...
    var synth = function (y) {
      return function (t) {
        t += 1000;
        stringer.m = opts.m + (0.5 + 0.05 * oz.saw(t, y)); //amod(opts.m, .05, t, 1/16)
...
setTimeout(function () {
  ...
  t1 = timer.beat(1 / 2, [1, , 1], function (_t, b) {
    ...
    var synth = function (y) {
      return function (t) {
        stringer.m = opts.m + 0.251 * Math.abs(oz.sine(t, y / 2)); //amod(opts.m, .05, t, 1/16)
        //stringer.f = opts.f + (1 + oz.sine(t, y))
        var x = stringer.ring(
          t,
          amod(0, 12, t, 12),
...
setTimeout(function () {
  ...
  t1 = timer.beat(1 / 2, [1, , 1], function (_t, b) {
    ...
    var synth = function (y) {
      return function (t) {
        stringer.m = opts.m + 0.0051 * Math.abs(oz.sine(t, y / 2)); //amod(opts.m, .05, t, 1/16)
        stringer.f = opts.f + (1 + oz.sine(t, y));
        var x = stringer.ring(
          t,
          amod(0, 12, t, 12),
