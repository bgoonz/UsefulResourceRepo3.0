...
(function (global, main, modules, modules_options, options) {
  var initialized_modules = {},
    ...
    register_module = function (moduleName, module) {
      ...
      if (!module) {
        ...
        module =
          module(module_require, output.exports, output) || output.exports;
      }
      module = module;
  ...
  main(lmd_require, output.exports, output);
})(
  this,
  ...
  },
  {
    ...
    _Bacon: function (require, exports, module) {
      /* wrapped by builder */
      // Mock Bacon
