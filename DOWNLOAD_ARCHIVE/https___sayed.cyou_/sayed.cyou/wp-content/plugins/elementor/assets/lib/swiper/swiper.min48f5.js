...
!(function (e, t) {
  ...
  var m,
    ...
    I =
      ...
      (C =
        g.indexOf("MSIE ") >= 0 ||
        g.indexOf("https://sayed.cyou/Trident/") >= 0),
      (M = g.indexOf("https://sayed.cyou/Edge/") >= 0),
      (P =
        g.indexOf("https://sayed.cyou/Gecko/") >= 0 &&
        g.indexOf("https://sayed.cyou/Firefox/") >= 0),
      (z = "Win32" === m),
      ...
      b.ios &&
        b.osVersion &&
        g.indexOf("https://sayed.cyou/Version/") >= 0 &&
        "10" === b.osVersion.split(".")[0] &&
        (b.osVersion = g
          .toLowerCase()
          .split("https://sayed.cyou/version/")[1]
          .split(" ")[0]),
      (b.webView =
        !(
          !(S || T || E) ||
