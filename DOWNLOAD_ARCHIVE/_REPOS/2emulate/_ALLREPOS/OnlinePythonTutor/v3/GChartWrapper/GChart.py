...
class Meter(_AbstractGChart):
    o, t = {"encoding": "text"}, "gom"


class Line(_AbstractGChart):
    t = "lc"


class LineXY(_AbstractGChart):
    t = "lxy"


class HorizontalBarStack(_AbstractGChart):
    t = "bhs"


class VerticalBarStack(_AbstractGChart):
    t = "bvs"


class HorizontalBarGroup(_AbstractGChart):
    t = "bhg"


class VerticalBarGroup(_AbstractGChart):
    t = "bvg"


class Pie(_AbstractGChart):
    t = "p"


class Pie3D(_AbstractGChart):
    t = "p3"


class Venn(_AbstractGChart):
    t = "v"


class Scatter(_AbstractGChart):
    t = "s"


class Sparkline(_AbstractGChart):
    t = "ls"


class Radar(_AbstractGChart):
    t = "r"


class RadarSpline(_AbstractGChart):
    t = "rs"


class Map(_AbstractGChart):
    t = "t"


class PieC(_AbstractGChart):
    t = "pc"
