  ...
  function t(d, b) {
    ...
    a.extend(c, {
      load: function (e) {
        ...
        var i = b.top,
          r = b.left,
          u = f.outerWidth({ margin: true }),
          v = f.outerHeight({ margin: true });
        if (typeof i == 'string')
          i =
            i == 'center'
        ...
        b.closeOnClick &&
          a(document).bind('click.' + n, function (l) {
            a(l.target).parents(f).length || c.close(l);
          });
        b.closeOnEsc &&
          a(document).bind('keydown.' + n, function (l) {
...
(function (e) {
  ...
  function u(f, c) {
    ...
    c.keyboard &&
      e(document).bind('keydown.scrollable', function (a) {
