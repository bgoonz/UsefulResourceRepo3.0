...
const RouteSettings = (props) => {
      ...
      .map((domain) => [
        h(
          LinkItem,
          {
            ...
            text: domain.data.id,
            onClick: () =>
              showDomainEditModal(domain.data.id, domain.data.title),
          },
          domain.data.title
        ),
        h(Line),
  ...
  return h(
    ...
    h(
      ...
      h(
        LinkItem,
        { type: 'button', onClick: () => props.deleteToken(props) },
        'Sign Out'
      )
    ),
    ...
    h(
      ...
      h(
        LinkItem,
        { type: 'a', href: homepage, target: '_blank' },
        'Ackee on GitHub'
      ),
      h(Line),
      h(
        ...
        {
          type: 'a',
          href: 'https://github.com/electerious/Ackee/blob/master/docs/Get%20started.md',
          target: '_blank',
        },
        'Get started'
      ),
