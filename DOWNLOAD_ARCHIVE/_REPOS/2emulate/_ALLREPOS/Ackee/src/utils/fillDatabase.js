...
const langauges = [null, 'en', 'de', 'fr', 'ni'];
...
const screenColorDepths = [null, 16, 24, 32, 48];
...
const operatingSystems = [
  {
    name: 'OS X',
    versions: ['10.14.6', '10.13.1', '10.12.4'],
  },
  {
    name: 'Windows',
    versions: ['8.1', '8', '7'],
...
const createRecord = () => {
  ...
  return randomItem([anonymousRecord, detailedRecord]);
};
