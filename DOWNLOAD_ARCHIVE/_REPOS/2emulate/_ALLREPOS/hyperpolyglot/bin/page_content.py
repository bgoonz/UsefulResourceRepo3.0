...
def download(page, output_stream):
    ...
    p = sp.pages.get_one({"site": site, "page": page})
...
def upload(page, input_stream):
    ...
    sp = xmlrpclib.ServerProxy(uri)
    sp.pages.save_one({"site": site, "page": page, "content": content})


if __name__ == "__main__":

    parser = argparse.ArgumentParser()
    parser.add_argument("--page", "-p", required=True, dest="page")
    parser.add_argument("--upload", "-u", dest="upload", action="store_true")
