...
flags.DEFINE_list("styles", ["google", "tensorflow"], "Lint style modules to include.")
  ...
  """
    ...
    def is_lint(member):
        return (
            ...
            and member.__module__ == mod_name
            and hasattr(member, "_lint")
        )
...
def add_styles(styles, excluded_lints, verbose):
  ...
  """
    ...
    for style in styles:
        ...
        lints = [getattr(mem[1], "_lint") for mem in inspect.getmembers(mod, is_lint)]
