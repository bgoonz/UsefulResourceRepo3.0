...
class Cfengine3Lexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (r"(\S+)(\s*)(=>)(\s*)", bygroups(Keyword.Reserved, Text, Operator, Text)),
            (r'"', String, "string"),
...
class NestedTextLexer(RegexLexer):
    ...
    tokens = {
        "root": [
            ...
            (
                r"^(\s*)(> ?)(.*?)(\s*)$",
                bygroups(Text, Punctuation, String, Whitespace),
            ),
            (
                r"^(\s*)(- ?)(.*?)(\s*)$",
                bygroups(Text, Punctuation, String, Whitespace),
            ...
            (
                ...
                bygroups(Text, Punctuation, Name, Punctuation, String, Whitespace),
            ),
            (
                _quoted_dict_item.format('"'),
                bygroups(Text, Punctuation, Name, Punctuation, String, Whitespace),
            ...
            (
                r"^(\s*)(.*?)(: ?)(.*?)(\s*)$",
                bygroups(Text, Name, Punctuation, String, Whitespace),
            ),
        ]
    }
