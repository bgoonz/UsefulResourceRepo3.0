...
class BibStylesConfig(object):
    ...
    defaulttags = {u"YY": u"??", u"authors": u"", u"surname": u""}
...
class ContainerConfig(object):
    ...
    string = {u"startcommand": u"\\"}

    table = {u"headers": [u"<lyxtabular", u"<features"]}
...
class EscapeConfig(object):
    ...
    entities = {u"&": u"&amp;", u"<": u"&lt;", u">": u"&gt;"}

    html = {u"/>": u">"}

    iso885915 = {u" ": u"&nbsp;", u" ": u"&emsp;", u" ": u"&#8197;"}
...
class FormulaConfig(object):
    ...
    labelfunctions = {u"\\label": u'a name="#"'}
    ...
    symbolfunctions = {u"^": u"sup", u"_": u"sub"}
    ...
    urls = {u"googlecharts": u"http://chart.googleapis.com/chart?cht=tx&chl="}


class GeneralConfig(object):
    "Configuration class from elyxer.config file"

    version = {u"date": u"2015-02-26", u"lyxformat": u"413", u"number": u"1.2.5"}
...
class ImageConfig(object):
    ...
    cropboxformats = {u".eps": u"ps", u".pdf": u"pdf", u".ps": u"ps"}

    formats = {u"default": u".png", u"vector": [u".svg", u".eps"]}
...
class TagConfig(object):
    ...
    family = {u"sans": u'span class="sans"', u"typewriter": u"tt"}
    ...
    group = {u"layouts": [u"Quotation", u"Quote"]}
    ...
    listitems = {u"Enumerate": u"ol", u"Itemize": u"ul"}

    notes = {u"Comment": u"", u"Greyedout": u'span class="greyedout"', u"Note": u""}

    script = {u"subscript": u"sub", u"superscript": u"sup"}
    ...
    def processoptions(self):
        ...
        if Options.splitpart:
            try:
                ...
                Trace.error(
                    "--splitpart needs a numeric argument, not " + Options.splitpart
                )
                self.usage()
    ...
    def write(self, strings):
        ...
        for string in strings:
            if not isinstance(string, basestring):
                Trace.error(
                    "Not a string: " + unicode(string) + " in " + unicode(strings)
                )
                return
...
class MacroParameter(FormulaBit):
    ...
    def parsebit(self, pos):
        ...
        self.contents = [
            TaggedBit().constant("#" + unicode(self.number), 'span class="unknown"')
        ]
...
FormulaCommand.types += [MacroFunction]
