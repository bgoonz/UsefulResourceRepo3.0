    ...
    tokens = {
        ...
        "root": [
            ...
            (
                s(r"($type)([ \t]+)($id)(\s*)(:=)"),
                bygroups(
                    using(this, state="inType"), Text, Name.Variable, Text, Operator
                ),
            ),
            # var := val
            ...
            (
                ...
                bygroups(
                    using(this, state="inType"), Text, Name.Function, Text, Punctuation
                ),
                "insideMethodDeclArgs",
            ),
            # ArgType argName,
            (
                s(r"($type)(\s+)($id)(\s*)(,)"),
                bygroups(
                    using(this, state="inType"), Text, Name.Variable, Text, Punctuation
                ),
            ),
            # ArgType argName)
        ...
        "facet": [(r"\s+", Text), (r"\{", Punctuation, "facetFields"), default("#pop")],
        "facetFields": [
            include("comments"),
            include("literals"),
            include("operators"),
