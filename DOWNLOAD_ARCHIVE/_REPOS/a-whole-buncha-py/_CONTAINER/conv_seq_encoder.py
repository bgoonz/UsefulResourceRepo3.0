    ...
    def get_default_hyperparameters(cls) -> Dict[str, Any]:
        encoder_hypers = {
            ...
            "1dcnn_kernel_width": [
                ...
                16,
                16,
            ],  # Has to have same length as 1dcnn_layer_list
    ...
    def make_model(self, is_train: bool = False) -> tf.Tensor:
        with tf.variable_scope("1dcnn_encoder"):
            ...
            num_filters_and_width = zip(
                self.get_hyper("1dcnn_layer_list"), self.get_hyper("1dcnn_kernel_width")
            )
            for (layer_idx, (num_filters, kernel_width)) in enumerate(
                num_filters_and_width
            ):
                ...
                current_embeddings = tf.nn.dropout(
                    current_embeddings, keep_prob=self.placeholders["dropout_keep_rate"]
                )
