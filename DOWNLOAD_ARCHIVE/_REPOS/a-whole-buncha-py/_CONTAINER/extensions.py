...
_base_flags.update(
    {
        "user": (
            {"BaseExtensionApp": {"user": True}},
            "Apply the operation only for the given user",
        ),
        "system": (
            {"BaseExtensionApp": {"user": False, "sys_prefix": False}},
            "Apply the operation system-wide",
        ),
        "sys-prefix": (
            {"BaseExtensionApp": {"sys_prefix": True}},
            "Use sys.prefix as the prefix for installing nbextensions (for environments, packaging)",
        ),
        "py": ({"BaseExtensionApp": {"python": True}}, "Install from a Python package"),
    }
)
