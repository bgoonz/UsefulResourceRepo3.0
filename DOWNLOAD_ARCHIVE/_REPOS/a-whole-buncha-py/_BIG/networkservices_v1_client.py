...
from googlecloudsdk.third_party.apis.networkservices.v1 import (
    networkservices_v1_messages as messages,
)
...
class NetworkservicesV1(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_locations_edgeCacheKeysets = self.ProjectsLocationsEdgeCacheKeysetsService(
            self
        )
        self.projects_locations_edgeCacheOrigins = self.ProjectsLocationsEdgeCacheOriginsService(
            self
        )
        self.projects_locations_edgeCacheServices = self.ProjectsLocationsEdgeCacheServicesService(
            self
        )
    ...
    class ProjectsLocationsEdgeCacheKeysetsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                NetworkservicesV1.ProjectsLocationsEdgeCacheKeysetsService, self
            ).__init__(client)
    ...
    class ProjectsLocationsEdgeCacheOriginsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                NetworkservicesV1.ProjectsLocationsEdgeCacheOriginsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsEdgeCacheServicesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                NetworkservicesV1.ProjectsLocationsEdgeCacheServicesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(NetworkservicesV1.ProjectsLocationsOperationsService, self).__init__(
                client
            )
            self._upload_configs = {}
