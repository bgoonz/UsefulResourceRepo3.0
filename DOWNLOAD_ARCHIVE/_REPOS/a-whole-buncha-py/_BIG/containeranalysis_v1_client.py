...
from googlecloudsdk.third_party.apis.containeranalysis.v1 import (
    containeranalysis_v1_messages as messages,
)
...
class ContaineranalysisV1(base_api.BaseApiClient):
    ...
    class ProjectsNotesOccurrencesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(ContaineranalysisV1.ProjectsNotesOccurrencesService, self).__init__(
                client
            )
            self._upload_configs = {}
