...
class DatastoreProjectsExportRequest(_messages.Message):
  ...
  """
    ...
    googleDatastoreAdminV1ExportEntitiesRequest = _messages.MessageField(
        "GoogleDatastoreAdminV1ExportEntitiesRequest", 1
    )
    projectId = _messages.StringField(2, required=True)
...
class DatastoreProjectsImportRequest(_messages.Message):
  ...
  """
    ...
    googleDatastoreAdminV1ImportEntitiesRequest = _messages.MessageField(
        "GoogleDatastoreAdminV1ImportEntitiesRequest", 1
    )
    projectId = _messages.StringField(2, required=True)
...
class GoogleDatastoreAdminV1Index(_messages.Message):
  ...
  """
    ...
    properties = _messages.MessageField(
        "GoogleDatastoreAdminV1IndexedProperty", 5, repeated=True
    )
