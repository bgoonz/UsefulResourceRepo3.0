...
from googlecloudsdk.third_party.apis.metastore.v1 import (
    metastore_v1_messages as messages,
)
...
class MetastoreV1(base_api.BaseApiClient):
    ...
    class ProjectsLocationsServicesBackupsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(MetastoreV1.ProjectsLocationsServicesBackupsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsServicesMetadataImportsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                MetastoreV1.ProjectsLocationsServicesMetadataImportsService, self
            ).__init__(client)
            self._upload_configs = {}
