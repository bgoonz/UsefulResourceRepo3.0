...
class ManagedZone(_messages.Message):
  ...
  """
    ...
    privateVisibilityConfig = _messages.MessageField(
        "ManagedZonePrivateVisibilityConfig", 14
    )
    ...
    serviceDirectoryConfig = _messages.MessageField(
        "ManagedZoneServiceDirectoryConfig", 16
    )
...
class ManagedZoneForwardingConfig(_messages.Message):
  ...
  """
    ...
    targetNameServers = _messages.MessageField(
        "ManagedZoneForwardingConfigNameServerTarget", 2, repeated=True
    )
...
class ManagedZoneForwardingConfigNameServerTarget(_messages.Message):
  ...
  """
    ...
    kind = _messages.StringField(
        4, default="dns#managedZoneForwardingConfigNameServerTarget"
    )
...
class ManagedZonePrivateVisibilityConfig(_messages.Message):
  ...
  """
    ...
    gkeClusters = _messages.MessageField(
        "ManagedZonePrivateVisibilityConfigGKECluster", 1, repeated=True
    )
    kind = _messages.StringField(2, default="dns#managedZonePrivateVisibilityConfig")
    networks = _messages.MessageField(
        "ManagedZonePrivateVisibilityConfigNetwork", 3, repeated=True
    )
...
class ManagedZonePrivateVisibilityConfigGKECluster(_messages.Message):
  ...
  """
    ...
    kind = _messages.StringField(
        2, default="dns#managedZonePrivateVisibilityConfigGKECluster"
    )
...
class ManagedZonePrivateVisibilityConfigNetwork(_messages.Message):
  ...
  """
    ...
    kind = _messages.StringField(
        1, default="dns#managedZonePrivateVisibilityConfigNetwork"
    )
...
class ManagedZoneServiceDirectoryConfigNamespace(_messages.Message):
  ...
  """
    ...
    kind = _messages.StringField(
        2, default="dns#managedZoneServiceDirectoryConfigNamespace"
    )
...
class Policy(_messages.Message):
  ...
  """
    ...
    alternativeNameServerConfig = _messages.MessageField(
        "PolicyAlternativeNameServerConfig", 1
    )
...
class PolicyAlternativeNameServerConfig(_messages.Message):
  ...
  """
    ...
    targetNameServers = _messages.MessageField(
        "PolicyAlternativeNameServerConfigTargetNameServer", 2, repeated=True
    )
...
class PolicyAlternativeNameServerConfigTargetNameServer(_messages.Message):
  ...
  """
    ...
    ipv6Address = _messages.StringField(3)
    kind = _messages.StringField(
        4, default="dns#policyAlternativeNameServerConfigTargetNameServer"
    )
...
class Quota(_messages.Message):
  ...
  Fields:
    ...
    gkeClustersPerResponsePolicy: A integer attribute.
    ...
    responsePolicyRulesPerResponsePolicy: A integer attribute.
  ...
  """
    ...
    gkeClustersPerManagedZone = _messages.IntegerField(
        2, variant=_messages.Variant.INT32
    )
    gkeClustersPerResponsePolicy = _messages.IntegerField(
    ...
    managedZonesPerGkeCluster = _messages.IntegerField(
    ...
    resourceRecordsPerRrset = _messages.IntegerField(
        12, variant=_messages.Variant.INT32
    )
    responsePolicyRulesPerResponsePolicy = _messages.IntegerField(
        13, variant=_messages.Variant.INT32
    )
    rrsetAdditionsPerChange = _messages.IntegerField(
        14, variant=_messages.Variant.INT32
    )
    rrsetDeletionsPerChange = _messages.IntegerField(
        15, variant=_messages.Variant.INT32
    )
    rrsetsPerManagedZone = _messages.IntegerField(16, variant=_messages.Variant.INT32)
    targetNameServersPerManagedZone = _messages.IntegerField(
        17, variant=_messages.Variant.INT32
    )
    targetNameServersPerPolicy = _messages.IntegerField(
        18, variant=_messages.Variant.INT32
    )
    totalRrdataSizePerChange = _messages.IntegerField(
        19, variant=_messages.Variant.INT32
    )
...
class RRSetRoutingPolicyGeoPolicy(_messages.Message):
  ...
  """
    ...
    failovers = _messages.MessageField(
        "RRSetRoutingPolicyGeoPolicyGeoPolicyItem", 1, repeated=True
    )
    items = _messages.MessageField(
        "RRSetRoutingPolicyGeoPolicyGeoPolicyItem", 2, repeated=True
    )
...
class RRSetRoutingPolicyGeoPolicyGeoPolicyItem(_messages.Message):
  ...
  """
    ...
    kind = _messages.StringField(
        1, default="dns#rRSetRoutingPolicyGeoPolicyGeoPolicyItem"
    )
...
class RRSetRoutingPolicyWrrPolicy(_messages.Message):
  ...
  """
    ...
    items = _messages.MessageField(
        "RRSetRoutingPolicyWrrPolicyWrrPolicyItem", 1, repeated=True
    )
