...
class RSASSAPSSParams(Sequence):
    _fields = [
        (
            "hash_algorithm",
            DigestAlgorithm,
            {"tag_type": "explicit", "tag": 0, "default": {"algorithm": "sha1"}},
        ),
        (
            "mask_gen_algorithm",
            MaskGenAlgorithm,
        ...
        ("salt_length", Integer, {"tag_type": "explicit", "tag": 2, "default": 20}),
        (
            "trailer_field",
            TrailerField,
            {"tag_type": "explicit", "tag": 3, "default": "trailer_field_bc"},
        ),
    ]
    ...
    _fields = [
        ...
        (
            ...
            PSourceAlgorithm,
            {
                "tag_type": "explicit",
                "tag": 2,
                "default": {"algorithm": "p_specified", "parameters": b""},
            },
        ),
    ]
