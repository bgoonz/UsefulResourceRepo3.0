...
from samples.servicemanagement_sample.servicemanagement_v1 import (
    servicemanagement_v1_messages as messages,
)
...
class ServicemanagementV1(base_api.BaseApiClient):
    ...
    _SCOPES = [
        ...
        u"https://www.googleapis.com/auth/service.management",
    ]
    _VERSION = u"v1"
...
service.
    ...
    class ServicesAccessPolicyService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(ServicemanagementV1.ServicesAccessPolicyService, self).__init__(
                client
            )
            self._upload_configs = {}
...
Operation<response: SubmitConfigSourceResponse>
    ...
    class ServicesCustomerSettingsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(ServicemanagementV1.ServicesCustomerSettingsService, self).__init__(
                client
            )
            self._upload_configs = {}
...
Operation<response: CustomerSettings>
    ...
    class ServicesProjectSettingsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(ServicemanagementV1.ServicesProjectSettingsService, self).__init__(
                client
            )
            self._upload_configs = {}
