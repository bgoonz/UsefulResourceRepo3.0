...
class LookupEffectiveGuestPoliciesResponse(_messages.Message):
  ...
  """
    ...
    packageRepositories = _messages.MessageField(
        "LookupEffectiveGuestPoliciesResponseSourcedPackageRepository", 1, repeated=True
    )
    packages = _messages.MessageField(
        "LookupEffectiveGuestPoliciesResponseSourcedPackage", 2, repeated=True
    )
    softwareRecipes = _messages.MessageField(
        "LookupEffectiveGuestPoliciesResponseSourcedSoftwareRecipe", 3, repeated=True
    )
...
class OsconfigProjectsZonesInstancesLookupGuestPoliciesRequest(_messages.Message):
  ...
  """
    ...
    lookupEffectiveGuestPoliciesRequest = _messages.MessageField(
        "LookupEffectiveGuestPoliciesRequest", 2
    )
...
class SoftwareRecipeStepExecFile(_messages.Message):
  ...
  """
    ...
    allowedExitCodes = _messages.IntegerField(
        1, repeated=True, variant=_messages.Variant.INT32
    )
