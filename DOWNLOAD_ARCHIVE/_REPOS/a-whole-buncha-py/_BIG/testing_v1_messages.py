...
class AndroidTestLoop(_messages.Message):
  ...
  """
    ...
    scenarios = _messages.IntegerField(
...
class ManualSharding(_messages.Message):
  ...
  """
    ...
    testTargetsForShard = _messages.MessageField(
        "TestTargetsForShard", 1, repeated=True
    )
...
class TestEnvironmentCatalog(_messages.Message):
  ...
  """
    ...
    networkConfigurationCatalog = _messages.MessageField(
        "NetworkConfigurationCatalog", 4
    )
...
class TestSetup(_messages.Message):
  ...
  """
    ...
    environmentVariables = _messages.MessageField(
        "EnvironmentVariable", 5, repeated=True
    )
...
class TestingTestEnvironmentCatalogGetRequest(_messages.Message):
  ...
  """
    ...
    environmentType = _messages.EnumField(
        "EnvironmentTypeValueValuesEnum", 1, required=True
    )
