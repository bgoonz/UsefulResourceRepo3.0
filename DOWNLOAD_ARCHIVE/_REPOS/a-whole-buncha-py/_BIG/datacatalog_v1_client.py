...
from googlecloudsdk.third_party.apis.datacatalog.v1 import (
    datacatalog_v1_messages as messages,
)
...
class DatacatalogV1(base_api.BaseApiClient):
    ...
    class ProjectsLocationsEntryGroupsEntriesTagsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                DatacatalogV1.ProjectsLocationsEntryGroupsEntriesTagsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsEntryGroupsEntriesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                DatacatalogV1.ProjectsLocationsEntryGroupsEntriesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsEntryGroupsTagsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(DatacatalogV1.ProjectsLocationsEntryGroupsTagsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsEntryGroupsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(DatacatalogV1.ProjectsLocationsEntryGroupsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsTagTemplatesFieldsEnumValuesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                DatacatalogV1.ProjectsLocationsTagTemplatesFieldsEnumValuesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsTagTemplatesFieldsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                DatacatalogV1.ProjectsLocationsTagTemplatesFieldsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsTagTemplatesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(DatacatalogV1.ProjectsLocationsTagTemplatesService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsTaxonomiesPolicyTagsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                DatacatalogV1.ProjectsLocationsTaxonomiesPolicyTagsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsTaxonomiesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(DatacatalogV1.ProjectsLocationsTaxonomiesService, self).__init__(
                client
            )
            self._upload_configs = {}
