...
class ConfigManagementConfigSyncState(_messages.Message):
  ...
  """
    ...
    deploymentState = _messages.MessageField(
        "ConfigManagementConfigSyncDeploymentState", 1
    )
...
class ConfigManagementHierarchyControllerState(_messages.Message):
  ...
  """
    ...
    state = _messages.MessageField(
        "ConfigManagementHierarchyControllerDeploymentState", 1
    )
...
class ConfigManagementMembershipSpec(_messages.Message):
  ...
  """
    ...
    hierarchyController = _messages.MessageField(
        "ConfigManagementHierarchyControllerConfig", 3
    )
...
class ConfigManagementMembershipState(_messages.Message):
  ...
  """
    ...
    hierarchyControllerState = _messages.MessageField(
        "ConfigManagementHierarchyControllerState", 4
    )
    ...
    policyControllerState = _messages.MessageField(
        "ConfigManagementPolicyControllerState", 7
    )
...
class ConfigManagementPolicyControllerState(_messages.Message):
  ...
  """
    ...
    deploymentState = _messages.MessageField(
        "ConfigManagementGatekeeperDeploymentState", 1
    )
...
class ConfigManagementSyncError(_messages.Message):
  ...
  """
    ...
    errorResources = _messages.MessageField(
        "ConfigManagementErrorResource", 3, repeated=True
    )
