  ...
  """
    if is_insight_api:
        if args.project:
            ...
            service = recommender_service.FoldersInsightTypeInsightsService(api_version)
...
def GetDescribeRequestFromArgs(args, parent_resource, is_insight_api, api_version):
    """Returns the describe request from the user-specified arguments.
...
def GetMarkActiveRequestFromArgs(args, parent_resource, is_insight_api, api_version):
  ...
  """
    ...
    if api_version == RECOMMENDER_API_ALPHA_VERSION:
        message_request_field = (
            messages.GoogleCloudRecommenderV1alpha2MarkRecommendationClaimedRequest
        )
        mark_recommendation_claimed_request = messages.GoogleCloudRecommenderV1alpha2MarkRecommendationClaimedRequest(
            etag=args.etag,
            stateMetadata=ParseStateMetadata(
                args.state_metadata, message_request_field
            ),
        )
        if args.project:
        ...
        message_request_field = (
            messages.GoogleCloudRecommenderV1beta1MarkRecommendationClaimedRequest
        )
        ...
        message_request_field = (
            messages.GoogleCloudRecommenderV1MarkRecommendationClaimedRequest
        )
...
def GetMarkFailedRequestFromArgs(args, parent_resource, api_version):
  ...
  """
    ...
    if api_version == RECOMMENDER_API_ALPHA_VERSION:
        message_request_field = (
            messages.GoogleCloudRecommenderV1alpha2MarkRecommendationFailedRequest
        )
        ...
        message_request_field = (
            messages.GoogleCloudRecommenderV1MarkRecommendationFailedRequest
        )
...
def GetMarkDismissedRequestFromArgs(args, parent_resource, is_insight_api, api_version):
...
def GetMarkAcceptedRequestFromArgs(args, parent_resource, is_insight_api, api_version):
  ...
  """
    ...
    if api_version == RECOMMENDER_API_ALPHA_VERSION:
        if is_insight_api:
            message_request_field = (
                messages.GoogleCloudRecommenderV1alpha2MarkInsightAcceptedRequest
            )
        ...
        if is_insight_api:
            message_request_field = (
                messages.GoogleCloudRecommenderV1beta1MarkInsightAcceptedRequest
            )
        ...
        if is_insight_api:
            message_request_field = (
                messages.GoogleCloudRecommenderV1MarkInsightAcceptedRequest
            )
...
def GetMarkSucceededRequestFromArgs(args, parent_resource, api_version):
  ...
  """
    ...
    if api_version == RECOMMENDER_API_ALPHA_VERSION:
        message_request_field = (
            messages.GoogleCloudRecommenderV1alpha2MarkRecommendationSucceededRequest
        )
        ...
        message_request_field = (
            messages.GoogleCloudRecommenderV1beta1MarkRecommendationSucceededRequest
        )
        ...
        message_request_field = (
            messages.GoogleCloudRecommenderV1MarkRecommendationSucceededRequest
        )
