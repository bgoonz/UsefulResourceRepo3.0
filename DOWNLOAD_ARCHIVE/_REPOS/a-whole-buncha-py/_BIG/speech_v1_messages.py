...
class RecognitionMetadata(_messages.Message):
  ...
  """
    ...
    industryNaicsCodeOfAudio = _messages.IntegerField(
        2, variant=_messages.Variant.UINT32
    )
...
class SpeechRecognitionResult(_messages.Message):
  ...
  """
    ...
    alternatives = _messages.MessageField(
        "SpeechRecognitionAlternative", 1, repeated=True
    )
