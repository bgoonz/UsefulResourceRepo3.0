...
class InstanceOSPoliciesCompliance(_messages.Message):
  ...
  """
    ...
    osPolicyCompliances = _messages.MessageField(
        "InstanceOSPoliciesComplianceOSPolicyCompliance", 7, repeated=True
    )
...
class InstanceOSPoliciesComplianceOSPolicyCompliance(_messages.Message):
  ...
  """
    ...
    osPolicyResourceCompliances = _messages.MessageField(
        "OSPolicyResourceCompliance", 3, repeated=True
    )
...
class InventoryWindowsUpdatePackage(_messages.Message):
  ...
  """
    ...
    categories = _messages.MessageField(
        "InventoryWindowsUpdatePackageWindowsUpdateCategory", 1, repeated=True
    )
    description = _messages.StringField(2)
...
class ListInstanceOSPoliciesCompliancesResponse(_messages.Message):
  ...
  """
    ...
    instanceOsPoliciesCompliances = _messages.MessageField(
        "InstanceOSPoliciesCompliance", 1, repeated=True
    )
...
class ListVulnerabilityReportsResponse(_messages.Message):
  ...
  """
    ...
    nextPageToken = _messages.StringField(1)
    vulnerabilityReports = _messages.MessageField(
        "VulnerabilityReport", 2, repeated=True
    )
...
class OSPolicyAssignmentInstanceFilter(_messages.Message):
  ...
  """
    ...
    exclusionLabels = _messages.MessageField(
        "OSPolicyAssignmentLabelSet", 2, repeated=True
    )
    inclusionLabels = _messages.MessageField(
        "OSPolicyAssignmentLabelSet", 3, repeated=True
    )
    inventories = _messages.MessageField(
        "OSPolicyAssignmentInstanceFilterInventory", 4, repeated=True
    )
...
class OSPolicyResourceCompliance(_messages.Message):
  ...
  """
    ...
    execResourceOutput = _messages.MessageField(
        "OSPolicyResourceComplianceExecResourceOutput", 2
    )
...
class OSPolicyResourceGroup(_messages.Message):
  ...
  """
    ...
    inventoryFilters = _messages.MessageField(
        "OSPolicyInventoryFilter", 1, repeated=True
    )
...
class OSPolicyResourceRepositoryResource(_messages.Message):
  ...
  """
    ...
    zypper = _messages.MessageField(
        "OSPolicyResourceRepositoryResourceZypperRepository", 4
    )
...
class OsconfigProjectsLocationsInstanceOSPoliciesCompliancesGetRequest(
    _messages.Message
):
...
class OsconfigProjectsLocationsInstancesVulnerabilityReportsGetRequest(
    _messages.Message
):
...
class OsconfigProjectsLocationsInstancesVulnerabilityReportsListRequest(
    _messages.Message
):
...
class VulnerabilityReport(_messages.Message):
  ...
  """
    ...
    vulnerabilities = _messages.MessageField(
        "VulnerabilityReportVulnerability", 3, repeated=True
    )
...
class VulnerabilityReportVulnerabilityDetails(_messages.Message):
  ...
  """
    ...
    references = _messages.MessageField(
        "VulnerabilityReportVulnerabilityDetailsReference", 5, repeated=True
    )
...
encoding.AddCustomJsonFieldMapping(OSPolicyResource, "exec_", "exec")
