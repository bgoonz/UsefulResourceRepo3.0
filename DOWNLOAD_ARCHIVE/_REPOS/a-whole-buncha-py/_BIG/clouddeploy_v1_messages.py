...
class ClouddeployProjectsLocationsDeliveryPipelinesGetIamPolicyRequest(
    _messages.Message
):
...
class ClouddeployProjectsLocationsDeliveryPipelinesReleasesGetRequest(
    _messages.Message
):
...
class ClouddeployProjectsLocationsDeliveryPipelinesReleasesRolloutsGetRequest(
    _messages.Message
):
    r"""A
...
class ClouddeployProjectsLocationsDeliveryPipelinesSetIamPolicyRequest(
    _messages.Message
):
...
class ClouddeployProjectsLocationsDeliveryPipelinesTestIamPermissionsRequest(
    _messages.Message
):
