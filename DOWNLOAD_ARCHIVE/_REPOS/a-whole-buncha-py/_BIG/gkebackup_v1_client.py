...
from googlecloudsdk.third_party.apis.gkebackup.v1 import (
    gkebackup_v1_messages as messages,
)
...
class GkebackupV1(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_locations_backupPlans_backups_volumeBackups = self.ProjectsLocationsBackupPlansBackupsVolumeBackupsService(
            self
        )
        self.projects_locations_backupPlans_backups = self.ProjectsLocationsBackupPlansBackupsService(
            self
        )
        self.projects_locations_backupPlans = self.ProjectsLocationsBackupPlansService(
            self
        )
        self.projects_locations_operations = self.ProjectsLocationsOperationsService(
            self
        )
        self.projects_locations_restorePlans_restores_volumeRestores = self.ProjectsLocationsRestorePlansRestoresVolumeRestoresService(
            self
        )
        self.projects_locations_restorePlans_restores = self.ProjectsLocationsRestorePlansRestoresService(
            self
        )
        self.projects_locations_restorePlans = self.ProjectsLocationsRestorePlansService(
            self
        )
        self.projects_locations = self.ProjectsLocationsService(self)
        self.projects = self.ProjectsService(self)

    class ProjectsLocationsBackupPlansBackupsVolumeBackupsService(
        ...
        def __init__(self, client):
            super(
                GkebackupV1.ProjectsLocationsBackupPlansBackupsVolumeBackupsService,
                self,
            ).__init__(client)
    ...
    class ProjectsLocationsBackupPlansBackupsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                GkebackupV1.ProjectsLocationsBackupPlansBackupsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsBackupPlansService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(GkebackupV1.ProjectsLocationsBackupPlansService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsRestorePlansRestoresVolumeRestoresService(
        base_api.BaseApiService
    ):
        ...
        def __init__(self, client):
            super(
                GkebackupV1.ProjectsLocationsRestorePlansRestoresVolumeRestoresService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsRestorePlansRestoresService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                GkebackupV1.ProjectsLocationsRestorePlansRestoresService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsRestorePlansService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(GkebackupV1.ProjectsLocationsRestorePlansService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsService(base_api.BaseApiService):
        ...
        def DeleteOperations(self, request, global_params=None):
            r"""Deletes a long-running operation. This method indicates that the client is no longer interested in the operation result. It does not cancel the operation. If the server doesn't support this method, it returns `google.rpc.Code.UNIMPLEMENTED`.

      Args:
        request: (GkebackupProjectsLocationsDeleteOperationsRequest) input message
        global_params: (StandardQueryParameters, default: None) global arguments
      Returns:
        (Empty) The response message.
      """
            config = self.GetMethodConfig("DeleteOperations")
            return self._RunMethod(config, request, global_params=global_params)

        DeleteOperations.method_config = lambda: base_api.ApiMethodInfo(
            flat_path="v1/projects/{projectsId}/locations/{locationsId}/operations",
            http_method="DELETE",
            method_id="gkebackup.projects.locations.deleteOperations",
            ordered_params=["name"],
            path_params=["name"],
            query_params=[],
            relative_path="v1/{+name}/operations",
            request_field="",
            request_type_name="GkebackupProjectsLocationsDeleteOperationsRequest",
            response_type_name="Empty",
            supports_download=False,
        )
