...
class AccesscontextmanagerAccessPoliciesAccessLevelsTestIamPermissionsRequest(
    _messages.Message
):
    r"""A
...
class AccesscontextmanagerAccessPoliciesServicePerimetersCommitRequest(
  ...
  """
    ...
    commitServicePerimetersRequest = _messages.MessageField(
        "CommitServicePerimetersRequest", 1
    )
    parent = _messages.StringField(2, required=True)
...
class AccesscontextmanagerAccessPoliciesServicePerimetersReplaceAllRequest(
  ...
  """
    ...
    parent = _messages.StringField(1, required=True)
    replaceServicePerimetersRequest = _messages.MessageField(
        "ReplaceServicePerimetersRequest", 2
    )
...
class ListGcpUserAccessBindingsResponse(_messages.Message):
  ...
  """
    ...
    gcpUserAccessBindings = _messages.MessageField(
        "GcpUserAccessBinding", 1, repeated=True
    )
    nextPageToken = _messages.StringField(2)
