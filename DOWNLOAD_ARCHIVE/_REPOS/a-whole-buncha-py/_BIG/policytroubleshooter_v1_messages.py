...
class GoogleCloudPolicytroubleshooterV1ExplainedPolicy(_messages.Message):
  ...
  """
    ...
    bindingExplanations = _messages.MessageField(
        "GoogleCloudPolicytroubleshooterV1BindingExplanation", 2, repeated=True
    )
...
class GoogleCloudPolicytroubleshooterV1TroubleshootIamPolicyRequest(_messages.Message):
  ...
  """
    ...
    accessTuple = _messages.MessageField(
        "GoogleCloudPolicytroubleshooterV1AccessTuple", 1
    )
...
class GoogleCloudPolicytroubleshooterV1TroubleshootIamPolicyResponse(_messages.Message):
  ...
  """
    ...
    explainedPolicies = _messages.MessageField(
        "GoogleCloudPolicytroubleshooterV1ExplainedPolicy", 2, repeated=True
    )
