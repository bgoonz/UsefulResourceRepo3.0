...
from googlecloudsdk.third_party.apis.vmwareengine.v1 import (
    vmwareengine_v1_messages as messages,
)
...
class VmwareengineV1(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_locations_networkPolicies = self.ProjectsLocationsNetworkPoliciesService(
            self
        )
        ...
        self.projects_locations_privateClouds_clusters = self.ProjectsLocationsPrivateCloudsClustersService(
            self
        )
        self.projects_locations_privateClouds_hcxActivationKeys = self.ProjectsLocationsPrivateCloudsHcxActivationKeysService(
            self
        )
        self.projects_locations_privateClouds = self.ProjectsLocationsPrivateCloudsService(
            self
        )
    ...
    class ProjectsLocationsNetworkPoliciesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                VmwareengineV1.ProjectsLocationsNetworkPoliciesService, self
            ).__init__(client)
    ...
    class ProjectsLocationsNodeTypesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(VmwareengineV1.ProjectsLocationsNodeTypesService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(VmwareengineV1.ProjectsLocationsOperationsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsPrivateCloudsClustersService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                VmwareengineV1.ProjectsLocationsPrivateCloudsClustersService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsPrivateCloudsHcxActivationKeysService(
        ...
        def __init__(self, client):
            super(
                VmwareengineV1.ProjectsLocationsPrivateCloudsHcxActivationKeysService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsPrivateCloudsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(VmwareengineV1.ProjectsLocationsPrivateCloudsService, self).__init__(
                client
            )
            self._upload_configs = {}
