...
class Feature(_messages.Message):
  ...
  """
    ...
    anthosobservabilityFeatureSpec = _messages.MessageField(
        "AnthosObservabilityFeatureSpec", 1
    )
    apigeeFeatureSpec = _messages.MessageField("ApigeeFeatureSpec", 2)
    appdevexperienceFeatureSpec = _messages.MessageField(
        "AppDevExperienceFeatureSpec", 3
    )
    authorizerFeatureSpec = _messages.MessageField("AuthorizerFeatureSpec", 4)
    cloudauditloggingFeatureSpec = _messages.MessageField(
        "CloudAuditLoggingFeatureSpec", 5
    )
    cloudbuildFeatureSpec = _messages.MessageField("CloudBuildFeatureSpec", 6)
    configmanagementFeatureSpec = _messages.MessageField(
        "ConfigManagementFeatureSpec", 7
    )
    ...
    identityserviceFeatureSpec = _messages.MessageField(
        "IdentityServiceFeatureSpec", 13
    )
    labels = _messages.MessageField("LabelsValue", 14)
    meteringFeatureSpec = _messages.MessageField("MeteringFeatureSpec", 15)
    multiclusteringressFeatureSpec = _messages.MessageField(
        "MultiClusterIngressFeatureSpec", 16
    )
    multiclusterservicediscoveryFeatureSpec = _messages.MessageField(
        "MultiClusterServiceDiscoveryFeatureSpec", 17
    )
    name = _messages.StringField(18)
    servicedirectoryFeatureSpec = _messages.MessageField(
        "ServiceDirectoryFeatureSpec", 19
    )
    servicemeshFeatureSpec = _messages.MessageField("ServiceMeshFeatureSpec", 20)
    updateTime = _messages.StringField(21)
    workloadidentityplatformFeatureSpec = _messages.MessageField(
        "WorkloadIdentityPlatformFeatureSpec", 22
    )
...
class FeatureStateDetails(_messages.Message):
  ...
  """
    ...
    anthosobservabilityFeatureState = _messages.MessageField(
        "AnthosObservabilityFeatureState", 1
    )
    apigeeFeatureState = _messages.MessageField("ApigeeFeatureState", 2)
    appdevexperienceFeatureState = _messages.MessageField(
        "AppDevExperienceFeatureState", 3
    )
    authorizerFeatureState = _messages.MessageField("AuthorizerFeatureState", 4)
    cloudauditloggingFeatureState = _messages.MessageField(
        "CloudAuditLoggingFeatureState", 5
    )
    cloudbuildFeatureState = _messages.MessageField("CloudBuildFeatureState", 6)
    code = _messages.EnumField("CodeValueValuesEnum", 7)
    configmanagementFeatureState = _messages.MessageField(
        "ConfigManagementFeatureState", 8
    )
    description = _messages.StringField(9)
    helloworldFeatureState = _messages.MessageField("HelloWorldFeatureState", 10)
    identityserviceFeatureState = _messages.MessageField(
        "IdentityServiceFeatureState", 11
    )
    meteringFeatureState = _messages.MessageField("MeteringFeatureState", 12)
    multiclusteringressFeatureState = _messages.MessageField(
        "MultiClusterIngressFeatureState", 13
    )
    multiclusterservicediscoveryFeatureState = _messages.MessageField(
        "MultiClusterServiceDiscoveryFeatureState", 14
    )
    servicedirectoryFeatureState = _messages.MessageField(
        "ServiceDirectoryFeatureState", 15
    )
    servicemeshFeatureState = _messages.MessageField("ServiceMeshFeatureState", 16)
    updateTime = _messages.StringField(17)
    workloadidentityplatformFeatureState = _messages.MessageField(
        "WorkloadIdentityPlatformFeatureState", 18
    )
...
class GatekeeperDeploymentState(_messages.Message):
  ...
  """
    ...
    gatekeeperControllerManagerState = _messages.EnumField(
        "GatekeeperControllerManagerStateValueValuesEnum", 2
    )
...
class MeteringFeatureState(_messages.Message):
  ...
  """
    ...
    preciseLastMeasuredClusterVcpuCapacity = _messages.FloatField(
        2, variant=_messages.Variant.FLOAT
    )
...
class ServiceMeshFeatureState(_messages.Message):
  ...
  """
    ...
    analysisMessages = _messages.MessageField(
        "ServiceMeshAnalysisMessage", 1, repeated=True
    )
