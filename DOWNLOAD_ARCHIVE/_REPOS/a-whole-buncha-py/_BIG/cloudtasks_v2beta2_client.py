...
from googlecloudsdk.third_party.apis.cloudtasks.v2beta2 import (
    cloudtasks_v2beta2_messages as messages,
)
...
class CloudtasksV2beta2(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_locations_queues_tasks = self.ProjectsLocationsQueuesTasksService(
            self
        )
    ...
    class ProjectsLocationsQueuesTasksService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(CloudtasksV2beta2.ProjectsLocationsQueuesTasksService, self).__init__(
                client
            )
    ...
    class ProjectsLocationsQueuesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(CloudtasksV2beta2.ProjectsLocationsQueuesService, self).__init__(
                client
            )
            self._upload_configs = {}
