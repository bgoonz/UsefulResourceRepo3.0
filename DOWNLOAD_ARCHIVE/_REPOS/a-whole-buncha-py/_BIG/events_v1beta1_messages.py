...
class CustomResourceDefinitionSpec(_messages.Message):
  ...
  """
    ...
    additionalPrinterColumns = _messages.MessageField(
        "CustomResourceColumnDefinition", 1, repeated=True
    )
    ...
    versions = _messages.MessageField(
        "CustomResourceDefinitionVersion", 8, repeated=True
    )
...
class ObjectMeta(_messages.Message):
  ...
  """
    ...
    deletionGracePeriodSeconds = _messages.IntegerField(
...
encoding.AddCustomJsonFieldMapping(JSONSchemaProps, "not_", "not")
encoding.AddCustomJsonFieldMapping(ListMeta, "continue_", "continue")
