...
from googlecloudsdk.third_party.apis.container.v1alpha1 import (
    container_v1alpha1_messages as messages,
)
...
class ContainerV1alpha1(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_aggregated_usableSubnetworks = self.ProjectsAggregatedUsableSubnetworksService(
            self
        )
        ...
        self.projects_locations_clusters_well_known = self.ProjectsLocationsClustersWellKnownService(
            self
        )
        ...
        self.projects_zones_clusters_nodePools = self.ProjectsZonesClustersNodePoolsService(
            self
        )
    ...
    class ProjectsAggregatedUsableSubnetworksService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ContainerV1alpha1.ProjectsAggregatedUsableSubnetworksService, self
            ).__init__(client)
    ...
    class ProjectsLocationsClustersNodePoolsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ContainerV1alpha1.ProjectsLocationsClustersNodePoolsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsClustersWellKnownService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ContainerV1alpha1.ProjectsLocationsClustersWellKnownService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsClustersService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(ContainerV1alpha1.ProjectsLocationsClustersService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(ContainerV1alpha1.ProjectsLocationsOperationsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsZonesClustersNodePoolsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ContainerV1alpha1.ProjectsZonesClustersNodePoolsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsZonesOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(ContainerV1alpha1.ProjectsZonesOperationsService, self).__init__(
                client
            )
            self._upload_configs = {}
