...
from googlecloudsdk.third_party.apis.alloydb.v1alpha1 import (
    alloydb_v1alpha1_messages as messages,
)
...
class AlloydbV1alpha1(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_locations_clusters_backups = self.ProjectsLocationsClustersBackupsService(
            self
        )
        self.projects_locations_clusters_instances = self.ProjectsLocationsClustersInstancesService(
            self
        )
        self.projects_locations_clusters_users = self.ProjectsLocationsClustersUsersService(
            self
        )
        ...
        self.projects_locations_supportedDatabaseFlags = self.ProjectsLocationsSupportedDatabaseFlagsService(
            self
        )
    ...
    class ProjectsLocationsBackupsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(AlloydbV1alpha1.ProjectsLocationsBackupsService, self).__init__(
                client
            )
    ...
    class ProjectsLocationsClustersBackupsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                AlloydbV1alpha1.ProjectsLocationsClustersBackupsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsClustersInstancesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                AlloydbV1alpha1.ProjectsLocationsClustersInstancesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsClustersUsersService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(AlloydbV1alpha1.ProjectsLocationsClustersUsersService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsClustersService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(AlloydbV1alpha1.ProjectsLocationsClustersService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsInstancesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(AlloydbV1alpha1.ProjectsLocationsInstancesService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(AlloydbV1alpha1.ProjectsLocationsOperationsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsSupportedDatabaseFlagsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                AlloydbV1alpha1.ProjectsLocationsSupportedDatabaseFlagsService, self
            ).__init__(client)
            self._upload_configs = {}
