...
class TestCreateAndExtend(SynchronousTestCase):
    ...
    def test_extend_idof(self):
        ...
        meta_schema = {u"$id": "the://wrong/id/", u"__test__": correct_id}
...
class TestLegacyTypeChecking(SynchronousTestCase):
    ...
    def test_extend(self):
        ...
        Extended = validators.extend(Validator, validators={u"new": new})
        self.assertEqual(
            (
                Extended.VALIDATORS,
                Extended.META_SCHEMA,
    ...
    def test_extending_a_legacy_validator_with_a_type_checker_errors(self):
        ...
        with self.assertRaises(TypeError) as e:
            validators.extend(Validator, validators={}, type_checker=TypeChecker())
...
class TestValidationErrorDetails(TestCase):
    ...
    def test_boolean_schema_False(self):
        ...
        self.assertEqual(
            ...
            ("False schema does not allow 12", None, None, 12, False, deque([])),
        )

    def test_ref(self):
        ref, schema = "someRef", {"additionalProperties": {"type": "integer"}}
        validator = validators.Draft7Validator(
            {"$ref": ref}, resolver=validators.RefResolver("", {}, store={ref: schema})
        )
