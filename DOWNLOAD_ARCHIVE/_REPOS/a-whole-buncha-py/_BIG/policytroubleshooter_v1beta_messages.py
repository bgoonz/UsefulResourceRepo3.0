...
class GoogleCloudPolicytroubleshooterV1betaExplainedPolicy(_messages.Message):
  ...
  """
    ...
    bindingExplanations = _messages.MessageField(
        "GoogleCloudPolicytroubleshooterV1betaBindingExplanation", 2, repeated=True
    )
...
class GoogleCloudPolicytroubleshooterV1betaTroubleshootIamPolicyRequest(
  ...
  """
    ...
    accessTuple = _messages.MessageField(
        "GoogleCloudPolicytroubleshooterV1betaAccessTuple", 1
    )
...
class GoogleCloudPolicytroubleshooterV1betaTroubleshootIamPolicyResponse(
  ...
  """
    ...
    explainedPolicies = _messages.MessageField(
        "GoogleCloudPolicytroubleshooterV1betaExplainedPolicy", 2, repeated=True
    )
