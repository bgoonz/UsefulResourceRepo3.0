...
class LookupConfigsRequest(_messages.Message):
  ...
  """
    ...
    configTypes = _messages.EnumField(
        "ConfigTypesValueListEntryValuesEnum", 1, repeated=True
    )
...
class OsconfigProjectsZonesInstancesReportPatchJobInstanceDetailsRequest(
    _messages.Message
):
  ...
  """
    ...
    reportPatchJobInstanceDetailsRequest = _messages.MessageField(
        "ReportPatchJobInstanceDetailsRequest", 1
    )
    resource = _messages.StringField(2, required=True)
