...
class SpannerV1(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_instances_backupOperations = self.ProjectsInstancesBackupOperationsService(
            self
        )
        self.projects_instances_backups_operations = self.ProjectsInstancesBackupsOperationsService(
            self
        )
        self.projects_instances_backups = self.ProjectsInstancesBackupsService(self)
        self.projects_instances_databaseOperations = self.ProjectsInstancesDatabaseOperationsService(
            self
        )
        self.projects_instances_databases_operations = self.ProjectsInstancesDatabasesOperationsService(
            self
        )
        self.projects_instances_databases_sessions = self.ProjectsInstancesDatabasesSessionsService(
            self
        )
        self.projects_instances_databases = self.ProjectsInstancesDatabasesService(self)
        self.projects_instances_operations = self.ProjectsInstancesOperationsService(
            self
        )
    ...
    class ProjectsInstancesBackupOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(SpannerV1.ProjectsInstancesBackupOperationsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsInstancesBackupsOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(SpannerV1.ProjectsInstancesBackupsOperationsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsInstancesDatabaseOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(SpannerV1.ProjectsInstancesDatabaseOperationsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsInstancesDatabasesOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(SpannerV1.ProjectsInstancesDatabasesOperationsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsInstancesDatabasesSessionsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(SpannerV1.ProjectsInstancesDatabasesSessionsService, self).__init__(
                client
            )
            self._upload_configs = {}
