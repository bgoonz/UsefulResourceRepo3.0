...
class ArtifactregistryProjectsLocationsRepositoriesPackagesDeleteRequest(
    _messages.Message
):
...
class ArtifactregistryProjectsLocationsRepositoriesPackagesGetRequest(
    _messages.Message
):
...
class ArtifactregistryProjectsLocationsRepositoriesPackagesTagsDeleteRequest(
    _messages.Message
):
...
class ArtifactregistryProjectsLocationsRepositoriesPackagesTagsGetRequest(
    _messages.Message
):
...
class ListFilesResponse(_messages.Message):
  ...
  """
    ...
    files = _messages.MessageField(
        "GoogleDevtoolsArtifactregistryV1beta2File", 1, repeated=True
    )
...
class ProjectSettings(_messages.Message):
  ...
  """
    ...
    legacyRedirectionState = _messages.EnumField(
        "LegacyRedirectionStateValueValuesEnum", 1
    )
