...
from googlecloudsdk.third_party.apis.clouddeploy.v1 import (
    clouddeploy_v1_messages as messages,
)
...
class ClouddeployV1(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_locations_deliveryPipelines_releases_rollouts = self.ProjectsLocationsDeliveryPipelinesReleasesRolloutsService(
            self
        )
        self.projects_locations_deliveryPipelines_releases = self.ProjectsLocationsDeliveryPipelinesReleasesService(
            self
        )
        self.projects_locations_deliveryPipelines = self.ProjectsLocationsDeliveryPipelinesService(
            self
        )
    ...
    class ProjectsLocationsDeliveryPipelinesReleasesRolloutsService(
        ...
        def __init__(self, client):
            super(
                ClouddeployV1.ProjectsLocationsDeliveryPipelinesReleasesRolloutsService,
                self,
            ).__init__(client)
    ...
    class ProjectsLocationsDeliveryPipelinesReleasesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ClouddeployV1.ProjectsLocationsDeliveryPipelinesReleasesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsDeliveryPipelinesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ClouddeployV1.ProjectsLocationsDeliveryPipelinesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(ClouddeployV1.ProjectsLocationsOperationsService, self).__init__(
                client
            )
            self._upload_configs = {}
