...
class ConnectionProfile(_messages.Message):
  ...
  """
    ...
    staticServiceIpConnectivity = _messages.MessageField(
        "StaticServiceIpConnectivity", 11
    )
...
class DatastreamProjectsLocationsConnectionProfilesDiscoverRequest(_messages.Message):
  ...
  """
    ...
    discoverConnectionProfileRequest = _messages.MessageField(
        "DiscoverConnectionProfileRequest", 1
    )
...
class DatastreamProjectsLocationsPrivateConnectionsRoutesDeleteRequest(
    _messages.Message
):
