...
from googlecloudsdk.third_party.apis.datamigration.v1 import (
    datamigration_v1_messages as messages,
)
...
class DatamigrationV1(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_locations_migrationJobs = self.ProjectsLocationsMigrationJobsService(
            self
        )
    ...
    class ProjectsLocationsConnectionProfilesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                DatamigrationV1.ProjectsLocationsConnectionProfilesService, self
            ).__init__(client)
    ...
    class ProjectsLocationsMigrationJobsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(DatamigrationV1.ProjectsLocationsMigrationJobsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(DatamigrationV1.ProjectsLocationsOperationsService, self).__init__(
                client
            )
            self._upload_configs = {}
