...
from googlecloudsdk.third_party.apis.appengine.v1 import (
    appengine_v1_messages as messages,
)
...
class AppengineV1(base_api.BaseApiClient):
    ...
    class AppsServicesVersionsInstancesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(AppengineV1.AppsServicesVersionsInstancesService, self).__init__(
                client
            )
            self._upload_configs = {}
