...
from googlecloudsdk.third_party.apis.binaryauthorization.v1alpha2 import (
    binaryauthorization_v1alpha2_messages as messages,
)
...
class BinaryauthorizationV1alpha2(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_attestors_attestations = self.ProjectsAttestorsAttestationsService(
            self
        )
        self.projects_attestors = self.ProjectsAttestorsService(self)
        self.projects_continuousValidationConfig = self.ProjectsContinuousValidationConfigService(
            self
        )
    ...
    class ProjectsAttestorsAttestationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                BinaryauthorizationV1alpha2.ProjectsAttestorsAttestationsService, self
            ).__init__(client)
    ...
    class ProjectsAttestorsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(BinaryauthorizationV1alpha2.ProjectsAttestorsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsContinuousValidationConfigService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                BinaryauthorizationV1alpha2.ProjectsContinuousValidationConfigService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsPolicyService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(BinaryauthorizationV1alpha2.ProjectsPolicyService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class SystempolicyService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(BinaryauthorizationV1alpha2.SystempolicyService, self).__init__(
                client
            )
            self._upload_configs = {}
