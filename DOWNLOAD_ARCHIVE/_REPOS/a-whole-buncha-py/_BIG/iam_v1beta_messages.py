...
class GoogleIamAdminV1AuditData(_messages.Message):
  ...
  """
    ...
    permissionDelta = _messages.MessageField(
        "GoogleIamAdminV1AuditDataPermissionDelta", 1
    )
...
class GoogleIamV1betaListWorkloadIdentityPoolProvidersResponse(_messages.Message):
  ...
  """
    ...
    workloadIdentityPoolProviders = _messages.MessageField(
        "GoogleIamV1betaWorkloadIdentityPoolProvider", 2, repeated=True
    )
...
class GoogleIamV1betaListWorkloadIdentityPoolsResponse(_messages.Message):
  ...
  """
    ...
    nextPageToken = _messages.StringField(1)
    workloadIdentityPools = _messages.MessageField(
        "GoogleIamV1betaWorkloadIdentityPool", 2, repeated=True
    )
...
class IamProjectsLocationsWorkloadIdentityPoolsCreateRequest(_messages.Message):
  ...
  """
    ...
    googleIamV1betaWorkloadIdentityPool = _messages.MessageField(
        "GoogleIamV1betaWorkloadIdentityPool", 1
    )
...
class IamProjectsLocationsWorkloadIdentityPoolsProvidersCreateRequest(
  ...
  """
    ...
    googleIamV1betaWorkloadIdentityPoolProvider = _messages.MessageField(
        "GoogleIamV1betaWorkloadIdentityPoolProvider", 1
    )
    parent = _messages.StringField(2, required=True)
    workloadIdentityPoolProviderId = _messages.StringField(3)


class IamProjectsLocationsWorkloadIdentityPoolsProvidersDeleteRequest(
    _messages.Message
):
...
class IamProjectsLocationsWorkloadIdentityPoolsProvidersOperationsGetRequest(
    _messages.Message
):
...
class IamProjectsLocationsWorkloadIdentityPoolsProvidersUndeleteRequest(
    _messages.Message
):
  ...
  """
    ...
    googleIamV1betaUndeleteWorkloadIdentityPoolProviderRequest = _messages.MessageField(
        "GoogleIamV1betaUndeleteWorkloadIdentityPoolProviderRequest", 1
    )
    name = _messages.StringField(2, required=True)
...
class IamProjectsLocationsWorkloadIdentityPoolsUndeleteRequest(_messages.Message):
  ...
  """
    ...
    googleIamV1betaUndeleteWorkloadIdentityPoolRequest = _messages.MessageField(
        "GoogleIamV1betaUndeleteWorkloadIdentityPoolRequest", 1
    )
    name = _messages.StringField(2, required=True)
