...
class NotebooksProjectsLocationsInstancesSetAcceleratorRequest(_messages.Message):
  ...
  """
    ...
    name = _messages.StringField(1, required=True)
    setInstanceAcceleratorRequest = _messages.MessageField(
        "SetInstanceAcceleratorRequest", 2
    )
...
class NotebooksProjectsLocationsInstancesSetMachineTypeRequest(_messages.Message):
  ...
  """
    ...
    name = _messages.StringField(1, required=True)
    setInstanceMachineTypeRequest = _messages.MessageField(
        "SetInstanceMachineTypeRequest", 2
    )
...
class NotebooksProjectsLocationsInstancesUpgradeInternalRequest(_messages.Message):
  ...
  """
    ...
    name = _messages.StringField(1, required=True)
    upgradeInstanceInternalRequest = _messages.MessageField(
        "UpgradeInstanceInternalRequest", 2
    )
...
class ReservationAffinity(_messages.Message):
  ...
  """
    ...
    consumeReservationType = _messages.EnumField(
        "ConsumeReservationTypeValueValuesEnum", 1
    )
