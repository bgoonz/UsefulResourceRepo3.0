...
class ClientTlsPolicy(_messages.Message):
  ...
  """
    ...
    clientCertificate = _messages.MessageField(
        "GoogleCloudNetworksecurityV1beta1CertificateProvider", 1
    )
    createTime = _messages.StringField(2)
    description = _messages.StringField(3)
    labels = _messages.MessageField("LabelsValue", 4)
...
class GoogleCloudNetworksecurityV1beta1CertificateProvider(_messages.Message):
  ...
  """
    ...
    grpcEndpoint = _messages.MessageField(
        "GoogleCloudNetworksecurityV1beta1GrpcEndpoint", 2
    )
...
class GoogleIamV1CloudAuditOptions(_messages.Message):
  ...
  """
    ...
    authorizationLoggingOptions = _messages.MessageField(
        "AuthorizationLoggingOptions", 1
    )
...
class ServerTlsPolicy(_messages.Message):
  ...
  """
    ...
    serverCertificate = _messages.MessageField(
        "GoogleCloudNetworksecurityV1beta1CertificateProvider", 7
    )
    updateTime = _messages.StringField(8)
...
encoding.AddCustomJsonFieldMapping(GoogleIamV1Rule, "in_", "in")
