...
from googlecloudsdk.third_party.apis.essentialcontacts.v1alpha1 import (
    essentialcontacts_v1alpha1_messages as messages,
)
...
class EssentialcontactsV1alpha1(base_api.BaseApiClient):
    ...
    class FoldersContactsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(EssentialcontactsV1alpha1.FoldersContactsService, self).__init__(
                client
            )
    ...
    class OrganizationsContactsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                EssentialcontactsV1alpha1.OrganizationsContactsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsContactsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(EssentialcontactsV1alpha1.ProjectsContactsService, self).__init__(
                client
            )
            self._upload_configs = {}
