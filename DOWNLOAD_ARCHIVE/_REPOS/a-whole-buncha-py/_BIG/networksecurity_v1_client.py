...
from googlecloudsdk.third_party.apis.networksecurity.v1 import (
    networksecurity_v1_messages as messages,
)
...
class NetworksecurityV1(base_api.BaseApiClient):
    ...
    class ProjectsLocationsAuthorizationPoliciesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                NetworksecurityV1.ProjectsLocationsAuthorizationPoliciesService, self
            ).__init__(client)
    ...
    class ProjectsLocationsClientTlsPoliciesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                NetworksecurityV1.ProjectsLocationsClientTlsPoliciesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(NetworksecurityV1.ProjectsLocationsOperationsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsServerTlsPoliciesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                NetworksecurityV1.ProjectsLocationsServerTlsPoliciesService, self
            ).__init__(client)
            self._upload_configs = {}
