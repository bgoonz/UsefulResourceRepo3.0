...
from googlecloudsdk.third_party.apis.cloudidentity.v1beta1 import (
    cloudidentity_v1beta1_messages as messages,
)
...
class CloudidentityV1beta1(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.devices_deviceUsers_clientStates = self.DevicesDeviceUsersClientStatesService(
            self
        )
    ...
    class CustomersUserinvitationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(CloudidentityV1beta1.CustomersUserinvitationsService, self).__init__(
                client
            )
    ...
    class DevicesDeviceUsersClientStatesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                CloudidentityV1beta1.DevicesDeviceUsersClientStatesService, self
            ).__init__(client)
            self._upload_configs = {}
