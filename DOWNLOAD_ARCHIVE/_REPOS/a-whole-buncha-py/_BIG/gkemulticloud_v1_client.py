...
from googlecloudsdk.third_party.apis.gkemulticloud.v1 import (
    gkemulticloud_v1_messages as messages,
)
...
class GkemulticloudV1(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_locations_awsClusters_awsNodePools = self.ProjectsLocationsAwsClustersAwsNodePoolsService(
            self
        )
        self.projects_locations_awsClusters_well_known = self.ProjectsLocationsAwsClustersWellKnownService(
            self
        )
        self.projects_locations_awsClusters = self.ProjectsLocationsAwsClustersService(
            self
        )
        self.projects_locations_azureClients = self.ProjectsLocationsAzureClientsService(
            self
        )
        self.projects_locations_azureClusters_azureNodePools = self.ProjectsLocationsAzureClustersAzureNodePoolsService(
            self
        )
        self.projects_locations_azureClusters_well_known = self.ProjectsLocationsAzureClustersWellKnownService(
            self
        )
        self.projects_locations_azureClusters = self.ProjectsLocationsAzureClustersService(
            self
        )
    ...
    class ProjectsLocationsAwsClustersAwsNodePoolsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                GkemulticloudV1.ProjectsLocationsAwsClustersAwsNodePoolsService, self
            ).__init__(client)
    ...
    class ProjectsLocationsAwsClustersWellKnownService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                GkemulticloudV1.ProjectsLocationsAwsClustersWellKnownService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsAwsClustersService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(GkemulticloudV1.ProjectsLocationsAwsClustersService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsAzureClientsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(GkemulticloudV1.ProjectsLocationsAzureClientsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsAzureClustersAzureNodePoolsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                GkemulticloudV1.ProjectsLocationsAzureClustersAzureNodePoolsService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsAzureClustersWellKnownService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                GkemulticloudV1.ProjectsLocationsAzureClustersWellKnownService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsAzureClustersService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(GkemulticloudV1.ProjectsLocationsAzureClustersService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(GkemulticloudV1.ProjectsLocationsOperationsService, self).__init__(
                client
            )
            self._upload_configs = {}
