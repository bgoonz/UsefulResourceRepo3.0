...
from googlecloudsdk.third_party.apis.notebooks.v1 import (
    notebooks_v1_messages as messages,
)
...
class NotebooksV1(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_locations_executions = self.ProjectsLocationsExecutionsService(
            self
        )
    ...
    class ProjectsLocationsEnvironmentsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(NotebooksV1.ProjectsLocationsEnvironmentsService, self).__init__(
                client
            )
