...
class UserServiceError(ProtocolBuffer.ProtocolMessage):
    ...
    _TYPES = _BuildTagLookupTable(
        {0: ProtocolBuffer.Encoder.NUMERIC}, 0, ProtocolBuffer.Encoder.MAX_TYPE
    )
...
class CreateLoginURLResponse(ProtocolBuffer.ProtocolMessage):
    ...
    _TYPES = _BuildTagLookupTable(
        {0: ProtocolBuffer.Encoder.NUMERIC, 1: ProtocolBuffer.Encoder.STRING},
        1,
        ProtocolBuffer.Encoder.MAX_TYPE,
    )
...
class CreateLogoutURLRequest(ProtocolBuffer.ProtocolMessage):
    ...
    _TEXT = _BuildTagLookupTable(
        {0: "ErrorCode", 1: "destination_url", 2: "auth_domain"}, 2
    )
...
class CreateLogoutURLResponse(ProtocolBuffer.ProtocolMessage):
    ...
    def has_logout_url(self):
        return self.has_logout_url_

    def MergeFrom(self, x):
        assert x is not self
        if x.has_logout_url():
            self.set_logout_url(x.logout_url())

    def Equals(self, x):
        if x is self:
            return 1
        if self.has_logout_url_ != x.has_logout_url_:
            return 0
        if self.has_logout_url_ and self.logout_url_ != x.logout_url_:
            return 0
        return 1
    ...
    def ByteSize(self):
        n = 0
        if self.has_logout_url_:
            n += 1 + self.lengthString(len(self.logout_url_))
        return n
    ...
    _TEXT = _BuildTagLookupTable({0: "ErrorCode", 1: "logout_url"}, 1)
...
class GetOAuthUserRequest(ProtocolBuffer.ProtocolMessage):
    ...
    def Equals(self, x):
        ...
        if (
            ...
            and self.request_writer_permission_ != x.request_writer_permission_
        ):
            return 0
        return 1
    ...
    _TEXT = _BuildTagLookupTable(
        {0: "ErrorCode", 1: "scope", 2: "scopes", 3: "request_writer_permission"}, 3
    )
...
class GetOAuthUserResponse(ProtocolBuffer.ProtocolMessage):
    ...
    def user_organization(self):
        return self.user_organization_
    ...
    def has_user_organization(self):
        return self.has_user_organization_

    def is_admin(self):
        return self.is_admin_
    ...
    def has_is_admin(self):
        return self.has_is_admin_
    ...
    def is_project_writer(self):
        return self.is_project_writer_
    ...
    def has_is_project_writer(self):
        return self.has_is_project_writer_
    ...
    def MergeFrom(self, x):
        ...
        if x.has_user_id():
            self.set_user_id(x.user_id())
        if x.has_auth_domain():
            self.set_auth_domain(x.auth_domain())
        if x.has_user_organization():
            self.set_user_organization(x.user_organization())
        if x.has_is_admin():
            self.set_is_admin(x.is_admin())
        if x.has_client_id():
            self.set_client_id(x.client_id())
        for i in range(x.scopes_size()):
            self.add_scopes(x.scopes(i))
        if x.has_is_project_writer():
            self.set_is_project_writer(x.is_project_writer())
    ...
    def Equals(self, x):
        ...
        if self.has_email_ and self.email_ != x.email_:
            return 0
        if self.has_user_id_ != x.has_user_id_:
            return 0
        if self.has_user_id_ and self.user_id_ != x.user_id_:
            return 0
        if self.has_auth_domain_ != x.has_auth_domain_:
            return 0
        if self.has_auth_domain_ and self.auth_domain_ != x.auth_domain_:
            return 0
        if self.has_user_organization_ != x.has_user_organization_:
            return 0
        if (
            self.has_user_organization_
            and self.user_organization_ != x.user_organization_
        ):
            return 0
        if self.has_is_admin_ != x.has_is_admin_:
            return 0
        if self.has_is_admin_ and self.is_admin_ != x.is_admin_:
            return 0
        if self.has_client_id_ != x.has_client_id_:
            return 0
        if self.has_client_id_ and self.client_id_ != x.client_id_:
            return 0
        if len(self.scopes_) != len(x.scopes_):
            return 0
        for e1, e2 in zip(self.scopes_, x.scopes_):
            if e1 != e2:
                return 0
        if self.has_is_project_writer_ != x.has_is_project_writer_:
            return 0
        if (
            self.has_is_project_writer_
            and self.is_project_writer_ != x.is_project_writer_
        ):
            return 0
        return 1
    ...
    def ByteSize(self):
        n = 0
        if self.has_email_:
            n += 1 + self.lengthString(len(self.email_))
        if self.has_user_id_:
            n += 1 + self.lengthString(len(self.user_id_))
        if self.has_auth_domain_:
            n += 1 + self.lengthString(len(self.auth_domain_))
        if self.has_user_organization_:
        ...
        if self.has_is_admin_:
            n += 2
        if self.has_client_id_:
            n += 1 + self.lengthString(len(self.client_id_))
        n += 1 * len(self.scopes_)
        for i in range(len(self.scopes_)):
            n += self.lengthString(len(self.scopes_[i]))
        if self.has_is_project_writer_:
