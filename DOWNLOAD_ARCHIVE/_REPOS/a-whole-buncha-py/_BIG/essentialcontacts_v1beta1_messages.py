...
class EssentialcontactsFoldersContactsComputeRequest(_messages.Message):
  ...
  """
    ...
    notificationCategories = _messages.EnumField(
        "NotificationCategoriesValueValuesEnum", 1, repeated=True
    )
...
class EssentialcontactsFoldersContactsCreateRequest(_messages.Message):
  ...
  """
    ...
    googleCloudEssentialcontactsV1beta1Contact = _messages.MessageField(
        "GoogleCloudEssentialcontactsV1beta1Contact", 1
    )
...
class EssentialcontactsFoldersContactsSendTestMessageRequest(_messages.Message):
  ...
  """
    ...
    googleCloudEssentialcontactsV1beta1SendTestMessageRequest = _messages.MessageField(
        "GoogleCloudEssentialcontactsV1beta1SendTestMessageRequest", 1
    )
...
class GoogleCloudEssentialcontactsV1beta1ComputeContactsResponse(_messages.Message):
  ...
  """
    ...
    contacts = _messages.MessageField(
        "GoogleCloudEssentialcontactsV1beta1Contact", 1, repeated=True
    )
