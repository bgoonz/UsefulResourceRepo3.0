...
class VisionV1(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_locations_productSets_products = self.ProjectsLocationsProductSetsProductsService(
            self
        )
        self.projects_locations_productSets = self.ProjectsLocationsProductSetsService(
            self
        )
        self.projects_locations_products_referenceImages = self.ProjectsLocationsProductsReferenceImagesService(
            self
        )
    ...
    class ProjectsLocationsProductSetsProductsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(VisionV1.ProjectsLocationsProductSetsProductsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsProductsReferenceImagesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                VisionV1.ProjectsLocationsProductsReferenceImagesService, self
            ).__init__(client)
            self._upload_configs = {}
