...
class CloudiotV1(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_locations_registries_devices_configVersions = self.ProjectsLocationsRegistriesDevicesConfigVersionsService(
            self
        )
        self.projects_locations_registries_devices_states = self.ProjectsLocationsRegistriesDevicesStatesService(
            self
        )
        self.projects_locations_registries_devices = self.ProjectsLocationsRegistriesDevicesService(
            self
        )
        self.projects_locations_registries_groups_devices = self.ProjectsLocationsRegistriesGroupsDevicesService(
            self
        )
        self.projects_locations_registries_groups = self.ProjectsLocationsRegistriesGroupsService(
            self
        )
        self.projects_locations_registries = self.ProjectsLocationsRegistriesService(
            self
        )
        self.projects_locations = self.ProjectsLocationsService(self)
        self.projects = self.ProjectsService(self)

    class ProjectsLocationsRegistriesDevicesConfigVersionsService(
        ...
        def __init__(self, client):
            super(
                CloudiotV1.ProjectsLocationsRegistriesDevicesConfigVersionsService, self
            ).__init__(client)
    ...
    class ProjectsLocationsRegistriesDevicesStatesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                CloudiotV1.ProjectsLocationsRegistriesDevicesStatesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsRegistriesDevicesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(CloudiotV1.ProjectsLocationsRegistriesDevicesService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsRegistriesGroupsDevicesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                CloudiotV1.ProjectsLocationsRegistriesGroupsDevicesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsRegistriesGroupsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(CloudiotV1.ProjectsLocationsRegistriesGroupsService, self).__init__(
                client
            )
            self._upload_configs = {}
