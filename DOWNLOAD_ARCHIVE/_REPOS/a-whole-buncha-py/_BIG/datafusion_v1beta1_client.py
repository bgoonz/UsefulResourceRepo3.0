...
from googlecloudsdk.third_party.apis.datafusion.v1beta1 import (
    datafusion_v1beta1_messages as messages,
)
...
class DatafusionV1beta1(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_locations_instances_dnsPeerings = self.ProjectsLocationsInstancesDnsPeeringsService(
            self
        )
        self.projects_locations_instances_namespaces = self.ProjectsLocationsInstancesNamespacesService(
            self
        )
    ...
    class ProjectsLocationsInstancesDnsPeeringsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                DatafusionV1beta1.ProjectsLocationsInstancesDnsPeeringsService, self
            ).__init__(client)
    ...
    class ProjectsLocationsInstancesNamespacesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                DatafusionV1beta1.ProjectsLocationsInstancesNamespacesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsInstancesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(DatafusionV1beta1.ProjectsLocationsInstancesService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(DatafusionV1beta1.ProjectsLocationsOperationsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsVersionsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(DatafusionV1beta1.ProjectsLocationsVersionsService, self).__init__(
                client
            )
            self._upload_configs = {}
