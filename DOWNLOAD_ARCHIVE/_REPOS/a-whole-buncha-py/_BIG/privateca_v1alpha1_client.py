...
from googlecloudsdk.third_party.apis.privateca.v1alpha1 import (
    privateca_v1alpha1_messages as messages,
)
...
class PrivatecaV1alpha1(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_locations_certificateAuthorities_certificateRevocationLists = self.ProjectsLocationsCertificateAuthoritiesCertificateRevocationListsService(
            self
        )
        self.projects_locations_certificateAuthorities_certificates = self.ProjectsLocationsCertificateAuthoritiesCertificatesService(
            self
        )
        self.projects_locations_certificateAuthorities = self.ProjectsLocationsCertificateAuthoritiesService(
            self
        )
        self.projects_locations_operations = self.ProjectsLocationsOperationsService(
            self
        )
        self.projects_locations_reusableConfigs = self.ProjectsLocationsReusableConfigsService(
            self
        )
        self.projects_locations = self.ProjectsLocationsService(self)
        self.projects = self.ProjectsService(self)

    class ProjectsLocationsCertificateAuthoritiesCertificateRevocationListsService(
        ...
        def __init__(self, client):
            super(
                PrivatecaV1alpha1.ProjectsLocationsCertificateAuthoritiesCertificateRevocationListsService,
                self,
            ).__init__(client)
    ...
    class ProjectsLocationsCertificateAuthoritiesCertificatesService(
        base_api.BaseApiService
    ):
        ...
        def __init__(self, client):
            super(
                PrivatecaV1alpha1.ProjectsLocationsCertificateAuthoritiesCertificatesService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsCertificateAuthoritiesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                PrivatecaV1alpha1.ProjectsLocationsCertificateAuthoritiesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(PrivatecaV1alpha1.ProjectsLocationsOperationsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsReusableConfigsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                PrivatecaV1alpha1.ProjectsLocationsReusableConfigsService, self
            ).__init__(client)
            self._upload_configs = {}
