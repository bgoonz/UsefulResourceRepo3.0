...
from googlecloudsdk.third_party.apis.anthosevents.v1 import (
    anthosevents_v1_messages as messages,
)
...
class AnthoseventsV1(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.api_v1_namespaces_serviceaccounts = self.ApiV1NamespacesServiceaccountsService(
            self
        )
        ...
        self.namespaces_cloudauditlogssources = self.NamespacesCloudauditlogssourcesService(
            self
        )
        self.namespaces_cloudpubsubsources = self.NamespacesCloudpubsubsourcesService(
            self
        )
        self.namespaces_cloudschedulersources = self.NamespacesCloudschedulersourcesService(
            self
        )
        self.namespaces_cloudstoragesources = self.NamespacesCloudstoragesourcesService(
            self
        )
        ...
        self.projects_locations_configmaps = self.ProjectsLocationsConfigmapsService(
            self
        )
        self.projects_locations_namespaces_configmaps = self.ProjectsLocationsNamespacesConfigmapsService(
            self
        )
        self.projects_locations_namespaces_serviceaccounts = self.ProjectsLocationsNamespacesServiceaccountsService(
            self
        )
        self.projects_locations_namespaces = self.ProjectsLocationsNamespacesService(
            self
        )
        self.projects_locations_secrets = self.ProjectsLocationsSecretsService(self)
        self.projects_locations_serviceaccounts = self.ProjectsLocationsServiceaccountsService(
            self
        )
    ...
    class ApiV1NamespacesConfigmapsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(AnthoseventsV1.ApiV1NamespacesConfigmapsService, self).__init__(
                client
            )
    ...
    class ApiV1NamespacesServiceaccountsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(AnthoseventsV1.ApiV1NamespacesServiceaccountsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class CustomresourcedefinitionsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(AnthoseventsV1.CustomresourcedefinitionsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class NamespacesCloudauditlogssourcesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(AnthoseventsV1.NamespacesCloudauditlogssourcesService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class NamespacesCloudpubsubsourcesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(AnthoseventsV1.NamespacesCloudpubsubsourcesService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class NamespacesCloudschedulersourcesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(AnthoseventsV1.NamespacesCloudschedulersourcesService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class NamespacesCloudstoragesourcesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(AnthoseventsV1.NamespacesCloudstoragesourcesService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsConfigmapsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(AnthoseventsV1.ProjectsLocationsConfigmapsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsNamespacesConfigmapsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                AnthoseventsV1.ProjectsLocationsNamespacesConfigmapsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsNamespacesServiceaccountsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                AnthoseventsV1.ProjectsLocationsNamespacesServiceaccountsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsNamespacesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(AnthoseventsV1.ProjectsLocationsNamespacesService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsServiceaccountsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                AnthoseventsV1.ProjectsLocationsServiceaccountsService, self
            ).__init__(client)
            self._upload_configs = {}
