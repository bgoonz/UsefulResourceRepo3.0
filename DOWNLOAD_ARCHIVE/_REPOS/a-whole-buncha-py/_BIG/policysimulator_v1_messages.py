    ...
    """
      ...
      """
            ...
            value = _messages.MessageField(
                "GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembership", 2
            )
...
class GoogleCloudPolicysimulatorV1ExplainedAccess(_messages.Message):
  ...
  """
    ...
    policies = _messages.MessageField(
        "GoogleCloudPolicysimulatorV1ExplainedPolicy", 3, repeated=True
    )
...
class GoogleCloudPolicysimulatorV1ExplainedPolicy(_messages.Message):
  ...
  """
    ...
    bindingExplanations = _messages.MessageField(
        "GoogleCloudPolicysimulatorV1BindingExplanation", 2, repeated=True
    )
...
class GoogleCloudPolicysimulatorV1ListReplayResultsResponse(_messages.Message):
  ...
  """
    ...
    replayResults = _messages.MessageField(
        "GoogleCloudPolicysimulatorV1ReplayResult", 2, repeated=True
    )
...
class GoogleCloudPolicysimulatorV1ReplayDiff(_messages.Message):
  ...
  """
    ...
    accessDiff = _messages.MessageField(
        "GoogleCloudPolicysimulatorV1AccessStateDiff", 1
    )
...
class PolicysimulatorFoldersLocationsReplaysCreateRequest(_messages.Message):
  ...
  """
    ...
    googleCloudPolicysimulatorV1Replay = _messages.MessageField(
        "GoogleCloudPolicysimulatorV1Replay", 1
    )
