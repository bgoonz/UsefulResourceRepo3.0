...
class AutomaticStatus(_messages.Message):
  ...
  """
    ...
    customerManagedEncryption = _messages.MessageField(
        "CustomerManagedEncryptionStatus", 1
    )
...
class SecretmanagerProjectsSecretsVersionsDestroyRequest(_messages.Message):
  ...
  """
    ...
    destroySecretVersionRequest = _messages.MessageField(
        "DestroySecretVersionRequest", 1
    )
    name = _messages.StringField(2, required=True)
...
class SecretmanagerProjectsSecretsVersionsDisableRequest(_messages.Message):
  ...
  """
    ...
    disableSecretVersionRequest = _messages.MessageField(
        "DisableSecretVersionRequest", 1
    )
    name = _messages.StringField(2, required=True)
