...
from googlecloudsdk.third_party.apis.artifactregistry.v1beta2 import (
    artifactregistry_v1beta2_messages as messages,
)
...
class ArtifactregistryV1beta2(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_locations_repositories_aptArtifacts = self.ProjectsLocationsRepositoriesAptArtifactsService(
            self
        )
        self.projects_locations_repositories_aptartifacts = self.ProjectsLocationsRepositoriesAptartifactsService(
            self
        )
        self.projects_locations_repositories_files = self.ProjectsLocationsRepositoriesFilesService(
            self
        )
        self.projects_locations_repositories_packages_tags = self.ProjectsLocationsRepositoriesPackagesTagsService(
            self
        )
        self.projects_locations_repositories_packages_versions = self.ProjectsLocationsRepositoriesPackagesVersionsService(
            self
        )
        self.projects_locations_repositories_packages = self.ProjectsLocationsRepositoriesPackagesService(
            self
        )
        self.projects_locations_repositories_yumArtifacts = self.ProjectsLocationsRepositoriesYumArtifactsService(
            self
        )
        self.projects_locations_repositories_yumartifacts = self.ProjectsLocationsRepositoriesYumartifactsService(
            self
        )
        self.projects_locations_repositories = self.ProjectsLocationsRepositoriesService(
            self
        )
    ...
    class ProjectsLocationsOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ArtifactregistryV1beta2.ProjectsLocationsOperationsService, self
            ).__init__(client)
    ...
    class ProjectsLocationsRepositoriesAptArtifactsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ArtifactregistryV1beta2.ProjectsLocationsRepositoriesAptArtifactsService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsRepositoriesFilesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ArtifactregistryV1beta2.ProjectsLocationsRepositoriesFilesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsRepositoriesPackagesTagsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ArtifactregistryV1beta2.ProjectsLocationsRepositoriesPackagesTagsService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsRepositoriesPackagesVersionsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ArtifactregistryV1beta2.ProjectsLocationsRepositoriesPackagesVersionsService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsRepositoriesPackagesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ArtifactregistryV1beta2.ProjectsLocationsRepositoriesPackagesService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsRepositoriesYumArtifactsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ArtifactregistryV1beta2.ProjectsLocationsRepositoriesYumArtifactsService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsRepositoriesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                ArtifactregistryV1beta2.ProjectsLocationsRepositoriesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(ArtifactregistryV1beta2.ProjectsLocationsService, self).__init__(
                client
            )
            self._upload_configs = {}
