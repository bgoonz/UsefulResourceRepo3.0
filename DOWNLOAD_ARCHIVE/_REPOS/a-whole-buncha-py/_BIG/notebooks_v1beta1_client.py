...
from googlecloudsdk.third_party.apis.notebooks.v1beta1 import (
    notebooks_v1beta1_messages as messages,
)
...
class NotebooksV1beta1(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_locations_environments = self.ProjectsLocationsEnvironmentsService(
            self
        )
    ...
    class ProjectsLocationsEnvironmentsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(NotebooksV1beta1.ProjectsLocationsEnvironmentsService, self).__init__(
                client
            )
    ...
    class ProjectsLocationsInstancesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(NotebooksV1beta1.ProjectsLocationsInstancesService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(NotebooksV1beta1.ProjectsLocationsOperationsService, self).__init__(
                client
            )
            self._upload_configs = {}
