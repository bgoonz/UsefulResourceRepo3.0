...
from googlecloudsdk.third_party.apis.firestore.v1 import (
    firestore_v1_messages as messages,
)
...
class FirestoreV1(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_databases_collectionGroups_fields = self.ProjectsDatabasesCollectionGroupsFieldsService(
            self
        )
        self.projects_databases_collectionGroups_indexes = self.ProjectsDatabasesCollectionGroupsIndexesService(
            self
        )
        self.projects_databases_collectionGroups = self.ProjectsDatabasesCollectionGroupsService(
            self
        )
        self.projects_databases_documents = self.ProjectsDatabasesDocumentsService(self)
        self.projects_databases_operations = self.ProjectsDatabasesOperationsService(
            self
        )
    ...
    class ProjectsDatabasesCollectionGroupsFieldsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                FirestoreV1.ProjectsDatabasesCollectionGroupsFieldsService, self
            ).__init__(client)
    ...
    class ProjectsDatabasesCollectionGroupsIndexesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                FirestoreV1.ProjectsDatabasesCollectionGroupsIndexesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsDatabasesCollectionGroupsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(FirestoreV1.ProjectsDatabasesCollectionGroupsService, self).__init__(
                client
            )
            self._upload_configs = {}
