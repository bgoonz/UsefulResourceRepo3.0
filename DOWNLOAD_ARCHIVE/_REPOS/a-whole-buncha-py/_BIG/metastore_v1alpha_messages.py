...
class LocationMetadata(_messages.Message):
  ...
  """
    ...
    supportedHiveMetastoreVersions = _messages.MessageField(
        "HiveMetastoreVersion", 1, repeated=True
    )
...
class MetastoreProjectsLocationsServicesBackupsTestIamPermissionsRequest(
    _messages.Message
):
...
class MetastoreProjectsLocationsServicesDatabasesTestIamPermissionsRequest(
    _messages.Message
):
