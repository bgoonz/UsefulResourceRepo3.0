...
from googlecloudsdk.third_party.apis.securitycenter.v1beta2 import (
    securitycenter_v1beta2_messages as messages,
)
...
class SecuritycenterV1beta2(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.folders_containerThreatDetectionSettings = self.FoldersContainerThreatDetectionSettingsService(
            self
        )
        self.folders_eventThreatDetectionSettings = self.FoldersEventThreatDetectionSettingsService(
            self
        )
        self.folders_securityHealthAnalyticsSettings = self.FoldersSecurityHealthAnalyticsSettingsService(
            self
        )
        self.folders_webSecurityScannerSettings = self.FoldersWebSecurityScannerSettingsService(
            self
        )
        self.folders = self.FoldersService(self)
        self.organizations_containerThreatDetectionSettings = self.OrganizationsContainerThreatDetectionSettingsService(
            self
        )
        self.organizations_eventThreatDetectionSettings = self.OrganizationsEventThreatDetectionSettingsService(
            self
        )
        self.organizations_securityHealthAnalyticsSettings = self.OrganizationsSecurityHealthAnalyticsSettingsService(
            self
        )
        self.organizations_webSecurityScannerSettings = self.OrganizationsWebSecurityScannerSettingsService(
            self
        )
        self.organizations = self.OrganizationsService(self)
        self.projects_containerThreatDetectionSettings = self.ProjectsContainerThreatDetectionSettingsService(
            self
        )
        self.projects_eventThreatDetectionSettings = self.ProjectsEventThreatDetectionSettingsService(
            self
        )
        self.projects_locations_clusters_containerThreatDetectionSettings = self.ProjectsLocationsClustersContainerThreatDetectionSettingsService(
            self
        )
        self.projects_locations_clusters = self.ProjectsLocationsClustersService(self)
        self.projects_locations = self.ProjectsLocationsService(self)
        self.projects_securityHealthAnalyticsSettings = self.ProjectsSecurityHealthAnalyticsSettingsService(
            self
        )
        self.projects_webSecurityScannerSettings = self.ProjectsWebSecurityScannerSettingsService(
            self
        )
    ...
    class FoldersContainerThreatDetectionSettingsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                SecuritycenterV1beta2.FoldersContainerThreatDetectionSettingsService,
                self,
            ).__init__(client)
    ...
    class FoldersEventThreatDetectionSettingsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                SecuritycenterV1beta2.FoldersEventThreatDetectionSettingsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class FoldersSecurityHealthAnalyticsSettingsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                SecuritycenterV1beta2.FoldersSecurityHealthAnalyticsSettingsService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class FoldersWebSecurityScannerSettingsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                SecuritycenterV1beta2.FoldersWebSecurityScannerSettingsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class OrganizationsContainerThreatDetectionSettingsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                SecuritycenterV1beta2.OrganizationsContainerThreatDetectionSettingsService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class OrganizationsEventThreatDetectionSettingsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                SecuritycenterV1beta2.OrganizationsEventThreatDetectionSettingsService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class OrganizationsSecurityHealthAnalyticsSettingsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                SecuritycenterV1beta2.OrganizationsSecurityHealthAnalyticsSettingsService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class OrganizationsWebSecurityScannerSettingsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                SecuritycenterV1beta2.OrganizationsWebSecurityScannerSettingsService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsContainerThreatDetectionSettingsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                SecuritycenterV1beta2.ProjectsContainerThreatDetectionSettingsService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsEventThreatDetectionSettingsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                SecuritycenterV1beta2.ProjectsEventThreatDetectionSettingsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsClustersContainerThreatDetectionSettingsService(
        ...
        def __init__(self, client):
            super(
                SecuritycenterV1beta2.ProjectsLocationsClustersContainerThreatDetectionSettingsService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsClustersService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                SecuritycenterV1beta2.ProjectsLocationsClustersService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsSecurityHealthAnalyticsSettingsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                SecuritycenterV1beta2.ProjectsSecurityHealthAnalyticsSettingsService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsWebSecurityScannerSettingsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                SecuritycenterV1beta2.ProjectsWebSecurityScannerSettingsService, self
            ).__init__(client)
            self._upload_configs = {}
