...
class CertificateInfo(_messages.Message):
  ...
  """
    ...
    certificateValidationState = _messages.EnumField(
        "CertificateValidationStateValueValuesEnum", 3
    )
...
class Device(_messages.Message):
  ...
  """
    ...
    endpointVerificationSpecificAttributes = _messages.MessageField(
        "EndpointVerificationSpecificAttributes", 13
    )
