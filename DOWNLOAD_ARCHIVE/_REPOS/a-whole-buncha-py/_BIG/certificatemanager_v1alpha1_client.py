...
from googlecloudsdk.third_party.apis.certificatemanager.v1alpha1 import (
    certificatemanager_v1alpha1_messages as messages,
)
...
class CertificatemanagerV1alpha1(base_api.BaseApiClient):
    ...
    class ProjectsLocationsCertificateMapsCertificateMapEntriesService(
        ...
        def __init__(self, client):
            super(
                CertificatemanagerV1alpha1.ProjectsLocationsCertificateMapsCertificateMapEntriesService,
                self,
            ).__init__(client)
    ...
    class ProjectsLocationsCertificateMapsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                CertificatemanagerV1alpha1.ProjectsLocationsCertificateMapsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsCertificatesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                CertificatemanagerV1alpha1.ProjectsLocationsCertificatesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                CertificatemanagerV1alpha1.ProjectsLocationsOperationsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(CertificatemanagerV1alpha1.ProjectsLocationsService, self).__init__(
                client
            )
            self._upload_configs = {}
