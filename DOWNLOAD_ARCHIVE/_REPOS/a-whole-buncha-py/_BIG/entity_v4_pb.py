...
class PartitionId(ProtocolBuffer.ProtocolMessage):
    ...
    _Constants_NAMES = {100: "MAX_DIMENSION_TAG"}
    ...
    _TEXT = _BuildTagLookupTable({0: "ErrorCode", 3: "dataset_id", 4: "namespace"}, 4)
...
class Key(ProtocolBuffer.ProtocolMessage):
    ...
    def IsInitialized(self, debug_strs=None):
        initialized = 1
        if self.has_partition_id_ and not self.partition_id_.IsInitialized(debug_strs):
            initialized = 0
    ...
    _TEXT = _BuildTagLookupTable(
        {0: "ErrorCode", 1: "partition_id", 2: "path_element"}, 2
    )
...
class Value(ProtocolBuffer.ProtocolMessage):
    ...
    def Equals(self, x):
        ...
        if (
            self.has_timestamp_microseconds_value_
            and self.timestamp_microseconds_value_ != x.timestamp_microseconds_value_
        ):
            return 0
        ...
        if self.has_geo_point_value_ != x.has_geo_point_value_:
            return 0
        if self.has_geo_point_value_ and self.geo_point_value_ != x.geo_point_value_:
            return 0
    ...
    def IsInitialized(self, debug_strs=None):
        ...
        if self.has_key_value_ and not self.key_value_.IsInitialized(debug_strs):
            initialized = 0
        if self.has_entity_value_ and not self.entity_value_.IsInitialized(debug_strs):
            initialized = 0
...
class Entity(ProtocolBuffer.ProtocolMessage):
    ...
    _TEXT = _BuildTagLookupTable({0: "ErrorCode", 1: "key", 2: "property"}, 2)
