...
class DataprocV1(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.projects_locations_autoscalingPolicies = self.ProjectsLocationsAutoscalingPoliciesService(
            self
        )
        self.projects_locations_batches = self.ProjectsLocationsBatchesService(self)
        self.projects_locations_workflowTemplates = self.ProjectsLocationsWorkflowTemplatesService(
            self
        )
        self.projects_locations = self.ProjectsLocationsService(self)
        self.projects_regions_autoscalingPolicies = self.ProjectsRegionsAutoscalingPoliciesService(
            self
        )
        ...
        self.projects_regions_workflowTemplates = self.ProjectsRegionsWorkflowTemplatesService(
            self
        )
    ...
    class ProjectsLocationsAutoscalingPoliciesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                DataprocV1.ProjectsLocationsAutoscalingPoliciesService, self
            ).__init__(client)
    ...
    class ProjectsLocationsWorkflowTemplatesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(DataprocV1.ProjectsLocationsWorkflowTemplatesService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsRegionsAutoscalingPoliciesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(DataprocV1.ProjectsRegionsAutoscalingPoliciesService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsRegionsWorkflowTemplatesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(DataprocV1.ProjectsRegionsWorkflowTemplatesService, self).__init__(
                client
            )
            self._upload_configs = {}
