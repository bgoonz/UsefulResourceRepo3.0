...
from googlecloudsdk.third_party.apis.datamigration.v1alpha2 import (
    datamigration_v1alpha2_messages as messages,
)
...
class DatamigrationV1alpha2(base_api.BaseApiClient):
    ...
    class ProjectsLocationsConnectionProfilesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                DatamigrationV1alpha2.ProjectsLocationsConnectionProfilesService, self
            ).__init__(client)
    ...
    class ProjectsLocationsMigrationJobsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                DatamigrationV1alpha2.ProjectsLocationsMigrationJobsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                DatamigrationV1alpha2.ProjectsLocationsOperationsService, self
            ).__init__(client)
            self._upload_configs = {}
