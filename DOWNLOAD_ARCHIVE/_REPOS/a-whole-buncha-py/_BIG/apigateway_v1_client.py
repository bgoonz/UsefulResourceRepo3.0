...
from googlecloudsdk.third_party.apis.apigateway.v1 import (
    apigateway_v1_messages as messages,
)
...
class ApigatewayV1(base_api.BaseApiClient):
    ...
    class ProjectsLocationsApisConfigsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(ApigatewayV1.ProjectsLocationsApisConfigsService, self).__init__(
                client
            )
    ...
    class ProjectsLocationsOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(ApigatewayV1.ProjectsLocationsOperationsService, self).__init__(
                client
            )
            self._upload_configs = {}
