...
from googlecloudsdk.third_party.apis.appengine.v1beta import (
    appengine_v1beta_messages as messages,
)
...
class AppengineV1beta(base_api.BaseApiClient):
    ...
    def __init__(
        ...
        self.apps_services_versions_instances = self.AppsServicesVersionsInstancesService(
            self
        )
    ...
    class AppsAuthorizedCertificatesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(AppengineV1beta.AppsAuthorizedCertificatesService, self).__init__(
                client
            )
    ...
    class AppsFirewallIngressRulesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(AppengineV1beta.AppsFirewallIngressRulesService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class AppsServicesVersionsInstancesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(AppengineV1beta.AppsServicesVersionsInstancesService, self).__init__(
                client
            )
            self._upload_configs = {}
