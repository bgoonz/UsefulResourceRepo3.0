...
class CloudFunction(_messages.Message):
  ...
  """
    ...
    buildEnvironmentVariables = _messages.MessageField(
        "BuildEnvironmentVariablesValue", 2
    )
    ...
    secretEnvironmentVariables = _messages.MessageField(
        "SecretEnvVar", 20, repeated=True
    )
    ...
    vpcConnectorEgressSettings = _messages.EnumField(
        "VpcConnectorEgressSettingsValueValuesEnum", 32
    )
...
class CloudfunctionsProjectsLocationsFunctionsTestIamPermissionsRequest(
    _messages.Message
):
...
class GoogleCloudFunctionsV2alphaOperationMetadata(_messages.Message):
  ...
  """
    ...
    stages = _messages.MessageField(
        "GoogleCloudFunctionsV2alphaStage", 6, repeated=True
    )
...
class GoogleCloudFunctionsV2alphaStage(_messages.Message):
  ...
  """
    ...
    stateMessages = _messages.MessageField(
        "GoogleCloudFunctionsV2alphaStateMessage", 6, repeated=True
    )
...
class GoogleCloudFunctionsV2betaStage(_messages.Message):
  ...
  """
    ...
    state = _messages.EnumField("StateValueValuesEnum", 5)
    stateMessages = _messages.MessageField(
        "GoogleCloudFunctionsV2betaStateMessage", 6, repeated=True
    )
