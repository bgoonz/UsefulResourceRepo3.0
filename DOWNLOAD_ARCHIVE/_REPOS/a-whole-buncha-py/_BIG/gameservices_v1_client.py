...
from googlecloudsdk.third_party.apis.gameservices.v1 import (
    gameservices_v1_messages as messages,
)
...
class GameservicesV1(base_api.BaseApiClient):
    ...
    class ProjectsLocationsGameServerDeploymentsConfigsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                GameservicesV1.ProjectsLocationsGameServerDeploymentsConfigsService,
                self,
            ).__init__(client)
    ...
    class ProjectsLocationsGameServerDeploymentsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                GameservicesV1.ProjectsLocationsGameServerDeploymentsService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(GameservicesV1.ProjectsLocationsOperationsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsRealmsGameServerClustersService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                GameservicesV1.ProjectsLocationsRealmsGameServerClustersService, self
            ).__init__(client)
            self._upload_configs = {}
