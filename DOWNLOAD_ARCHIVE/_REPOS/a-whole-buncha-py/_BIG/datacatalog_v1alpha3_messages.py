...
class DatacatalogProjectsCrawlersCreateRequest(_messages.Message):
  ...
  """
    ...
    googleCloudDatacatalogV1alpha3Crawler = _messages.MessageField(
        "GoogleCloudDatacatalogV1alpha3Crawler", 2
    )
    parent = _messages.StringField(3, required=True)
...
class DatacatalogProjectsCrawlersPatchRequest(_messages.Message):
  ...
  """
    ...
    googleCloudDatacatalogV1alpha3Crawler = _messages.MessageField(
        "GoogleCloudDatacatalogV1alpha3Crawler", 1
    )
...
class DatacatalogProjectsCrawlersRunRequest(_messages.Message):
  ...
  """
    ...
    googleCloudDatacatalogV1alpha3RunCrawlerRequest = _messages.MessageField(
        "GoogleCloudDatacatalogV1alpha3RunCrawlerRequest", 1
    )
    name = _messages.StringField(2, required=True)
...
class DatacatalogProjectsTaxonomiesCategoriesCreateRequest(_messages.Message):
  ...
  """
    ...
    googleCloudDatacatalogV1alpha3Category = _messages.MessageField(
        "GoogleCloudDatacatalogV1alpha3Category", 1
    )
...
class DatacatalogProjectsTaxonomiesCategoriesTestIamPermissionsRequest(
    _messages.Message
):
...
class DatacatalogProjectsTaxonomiesCreateRequest(_messages.Message):
  ...
  """
    ...
    googleCloudDatacatalogV1alpha3Taxonomy = _messages.MessageField(
        "GoogleCloudDatacatalogV1alpha3Taxonomy", 1
    )
    parent = _messages.StringField(2, required=True)
...
class DatacatalogProjectsTaxonomiesImportRequest(_messages.Message):
  ...
  """
    ...
    googleCloudDatacatalogV1alpha3ImportTaxonomiesRequest = _messages.MessageField(
        "GoogleCloudDatacatalogV1alpha3ImportTaxonomiesRequest", 1
    )
    parent = _messages.StringField(2, required=True)
...
class GoogleCloudDatacatalogV1alpha3BucketScope(_messages.Message):
  ...
  """
    ...
    buckets = _messages.MessageField(
        "GoogleCloudDatacatalogV1alpha3BucketSpec", 1, repeated=True
    )
...
class GoogleCloudDatacatalogV1alpha3CrawlerConfig(_messages.Message):
  ...
  """
    ...
    organizationScope = _messages.MessageField(
        "GoogleCloudDatacatalogV1alpha3ParentOrganizationScope", 4
    )
    projectScope = _messages.MessageField(
        "GoogleCloudDatacatalogV1alpha3ParentProjectScope", 5
    )
    scheduledRun = _messages.MessageField(
        "GoogleCloudDatacatalogV1alpha3ScheduledRun", 6
    )
...
class GoogleCloudDatacatalogV1alpha3ExportTaxonomiesResponse(_messages.Message):
  ...
  """
    ...
    taxonomies = _messages.MessageField(
        "GoogleCloudDatacatalogV1alpha3SerializedTaxonomy", 1, repeated=True
    )
...
class GoogleCloudDatacatalogV1alpha3ImportTaxonomiesResponse(_messages.Message):
  ...
  """
    ...
    taxonomies = _messages.MessageField(
        "GoogleCloudDatacatalogV1alpha3Taxonomy", 1, repeated=True
    )
...
class GoogleCloudDatacatalogV1alpha3ListCategoriesResponse(_messages.Message):
  ...
  """
    ...
    categories = _messages.MessageField(
        "GoogleCloudDatacatalogV1alpha3Category", 1, repeated=True
    )
...
class GoogleCloudDatacatalogV1alpha3ListCrawlerRunsResponse(_messages.Message):
  ...
  """
    ...
    crawlerRuns = _messages.MessageField(
        "GoogleCloudDatacatalogV1alpha3CrawlerRun", 1, repeated=True
    )
    nextPageToken = _messages.StringField(2)
...
class GoogleCloudDatacatalogV1alpha3ListCrawlersResponse(_messages.Message):
  ...
  """
    ...
    crawlers = _messages.MessageField(
        "GoogleCloudDatacatalogV1alpha3Crawler", 1, repeated=True
    )
    nextPageToken = _messages.StringField(2)
...
class GoogleCloudDatacatalogV1alpha3ListTaxonomiesResponse(_messages.Message):
  ...
  """
    ...
    taxonomies = _messages.MessageField(
        "GoogleCloudDatacatalogV1alpha3Taxonomy", 2, repeated=True
    )
...
class GoogleCloudDatacatalogV1alpha3SerializedCategory(_messages.Message):
  ...
  """
    ...
    childCategories = _messages.MessageField(
        "GoogleCloudDatacatalogV1alpha3SerializedCategory", 1, repeated=True
    )
    description = _messages.StringField(2)
    displayName = _messages.StringField(3)
