...
from googlecloudsdk.third_party.apis.privateca.v1beta1 import (
    privateca_v1beta1_messages as messages,
)
...
class PrivatecaV1beta1(base_api.BaseApiClient):
    ...
    class ProjectsLocationsCertificateAuthoritiesCertificateRevocationListsService(
        ...
        def __init__(self, client):
            super(
                PrivatecaV1beta1.ProjectsLocationsCertificateAuthoritiesCertificateRevocationListsService,
                self,
            ).__init__(client)
    ...
    class ProjectsLocationsCertificateAuthoritiesCertificatesService(
        ...
        def __init__(self, client):
            super(
                PrivatecaV1beta1.ProjectsLocationsCertificateAuthoritiesCertificatesService,
                self,
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsCertificateAuthoritiesService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                PrivatecaV1beta1.ProjectsLocationsCertificateAuthoritiesService, self
            ).__init__(client)
            self._upload_configs = {}
    ...
    class ProjectsLocationsOperationsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(PrivatecaV1beta1.ProjectsLocationsOperationsService, self).__init__(
                client
            )
            self._upload_configs = {}
    ...
    class ProjectsLocationsReusableConfigsService(base_api.BaseApiService):
        ...
        def __init__(self, client):
            super(
                PrivatecaV1beta1.ProjectsLocationsReusableConfigsService, self
            ).__init__(client)
            self._upload_configs = {}
