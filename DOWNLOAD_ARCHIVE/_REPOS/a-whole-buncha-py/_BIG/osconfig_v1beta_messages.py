...
class EffectiveGuestPolicy(_messages.Message):
  ...
  """
    ...
    packageRepositories = _messages.MessageField(
        "EffectiveGuestPolicySourcedPackageRepository", 1, repeated=True
    )
    packages = _messages.MessageField(
        "EffectiveGuestPolicySourcedPackage", 2, repeated=True
    )
    softwareRecipes = _messages.MessageField(
        "EffectiveGuestPolicySourcedSoftwareRecipe", 3, repeated=True
    )
...
class OsconfigProjectsZonesInstancesLookupEffectiveGuestPolicyRequest(
  ...
  """
    ...
    lookupEffectiveGuestPolicyRequest = _messages.MessageField(
        "LookupEffectiveGuestPolicyRequest", 2
    )
